...
@Controller('motivos-desconto')
export class MotivoDescontoController {
  constructor(private readonly service: MotivoDescontoService) {}
  ...
  @Post()
  criar(
    @Body() dto: CriarMotivoDescontoDto,
    @TenantAtual() idTenacidade: bigint,
    @UsuarioAtual() idUsuario: bigint,
    @Req() req: Request,
  ) {
  ...
  atualizar(
    @Param('id') id: string,
    @Body() dto: AtualizarMotivoDescontoDto,
    @TenantAtual() idTenacidade: bigint,
    @UsuarioAtual() idUsuario: bigint,
    @Req() req: Request,
  ) {
