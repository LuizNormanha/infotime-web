...
@Controller('series-nota-fiscal-servico')
export class SerieNotaFiscalServicoController {
  constructor(private readonly service: SerieNotaFiscalServicoService) {}
  ...
  @Post()
  criar(
    @Body() dto: CriarSerieNotaFiscalServicoDto,
    @TenantAtual() idTenacidade: bigint,
    @UsuarioAtual() idUsuario: bigint,
    @Req() req: Request,
  ) {
  ...
  atualizar(
    @Param('id') id: string,
    @Body() dto: AtualizarSerieNotaFiscalServicoDto,
    @TenantAtual() idTenacidade: bigint,
    @UsuarioAtual() idUsuario: bigint,
    @Req() req: Request,
  ) {
