...
@Controller('usuario-permissoes')
export class UsuarioPermissoesController {
  constructor(private readonly service: UsuarioPermissoesService) {}
  ...
  @Post()
  criar(
    @Body() dto: CriarUsuarioPermissaoDto,
    @TenantAtual() idTenacidade: bigint,
    @UsuarioAtual() idUsuario: bigint,
    @Req() req: Request,
  ) {
  ...
  atualizar(
    @Param('id') id: string,
    @Body() dto: AtualizarUsuarioPermissaoDto,
    @TenantAtual() idTenacidade: bigint,
    @UsuarioAtual() idUsuario: bigint,
    @Req() req: Request,
  ) {
