...
export class TipoAplicacaoController {
  constructor(private readonly service: TipoAplicacaoService) {}
  ...
  @Post()
  criar(
    @Body() dto: CriarTipoAplicacaoDto,
    @TenantAtual() idTenacidade: bigint,
    @UsuarioAtual() idUsuario: bigint,
    @Req() req: Request,
  ) {
  ...
  atualizar(
    @Param('id') id: string,
    @Body() dto: AtualizarTipoAplicacaoDto,
    @TenantAtual() idTenacidade: bigint,
    @UsuarioAtual() idUsuario: bigint,
    @Req() req: Request,
  ) {
