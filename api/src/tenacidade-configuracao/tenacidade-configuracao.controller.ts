...
@Controller('tenacidade-configuracoes')
export class TenacidadeConfiguracaoController {
  constructor(private readonly service: TenacidadeConfiguracaoService) {}
  ...
  @Post()
  criar(
    @Body() dto: CriarTenacidadeConfiguracaoDto,
    @TenantAtual() idTenacidade: bigint,
    @UsuarioAtual() idUsuario: bigint,
    @Req() req: Request,
  ) {
  ...
  atualizar(
    @Param('id') id: string,
    @Body() dto: AtualizarTenacidadeConfiguracaoDto,
    @TenantAtual() idTenacidade: bigint,
    @UsuarioAtual() idUsuario: bigint,
    @Req() req: Request,
  ) {
