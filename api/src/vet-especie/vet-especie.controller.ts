...
@Controller('vet-especies')
export class VetEspecieController {
  constructor(private readonly service: VetEspecieService) {}
  ...
  atualizar(
    @Param('id') id: string,
    @Body() dto: AtualizarVetEspecieDto,
    @TenantAtual() idTenacidade: bigint,
    @UsuarioAtual() idUsuario: bigint,
    @Req() req: Request,
  ) {
