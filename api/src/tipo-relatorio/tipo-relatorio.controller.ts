...
@Controller('tipos-relatorio')
export class TipoRelatorioController {
  constructor(private readonly service: TipoRelatorioService) {}
  ...
  @Post()
  criar(
    @Body() dto: CriarTipoRelatorioDto,
    @TenantAtual() idTenacidade: bigint,
    @UsuarioAtual() idUsuario: bigint,
    @Req() req: Request,
  ) {
  ...
  atualizar(
    @Param('id') id: string,
    @Body() dto: AtualizarTipoRelatorioDto,
    @TenantAtual() idTenacidade: bigint,
    @UsuarioAtual() idUsuario: bigint,
    @Req() req: Request,
  ) {
