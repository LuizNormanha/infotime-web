...
@Controller('unidades-atendimento')
export class UnidadeAtendimentoController {
  constructor(private readonly service: UnidadeAtendimentoService) {}
  ...
  @Post()
  criar(
    @Body() dto: CriarUnidadeAtendimentoDto,
    @TenantAtual() idTenacidade: bigint,
    @UsuarioAtual() idUsuario: bigint,
    @Req() req: Request,
  ) {
  ...
  atualizar(
    @Param('id') id: string,
    @Body() dto: AtualizarUnidadeAtendimentoDto,
    @TenantAtual() idTenacidade: bigint,
    @UsuarioAtual() idUsuario: bigint,
    @Req() req: Request,
  ) {
