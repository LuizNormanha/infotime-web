...
@Controller('motivos-retificacao')
export class MotivoRetificacaoController {
  constructor(private readonly service: MotivoRetificacaoService) {}
  ...
  @Post()
  criar(
    @Body() dto: CriarMotivoRetificacaoDto,
    @TenantAtual() idTenacidade: bigint,
    @UsuarioAtual() idUsuario: bigint,
    @Req() req: Request,
  ) {
  ...
  atualizar(
    @Param('id') id: string,
    @Body() dto: AtualizarMotivoRetificacaoDto,
    @TenantAtual() idTenacidade: bigint,
    @UsuarioAtual() idUsuario: bigint,
    @Req() req: Request,
  ) {
