...
export class MotivoCancelamentoController {
  constructor(private readonly service: MotivoCancelamentoService) {}
  ...
  @Post()
  criar(
    @Body() dto: CriarMotivoCancelamentoDto,
    @TenantAtual() idTenacidade: bigint,
    @UsuarioAtual() idUsuario: bigint,
    @Req() req: Request,
  ) {
  ...
  atualizar(
    @Param('id') id: string,
    @Body() dto: AtualizarMotivoCancelamentoDto,
    @TenantAtual() idTenacidade: bigint,
    @UsuarioAtual() idUsuario: bigint,
    @Req() req: Request,
  ) {
