...
```text
GET    /api/plano/conta   # ajustar pluralização real na implementação
GET    /api/.../:id
POST   /api/...
PUT    /api/.../:id
DELETE /api/.../:id
...
- Body e query em `apps/api-nest/src/modules/plano-conta/` *(path kebab a definir na implementação)*.
