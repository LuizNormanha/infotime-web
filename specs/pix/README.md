...
Migrar o módulo **pix** do legado Scriptcase/PHP para o Infotime Web, preservando regras de negócio e aderência aos dados reais (TLL).
...
Corpus: `migration-source/infotime-migration/pix/database/`
...
Ver [`telas.md`](telas.md) e screenshots em `migration-source/infotime-migration/pix/screenshots/`.
...
- `mapa-campos.md`
- `regras-negocio.md`
- `tela-cobranca-direta.md`
- `tela-cobranca-vencimento.md`
