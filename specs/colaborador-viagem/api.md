...
```text
GET    /api/colaborador/viagem   # ajustar pluralização real na implementação
GET    /api/.../:id
POST   /api/...
PUT    /api/.../:id
DELETE /api/.../:id
...
- Body e query em `apps/api-nest/src/modules/colaborador-viagem/` *(path kebab a definir na implementação)*.
