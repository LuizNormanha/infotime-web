...
```text
GET    /api/colaborador/rh   # ajustar pluralização real na implementação
GET    /api/.../:id
POST   /api/...
PUT    /api/.../:id
DELETE /api/.../:id
...
- Body e query em `apps/api-nest/src/modules/colaborador-rh/` *(path kebab a definir na implementação)*.
