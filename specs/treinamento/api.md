...
```text
GET    /api/treinamento   # ajustar pluralização real na implementação
GET    /api/.../:id
POST   /api/...
PUT    /api/.../:id
DELETE /api/.../:id
...
- Body e query em `apps/api-nest/src/modules/treinamento/` *(path kebab a definir na implementação)*.
