...
```text
GET    /api/almoxarifado/entrada   # ajustar pluralização real na implementação
GET    /api/.../:id
POST   /api/...
PUT    /api/.../:id
DELETE /api/.../:id
...
- Body e query em `apps/api-nest/src/modules/almoxarifado-entrada/` *(path kebab a definir na implementação)*.
