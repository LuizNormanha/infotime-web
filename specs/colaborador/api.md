...
```text
GET    /api/colaborador   # ajustar pluralização real na implementação
GET    /api/.../:id
POST   /api/...
PUT    /api/.../:id
DELETE /api/.../:id
...
- Body e query em `apps/api-nest/src/modules/colaborador/` *(path kebab a definir na implementação)*.
