# Especificação — pop-documento

## Objetivo

Migrar o módulo **pop-documento** do legado Scriptcase/PHP para o Infotime Web, preservando regras de negócio e aderência aos dados reais (TLL).
...
Corpus: `migration-source/infotime-migration/pop-documento/database/`
...
Ver [`telas.md`](telas.md) e screenshots em `migration-source/infotime-migration/pop-documento/screenshots/`.

## Arquivos Scriptcase analisados (amostra)

Total PHP no corpus: amostra abaixo; lista completa sob `scriptcase/`.

- `PopDocumento_Frm.php`
- `PopDocumento_Frm_apl.php`
- `PopDocumento_Lst.php`
- `TipoDocumento_Gde.php`
- `TipoDocumento_Gde_apl.php`
