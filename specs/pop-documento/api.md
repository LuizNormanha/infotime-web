...
```text
GET    /api/pop/documento   # ajustar pluralização real na implementação
GET    /api/.../:id
POST   /api/...
PUT    /api/.../:id
DELETE /api/.../:id
...
- Body e query em `apps/api-nest/src/modules/pop-documento/` *(path kebab a definir na implementação)*.
