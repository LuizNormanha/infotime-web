...
```text
GET    /api/almoxarifado/requisicao   # ajustar pluralização real na implementação
GET    /api/.../:id
POST   /api/...
PUT    /api/.../:id
DELETE /api/.../:id
...
- Body e query em `apps/api-nest/src/modules/almoxarifado-requisicao/` *(path kebab a definir na implementação)*.
