...
| `formulario/` | **Ativo** — ver [`formulario/README.md`](formulario/README.md) (cadastro/edição CRUD); padrão **lookup + cartão em groupbox:** [`formulario/cartao-selecao.md`](formulario/cartao-selecao.md). |
