...
- O sistema deve armazenar apenas hash de senha, usando algoritmo seguro (por exemplo, bcrypt, Argon2 ou similar) com salt adequado.
...
7.1. O campo `id_tenacidade` (ou equivalente) deve ser considerado em todas as operações de usuário:
