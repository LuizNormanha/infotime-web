...
include_once('Dash_Colaborador_session.php');
@ini_set('session.cookie_httponly', 1);
@ini_set('session.use_only_cookies', 1);
@ini_set('session.cookie_secure', 0);
@session_start();

$_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_perfil']          = "ligasistemas";
$_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_path_prod']       = "";
$_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_path_imagens']    = "";
$_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_path_imag_temp']  = "";
$_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_path_doc']        = "";
...
//check prod
if(empty($_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_path_prod']))
{
    /*check prod*/$_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
}
//check img
if(empty($_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_path_imagens']))
{
    /*check img*/$_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
}
//check tmp
if(empty($_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_path_imag_temp']))
{
    /*check tmp*/$_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
}
//check doc
if(empty($_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_path_doc']))
{
    /*check doc*/$_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
}
...
if (!empty($_POST))
{
    foreach ($_POST as $nmgp_var => $nmgp_val)
    {
        ...
        nm_limpa_str_Dash_Colaborador($nmgp_val);
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_path_imag_temp'] . "/sc_apl_default_LIGA_InfoTIME.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_path_imag_temp'] . "/sc_apl_default_LIGA_InfoTIME.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "Dash_Colaborador") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['Dash_Colaborador']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['Dash_Colaborador']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['Dash_Colaborador']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_LIGA_InfoTIME'])) {
            $_SESSION['scriptcase']['Dash_Colaborador']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_LIGA_InfoTIME'];
        }
    }
}
if (isset($nmgp_parms) && !empty($nmgp_parms) && !is_array($nmgp_parms))
{
    ...
    while (!empty($todo[$ix]))
    {
       ...
       if (1 < sizeof($cadapar))
       {
           ...
           nm_limpa_str_Dash_Colaborador($cadapar[1]);
...
elseif (isset($script_case_init) && !empty($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Dash_Colaborador']['parms']))
{
    if (!isset($nmgp_opcao) || ($nmgp_opcao != "incluir" && $nmgp_opcao != "novo" && $nmgp_opcao != "recarga" && $nmgp_opcao != "muda_form"))
    {
        $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['Dash_Colaborador']['parms']);
        $todo  = explode("?@?", $todox);
        $ix = 0;
        while (!empty($todo[$ix]))
        {
...
$Dash_Colaborador_control = new Dash_Colaborador_control();
$Dash_Colaborador_control->control();

class Dash_Colaborador_ini {
    ...
    function init()
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->sc_page]['Dash_Colaborador'])) {
            $_SESSION['sc_session'][$this->sc_page]['Dash_Colaborador'] = array();
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['Dash_Colaborador']['embutida_form'])) {
            $_SESSION['sc_session'][$this->sc_page]['Dash_Colaborador']['embutida_form'] = false;
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['Dash_Colaborador']['embutida_proc'])) {
            $_SESSION['sc_session'][$this->sc_page]['Dash_Colaborador']['embutida_proc'] = false;
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['Dash_Colaborador']['iframe_menu'])) {
            $_SESSION['sc_session'][$this->sc_page]['Dash_Colaborador']['iframe_menu'] = false;
        }

        $this->nm_cod_apl      = "Dash_Colaborador";
        $this->nm_nome_apl     = "";
        $this->nm_seguranca    = "";
        ...
        $this->nm_dt_criacao   = "20210806";
        $this->nm_hr_criacao   = "092412";
        ...
        if (!isset($_SESSION['sc_session'][$this->sc_page]['Dash_Colaborador']['initialize'])) {
            $_SESSION['sc_session'][$this->sc_page]['Dash_Colaborador']['initialize'] = true;
        } elseif (!isset($_SERVER['HTTP_REFERER'])) {
            $_SESSION['sc_session'][$this->sc_page]['Dash_Colaborador']['initialize'] = false;
        } elseif (false === strpos($_SERVER['HTTP_REFERER'], '/Dash_Colaborador/')) {
            $_SESSION['sc_session'][$this->sc_page]['Dash_Colaborador']['initialize'] = true;
        } else {
            $_SESSION['sc_session'][$this->sc_page]['Dash_Colaborador']['initialize'] = false;
        }
        ...
        $this->sc_protocolo   = "";
        $this->path_prod      = $_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_path_prod'];
        $this->path_imagens   = $_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_path_imagens'];
        $this->path_imag_temp = $_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_path_imag_temp'];
        $this->path_doc       = $_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_path_doc'];
        ...
        $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/Dash_Colaborador';
        ...
        if (isset($_SESSION['scriptcase']['Dash_Colaborador']['session_timeout']['lang'])) {
            $this->str_lang = $_SESSION['scriptcase']['Dash_Colaborador']['session_timeout']['lang'];
        }
        elseif (!isset($_SESSION['scriptcase']['Dash_Colaborador']['actual_lang']) || $_SESSION['scriptcase']['Dash_Colaborador']['actual_lang'] != $this->str_lang) {
            $_SESSION['scriptcase']['Dash_Colaborador']['actual_lang'] = $this->str_lang;
        ...
        if (isset($_SESSION['scriptcase']['Dash_Colaborador']['session_timeout']['redir'])) {
...
';
            ...
            if ($_SESSION['scriptcase']['Dash_Colaborador']['session_timeout']['redir_tp'] == "R") {
                $SS_cod_html .= "  </HEAD>\r\n";
                $SS_cod_html .= "   <body>\r\n";
            }
            else {
                ...
                $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['Dash_Colaborador']['session_timeout']['redir'] . "');\">\r\n";
                $SS_cod_html .= "     </form>\r\n";
            ...
            if ($_SESSION['scriptcase']['Dash_Colaborador']['session_timeout']['redir_tp'] == "R") {
                $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['Dash_Colaborador']['session_timeout']['redir'] . "');\r\n";
            }
            ...
            $SS_cod_html .= " </body>\r\n";
            $SS_cod_html .= "</HTML>\r\n";
            unset($_SESSION['scriptcase']['Dash_Colaborador']['session_timeout']);
   ...
   {
      $con_devel             =  (isset($_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      ...
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_conexao']) && $_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_perfil']) && $_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['Dash_Colaborador']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['Dash_Colaborador']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      if (isset($_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_conexao']))
      {
          db_conect_devel($_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_conexao'], $this->root . $this->path_prod, 'LIGA_InfoTIME', 2, $this->force_db_utf8); 
          if (empty($_SESSION['scriptcase']['glo_tpbanco']) && empty($_SESSION['scriptcase']['glo_banco']))
          {
              $nm_crit_perfil = true;
          }
      }
      if (isset($_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_perfil'];
      }
...
// 
      ...
      {
         $_SESSION['sc_session'][$this->sc_page]['Dash_Colaborador']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['Dash_Colaborador']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['Dash_Colaborador']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
          {
              $_SESSION['sc_session'][$this->sc_page]['Dash_Colaborador']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['Dash_Colaborador']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['Dash_Colaborador']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['Dash_Colaborador']['SC_sep_date1'];
      }
// 
...
<body>
    <div class='ui container' style='padding-top:2rem'>
        <section class='ui message'>
          ...
          echo $str_message;
          if (!$_SESSION['sc_session'][$this->sc_page]['Dash_Colaborador']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->sc_page]['Dash_Colaborador']['sc_outra_jan']) || $_SESSION['sc_session'][$this->sc_page]['Dash_Colaborador']['sc_outra_jan'] != 'Dash_Colaborador')) 
          { 
...
// 
  function conectDB()
  {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_conexao'], $this->root . $this->path_prod, 'LIGA_InfoTIME', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['Dash_Colaborador']['glo_nm_conexao'], $this->root . $this->path_prod, 'LIGA_InfoTIME', 1, $this->force_db_utf8);
    }
    else {
...
} // Dash_Colaborador_ini

class Dash_Colaborador_control {
...
$_SESSION['scriptcase']['Dash_Colaborador']['contr_erro'] = 'on';
 
$_SESSION['scriptcase']['Dash_Colaborador']['contr_erro'] = 'off';
...
$_SESSION['scriptcase']['Dash_Colaborador']['contr_erro'] = 'off';
    ...
    function control()
    {
        ...
        $this->Db = $this->Ini->Db;
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['Dash_Colaborador']['initialize']) {
            $this->executeApplicationInit();
            $_SESSION['sc_session'][$this->Ini->sc_page]['Dash_Colaborador']['initialize'] = false;
        }
    ...
    function init()
    {
        if (!$this->Ini)
        {
            $this->Ini = new Dash_Colaborador_ini();
            $this->Ini->init();
        }
        ...
        $_SESSION['scriptcase']['sc_aba_iframe']['Dash_Colaborador'] = array(
        );

        $_SESSION['scriptcase']['dashboard_targets']['Dash_Colaborador'] = array();


        $_SESSION['scriptcase']['dashboard_scinit']['Dash_Colaborador'] = array();

        $_SESSION['scriptcase']['dashboard_scinit']['Dash_Colaborador']['dbifrm_widget2'] = rand(2, 10000);

        $_SESSION['scriptcase']['dashboard_toolbar']['Dash_Colaborador'] = array();

        $this->Change_Menu = false;
        if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Dash_Colaborador']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['Dash_Colaborador']['sc_outra_jan']))
        {
            $this->sc_init_menu = "x";
            if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['Dash_Colaborador']))
            {
                $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['Dash_Colaborador'];
            }
            ...
            if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Dash_Colaborador']))
            {
                 $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Dash_Colaborador']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('Dash_Colaborador') . "/Dash_Colaborador.php";
                 $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Dash_Colaborador']['label'] = "Dash_Colaborador";
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="Dash_Colaborador_container_index.css" />
<?php
...
var scIframeSCInit = {};
<?php
        foreach ($_SESSION['scriptcase']['dashboard_scinit']['Dash_Colaborador'] as $sIframe => $iSCInit) {
?>
...
<?php
$this->startUpWidget_widget2();
$this->getWidgetContent_widget2();
?>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="0" data-gs-width="3" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-0">
                    <div  class="grid-stack-item-content" id="id-div-0">
                        <div class="widget-head" style="display:none">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('0');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="Widget2" /></a>
                        ...
                        <div class='widget-content widget-content-title-none scContainerIndexMoldura scContainerIndexMoldura_widget2' style="height: 100%; align-content: center" id="id-div-iframe-0"><?php echo $this->getWidgetOutput_widget2(); ?></div>
                    </div>
                </div></div>
      ...
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%">
       <TR valign="middle">
        <TD align="left" class="css_rodape">
           InfoTIME - LIGA Sistemas - www.liga.inf.br - 2024
        </TD>
...
<META http-equiv="Pragma" content="no-cache" />
    ...
    <body class="scGridPage">
        <form name="Fsenha" method="post" action="Dash_Colaborador.php">
...
<?php
    ...
    function startUpWidget_widget2()
    {
        $this->runningWidgetId = "widget2";
        $this->runningWidgetType = "index";
    ...
    function getWidgetContent_widget2()
    {
        $this->restartFlushBuffer();
        $dataResult = $this->getIndexContentData_widget2();
        $this->restartGetBuffer();

        if (true !== $dataResult) {
            $this->widgetInfo['get_data_result'] = false;
            $this->widgetInfo['get_data_error'] = $dataResult;
            $this->widgetInfo['output'] = $dataResult;
        } else {
            ...
            $this->widgetInfo['output'] = $this->getIndexContentHtml_widget2();
        }
    }

    function getWidgetOutput_widget2()
    {
    ...
    function getIndexContentData_widget2() {
        ...
        {
            $sSql = "SELECT COUNT(IdLancamentoDespesa), DataPrevisao FROM lancamentodespesa WHERE (" . $this->getIndexWhereBI_widget2() . ") GROUP BY DataPrevisao ORDER BY DataPrevisao DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
        {
            $sSql = "SELECT COUNT(\"IdLancamentoDespesa\"), \"DataPrevisao\" FROM lancamentodespesa WHERE (" . $this->getIndexWhereBI_widget2() . ") GROUP BY 2 ORDER BY \"DataPrevisao\" DESC";
        }
        ...
        $this->indexData['chart_data'][] = $oRs->fields[0];
        ...
        $this->indexData['chart_data'] = array_reverse($this->indexData['chart_data']);
    ...
    function getIndexContentHtml_widget2() {
        ...
        $html = $this->getStyleChanges('widget2', 'index');
        $html .= <<<IDXHTML
<div style="text-align: center; padding: 5px">
    <div style="display: inline-block">

IDXHTML;
        $indexTitle = $this->widgetParams['title'];
        $indexIcon = <<<IDXHTML
<img src="{$this->Ini->path_imag_cab}/scriptcase__NM__img__NM__ct_bar_bar_2d.png" />

IDXHTML;

        if ('' != $indexTitle || '' != $indexIcon) {
            $titleIconSeparator = '' != $indexTitle && '' != $indexIcon ? '&nbsp;' : '';
            $titleLines = [];

            if ('' != $indexIcon) {
                $titleLines[] = $indexIcon;
            }
            if ('' != $indexTitle) {
                $titleLines[] = $indexTitle;
            }

            $titleData = implode('<br />', $titleLines);

            $html .= <<<IDXHTML
        <div class="clearfix">
            <span style="" class="scContainerIndexTitle scContainerIndexTitle_widget2">
                $titleData
            </span>
        </div>
...
IDXHTML;
        ...
        <div class="clearfix">
            <span style="float: right">
                <span class="scContainerIndexDimension scContainerIndexDimension_widget2">
                    {$this->indexData['new_dimension']}{$this->indexData['new_metric_sep']}
                </span>{$this->indexData['new_metric_value']}
            </span>
        </div>
        <div class="clearfix">
            <span class="{$this->indexData['index_class']}Size {$this->indexData['index_class']}Size_widget2">
                <span class="{$this->indexData['index_class']} {$this->indexData['index_class']}_widget2">
                    {$this->indexData['new_metric_formatted']}
                </span>
                {$this->indexData['icon']}
            </span>
        </div>
...
IDXHTML;
        ...
        <div class="clearfix">
            <span style="float: right">
                <span class="scContainerIndexDimension scContainerIndexDimension_widget2">
                    {$this->indexData['old_dimension']}:
                </span>
                <span class="{$this->indexData['old_metric_class']} {$this->indexData['old_metric_class']}_widget2">
                    {$this->indexData['old_metric_formatted']}
                </span>
            </span>
        </div>
...
IDXHTML;
        if ('' != $this->widgetParams['legend']) {
            $html .= <<<IDXHTML
        <div class="clearfix">
            <span style="" class="scContainerIndexLegend scContainerIndexLegend_widget2">
                {$this->widgetParams['legend']}
            </span>
        </div>
...
IDXHTML;
    ...
    function formatIndexMetric_widget2($value) {
        ...
        function getIndexWhereBI_widget2() {
                ...
                if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access)) {
                        // DATETIME
                        $BIFormatField = "FORMAT(DataPrevisao, 'yyyy-mm-dd')";
                ...
                elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres)) {
                        // DATETIME
                        $BIFormatField = "DATE(\"DataPrevisao\")";
                        $BIFormatDate1 = "'{$BIYear1}-{$BIMonth1}-{$BIDay1}'";
                        $BIFormatDate2 = "'{$BIYear2}-{$BIMonth2}-{$BIDay2}'";
                ...
                elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql)) {
                        // DATETIME
                        $BIFormatField = "DATE_FORMAT(`DataPrevisao`, '%Y-%m-%d')";
                        $BIFormatDate1 = "'{$BIYear1}-{$BIMonth1}-{$BIDay1}'";
                        $BIFormatDate2 = "'{$BIYear2}-{$BIMonth2}-{$BIDay2}'";
                ...
                elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sqlite)) {
                        // DATETIME
                        $BIFormatField = "strftime('%Y-%m-%d', `DataPrevisao`)";
                        $BIFormatDate1 = "'{$BIYear1}-{$BIMonth1}-{$BIDay1}'";
                        $BIFormatDate2 = "'{$BIYear2}-{$BIMonth2}-{$BIDay2}'";
                ...
                elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase)) {
                        // DATETIME
                        $BIFormatField = "CAST(\"DataPrevisao\" AS DATE)";
                        $BIFormatDate1 = "'{$BIYear1}-{$BIMonth1}-{$BIDay1}'";
                        $BIFormatDate2 = "'{$BIYear2}-{$BIMonth2}-{$BIDay2}'";
                        ...
                        // DATETIME
                        $BIFormatField = "YYYYMMDD2(DataPrevisao)";
                        $BIFormatDate1 = "'{$BIYear1}-{$BIMonth1}-{$BIDay1}'";
                        $BIFormatDate2 = "'{$BIYear2}-{$BIMonth2}-{$BIDay2}'";
...
} // Dash_Colaborador_control

function nm_limpa_str_Dash_Colaborador(&$str)
{
}
