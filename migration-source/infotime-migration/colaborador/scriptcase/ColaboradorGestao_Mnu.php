<?php
include_once('ColaboradorGestao_Mnu_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_prod']      = "";
    $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_perfil']         = "ligasistemas";
    $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo']      = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class ColaboradorGestao_Mnu_class
{
  var $Db;
  var $sc_charset;
  var $force_mobile;
 ...
 function ColaboradorGestao_Mnu_menu()
 {
    global $ColaboradorGestao_Mnu_menuData, $nm_data_fixa;
 ...
 if (isset($_REQUEST["ajax_notif_request"]))    { 
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "ColaboradorGestao_Mnu/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_imag_temp'];
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/ColaboradorGestao_Mnu_erro.php");
}
include_once(dirname(__FILE__) . "/ColaboradorGestao_Mnu_erro.class.php"); 
$this->Erro = new ColaboradorGestao_Mnu_erro();
$str_path = substr($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_conexao']);
}

/* Definição dos Caminhos */
$ColaboradorGestao_Mnu_menuData         = array();
$ColaboradorGestao_Mnu_menuData['path'] = array();
$ColaboradorGestao_Mnu_menuData['url']  = array();
$ColaboradorGestao_Mnu_menuData['data'] = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $ColaboradorGestao_Mnu_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $ColaboradorGestao_Mnu_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $ColaboradorGestao_Mnu_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $ColaboradorGestao_Mnu_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$ColaboradorGestao_Mnu_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$ColaboradorGestao_Mnu_menuData['url']['web']   = str_replace("\\", '/', $ColaboradorGestao_Mnu_menuData['url']['web']);
$ColaboradorGestao_Mnu_menuData['path']['root'] = substr($ColaboradorGestao_Mnu_menuData['path']['sys'],  0, -1 * strlen($ColaboradorGestao_Mnu_menuData['url']['web']));
$ColaboradorGestao_Mnu_menuData['path']['app']  = substr($ColaboradorGestao_Mnu_menuData['path']['sys'],  0, strrpos($ColaboradorGestao_Mnu_menuData['path']['sys'],  '/'));
$ColaboradorGestao_Mnu_menuData['path']['link'] = substr($ColaboradorGestao_Mnu_menuData['path']['app'],  0, strrpos($ColaboradorGestao_Mnu_menuData['path']['app'],  '/'));
$ColaboradorGestao_Mnu_menuData['path']['link'] = substr($ColaboradorGestao_Mnu_menuData['path']['link'], 0, strrpos($ColaboradorGestao_Mnu_menuData['path']['link'], '/')) . '/';
$ColaboradorGestao_Mnu_menuData['path']['app'] .= '/';
$ColaboradorGestao_Mnu_menuData['url']['app']   = substr($ColaboradorGestao_Mnu_menuData['url']['web'],  0, strrpos($ColaboradorGestao_Mnu_menuData['url']['web'],  '/'));
$ColaboradorGestao_Mnu_menuData['url']['link']  = substr($ColaboradorGestao_Mnu_menuData['url']['app'],  0, strrpos($ColaboradorGestao_Mnu_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] == "S")
{
    $ColaboradorGestao_Mnu_menuData['url']['link']  = substr($ColaboradorGestao_Mnu_menuData['url']['link'], 0, strrpos($ColaboradorGestao_Mnu_menuData['url']['link'], '/'));
}
$ColaboradorGestao_Mnu_menuData['url']['link']  .= '/';
$ColaboradorGestao_Mnu_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['ColaboradorGestao_Mnu']['sc_apl_link'] = $ColaboradorGestao_Mnu_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['actual_lang']) || $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['actual_lang'] = $this->str_lang;
...
include_once("ColaboradorGestao_Mnu_toolbar.php");
...
if ($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "ColaboradorGestao_Mnu";
     $_SESSION['scriptcase']['menu_apls']['ColaboradorGestao_Mnu'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_conexao']) && $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_perfil']) && $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['ColaboradorGestao_Mnu']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['ColaboradorGestao_Mnu']['init']))
{
    $_SESSION['sc_session'][1]['ColaboradorGestao_Mnu']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['ColaboradorGestao_Mnu']['init'];
...
if (!isset($varDescricaoColaborador) && isset($vardescricaocolaborador)) 
{
    $_SESSION["varDescricaoColaborador"] = $vardescricaocolaborador;
}
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_ColaboradorGestao_Mnu'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_ColaboradorGestao_Mnu'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_ColaboradorGestao_Mnu'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
{
    if(function_exists("nm_check_perfil_exists")) nm_check_perfil_exists($path_libs, $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_prod']);
    $_SESSION['sc_session'][1]['SC_Check_Perfil'] = true;
}
$nm_falta_var    = ""; 
$nm_falta_var_db = ""; 
if (isset($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_conexao']))
{
    db_conect_devel($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_prod'], 'LIGA_InfoTIME', 2); 
}
if (isset($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_perfil']))
{
   $_SESSION['scriptcase']['glo_perfil'] = $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_perfil'];
}
...
if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
{
    ...
    if (strlen($SC_temp) == 2)
    {
       $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['SC_sep_date']  = substr($SC_temp, 0, 1); 
       $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
   }
   else
    {
       $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['SC_sep_date']  = $SC_temp; 
       $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['SC_sep_date1'] = $SC_temp; 
   }
}
...
if (!empty($nm_falta_var) || !empty($nm_falta_var_db))
{
    ...
    { 
        if (isset($_SESSION['sc_session'][1]['ColaboradorGestao_Mnu']['sc_outra_jan']) && $_SESSION['sc_session'][1]['ColaboradorGestao_Mnu']['sc_outra_jan'])
        {
...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
 $glo_senha_protect = (isset($_SESSION['scriptcase']['glo_senha_protect'])) ? $_SESSION['scriptcase']['glo_senha_protect'] : "S";
if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_conexao']))
{ 
   $this->Db = db_conect_devel($_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_prod'], 'LIGA_InfoTIME'); 
} 
else 
{ 
...
//
      $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['contr_erro'] = 'on';
  ?>
<style>
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'ColaboradorGestao_Mnu'))
{
    $_SESSION['sc_session'][1]['ColaboradorGestao_Mnu']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_ColaboradorGestao_Mnu'] = "javascript:window.close()";
}
...
if(is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/Colaborador_Frm_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/Colaborador_Frm_ini.php");
    ...
    {
      if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Colaborador_Frm']))
      {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorSalarioAdiantamento_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorSalarioAdiantamento_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ColaboradorSalarioAdiantamento_Lst']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorViagem_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorViagem_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ColaboradorViagem_Lst']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorAtestado_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorAtestado_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ColaboradorAtestado_Lst']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorAvaliacao_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorAvaliacao_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ColaboradorAvaliacao_Lst']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorComprovanteRendimento_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorComprovanteRendimento_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ColaboradorComprovanteRendimento_Lst']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['ColaboradorComprovanteRendimento_Lst'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorComunicacao_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorComunicacao_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ColaboradorComunicacao_Lst']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorDocumento_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorDocumento_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ColaboradorDocumento_Lst']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorExame_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorExame_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ColaboradorExame_Lst']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorFerias_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorFerias_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ColaboradorFerias_Lst']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorContraCheque_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorContraCheque_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ColaboradorContraCheque_Lst']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['ColaboradorContraCheque_Lst'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorFolhaPonto_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorFolhaPonto_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ColaboradorFolhaPonto_Lst']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['ColaboradorFolhaPonto_Lst'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorMedidaDisciplinar_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorMedidaDisciplinar_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ColaboradorMedidaDisciplinar_Lst']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorPlanoConta_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorPlanoConta_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ColaboradorPlanoConta_Lst']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['ColaboradorPlanoConta_Lst'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorReajuste_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorReajuste_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ColaboradorReajuste_Lst']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['ColaboradorReajuste_Lst'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorTarefa_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/ColaboradorTarefa_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ColaboradorTarefa_Lst']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/Colaborador_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/Colaborador_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Colaborador_Lst']))
        {
...
/* Itens do Menu */
$_SESSION['scriptcase']['ColaboradorGestao_Mnu']['contr_erro'] = 'on';
if (!isset($_SESSION['varDescricaoColaborador'])) {$_SESSION['varDescricaoColaborador'] = "";}
if (!isset($this->sc_temp_varDescricaoColaborador)) {$this->sc_temp_varDescricaoColaborador = (isset($_SESSION['varDescricaoColaborador'])) ? $_SESSION['varDescricaoColaborador'] : "";}
if (!isset($_SESSION['varNomeColaborador'])) {$_SESSION['varNomeColaborador'] = "";}
if (!isset($this->sc_temp_varNomeColaborador)) {$this->sc_temp_varNomeColaborador = (isset($_SESSION['varNomeColaborador'])) ? $_SESSION['varNomeColaborador'] : "";}
...
if (!isset($this->sc_temp_varIdColaboradorSel)) {$this->sc_temp_varIdColaboradorSel = (isset($_SESSION['varIdColaboradorSel'])) ? $_SESSION['varIdColaboradorSel'] : "";}
  unset($_SESSION['scriptcase']['sc_menu_del']['ColaboradorGestao_Mnu']);$NM_tmp_del = 'item_5';
...
{
    $_SESSION['scriptcase']['sc_menu_del']['ColaboradorGestao_Mnu'][] = trim($Cada_del);
}
...
$check_sql = "SELECT Nome, Celular, Cpf, Email"
   . " FROM colaborador"
...
if (isset($this->rs[0][0])) {
    ...
    $nome = 'Colaborador não cadastrado';
}

$this->sc_temp_varNomeColaborador = $nome;
$cpf = $this->FormatarDados($cpf, '##.###.###-##');
$this->sc_temp_varDescricaoColaborador = '
<style>
table, td, th {
...
<div style="border-bottom:6px solid #DDD;padding:10px;">
<table class="scGridTabela">
    <tr>
        <td><p style="color: #6c757d; background-color: #e3eaef"><b> Apelido </b></p></td>
        <td><p style="color: #6c757d; background-color: #e3eaef"><b> Celular </b></p></td>
        <td><p style="color: #6c757d; background-color: #e3eaef"><b> CPF </b></p></td>
        <td><p style="color: #6c757d; background-color: #e3eaef"><b> E-mail </b></p></td>
    </tr>
    <tr>
        <td><font size="2" color="#313a46">' . $nome . ' </font></td>
        <td><font size="2" color="#313a46">' . $celular . ' </font></td>
        <td><font size="2" color="#313a46">' . $cpf . ' </font></td>
        <td><font size="2" color="#313a46">' . $email . ' </font></td>
	</tr>
</table>
</div>
';
if (isset($this->sc_temp_varIdColaboradorSel)) {$_SESSION['varIdColaboradorSel'] = $this->sc_temp_varIdColaboradorSel;}
if (isset($this->sc_temp_varNomeColaborador)) {$_SESSION['varNomeColaborador'] = $this->sc_temp_varNomeColaborador;}
if (isset($this->sc_temp_varDescricaoColaborador)) {$_SESSION['varDescricaoColaborador'] = $this->sc_temp_varDescricaoColaborador;}
$_SESSION['scriptcase']['ColaboradorGestao_Mnu']['contr_erro'] = 'off';

$sOutputBuffer = ob_get_contents();
ob_end_clean();

$saida_apl = $_SESSION['scriptcase']['sc_saida_ColaboradorGestao_Mnu'];

$ColaboradorGestao_Mnu_menuData['data'] = array();
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorSalarioAdiantamento_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorSalarioAdiantamento_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Adiantamento salário";
$str_hint = "";
...
$ColaboradorGestao_Mnu_menuData['data']['itens']['item_16'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=item_16&sc_apl_menu=ColaboradorSalarioAdiantamento_Lst&sc_apl_link=" . urlencode($ColaboradorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-list",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
                                                  ...
                                                  'icon_check'     => "S",
                                                  'id'     => "item_16",
                                                  'target'      => $this->ColaboradorGestao_Mnu_target('_self'),
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorViagem_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorViagem_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Adiantamentos de viagem";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$ColaboradorGestao_Mnu_menuData['data']['itens']['item_4'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=item_4&sc_apl_menu=ColaboradorViagem_Lst&sc_apl_link=" . urlencode($ColaboradorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorAtestado_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorAtestado_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$ColaboradorGestao_Mnu_menuData['data']['itens']['item_7'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=item_7&sc_apl_menu=ColaboradorAtestado_Lst&sc_apl_link=" . urlencode($ColaboradorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorAvaliacao_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorAvaliacao_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$ColaboradorGestao_Mnu_menuData['data']['itens']['item_18'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=item_18&sc_apl_menu=ColaboradorAvaliacao_Lst&sc_apl_link=" . urlencode($ColaboradorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["Colaborador_Frm"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["Colaborador_Frm"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$ColaboradorGestao_Mnu_menuData['data']['itens']['item_13'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=item_13&sc_apl_menu=Colaborador_Frm&sc_apl_link=" . urlencode($ColaboradorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$ColaboradorGestao_Mnu_menuData['data']['itens']['item_5'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "#",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-list",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorComprovanteRendimento_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorComprovanteRendimento_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Comprovante de rendimento";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$ColaboradorGestao_Mnu_menuData['data']['itens']['item_19'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=item_19&sc_apl_menu=ColaboradorComprovanteRendimento_Lst&sc_apl_link=" . urlencode($ColaboradorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-list",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorComunicacao_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorComunicacao_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Comunicações";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$ColaboradorGestao_Mnu_menuData['data']['itens']['item_11'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=item_11&sc_apl_menu=ColaboradorComunicacao_Lst&sc_apl_link=" . urlencode($ColaboradorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "far fa-comments",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
                                                  'mega_check'     => "N",
                                                  'icon_check'     => "S",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorDocumento_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorDocumento_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Documentos";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$ColaboradorGestao_Mnu_menuData['data']['itens']['item_10'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=item_10&sc_apl_menu=ColaboradorDocumento_Lst&sc_apl_link=" . urlencode($ColaboradorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "far fa-file-alt",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorExame_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorExame_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$ColaboradorGestao_Mnu_menuData['data']['itens']['item_15'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=item_15&sc_apl_menu=ColaboradorExame_Lst&sc_apl_link=" . urlencode($ColaboradorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorFerias_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorFerias_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$ColaboradorGestao_Mnu_menuData['data']['itens']['item_6'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=item_6&sc_apl_menu=ColaboradorFerias_Lst&sc_apl_link=" . urlencode($ColaboradorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorContraCheque_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorContraCheque_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Folha de pagamento";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$ColaboradorGestao_Mnu_menuData['data']['itens']['item_3'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=item_3&sc_apl_menu=ColaboradorContraCheque_Lst&sc_apl_link=" . urlencode($ColaboradorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorFolhaPonto_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorFolhaPonto_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Folha de ponto";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$ColaboradorGestao_Mnu_menuData['data']['itens']['item_8'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=item_8&sc_apl_menu=ColaboradorFolhaPonto_Lst&sc_apl_link=" . urlencode($ColaboradorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-calendar-check",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
                                                  'mega_check'     => "N",
                                                  'icon_check'     => "S",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorMedidaDisciplinar_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorMedidaDisciplinar_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Medidas disciplinares";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$ColaboradorGestao_Mnu_menuData['data']['itens']['item_9'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=item_9&sc_apl_menu=ColaboradorMedidaDisciplinar_Lst&sc_apl_link=" . urlencode($ColaboradorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-list",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorPlanoConta_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorPlanoConta_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Plano de Contas";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$ColaboradorGestao_Mnu_menuData['data']['itens']['item_21'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=item_21&sc_apl_menu=ColaboradorPlanoConta_Lst&sc_apl_link=" . urlencode($ColaboradorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-list",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorReajuste_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorReajuste_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Reajustes salariais";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$ColaboradorGestao_Mnu_menuData['data']['itens']['item_20'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=item_20&sc_apl_menu=ColaboradorReajuste_Lst&sc_apl_link=" . urlencode($ColaboradorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-list",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$ColaboradorGestao_Mnu_menuData['data']['itens']['item_12'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "#",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-list",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorTarefa_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["ColaboradorTarefa_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$ColaboradorGestao_Mnu_menuData['data']['itens']['item_14'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=item_14&sc_apl_menu=ColaboradorTarefa_Lst&sc_apl_link=" . urlencode($ColaboradorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["Colaborador_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["Colaborador_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$ColaboradorGestao_Mnu_menuData['data']['itens']['item_17'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=item_17&sc_apl_menu=Colaborador_Lst&sc_apl_link=" . urlencode($ColaboradorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$ColaboradorGestao_Mnu_menuData['data_tb']['itens']['item_tb_1'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=item_tb_1&sc_apl_menu=search&sc_apl_link=" . urlencode($ColaboradorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$ColaboradorGestao_Mnu_menuData['data_tb']['itens']['item_tb_2'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=item_tb_2&sc_apl_menu=languages&sc_apl_link=" . urlencode($ColaboradorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$ColaboradorGestao_Mnu_menuData['data_tb']['itens']['item_tb_3'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=item_tb_3&sc_apl_menu=themes&sc_apl_link=" . urlencode($ColaboradorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$ColaboradorGestao_Mnu_menuData['data_tb']['itens']['item_tb_4'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=item_tb_4&sc_apl_menu=shortcuts&sc_apl_link=" . urlencode($ColaboradorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$ColaboradorGestao_Mnu_menuData['data_tb']['itens']['item_tb_5'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=item_tb_5&sc_apl_menu=notification&sc_apl_link=" . urlencode($ColaboradorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-bell",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['ColaboradorGestao_Mnu']))
{
    $ColaboradorGestao_Mnu_menuData['data']['itens'] = $_SESSION['scriptcase']['sc_def_menu']['ColaboradorGestao_Mnu'];
}
if (isset($_SESSION['scriptcase']['sc_usermenu']['ColaboradorGestao_Mnu']))
{
    $ColaboradorGestao_Mnu_menuData['data_user']['itens'] = $_SESSION['scriptcase']['sc_usermenu']['ColaboradorGestao_Mnu'];
}
if (isset($_SESSION['scriptcase']['sc_def_shortcuts']['ColaboradorGestao_Mnu']) && !empty($_SESSION['scriptcase']['sc_def_shortcuts']['ColaboradorGestao_Mnu']))
{
    $ColaboradorGestao_Mnu_menuData['shortcuts'] = $_SESSION['scriptcase']['sc_def_shortcuts']['ColaboradorGestao_Mnu'];
}
if (is_file("ColaboradorGestao_Mnu_help.txt"))
{
    $Arq_WebHelp = file("ColaboradorGestao_Mnu_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $ColaboradorGestao_Mnu_menuData['data'][] = array(
                    ...
                    'target'   => "" . $this->ColaboradorGestao_Mnu_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['ColaboradorGestao_Mnu']) && !empty($_SESSION['scriptcase']['sc_menu_del']['ColaboradorGestao_Mnu']))
{
    sc_menu_delete($ColaboradorGestao_Mnu_menuData['data'], $_SESSION['scriptcase']['sc_menu_del']['ColaboradorGestao_Mnu']);
    sc_menu_delete($ColaboradorGestao_Mnu_menuData['data_user'], $_SESSION['scriptcase']['sc_menu_del']['ColaboradorGestao_Mnu']);
}
if (isset($_SESSION['scriptcase']['sc_menu_disable']['ColaboradorGestao_Mnu']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['ColaboradorGestao_Mnu']))
{
    sc_menu_disable($ColaboradorGestao_Mnu_menuData['data'], $_SESSION['scriptcase']['sc_menu_disable']['ColaboradorGestao_Mnu']);
    sc_menu_disable($ColaboradorGestao_Mnu_menuData['data_user'], $_SESSION['scriptcase']['sc_menu_disable']['ColaboradorGestao_Mnu']);
}
...
<head>
 <title>ColaboradorGestao_Mnu</title>
 ...
 ?> 
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_prod']; ?>/third/font-awesome/6/css/all.min.css" type="text/css" media="screen" />
<style>
   .scTabText {
   }    <?php
...
/* Arquivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_prod']; ?>/third/lineicons/web-font-files/lineicons.css" /> 
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_prod']; ?>/third/Fuse/dist/fuse.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="ColaboradorGestao_Mnu_message.js"></script>
...
?>
<script>
Iframe_atual = "ColaboradorGestao_Mnu_iframe";
...
{
  if (str_id != "iframe_ColaboradorGestao_Mnu")
  {
      str_id        = str_id.replace("ColaboradorGestao_Mnu_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_ColaboradorGestao_Mnu', 'ColaboradorGestao_Mnu');
    //test link type
    ...
    if(str_target != '_blank' && $('#iframe_ColaboradorGestao_Mnu').length)
        $('#iframe_ColaboradorGestao_Mnu')[0].contentWindow.focus();
  }
}
</script>
<div id='main_menu_table' class='scMenuHMoldura'>
    <?php echo $this->ColaboradorGestao_Mnu_MenuH($ColaboradorGestao_Mnu_menuData, $path_imag_cab, $strAlign); ?>
    <div id='idMenuDown'>
        <div id='idMenuRightSide'>
    <div id="Iframe_control" style=''>
<?php
$SCR  = "";
$link_default = " onclick=\"openMenuItem('iframe_ColaboradorGestao_Mnu');\" item-href=\"ColaboradorGestao_Mnu_form_php.php?sc_item_menu=ColaboradorGestao_Mnu&sc_apl_menu=Colaborador_Frm&sc_apl_link=" . urlencode($ColaboradorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'] . "\"  item-target=\"ColaboradorGestao_Mnu_iframe\"";
?>
      <iframe id="iframe_ColaboradorGestao_Mnu" name="ColaboradorGestao_Mnu_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: ;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
...
function ColaboradorGestao_Mnu_Header()
{
?>
    
<?php
}function ColaboradorGestao_Mnu_MenuH($ColaboradorGestao_Mnu_menuData, $path_imag_cab, $strAlign)
{
?>
    <div id='idMenuLine' class='scMenuArea'>
        <?php echo $this->ColaboradorGestao_Mnu_escreveMenu($ColaboradorGestao_Mnu_menuData, $path_imag_cab, $strAlign); ?>
    </div>
<?php
}
function ColaboradorGestao_Mnu_Footer()
{
?>
    
<?php
}
function ColaboradorGestao_Mnu_escreveMenuRec($arr_menu, $arr_menu_apl, $path_imag_cab = '')
{
    ...
    $menu_data = json_decode('{"theme":"light-gray","layout":"V","header_string":"\" . $_SESSION[\'varNomeColaborador\'] . \" ","header_string_pos":"H","check_split":"S","check_toolbar":"N","check_show_search_path":"S","check_shortcut_label":"N","check_start_expanded":"S","check_use_loader":"S","should_reload":"S","layout_usr_pos":"out","usercheck":"N","username":"","userimage":"","userdesc":"","logo":"","logo_compact":"","pick_themes":[],"shortcuts":[],"items":[{"text":"Adiantamento sal\u00e1rio","app":"ColaboradorSalarioAdiantamento_Lst","hint":"","icon":"fas fa-list","icon_check":"S","id":"item_16","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Adiantamentos de viagem","app":"ColaboradorViagem_Lst","hint":"","icon":"fas fa-suitcase","icon_check":"S","id":"item_4","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Atestados","app":"ColaboradorAtestado_Lst","hint":"","icon":"far fa-file-alt","icon_check":"S","id":"item_7","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Avalia\u00e7\u00e3o","app":"ColaboradorAvaliacao_Lst","hint":"","icon":"fas fa-check-double","icon_check":"S","id":"item_18","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Cadastro","app":"Colaborador_Frm","hint":"","icon":"fas fa-user-edit","icon_check":"S","id":"item_13","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Cargos e sal\u00e1rios","app":"","hint":"","icon":"fas fa-list","icon_check":"S","id":"item_5","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Comprovante de rendimento","app":"ColaboradorComprovanteRendimento_Lst","hint":"","icon":"fas fa-list","icon_check":"S","id":"item_19","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Comunica\u00e7\u00f5es","app":"ColaboradorComunicacao_Lst","hint":"","icon":"far fa-comments","icon_check":"S","id":"item_11","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Documentos","app":"ColaboradorDocumento_Lst","hint":"","icon":"far fa-file-alt","icon_check":"S","id":"item_10","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Exames","app":"ColaboradorExame_Lst","hint":"","icon":"fas fa-medkit","icon_check":"S","id":"item_15","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"F\u00e9rias","app":"ColaboradorFerias_Lst","hint":"","icon":"fas fa-calendar-alt","icon_check":"S","id":"item_6","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Folha de pagamento","app":"ColaboradorContraCheque_Lst","hint":"","icon":"fas fa-hand-holding-usd","icon_check":"S","id":"item_3","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Folha de ponto","app":"ColaboradorFolhaPonto_Lst","hint":"","icon":"fas fa-calendar-check","icon_check":"S","id":"item_8","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Medidas disciplinares","app":"ColaboradorMedidaDisciplinar_Lst","hint":"","icon":"fas fa-list","icon_check":"S","id":"item_9","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Plano de Contas","app":"ColaboradorPlanoConta_Lst","hint":"","icon":"fas fa-list","icon_check":"S","id":"item_21","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Reajustes salariais","app":"ColaboradorReajuste_Lst","hint":"","icon":"fas fa-list","icon_check":"S","id":"item_20","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Rescis\u00e3o","app":"","hint":"","icon":"fas fa-list","icon_check":"S","id":"item_12","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Tarefas","app":"ColaboradorTarefa_Lst","hint":"","icon":"far fa-calendar-check","icon_check":"S","id":"item_14","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Sair","app":"Colaborador_Lst","hint":"","icon":"fas fa-sign-out-alt","icon_check":"S","id":"item_17","link_target":"parente","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"}],"user_items":[],"tb_items":[{"text":"Filtro","app":"search","icon":"fas fa-search","icon_check":"S","display":"N","id":"item_tb_1","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"},{"text":"Idiomas","app":"languages","icon":"fas fa-globe","icon_check":"S","display":"N","id":"item_tb_2","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"},{"text":"Temas","app":"themes","icon":"fas fa-paint-roller","icon_check":"S","display":"N","id":"item_tb_3","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"},{"text":"Atalhos","app":"shortcuts","icon":"fas fa-grip-vertical","icon_check":"S","display":"N","id":"item_tb_4","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"},{"text":"Notifica\u00e7\u00f5es","app":"notification","icon":"fas fa-bell","icon_check":"S","display":"N","id":"item_tb_5","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"}],"font_string":"Open Sans","notif_login_var":"\" . $_SESSION[\'usr_login\'] . \"","notif_data":{"notif_table":"notif_notifications","notif_id":"notif_id","notif_title":"notif_title","notif_message":"notif_message","notif_dtexpire":"notif_dtexpire","notif_login_sender":"notif_login_sender","notif_categ":"notif_categ","notif_type":"notif_type","notif_link":"notif_link","inbox_table":"notif_inbox","inbox_field_notif_id":"notif_id","inbox_field_ontop":"notif_ontop","inbox_field_userid":"login","inbox_field_isread":"notif_isread","inbox_field_read_date":"notif_dtread","inbox_field_sent_date":"notif_dtsent","inbox_field_tag":"notif_tags","inbox_field_important":"notif_important","user_table":"sec_users","user_login":"login","user_fullname":"name","user_image":"picture","notif_connection":""},"notif_open_all_app":"","notif_refresh_interval":"10000","notif_limit":"10","open_itens_tab":"N"}', true);
    ...
    $apl_link_build = "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=notif_app_link&sc_apl_menu=###APPNAME###&sc_apl_link=" . urlencode($arr_menu_apl['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'];

    $apl_default          = 'Colaborador_Frm';
    $apl_default_location = 'N';
    $apl_name_ref_sc = 'ColaboradorGestao_Mnu';
    ...
    {
        $apl_default = "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=ColaboradorGestao_Mnu&sc_apl_menu=" . $apl_default . "&sc_apl_link=" . urlencode($arr_menu_apl['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'];
    }
    if (isset($menu_data['notif_open_all_app']) && !empty($menu_data['notif_open_all_app']))
    {
        $menu_data['notif_open_all_app'] = "ColaboradorGestao_Mnu_form_php.php?sc_item_menu=notif_see_all&sc_apl_menu=" . $menu_data['notif_open_all_app'] . "&sc_apl_link=" . urlencode($arr_menu_apl['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_usa_grupo'];
    }
...
<span class="header-string-m-text"><?php echo "" . $_SESSION['varNomeColaborador'] . " "; ?></span>
          <?php
...
}function ColaboradorGestao_Mnu_escreveMenu($arr_menu_apl, $path_imag_cab = '', $strAlign = '')
{
        ...
        <div class='menu menu--horizontal'>
            ...
            <div class='menu__container scMenuHTableCssAlt'>
                <div class='menu__layer'>
                    <?php
                    $this->ColaboradorGestao_Mnu_escreveMenuRec($arr_menu, $arr_menu_apl, $path_imag_cab, 'menu__list');
                    ?>
                </div>
            </div>
        </div><?php
}
function ColaboradorGestao_Mnu_target($str_target)
{
    ...
    {
        return 'ColaboradorGestao_Mnu_iframe';
    }
}
   ...
   {
        $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['sc_init'][$apl_menu] = 1;
        return  1;
   }
function FormatarDados($parValor, $parMascara)
{ global $ColaboradorGestao_Mnu_menuData;
$_SESSION['scriptcase']['ColaboradorGestao_Mnu']['contr_erro'] = 'on';
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_imag_temp'] . "/sc_apl_default_LIGA_InfoTIME.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['glo_nm_path_imag_temp'] . "/sc_apl_default_LIGA_InfoTIME.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "ColaboradorGestao_Mnu") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_LIGA_InfoTIME'])) {
            $_SESSION['scriptcase']['ColaboradorGestao_Mnu']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_LIGA_InfoTIME'];
        }
    }
}
...
$contr_ColaboradorGestao_Mnu = new ColaboradorGestao_Mnu_class;
$contr_ColaboradorGestao_Mnu->ColaboradorGestao_Mnu_menu();
