<?php
//
class AlmoxarifadoEntradaProduto_Frm_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->Refresh_aba_menu)) {
          $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntradaProduto_Frm']['Refresh_aba_menu'] = $this->Refresh_aba_menu;
      }
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          $_POST['nmgp_opcao'] = "novo";
          $this->nmgp_opcao    = "novo";
          $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntradaProduto_Frm']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntradaProduto_Frm']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntradaProduto_Frm']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntradaProduto_Frm']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntradaProduto_Frm']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntradaProduto_Frm']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntradaProduto_Frm']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntradaProduto_Frm']['sc_redir_insert'] = $this->sc_redir_insert;
              unset($_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntradaProduto_Frm']['opc_ant']);
          }
          if (!isset($this->varIdAlmoxarifadoEntrada) && isset($this->varidalmoxarifadoentrada)) 
          {
              $this->varIdAlmoxarifadoEntrada = $this->varidalmoxarifadoentrada;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntradaProduto_Frm']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntradaProduto_Frm']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntradaProduto_Frm']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntradaProduto_Frm']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntradaProduto_Frm']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntradaProduto_Frm']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntradaProduto_Frm']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntradaProduto_Frm']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntradaProduto_Frm']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new AlmoxarifadoEntradaProduto_Frm_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['initialize'])
          {
              
/*----- Scriptcase Locale: Event onApplicationInit ------*/
$_SESSION['scriptcase']['AlmoxarifadoEntradaProduto_Frm']['contr_erro'] = 'on';
...
/*----- END - Scriptcase Locale: Event onApplicationInit ------*/
      ...
      $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntradaProduto_Frm']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['AlmoxarifadoEntradaProduto_Frm']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['AlmoxarifadoEntradaProduto_Frm'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['AlmoxarifadoEntradaProduto_Frm']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['AlmoxarifadoEntradaProduto_Frm']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('AlmoxarifadoEntradaProduto_Frm') . "/AlmoxarifadoEntradaProduto_Frm.php";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['AlmoxarifadoEntradaProduto_Frm']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " Produto";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "AlmoxarifadoEntradaProduto_Frm")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $this->Db = $this->Ini->Db; 
      $this->nm_new_label['datavalidade'] = 'Data validade';
      $this->nm_new_label['datafabricacao'] = 'Data fabricação';
      ...
      $_SESSION['scriptcase']['error_icon']['AlmoxarifadoEntradaProduto_Frm']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['AlmoxarifadoEntradaProduto_Frm'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }

      $this->Ini->cor_grid_par = $this->Ini->cor_grid_impar;
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "AlmoxarifadoEntradaProduto_Frm.php"; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_orig'] = " where (IdAlmoxarifadoEntrada = '" . $_SESSION['varIdAlmoxarifadoEntrada'] . "')";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_pesq'] = " where (IdAlmoxarifadoEntrada = '" . $_SESSION['varIdAlmoxarifadoEntrada'] . "')";
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntradaProduto_Frm']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['AlmoxarifadoEntradaProduto_Frm'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['AlmoxarifadoEntradaProduto_Frm'];
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("AlmoxarifadoEntradaProduto_Frm", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'AlmoxarifadoEntradaProduto_Frm/AlmoxarifadoEntradaProduto_Frm_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'AlmoxarifadoEntradaProduto_Frm_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'AlmoxarifadoEntradaProduto_Frm_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'AlmoxarifadoEntradaProduto_Frm_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'AlmoxarifadoEntradaProduto_Frm/AlmoxarifadoEntradaProduto_Frm_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "AlmoxarifadoEntradaProduto_Frm_erro.class.php"); 
      }
      $this->Erro      = new AlmoxarifadoEntradaProduto_Frm_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['opcao']))
         { 
             if ($this->idalmoxarifadoentradaproduto != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntradaProduto_Frm']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_insert_on = false;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['AlmoxarifadoEntradaProduto_Frm']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['AlmoxarifadoEntradaProduto_Frm']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "AlmoxarifadoEntradaProduto_Frm.php"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      $this->field_config['valorunitario']['symbol_mon'] = '';
      ...
      $this->field_config['idalmoxarifadoprodutovolume']               = array();
      $this->field_config['idalmoxarifadoprodutovolume']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['idalmoxarifadoprodutovolume']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['idalmoxarifadoprodutovolume']['symbol_dec'] = '';
      $this->field_config['idalmoxarifadoprodutovolume']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['idalmoxarifadoprodutovolume']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- datavalidade
      ...
      $this->field_config['valorpontopedido']['symbol_dec'] = '';
...
//
      ...
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
          ...
          if ('event_tipovalidade_onclick' == $this->NM_ajax_opcao)
          {
              $this->TipoValidade_onClick();
          }
          if ('event_valorunitario_onchange' == $this->NM_ajax_opcao)
          {
              $this->ValorUnitario_onChange();
          }
          AlmoxarifadoEntradaProduto_Frm_pack_ajax_response();
          exit;
      }
      if ($this->NM_ajax_flag && 'autocomp_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          if ('autocomp_idalmoxarifadoprodutovolume' == $this->NM_ajax_opcao)
          {
              if (isset($_GET['term'])) {
                  $this->idalmoxarifadoprodutovolume = ($_SESSION['scriptcase']['charset'] != "UTF-8") ? NM_utf8_decode(sc_convert_encoding($_GET['term'], $_SESSION['scriptcase']['charset'], 'UTF-8')) : $_GET['term'];
              } else {
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_idalmoxarifadoprodutovolume']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_idalmoxarifadoprodutovolume'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_idalmoxarifadoprodutovolume']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_idalmoxarifadoprodutovolume'] = array(); 
    }
   ...
   $old_value_idalmoxarifadoprodutovolume = $this->idalmoxarifadoprodutovolume;
   ...
   $this->nm_clear_val("idalmoxarifadoprodutovolume");
   ...
   $unformatted_value_idalmoxarifadoprodutovolume = $this->idalmoxarifadoprodutovolume;
   ...
   $nm_comando = "SELECT IdAlmoxarifadoProdutoVolume, Descricao FROM almoxarifadoprodutovolume WHERE #upperI#Descricao#upperF# LIKE '%" . substr($this->Db->qstr(sc_strtoupper($this->idalmoxarifadoprodutovolume)), 1, -1) . "%' ORDER BY Descricao";
   ...
   $this->idalmoxarifadoprodutovolume = $old_value_idalmoxarifadoprodutovolume;
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(AlmoxarifadoEntradaProduto_Frm_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', AlmoxarifadoEntradaProduto_Frm_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_idalmoxarifadoprodutovolume'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "AlmoxarifadoEntradaProduto_Frm.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm'][$path_doc_md5][1] = $Zip_name;
?><!DOCTYPE html>
...
<form name="Fdown" method="get" action="AlmoxarifadoEntradaProduto_Frm_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="AlmoxarifadoEntradaProduto_Frm"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="AlmoxarifadoEntradaProduto_Frm.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['csrf_token']) && $this->scCsrfGetToken() != $this->csrf_token)
     {
          $this->Campos_Mens_erro .= (empty($this->Campos_Mens_erro)) ? "" : "<br />";
          $this->Campos_Mens_erro .= "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_AlmoxarifadoEntradaProduto_Frm']) || !is_array($this->NM_ajax_info['errList']['geral_AlmoxarifadoEntradaProduto_Frm']))
              {
                  $this->NM_ajax_info['errList']['geral_AlmoxarifadoEntradaProduto_Frm'] = array();
              }
              $this->NM_ajax_info['errList']['geral_AlmoxarifadoEntradaProduto_Frm'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
$_SESSION['scriptcase']['AlmoxarifadoEntradaProduto_Frm']['contr_erro'] = 'on';
  $msgErro = '';
if ($this->tipovalidade  == 'S')
{
	if ((empty($this->datavalidade ) || $this->datavalidade  == "null"))
	{
		$msgErro = $msgErro . 'Data Validade: Campo Obrigatório.<br>';
	}
	if ((empty($this->datafabricacao ) || $this->datafabricacao  == "null"))
	{
		$msgErro = $msgErro . 'Data Fabricação: Campo Obrigatório.<br>';
	}
}
if ($msgErro != '')
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_AlmoxarifadoEntradaProduto_Frm';
...
/*----- END - Scriptcase Locale: Event onValidateSuccess ------*/
   ...
   if (isset($this->Field_no_validate['idalmoxarifadoproduto'])) {
       return;
               ...
               if (!empty($this->idalmoxarifadoproduto) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_idalmoxarifadoproduto']) && !in_array($this->idalmoxarifadoproduto, $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_idalmoxarifadoproduto']))
               {
                   $hasError = true;
    ...
    function ValidateField_valorunitario(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['php_cmp_required']['valorunitario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['php_cmp_required']['valorunitario'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Valor unitário" ; 
              if (!isset($Campos_Erros['valorunitario']))
              {
                  $Campos_Erros['valorunitario'] = array();
              }
              $Campos_Erros['valorunitario'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['valorunitario']) || !is_array($this->NM_ajax_info['errList']['valorunitario']))
                  {
                      $this->NM_ajax_info['errList']['valorunitario'] = array();
                  }
                  $this->NM_ajax_info['errList']['valorunitario'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
           } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_quantidade(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->quantidade, 10, 2, 0, 0, "N") == false)  
              { 
                  $hasError = true;
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['php_cmp_required']['quantidade']) || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['php_cmp_required']['quantidade'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_valortotal(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['php_cmp_required']['valortotal']) || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['php_cmp_required']['valortotal'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_idalmoxarifadoprodutovolume(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if (isset($this->Field_no_validate['idalmoxarifadoprodutovolume'])) {
          nm_limpa_numero($this->idalmoxarifadoprodutovolume, $this->field_config['idalmoxarifadoprodutovolume']['symbol_grp']) ; 
          return;
      }
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->idalmoxarifadoprodutovolume != '')  
          { 
              $iTestSize = 19;
              if (strlen($this->idalmoxarifadoprodutovolume) > $iTestSize)  
              { 
                  $hasError = true;
                  ...
                  $Campos_Erros['idalmoxarifadoprodutovolume'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  ...
                  $this->NM_ajax_info['errList']['idalmoxarifadoprodutovolume'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->idalmoxarifadoprodutovolume, 19, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Volume; " ; 
                  if (!isset($Campos_Erros['idalmoxarifadoprodutovolume']))
   ...
   if (isset($this->Field_no_validate['tipovalidade'])) {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['php_cmp_required']['tipovalidade']) || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['php_cmp_required']['tipovalidade'] == "on")
        { 
          $hasError = true;
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_tipovalidade']) && !in_array($this->tipovalidade, $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_tipovalidade']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tipovalidade']))
    ...
    function ValidateField_codigobarras(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->codigobarras) > 30) 
          { 
              $hasError = true;
              $Campos_Crit .= "Código de barras " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 30 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['codigobarras']))
              {
                  $Campos_Erros['codigobarras'] = array();
              }
              $Campos_Erros['codigobarras'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 30 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['codigobarras'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 30 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
   ...
   if (isset($this->Field_no_validate['tipopontopedido'])) {
    ...
    function ValidateField_nome(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "Nome " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
    ...
    function ValidateField_valorpontopedido(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if (isset($this->Field_no_validate['valorpontopedido'])) {
          nm_limpa_numero($this->valorpontopedido, $this->field_config['valorpontopedido']['symbol_grp']) ; 
          return;
      }
    ...
    function ValidateField_estoqueminimo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "Estoque Minimo: " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              if ($teste_validade->Valor($this->estoqueminimo, 8, 2, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Estoque Minimo; " ; 
                  if (!isset($Campos_Erros['estoqueminimo']))
                  {
                      $Campos_Erros['estoqueminimo'] = array();
                  }
    ...
    function ValidateField_estoquemaximo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "Estoque Maximo: " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              if ($teste_validade->Valor($this->estoquemaximo, 8, 2, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Estoque Maximo; " ; 
                  if (!isset($Campos_Erros['estoquemaximo']))
                  {
                      $Campos_Erros['estoquemaximo'] = array();
                  }
   ...
   if (isset($this->Field_no_validate['idempresa'])) {
       return;
               ...
               if (!empty($this->idempresa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_idempresa']) && !in_array($this->idempresa, $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_idempresa']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['dados_form'] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      nm_limpa_numero($this->idalmoxarifadoentradaproduto, $this->field_config['idalmoxarifadoentradaproduto']['symbol_grp']) ; 
      $this->Before_unformat['idalmoxarifadoprodutovolume'] = $this->idalmoxarifadoprodutovolume;
      nm_limpa_numero($this->idalmoxarifadoprodutovolume, $this->field_config['idalmoxarifadoprodutovolume']['symbol_grp']) ; 
   ...
   function nm_clear_val($Nome_Campo)
   {
      ...
      if ($Nome_Campo == "idalmoxarifadoprodutovolume")
      {
          nm_limpa_numero($this->idalmoxarifadoprodutovolume, $this->field_config['idalmoxarifadoprodutovolume']['symbol_grp']) ; 
      }
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      ...
      if ('' !== $this->idalmoxarifadoprodutovolume || (!empty($format_fields) && isset($format_fields['idalmoxarifadoprodutovolume'])))
      {
          nmgp_Form_Num_Val($this->idalmoxarifadoprodutovolume, $this->field_config['idalmoxarifadoprodutovolume']['symbol_grp'], $this->field_config['idalmoxarifadoprodutovolume']['symbol_dec'], "0", "S", $this->field_config['idalmoxarifadoprodutovolume']['format_neg'], "", "", "-", $this->field_config['idalmoxarifadoprodutovolume']['symbol_fmt']) ; 
      }
      ...
      {
          nmgp_Form_Num_Val($this->estoqueminimo, $this->field_config['estoqueminimo']['symbol_grp'], $this->field_config['estoqueminimo']['symbol_dec'], "2", "S", $this->field_config['estoqueminimo']['format_neg'], "", "", "-", $this->field_config['estoqueminimo']['symbol_fmt']) ; 
      }
      if ('' !== $this->estoquemaximo || (!empty($format_fields) && isset($format_fields['estoquemaximo'])))
      {
          nmgp_Form_Num_Val($this->estoquemaximo, $this->field_config['estoquemaximo']['symbol_grp'], $this->field_config['estoquemaximo']['symbol_dec'], "2", "S", $this->field_config['estoquemaximo']['format_neg'], "", "", "-", $this->field_config['estoquemaximo']['symbol_fmt']) ; 
      }
...
//-- 
   function nm_converte_datas($use_null = true, $bForce = false)
   {
      ...
      if ($this->datafabricacao == "" && $use_null)  
      { 
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idalmoxarifadoentradaproduto']['keyVal'] = AlmoxarifadoEntradaProduto_Frm_pack_protect_string($this->nmgp_dados_form['idalmoxarifadoentradaproduto']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_idalmoxarifadoproduto']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_idalmoxarifadoproduto'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_idalmoxarifadoproduto']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_idalmoxarifadoproduto'] = array(); 
}
$aLookup[] = array(AlmoxarifadoEntradaProduto_Frm_pack_protect_string('') => str_replace('<', '&lt;',AlmoxarifadoEntradaProduto_Frm_pack_protect_string('Selecione...')));
$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_idalmoxarifadoproduto'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   {
       $nm_comando = "SELECT IdAlmoxarifadoProduto, concat(Sigla, ' - ', Descricao)  FROM almoxarifadoproduto WHERE IdTenacidade = '" . $_SESSION['varIdTenacidade'] . "'  ORDER BY Sigla, Descricao";
   }
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
   {
       $nm_comando = "SELECT IdAlmoxarifadoProduto, Sigla&' - '&Descricao  FROM almoxarifadoproduto WHERE IdTenacidade = '" . $_SESSION['varIdTenacidade'] . "'  ORDER BY Sigla, Descricao";
   }
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_idalmoxarifadoproduto'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idalmoxarifadoproduto']['valList'][$i] = AlmoxarifadoEntradaProduto_Frm_pack_protect_string($v);
          }
   ...
   $nm_comando = "SELECT IdAlmoxarifadoProdutoVolume, Descricao FROM almoxarifadoprodutovolume WHERE IdAlmoxarifadoProdutoVolume = " . substr($this->Db->qstr($this->idalmoxarifadoprodutovolume), 1, -1) . " ORDER BY Descricao";
   if ($this->NM_case_insensitive)
   {
       if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres) && strpos($nm_comando, " LIKE ") !== false) {
           $nm_comando = str_replace(array(" LIKE ","#upperI#","#upperF#"), array(" ilike ","",""), $nm_comando);
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $this->NM_ajax_info['fldList']['idalmoxarifadoprodutovolume'] = array(
                       'row'    => '',
               'type'    => 'select2_ac',
               'valList' => array($unformatted_value_idalmoxarifadoprodutovolume),
              );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($aLookupOrig as $aValData)
          ...
          $val_output = isset($aLookup[0][AlmoxarifadoEntradaProduto_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idalmoxarifadoprodutovolume))]) ? $aLookup[0][AlmoxarifadoEntradaProduto_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idalmoxarifadoprodutovolume))] : "";
          $this->NM_ajax_info['fldList']['idalmoxarifadoprodutovolume_autocomp'] = array(
               'type'    => 'text',
...
$aLookup[] = array(AlmoxarifadoEntradaProduto_Frm_pack_protect_string('S') => str_replace('<', '&lt;',AlmoxarifadoEntradaProduto_Frm_pack_protect_string("Informada")));
$aLookup[] = array(AlmoxarifadoEntradaProduto_Frm_pack_protect_string('I') => str_replace('<', '&lt;',AlmoxarifadoEntradaProduto_Frm_pack_protect_string("Indeterminada")));
$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_tipovalidade'][] = 'S';
$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_tipovalidade'][] = 'I';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['tipovalidade']['valList'][$i] = AlmoxarifadoEntradaProduto_Frm_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(AlmoxarifadoEntradaProduto_Frm_pack_protect_string('P') => str_replace('<', '&lt;',AlmoxarifadoEntradaProduto_Frm_pack_protect_string("Porcentagem")));
$aLookup[] = array(AlmoxarifadoEntradaProduto_Frm_pack_protect_string('Q') => str_replace('<', '&lt;',AlmoxarifadoEntradaProduto_Frm_pack_protect_string("Quantidade")));
$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_tipopontopedido'][] = 'P';
$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_tipopontopedido'][] = 'Q';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['tipopontopedido']['valList'][$i] = AlmoxarifadoEntradaProduto_Frm_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_idempresa']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_idempresa'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_idempresa']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_idempresa'] = array(); 
}
$aLookup[] = array(AlmoxarifadoEntradaProduto_Frm_pack_protect_string('') => str_replace('<', '&lt;',AlmoxarifadoEntradaProduto_Frm_pack_protect_string('Selecione...')));
$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_idempresa'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Lookup_idempresa'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idempresa']['valList'][$i] = AlmoxarifadoEntradaProduto_Frm_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['upload_dir'][$fieldName][] = $newName;
  ...
  function nm_proc_onload($bFormat = true)
  {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Field_no_validate'] = array();
...
if ($this->tipovalidade  == 'S')
{
	$sc_tmp_field_name = 'datavalidade';
$this->NM_ajax_info['fieldLabel'][$sc_tmp_field_name] = $this->nm_new_label[$sc_tmp_field_name] = 'Data validade *';
	$sc_tmp_field_name = 'datafabricacao';
$this->NM_ajax_info['fieldLabel'][$sc_tmp_field_name] = $this->nm_new_label[$sc_tmp_field_name] = 'Data fabricação *';
}
$_SESSION['scriptcase']['AlmoxarifadoEntradaProduto_Frm']['contr_erro'] = 'off';
...
//----------- 
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "IdAlmoxarifadoProduto = $this->idalmoxarifadoproduto, IdAlmoxarifadoProdutoVolume = $this->idalmoxarifadoprodutovolume, IdEmpresa = $this->idempresa, Codigo = '$this->codigo', Nome = '$this->nome', Quantidade = $this->quantidade, ValorUnitario = $this->valorunitario, ValorTotal = $this->valortotal, TipoValidade = '$this->tipovalidade', DataValidade = #$this->datavalidade#, DataFabricacao = #$this->datafabricacao#, Lote = '$this->lote', EstoqueMinimo = $this->estoqueminimo, EstoqueMaximo = $this->estoquemaximo, ValorPontoPedido = $this->valorpontopedido, TipoPontoPedido = '$this->tipopontopedido', TemperaturaRecebimento = $this->temperaturarecebimento, TemperaturaTransporte = $this->temperaturatransporte, TemperaturaPadrao = $this->temperaturapadrao, CodigoBarras = '$this->codigobarras'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "IdAlmoxarifadoProduto = $this->idalmoxarifadoproduto, IdAlmoxarifadoProdutoVolume = $this->idalmoxarifadoprodutovolume, IdEmpresa = $this->idempresa, Codigo = '$this->codigo', Nome = '$this->nome', Quantidade = $this->quantidade, ValorUnitario = $this->valorunitario, ValorTotal = $this->valortotal, TipoValidade = '$this->tipovalidade', DataValidade = " . $this->Ini->date_delim . $this->datavalidade . $this->Ini->date_delim1 . ", DataFabricacao = " . $this->Ini->date_delim . $this->datafabricacao . $this->Ini->date_delim1 . ", Lote = '$this->lote', EstoqueMinimo = $this->estoqueminimo, EstoqueMaximo = $this->estoquemaximo, ValorPontoPedido = $this->valorpontopedido, TipoPontoPedido = '$this->tipopontopedido', TemperaturaRecebimento = $this->temperaturarecebimento, TemperaturaTransporte = $this->temperaturatransporte, TemperaturaPadrao = $this->temperaturapadrao, CodigoBarras = '$this->codigobarras'"; 
              } 
              ...
              $Prep_Tst = (isset($NM_val_form['idalmoxarifadoentrada']) && $NM_val_form['idalmoxarifadoentrada'] == "null"  && $this->nmgp_dados_select['idalmoxarifadoentrada'] == "") ? "null" : $this->nmgp_dados_select['idalmoxarifadoentrada'];
              if (isset($NM_val_form['idalmoxarifadoentrada']) && $NM_val_form['idalmoxarifadoentrada'] != $Prep_Tst) 
              { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              $this->nmgp_refresh_fields = array_diff(array('idalmoxarifadoproduto', 'valorunitario', 'quantidade', 'valortotal', 'idalmoxarifadoentradaproduto', 'codigo', 'lote', 'idalmoxarifadoprodutovolume', 'tipovalidade', 'datavalidade', 'datafabricacao', 'codigobarras', 'tipopontopedido', 'nome', 'valorpontopedido', 'estoqueminimo', 'estoquemaximo', 'temperaturapadrao', 'temperaturarecebimento', 'temperaturatransporte', 'idtenacidade', 'enderecoipauditoria', 'idalmoxarifadoentrada', 'idusuarioauditoria', 'nomeaplicacaoauditoria', 'idempresa'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (IdTenacidade, IdAlmoxarifadoEntrada, IdAlmoxarifadoProduto, IdAlmoxarifadoProdutoVolume, IdEmpresa, IdUsuarioAuditoria, Codigo, Nome, Volume, Quantidade, ValorUnitario, ValorTotal, TipoValidade, DataValidade, DataFabricacao, Lote, EstoqueMinimo, EstoqueMaximo, ValorPontoPedido, TipoPontoPedido, TemperaturaRecebimento, TemperaturaTransporte, TemperaturaPadrao, CodigoBarras, EnderecoIpAuditoria, NomeAplicacaoAuditoria) VALUES ($this->idtenacidade, $this->idalmoxarifadoentrada, $this->idalmoxarifadoproduto, $this->idalmoxarifadoprodutovolume, $this->idempresa, $this->idusuarioauditoria, '$this->codigo', '$this->nome', '$this->volume', $this->quantidade, $this->valorunitario, $this->valortotal, '$this->tipovalidade', #$this->datavalidade#, #$this->datafabricacao#, '$this->lote', $this->estoqueminimo, $this->estoquemaximo, $this->valorpontopedido, '$this->tipopontopedido', $this->temperaturarecebimento, $this->temperaturatransporte, $this->temperaturapadrao, '$this->codigobarras', '$this->enderecoipauditoria', '$this->nomeaplicacaoauditoria')"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "IdTenacidade, IdAlmoxarifadoEntrada, IdAlmoxarifadoProduto, IdAlmoxarifadoProdutoVolume, IdEmpresa, IdUsuarioAuditoria, Codigo, Nome, Volume, Quantidade, ValorUnitario, ValorTotal, TipoValidade, DataValidade, DataFabricacao, Lote, EstoqueMinimo, EstoqueMaximo, ValorPontoPedido, TipoPontoPedido, TemperaturaRecebimento, TemperaturaTransporte, TemperaturaPadrao, CodigoBarras, EnderecoIpAuditoria, NomeAplicacaoAuditoria) VALUES (" . $NM_seq_auto . "$this->idtenacidade, $this->idalmoxarifadoentrada, $this->idalmoxarifadoproduto, $this->idalmoxarifadoprodutovolume, $this->idempresa, $this->idusuarioauditoria, '$this->codigo', '$this->nome', '$this->volume', $this->quantidade, $this->valorunitario, $this->valortotal, '$this->tipovalidade', " . $this->Ini->date_delim . $this->datavalidade . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->datafabricacao . $this->Ini->date_delim1 . ", '$this->lote', $this->estoqueminimo, $this->estoquemaximo, $this->valorpontopedido, '$this->tipopontopedido', $this->temperaturarecebimento, $this->temperaturatransporte, $this->temperaturapadrao, '$this->codigobarras', '$this->enderecoipauditoria', '$this->nomeaplicacaoauditoria')"; 
              }
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['reg_start'] = 0; 
              }
...
/*----- END - Scriptcase Locale: Event onAfterDelete ------*/
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['parms'] = "idalmoxarifadoentradaproduto?#?$this->idalmoxarifadoentradaproduto?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['run_iframe'] == "R")
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['iframe_evento']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      ...
      { 
          ...
          $qt_geral_reg_AlmoxarifadoEntradaProduto_Frm = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['total'] = $qt_geral_reg_AlmoxarifadoEntradaProduto_Frm;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idalmoxarifadoentradaproduto))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_AlmoxarifadoEntradaProduto_Frm = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['reg_start'] > $qt_geral_reg_AlmoxarifadoEntradaProduto_Frm)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['reg_start'] = $qt_geral_reg_AlmoxarifadoEntradaProduto_Frm; 
          }
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['total'] + 1; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
//---------- 
      if ($this->nmgp_opcao != "novo" && $this->nmgp_opcao != "nada" && $this->nmgp_opcao != "refresh_insert") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          $nmgp_select = "SELECT IdAlmoxarifadoEntradaProduto, IdTenacidade, IdAlmoxarifadoEntrada, IdAlmoxarifadoProduto, IdAlmoxarifadoProdutoVolume, IdEmpresa, IdUsuarioAuditoria, Codigo, Nome, Volume, Quantidade, ValorUnitario, ValorTotal, TipoValidade, DataValidade, DataFabricacao, Lote, EstoqueMinimo, EstoqueMaximo, ValorPontoPedido, TipoPontoPedido, TemperaturaRecebimento, TemperaturaTransporte, TemperaturaPadrao, CodigoBarras, EnderecoIpAuditoria, NomeAplicacaoAuditoria from " . $this->Ini->nm_tabela ; 
          $aWhere = array();
          $aWhere[] = "(IdAlmoxarifadoEntrada = '" . $_SESSION['varIdAlmoxarifadoEntrada'] . "')";
          $aWhere[] = $sc_where_filter;
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (!empty($sc_where))
              {
                  if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['reg_start'] < $qt_geral_reg_AlmoxarifadoEntradaProduto_Frm;
              $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['opcao']   = '';
          }
      } 
...
//-- 
      ...
      { 
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
$original_valorunitario = $this->valorunitario;
$original_valortotal = $this->valortotal;

if (!empty($this->quantidade ) && !empty($this->valorunitario ))
{
	$this->valortotal  = $this->quantidade  * $this->valorunitario ;
}

$modificado_quantidade = $this->quantidade;
$modificado_valorunitario = $this->valorunitario;
$modificado_valortotal = $this->valortotal;
$this->nm_formatar_campos('quantidade', 'valorunitario', 'valortotal');
...
if ($original_valorunitario !== $modificado_valorunitario || isset($this->nmgp_cmp_readonly['valorunitario']) || (isset($bFlagRead_valorunitario) && $bFlagRead_valorunitario))
{
    $this->ajax_return_values_valorunitario(true);
}
if ($original_valortotal !== $modificado_valortotal || isset($this->nmgp_cmp_readonly['valortotal']) || (isset($bFlagRead_valortotal) && $bFlagRead_valortotal))
{
    $this->ajax_return_values_valortotal(true);
}
...
/*----- Scriptcase Locale: Ajax Event TipoValidade_onClick ------*/

function TipoValidade_onClick()
{
$_SESSION['scriptcase']['AlmoxarifadoEntradaProduto_Frm']['contr_erro'] = 'on';
  
$original_tipovalidade = $this->tipovalidade;
...
$modificado_tipovalidade = $this->tipovalidade;
$this->nm_formatar_campos('tipovalidade');
if ($original_tipovalidade !== $modificado_tipovalidade || isset($this->nmgp_cmp_readonly['tipovalidade']) || (isset($bFlagRead_tipovalidade) && $bFlagRead_tipovalidade))
{
    $this->ajax_return_values_tipovalidade(true);
}
$this->NM_ajax_info['event_field'] = 'TipoValidade';
AlmoxarifadoEntradaProduto_Frm_pack_ajax_response();
exit;
$_SESSION['scriptcase']['AlmoxarifadoEntradaProduto_Frm']['contr_erro'] = 'off';
}

/*----- END - Scriptcase Locale: Ajax Event TipoValidade_onClick ------*/


/*----- Scriptcase Locale: Ajax Event ValorUnitario_onChange ------*/

function ValorUnitario_onChange()
{
$_SESSION['scriptcase']['AlmoxarifadoEntradaProduto_Frm']['contr_erro'] = 'on';
...
$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Field_disabled_macro']['idtenacidade'] = array('I'=>array(),'U'=>array());
;
			$this->sc_field_readonly("idusuarioauditoria", 'on');
$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Field_disabled_macro']['idusuarioauditoria'] = array('I'=>array(),'U'=>array());
;
			$this->sc_field_readonly("enderecoipauditoria", 'on');
$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Field_disabled_macro']['enderecoipauditoria'] = array('I'=>array(),'U'=>array());
;
			$this->sc_field_readonly("nomeaplicacaoauditoria", 'on');
$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['Field_disabled_macro']['nomeaplicacaoauditoria'] = array('I'=>array(),'U'=>array());
;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("AlmoxarifadoEntradaProduto_Frm_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['dyn_search_cache']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_filter_form'] . " and ((IdAlmoxarifadoEntrada = '" . $_SESSION['varIdAlmoxarifadoEntrada'] . "')) and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_AlmoxarifadoEntradaProduto_Frm = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['total'] = $qt_geral_reg_AlmoxarifadoEntradaProduto_Frm;
      $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          AlmoxarifadoEntradaProduto_Frm_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      $nm_numeric[] = "idalmoxarifadoentradaproduto";$nm_numeric[] = "idtenacidade";$nm_numeric[] = "idalmoxarifadoentrada";$nm_numeric[] = "idalmoxarifadoproduto";$nm_numeric[] = "idalmoxarifadoprodutovolume";$nm_numeric[] = "idempresa";$nm_numeric[] = "idusuarioauditoria";$nm_numeric[] = "quantidade";$nm_numeric[] = "valorunitario";$nm_numeric[] = "valortotal";$nm_numeric[] = "estoqueminimo";$nm_numeric[] = "estoquemaximo";$nm_numeric[] = "valorpontopedido";$nm_numeric[] = "temperaturarecebimento";$nm_numeric[] = "temperaturatransporte";$nm_numeric[] = "temperaturapadrao";
         ...
         if (isset($Nm_datas[$campo_join]))
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['SC_sep_date1'];
              }
          }
   ...
   function SC_lookup_idalmoxarifadoproduto($condicao, $campo)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
      { 
          $nm_comando = "SELECT concat(Sigla,' - ',Descricao), IdAlmoxarifadoProduto FROM almoxarifadoproduto WHERE (#cmp_iconcat(Sigla,' - ',Descricao)#cmp_f#cmp_apos LIKE '%#arg_i" . $campo . "#arg_f%'#arg_apos) AND (IdTenacidade = '" . $_SESSION['varIdTenacidade'] . "')" ; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "SELECT Sigla&' - '&Descricao, IdAlmoxarifadoProduto FROM almoxarifadoproduto WHERE (#cmp_iSigla&' - '&Descricao#cmp_f#cmp_apos LIKE '%#arg_i" . $campo . "#arg_f%'#arg_apos) AND (IdTenacidade = '" . $_SESSION['varIdTenacidade'] . "')" ; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      { 
          $nm_comando = "SELECT Sigla||' - '||Descricao, IdAlmoxarifadoProduto FROM almoxarifadoproduto WHERE (#cmp_iSigla||' - '||Descricao#cmp_f#cmp_apos LIKE '%#arg_i" . $campo . "#arg_f%'#arg_apos) AND (IdTenacidade = '" . $_SESSION['varIdTenacidade'] . "')" ; 
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "AlmoxarifadoEntradaProduto_Frm_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['nm_run_menu'] = 2;
       $nmgp_saida_form = "AlmoxarifadoEntradaProduto_Frm_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntradaProduto_Frm']['ordem_ord'] == " desc") {
