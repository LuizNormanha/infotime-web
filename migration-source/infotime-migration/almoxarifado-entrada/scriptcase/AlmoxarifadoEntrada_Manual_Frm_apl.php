<?php
//
class AlmoxarifadoEntrada_Manual_Frm_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->Refresh_aba_menu)) {
          $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntrada_Manual_Frm']['Refresh_aba_menu'] = $this->Refresh_aba_menu;
      }
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          $_POST['nmgp_opcao'] = "novo";
          $this->nmgp_opcao    = "novo";
          $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntrada_Manual_Frm']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntrada_Manual_Frm']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntrada_Manual_Frm']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntrada_Manual_Frm']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntrada_Manual_Frm']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntrada_Manual_Frm']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntrada_Manual_Frm']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntrada_Manual_Frm']['sc_redir_insert'] = $this->sc_redir_insert;
              unset($_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntrada_Manual_Frm']['opc_ant']);
          }
          if (!isset($this->varIdAlmoxarifadoEntrada) && isset($this->varidalmoxarifadoentrada)) 
          {
              $this->varIdAlmoxarifadoEntrada = $this->varidalmoxarifadoentrada;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntrada_Manual_Frm']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntrada_Manual_Frm']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntrada_Manual_Frm']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntrada_Manual_Frm']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntrada_Manual_Frm']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntrada_Manual_Frm']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntrada_Manual_Frm']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntrada_Manual_Frm']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntrada_Manual_Frm']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new AlmoxarifadoEntrada_Manual_Frm_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['initialize'])
          {
              
/*----- Scriptcase Locale: Event onApplicationInit ------*/
$_SESSION['scriptcase']['AlmoxarifadoEntrada_Manual_Frm']['contr_erro'] = 'on';
...
/*----- END - Scriptcase Locale: Event onApplicationInit ------*/
      ...
      $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntrada_Manual_Frm']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['AlmoxarifadoEntrada_Manual_Frm']['upload_field_info']['nomereferencia'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'AlmoxarifadoEntrada_Manual_Frm',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['AlmoxarifadoEntrada_Manual_Frm']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['AlmoxarifadoEntrada_Manual_Frm'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['AlmoxarifadoEntrada_Manual_Frm']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['AlmoxarifadoEntrada_Manual_Frm']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('AlmoxarifadoEntrada_Manual_Frm') . "/AlmoxarifadoEntrada_Manual_Frm.php";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['AlmoxarifadoEntrada_Manual_Frm']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . "  Nota Fiscal / Produtos ";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "AlmoxarifadoEntrada_Manual_Frm")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['AlmoxarifadoEntrada_Manual_Frm']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['AlmoxarifadoEntrada_Manual_Frm'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }

      $this->Ini->cor_grid_par = $this->Ini->cor_grid_impar;
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "AlmoxarifadoEntrada_Manual_Frm.php"; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_orig'] = " where (IdAlmoxarifadoEntrada = '" . $_SESSION['varIdAlmoxarifadoEntrada'] . "')";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_pesq'] = " where (IdAlmoxarifadoEntrada = '" . $_SESSION['varIdAlmoxarifadoEntrada'] . "')";
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['AlmoxarifadoEntrada_Manual_Frm']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['AlmoxarifadoEntrada_Manual_Frm'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['AlmoxarifadoEntrada_Manual_Frm'];
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['dados_form'];
          if (!isset($this->cnpj)){$this->cnpj = $this->nmgp_dados_form['cnpj'];} 
          if (!isset($this->razaosocial)){$this->razaosocial = $this->nmgp_dados_form['razaosocial'];} 
          if (!isset($this->nomefantasia)){$this->nomefantasia = $this->nmgp_dados_form['nomefantasia'];} 
          if (!isset($this->versao)){$this->versao = $this->nmgp_dados_form['versao'];} 
          if (!isset($this->codigo)){$this->codigo = $this->nmgp_dados_form['codigo'];} 
          if (!isset($this->chave)){$this->chave = $this->nmgp_dados_form['chave'];} 
          if (!isset($this->numeronota)){$this->numeronota = $this->nmgp_dados_form['numeronota'];} 
          if (!isset($this->numerofatura)){$this->numerofatura = $this->nmgp_dados_form['numerofatura'];} 
          if (!isset($this->natureza)){$this->natureza = $this->nmgp_dados_form['natureza'];} 
          if (!isset($this->serie)){$this->serie = $this->nmgp_dados_form['serie'];} 
          if (!isset($this->datahoraemissao)){$this->datahoraemissao = $this->nmgp_dados_form['datahoraemissao'];} 
          if (!isset($this->qtdprodutos)){$this->qtdprodutos = $this->nmgp_dados_form['qtdprodutos'];} 
          if (!isset($this->qtdparcelas)){$this->qtdparcelas = $this->nmgp_dados_form['qtdparcelas'];} 
          if (!isset($this->nomearquivo)){$this->nomearquivo = $this->nmgp_dados_form['nomearquivo'];} 
          if (!isset($this->nomereferencia)){$this->nomereferencia = $this->nmgp_dados_form['nomereferencia'];} 
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("AlmoxarifadoEntrada_Manual_Frm", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'AlmoxarifadoEntrada_Manual_Frm/AlmoxarifadoEntrada_Manual_Frm_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'AlmoxarifadoEntrada_Manual_Frm_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'AlmoxarifadoEntrada_Manual_Frm_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'AlmoxarifadoEntrada_Manual_Frm_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'AlmoxarifadoEntrada_Manual_Frm/AlmoxarifadoEntrada_Manual_Frm_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "AlmoxarifadoEntrada_Manual_Frm_erro.class.php"); 
      }
      $this->Erro      = new AlmoxarifadoEntrada_Manual_Frm_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['opcao']))
         { 
             if ($this->idalmoxarifadoentrada != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['AlmoxarifadoEntrada_Manual_Frm']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['AlmoxarifadoEntrada_Manual_Frm']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['AlmoxarifadoEntrada_Manual_Frm']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "AlmoxarifadoEntrada_Manual_Frm.php"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "AlmoxarifadoEntrada_Manual_Frm.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm'][$path_doc_md5][1] = $Zip_name;
?><!DOCTYPE html>
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . "  Nota Fiscal / Produtos ") ?></TITLE>
...
<form name="Fdown" method="get" action="AlmoxarifadoEntrada_Manual_Frm_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="AlmoxarifadoEntrada_Manual_Frm"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="AlmoxarifadoEntrada_Manual_Frm.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['csrf_token']) && $this->scCsrfGetToken() != $this->csrf_token)
     {
          $this->Campos_Mens_erro .= (empty($this->Campos_Mens_erro)) ? "" : "<br />";
          $this->Campos_Mens_erro .= "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_AlmoxarifadoEntrada_Manual_Frm']) || !is_array($this->NM_ajax_info['errList']['geral_AlmoxarifadoEntrada_Manual_Frm']))
              {
                  $this->NM_ajax_info['errList']['geral_AlmoxarifadoEntrada_Manual_Frm'] = array();
              }
              $this->NM_ajax_info['errList']['geral_AlmoxarifadoEntrada_Manual_Frm'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
   ...
   if (isset($this->Field_no_validate['idfornecedor'])) {
      ...
      if ($this->idfornecedor == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['php_cmp_required']['idfornecedor']) || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['php_cmp_required']['idfornecedor'] == "on"))
      {
          $hasError = true;
          $Campos_Falta[] = "Fornecedor - CNPJ (Id.)" ; 
          ...
          if (!empty($this->idfornecedor) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idfornecedor']) && !in_array($this->idfornecedor, $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idfornecedor']))
          {
              $hasError = true;
    ...
    function ValidateField_datahorainclusao(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['php_cmp_required']['datahorainclusao']) || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['php_cmp_required']['datahorainclusao'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Incluída em" ; 
              if (!isset($Campos_Erros['datahorainclusao']))
              {
                  $Campos_Erros['datahorainclusao'] = array();
              }
      ...
      if ($this->nmgp_opcao == "incluir")
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['php_cmp_required']['datahorainclusao_hora']) || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['php_cmp_required']['datahorainclusao_hora'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Incluída em" ; 
              if (!isset($Campos_Erros['datahorainclusao_hora']))
   ...
   if (isset($this->Field_no_validate['idalmoxarifado'])) {
      ...
      if ($this->idalmoxarifado == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['php_cmp_required']['idalmoxarifado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['php_cmp_required']['idalmoxarifado'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->idalmoxarifado) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idalmoxarifado']) && !in_array($this->idalmoxarifado, $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idalmoxarifado']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['idalmoxarifado']))
    ...
    function ValidateField_idlancamentodespesa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          $this->sc_force_zero[] = 'idlancamentodespesa';
      } 
      nm_limpa_numero($this->idlancamentodespesa, $this->field_config['idlancamentodespesa']['symbol_grp']) ; 
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "Lançamento despesa: " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "Lançamento despesa; " ; 
                  if (!isset($Campos_Erros['idlancamentodespesa']))
                  {
                      $Campos_Erros['idlancamentodespesa'] = array();
                  }
    ...
    function ValidateField_valorcofins(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['php_cmp_required']['valorcofins']) || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['php_cmp_required']['valorcofins'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Valor COFINS" ; 
              if (!isset($Campos_Erros['valorcofins']))
              {
                  $Campos_Erros['valorcofins'] = array();
              }
              $Campos_Erros['valorcofins'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['valorcofins']) || !is_array($this->NM_ajax_info['errList']['valorcofins']))
                  {
                      $this->NM_ajax_info['errList']['valorcofins'] = array();
                  }
                  $this->NM_ajax_info['errList']['valorcofins'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
           } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_valorfrete(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['php_cmp_required']['valorfrete']) || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['php_cmp_required']['valorfrete'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Valor frete" ; 
              if (!isset($Campos_Erros['valorfrete']))
              {
                  $Campos_Erros['valorfrete'] = array();
              }
              $Campos_Erros['valorfrete'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['valorfrete']) || !is_array($this->NM_ajax_info['errList']['valorfrete']))
                  {
                      $this->NM_ajax_info['errList']['valorfrete'] = array();
                  }
                  $this->NM_ajax_info['errList']['valorfrete'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
           } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_valorpis(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['php_cmp_required']['valorpis']) || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['php_cmp_required']['valorpis'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Valor PIS" ; 
              if (!isset($Campos_Erros['valorpis']))
              {
                  $Campos_Erros['valorpis'] = array();
              }
              $Campos_Erros['valorpis'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['valorpis']) || !is_array($this->NM_ajax_info['errList']['valorpis']))
                  {
                      $this->NM_ajax_info['errList']['valorpis'] = array();
                  }
                  $this->NM_ajax_info['errList']['valorpis'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
           } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_valoricms(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['php_cmp_required']['valoricms']) || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['php_cmp_required']['valoricms'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Valor ICMS" ; 
              if (!isset($Campos_Erros['valoricms']))
              {
                  $Campos_Erros['valoricms'] = array();
              }
              $Campos_Erros['valoricms'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['valoricms']) || !is_array($this->NM_ajax_info['errList']['valoricms']))
                  {
                      $this->NM_ajax_info['errList']['valoricms'] = array();
                  }
                  $this->NM_ajax_info['errList']['valoricms'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
           } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_valortotal(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['php_cmp_required']['valortotal']) || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['php_cmp_required']['valortotal'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_valordesconto(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['php_cmp_required']['valordesconto']) || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['php_cmp_required']['valordesconto'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Valor desconto" ; 
              if (!isset($Campos_Erros['valordesconto']))
              {
                  $Campos_Erros['valordesconto'] = array();
              }
              $Campos_Erros['valordesconto'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['valordesconto']) || !is_array($this->NM_ajax_info['errList']['valordesconto']))
                  {
                      $this->NM_ajax_info['errList']['valordesconto'] = array();
                  }
                  $this->NM_ajax_info['errList']['valordesconto'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
           } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_valorliquido(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['php_cmp_required']['valorliquido']) || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['php_cmp_required']['valorliquido'] == "on") 
           { 
              $hasError = true;
   ...
   if ($this->nmgp_opcao == "incluir")
   {
               if (!empty($this->idtenacidade) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idtenacidade']) && !in_array($this->idtenacidade, $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idtenacidade']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if ($this->nmgp_opcao == "incluir")
   {
               if (!empty($this->idusuarioauditoria) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idusuarioauditoria']) && !in_array($this->idusuarioauditoria, $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idusuarioauditoria']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idalmoxarifadoentrada']['keyVal'] = AlmoxarifadoEntrada_Manual_Frm_pack_protect_string($this->nmgp_dados_form['idalmoxarifadoentrada']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idfornecedor']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idfornecedor'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idfornecedor']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idfornecedor'] = array(); 
}
$aLookup[] = array(AlmoxarifadoEntrada_Manual_Frm_pack_protect_string('') => str_replace('<', '&lt;',AlmoxarifadoEntrada_Manual_Frm_pack_protect_string('Selecione...')));
$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idfornecedor'][] = '';
   ...
   $nm_comando = "SELECT IdFornecedor, CONCAT(NomeFantasia, ' - ', Cnpj, ' (', IdFornecedor, ')') FROM fornecedor WHERE IdTenacidade = '" . $_SESSION['varIdTenacidade'] . "'  ORDER BY NomeFantasia";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(AlmoxarifadoEntrada_Manual_Frm_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', AlmoxarifadoEntrada_Manual_Frm_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idfornecedor'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idfornecedor']['valList'][$i] = AlmoxarifadoEntrada_Manual_Frm_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idalmoxarifado']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idalmoxarifado'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idalmoxarifado']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idalmoxarifado'] = array(); 
}
$aLookup[] = array(AlmoxarifadoEntrada_Manual_Frm_pack_protect_string('') => str_replace('<', '&lt;',AlmoxarifadoEntrada_Manual_Frm_pack_protect_string('Selecione...')));
$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idalmoxarifado'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   $nm_comando = "SELECT IdAlmoxarifado, CONCAT(Sigla, ' - ', Descricao)  FROM almoxarifado WHERE IdTenacidade = '" . $_SESSION['varIdTenacidade'] . "' AND IdAlmoxarifado IN     (SELECT          GROUP_CONCAT(DISTINCT IdAlmoxarifado ORDER BY IdAlmoxarifado DESC SEPARATOR ',')      FROM      	 empresa     WHERE        IdEmpresa IN (" . $_SESSION['varListaEmpresa'] . "))";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idalmoxarifado'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idalmoxarifado']['valList'][$i] = AlmoxarifadoEntrada_Manual_Frm_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idtenacidade']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idtenacidade'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idtenacidade']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idtenacidade'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idtenacidade'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idtenacidade']['valList'][$i] = AlmoxarifadoEntrada_Manual_Frm_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idusuarioauditoria']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idusuarioauditoria'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idusuarioauditoria']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idusuarioauditoria'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Lookup_idusuarioauditoria'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idusuarioauditoria']['valList'][$i] = AlmoxarifadoEntrada_Manual_Frm_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_nomeaplicacaoauditoria($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['upload_dir'][$fieldName][] = $newName;
  ...
  function nm_proc_onload($bFormat = true)
  {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Field_no_validate'] = array();
...
$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Field_disabled_macro']['datahorainclusao'] = array('I'=>array(),'U'=>array());
;
$this->sc_field_readonly("idlancamentodespesa", 'on');
$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Field_disabled_macro']['idlancamentodespesa'] = array('I'=>array(),'U'=>array());
;
$_SESSION['scriptcase']['AlmoxarifadoEntrada_Manual_Frm']['contr_erro'] = 'off';
...
//----------- 
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "IdFornecedor = $this->idfornecedor, IdAlmoxarifado = $this->idalmoxarifado, ValorTotal = $this->valortotal, ValorDesconto = $this->valordesconto, ValorLiquido = $this->valorliquido, ValorCofins = $this->valorcofins, ValorPis = $this->valorpis, ValorIcms = $this->valoricms, ValorFrete = $this->valorfrete, Observacoes = '$this->observacoes'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              $Prep_Tst = (isset($NM_val_form['idlancamentodespesa']) && $NM_val_form['idlancamentodespesa'] == "null"  && $this->nmgp_dados_select['idlancamentodespesa'] == "") ? "null" : $this->nmgp_dados_select['idlancamentodespesa'];
              if (isset($NM_val_form['idlancamentodespesa']) && $NM_val_form['idlancamentodespesa'] != $Prep_Tst) 
              { 
                  $SC_fields_update[] = "IdLancamentoDespesa = $this->idlancamentodespesa"; 
              } 
              ...
              $Prep_Tst = (isset($NM_val_form['razaosocial']) && $NM_val_form['razaosocial'] == "null"  && $this->nmgp_dados_select['razaosocial'] == "") ? "null" : $this->nmgp_dados_select['razaosocial'];
              if (isset($NM_val_form['razaosocial']) && $NM_val_form['razaosocial'] != $Prep_Tst) 
              { 
                  $SC_fields_update[] = "RazaoSocial = '$this->razaosocial'"; 
              } 
              $Prep_Tst = (isset($NM_val_form['nomefantasia']) && $NM_val_form['nomefantasia'] == "null"  && $this->nmgp_dados_select['nomefantasia'] == "") ? "null" : $this->nmgp_dados_select['nomefantasia'];
              if (isset($NM_val_form['nomefantasia']) && $NM_val_form['nomefantasia'] != $Prep_Tst) 
              { 
                  $SC_fields_update[] = "NomeFantasia = '$this->nomefantasia'"; 
              } 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (IdTenacidade, IdFornecedor, IdAlmoxarifado, IdLancamentoDespesa, IdUsuarioAuditoria, Cnpj, RazaoSocial, NomeFantasia, Versao, Codigo, Chave, Numeronota, Numerofatura, Natureza, Serie, DataHoraEmissao, ValorTotal, ValorDesconto, ValorLiquido, ValorCofins, ValorPis, ValorIcms, ValorFrete, QtdProdutos, QtdParcelas, NomeArquivo, NomeReferencia, Observacoes, DataHoraInclusao, EnderecoIpAuditoria, NomeAplicacaoAuditoria) VALUES ($this->idtenacidade, $this->idfornecedor, $this->idalmoxarifado, $this->idlancamentodespesa, $this->idusuarioauditoria, '$this->cnpj', '$this->razaosocial', '$this->nomefantasia', '$this->versao', '$this->codigo', '$this->chave', '$this->numeronota', '$this->numerofatura', '$this->natureza', '$this->serie', #$this->datahoraemissao#, $this->valortotal, $this->valordesconto, $this->valorliquido, $this->valorcofins, $this->valorpis, $this->valoricms, $this->valorfrete, $this->qtdprodutos, $this->qtdparcelas, '$this->nomearquivo', '$this->nomereferencia', '$this->observacoes', #$this->datahorainclusao#, '$this->enderecoipauditoria', '$this->nomeaplicacaoauditoria')"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "IdTenacidade, IdFornecedor, IdAlmoxarifado, IdLancamentoDespesa, IdUsuarioAuditoria, Cnpj, RazaoSocial, NomeFantasia, Versao, Codigo, Chave, Numeronota, Numerofatura, Natureza, Serie, DataHoraEmissao, ValorTotal, ValorDesconto, ValorLiquido, ValorCofins, ValorPis, ValorIcms, ValorFrete, QtdProdutos, QtdParcelas, NomeArquivo, NomeReferencia, Observacoes, DataHoraInclusao, EnderecoIpAuditoria, NomeAplicacaoAuditoria) VALUES (" . $NM_seq_auto . "$this->idtenacidade, $this->idfornecedor, $this->idalmoxarifado, $this->idlancamentodespesa, $this->idusuarioauditoria, '$this->cnpj', '$this->razaosocial', '$this->nomefantasia', '$this->versao', '$this->codigo', '$this->chave', '$this->numeronota', '$this->numerofatura', '$this->natureza', '$this->serie', " . $this->Ini->date_delim . $this->datahoraemissao . $this->Ini->date_delim1 . ", $this->valortotal, $this->valordesconto, $this->valorliquido, $this->valorcofins, $this->valorpis, $this->valoricms, $this->valorfrete, $this->qtdprodutos, $this->qtdparcelas, '$this->nomearquivo', '$this->nomereferencia', '$this->observacoes', " . $this->Ini->date_delim . $this->datahorainclusao . $this->Ini->date_delim1 . ", '$this->enderecoipauditoria', '$this->nomeaplicacaoauditoria')"; 
              }
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['parms'] = "idalmoxarifadoentrada?#?$this->idalmoxarifadoentrada?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          $nmgp_select = "SELECT IdAlmoxarifadoEntrada, IdTenacidade, IdFornecedor, IdAlmoxarifado, IdLancamentoDespesa, IdUsuarioAuditoria, Cnpj, RazaoSocial, NomeFantasia, Versao, Codigo, Chave, Numeronota, Numerofatura, Natureza, Serie, DataHoraEmissao, ValorTotal, ValorDesconto, ValorLiquido, ValorCofins, ValorPis, ValorIcms, ValorFrete, QtdProdutos, QtdParcelas, NomeArquivo, NomeReferencia, Observacoes, DataHoraInclusao, EnderecoIpAuditoria, NomeAplicacaoAuditoria from " . $this->Ini->nm_tabela ; 
          $aWhere = array();
          $aWhere[] = "(IdAlmoxarifadoEntrada = '" . $_SESSION['varIdAlmoxarifadoEntrada'] . "')";
          $aWhere[] = $sc_where_filter;
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (!empty($sc_where))
              {
                  if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['empty_filter'] = true;
                  return; 
              }
          ...
          { 
              ...
              $this->idlancamentodespesa = $rs->fields[4] ; 
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['parms'] = "idalmoxarifadoentrada?#?$this->idalmoxarifadoentrada?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['sub_dir'][0]  = "/" . $_SESSION['varIdTenacidade'];
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['reg_start'] < $qt_geral_reg_AlmoxarifadoEntrada_Manual_Frm;
              $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['opcao']   = '';
          }
      } 
...
//-- 
      ...
      { 
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
if ($this->idfornecedor  > 0) {
	...
	$this->cnpj  			= $cnpjc;
	$cep  			= $cep;
	$logradouro  	= $ipoLogadouro . ' ' . $logradouro;
	$numero  		= $numero;
...
$this->nm_formatar_campos('idfornecedor');
...
$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Field_disabled_macro']['idtenacidade'] = array('I'=>array(),'U'=>array());
;
			$this->sc_field_readonly("idusuarioauditoria", 'on');
$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Field_disabled_macro']['idusuarioauditoria'] = array('I'=>array(),'U'=>array());
;
			$this->sc_field_readonly("enderecoipauditoria", 'on');
$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Field_disabled_macro']['enderecoipauditoria'] = array('I'=>array(),'U'=>array());
;
			$this->sc_field_readonly("nomeaplicacaoauditoria", 'on');
$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['Field_disabled_macro']['nomeaplicacaoauditoria'] = array('I'=>array(),'U'=>array());
;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
        $this->initFormPages();
    include_once("AlmoxarifadoEntrada_Manual_Frm_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['dyn_search_cache']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_filter_form'] . " and ((IdAlmoxarifadoEntrada = '" . $_SESSION['varIdAlmoxarifadoEntrada'] . "')) and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_AlmoxarifadoEntrada_Manual_Frm = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['total'] = $qt_geral_reg_AlmoxarifadoEntrada_Manual_Frm;
      $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          AlmoxarifadoEntrada_Manual_Frm_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      $nm_numeric[] = "idalmoxarifadoentrada";$nm_numeric[] = "idtenacidade";$nm_numeric[] = "idfornecedor";$nm_numeric[] = "idalmoxarifado";$nm_numeric[] = "idlancamentodespesa";$nm_numeric[] = "idusuarioauditoria";$nm_numeric[] = "valortotal";$nm_numeric[] = "valordesconto";$nm_numeric[] = "valorliquido";$nm_numeric[] = "valorcofins";$nm_numeric[] = "valorpis";$nm_numeric[] = "valoricms";$nm_numeric[] = "valorfrete";$nm_numeric[] = "qtdprodutos";$nm_numeric[] = "qtdparcelas";
         ...
         if (isset($Nm_datas[$campo_join]))
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['SC_sep_date1'];
              }
          }
   ...
   function SC_lookup_idfornecedor($condicao, $campo)
   {
       ...
       {
           $nm_comando = "SELECT CONCAT(NomeFantasia,' - ',Cnpj,' (', IdFornecedor, ')'), IdFornecedor FROM fornecedor WHERE (CAST (IdFornecedor AS TEXT) LIKE '%$campo%') AND (IdTenacidade = '" . $_SESSION['varIdTenacidade'] . "')" ; 
       }
       else
       {
           $nm_comando = "SELECT CONCAT(NomeFantasia,' - ',Cnpj,' (', IdFornecedor, ')'), IdFornecedor FROM fornecedor WHERE (#cmp_iCONCAT(NomeFantasia,' - ',Cnpj,' (', IdFornecedor, ')')#cmp_f#cmp_apos LIKE '%#arg_i" . $campo . "#arg_f%'#arg_apos) AND (IdTenacidade = '" . $_SESSION['varIdTenacidade'] . "')" ; 
       }
       if ($condicao == "ii")
       {
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "AlmoxarifadoEntrada_Manual_Frm_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['nm_run_menu'] = 2;
       $nmgp_saida_form = "AlmoxarifadoEntrada_Manual_Frm_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['link_info']['compact_mode']) {
            return;
        }
?>
...
<div style="width: 100%">
 ...
 <div style="height:25px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: solid; border-color:#72c045; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " Nota Fiscal / Produtos "; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . "  Nota Fiscal / Produtos "; } ?></span></td>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['AlmoxarifadoEntrada_Manual_Frm']['ordem_ord'] == " desc") {
