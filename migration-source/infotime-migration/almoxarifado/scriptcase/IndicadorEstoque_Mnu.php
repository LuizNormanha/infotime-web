<?php
include_once('IndicadorEstoque_Mnu_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_prod']      = "";
    $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_perfil']         = "ligasistemas";
    $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_usa_grupo']      = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class IndicadorEstoque_Mnu_class
{
  var $Db;
  var $sc_charset;
  var $force_mobile;
 ...
 function IndicadorEstoque_Mnu_menu()
 {
    global $IndicadorEstoque_Mnu_menuData, $nm_data_fixa;
 ...
 if (isset($_REQUEST["ajax_notif_request"]))    { 
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "IndicadorEstoque_Mnu/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_imag_temp'];
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/IndicadorEstoque_Mnu_erro.php");
}
include_once(dirname(__FILE__) . "/IndicadorEstoque_Mnu_erro.class.php"); 
$this->Erro = new IndicadorEstoque_Mnu_erro();
$str_path = substr($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_conexao']);
}

/* Definição dos Caminhos */
$IndicadorEstoque_Mnu_menuData         = array();
$IndicadorEstoque_Mnu_menuData['path'] = array();
$IndicadorEstoque_Mnu_menuData['url']  = array();
$IndicadorEstoque_Mnu_menuData['data'] = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $IndicadorEstoque_Mnu_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $IndicadorEstoque_Mnu_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $IndicadorEstoque_Mnu_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $IndicadorEstoque_Mnu_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$IndicadorEstoque_Mnu_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$IndicadorEstoque_Mnu_menuData['url']['web']   = str_replace("\\", '/', $IndicadorEstoque_Mnu_menuData['url']['web']);
$IndicadorEstoque_Mnu_menuData['path']['root'] = substr($IndicadorEstoque_Mnu_menuData['path']['sys'],  0, -1 * strlen($IndicadorEstoque_Mnu_menuData['url']['web']));
$IndicadorEstoque_Mnu_menuData['path']['app']  = substr($IndicadorEstoque_Mnu_menuData['path']['sys'],  0, strrpos($IndicadorEstoque_Mnu_menuData['path']['sys'],  '/'));
$IndicadorEstoque_Mnu_menuData['path']['link'] = substr($IndicadorEstoque_Mnu_menuData['path']['app'],  0, strrpos($IndicadorEstoque_Mnu_menuData['path']['app'],  '/'));
$IndicadorEstoque_Mnu_menuData['path']['link'] = substr($IndicadorEstoque_Mnu_menuData['path']['link'], 0, strrpos($IndicadorEstoque_Mnu_menuData['path']['link'], '/')) . '/';
$IndicadorEstoque_Mnu_menuData['path']['app'] .= '/';
$IndicadorEstoque_Mnu_menuData['url']['app']   = substr($IndicadorEstoque_Mnu_menuData['url']['web'],  0, strrpos($IndicadorEstoque_Mnu_menuData['url']['web'],  '/'));
$IndicadorEstoque_Mnu_menuData['url']['link']  = substr($IndicadorEstoque_Mnu_menuData['url']['app'],  0, strrpos($IndicadorEstoque_Mnu_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_usa_grupo'] == "S")
{
    $IndicadorEstoque_Mnu_menuData['url']['link']  = substr($IndicadorEstoque_Mnu_menuData['url']['link'], 0, strrpos($IndicadorEstoque_Mnu_menuData['url']['link'], '/'));
}
$IndicadorEstoque_Mnu_menuData['url']['link']  .= '/';
$IndicadorEstoque_Mnu_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['IndicadorEstoque_Mnu']['sc_apl_link'] = $IndicadorEstoque_Mnu_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['actual_lang']) || $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['actual_lang'] = $this->str_lang;
...
include_once("IndicadorEstoque_Mnu_toolbar.php");
...
if ($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "IndicadorEstoque_Mnu";
     $_SESSION['scriptcase']['menu_apls']['IndicadorEstoque_Mnu'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_conexao']) && $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_perfil']) && $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['IndicadorEstoque_Mnu']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['IndicadorEstoque_Mnu']['init']))
{
    $_SESSION['sc_session'][1]['IndicadorEstoque_Mnu']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['IndicadorEstoque_Mnu']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_IndicadorEstoque_Mnu'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_IndicadorEstoque_Mnu'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_IndicadorEstoque_Mnu'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
{ 
    $_SESSION['scriptcase']['sc_apl_seg']['IndicadorEstoque_Mnu'] = "on";
} 
if (!isset($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['IndicadorEstoque_Mnu']) || $_SESSION['scriptcase']['sc_apl_seg']['IndicadorEstoque_Mnu'] != "on"))
{ 
...
{
    if(function_exists("nm_check_perfil_exists")) nm_check_perfil_exists($path_libs, $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_prod']);
    $_SESSION['sc_session'][1]['SC_Check_Perfil'] = true;
}
$nm_falta_var    = ""; 
$nm_falta_var_db = ""; 
if (isset($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_conexao']))
{
    db_conect_devel($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_prod'], 'LIGA_InfoTIME', 2); 
}
if (isset($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_perfil']))
{
   $_SESSION['scriptcase']['glo_perfil'] = $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_perfil'];
}
...
if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
{
    ...
    if (strlen($SC_temp) == 2)
    {
       $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['SC_sep_date']  = substr($SC_temp, 0, 1); 
       $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
   }
   else
    {
       $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['SC_sep_date']  = $SC_temp; 
       $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['SC_sep_date1'] = $SC_temp; 
   }
}
...
if (!empty($nm_falta_var) || !empty($nm_falta_var_db))
{
    ...
    { 
        if (isset($_SESSION['sc_session'][1]['IndicadorEstoque_Mnu']['sc_outra_jan']) && $_SESSION['sc_session'][1]['IndicadorEstoque_Mnu']['sc_outra_jan'])
        {
...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
 $glo_senha_protect = (isset($_SESSION['scriptcase']['glo_senha_protect'])) ? $_SESSION['scriptcase']['glo_senha_protect'] : "S";
if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_conexao']))
{ 
   $this->Db = db_conect_devel($_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_prod'], 'LIGA_InfoTIME'); 
} 
else 
{ 
...
//
      $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['contr_erro'] = 'on';
...
if (!isset($_SESSION['varTipoIndicador'])) {$_SESSION['varTipoIndicador'] = "";}
if (!isset($this->sc_temp_varTipoIndicador)) {$this->sc_temp_varTipoIndicador = (isset($_SESSION['varTipoIndicador'])) ? $_SESSION['varTipoIndicador'] : "";}
 ?>
<style>
...
$this->sc_temp_varTipoIndicador = 'Geral';

$check_sql = "SELECT GROUP_CONCAT(a.Sigla SEPARATOR ', ') AS Almoxarifado FROM empresa e INNER JOIN almoxarifado a ON (a.IdAlmoxarifado = e.IdAlmoxarifado) WHERE e.IdTenacidade = $this->sc_temp_varIdTenacidade AND e.IdEmpresa IN (" . $this->sc_temp_varIdAlmoxarifadoSel .")";
...
$this->sc_temp_varDescricao = 'Almoxarifado(s): '.$Descricao;
if (isset($this->sc_temp_varTipoIndicador)) {$_SESSION['varTipoIndicador'] = $this->sc_temp_varTipoIndicador;}
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'IndicadorEstoque_Mnu'))
{
    $_SESSION['sc_session'][1]['IndicadorEstoque_Mnu']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_IndicadorEstoque_Mnu'] = "javascript:window.close()";
}
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/estoque_almoxarifado_ctr_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/estoque_almoxarifado_ctr_ini.php");
    ...
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['estoque_almoxarifado_ctr']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['estoque_almoxarifado_ctr'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/IndicadorAlmoxarifadoProdutoGeral_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/IndicadorAlmoxarifadoProdutoGeral_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['IndicadorAlmoxarifadoProdutoGeral_Lst']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['IndicadorAlmoxarifadoProdutoGeral_Lst'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_IndicadorEstoque_Mnu'];

$IndicadorEstoque_Mnu_menuData['data'] = array();
$str_disabled = 'N';
$str_label = "Almoxarifado";
$str_hint = "";
...
$IndicadorEstoque_Mnu_menuData['data']['itens']['item_6'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "#",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-list-check",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
                                                  'mega_check'     => "N",
                                                  'icon_check'     => "S",
                                                  'id'     => "item_6",
                                                  'target'      => $this->IndicadorEstoque_Mnu_target('_self'),
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["estoque_almoxarifado_ctr"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["estoque_almoxarifado_ctr"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Posição de Estoque por Almoxarifado";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$IndicadorEstoque_Mnu_menuData['data']['itens']['item_6']['itens']['item_1'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "IndicadorEstoque_Mnu_form_php.php?sc_item_menu=item_1&sc_apl_menu=estoque_almoxarifado_ctr&sc_apl_link=" . urlencode($IndicadorEstoque_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$IndicadorEstoque_Mnu_menuData['data']['itens']['item_7'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "#",
                                                  'hint'        => $str_hint,
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["IndicadorAlmoxarifadoProdutoGeral_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["IndicadorAlmoxarifadoProdutoGeral_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Posição Geral de Estoque";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$IndicadorEstoque_Mnu_menuData['data']['itens']['item_7']['itens']['item_8'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "IndicadorEstoque_Mnu_form_php.php?sc_item_menu=item_8&sc_apl_menu=IndicadorAlmoxarifadoProdutoGeral_Lst&sc_apl_link=" . urlencode($IndicadorEstoque_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-list-check",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_label = "Estoque Abaixo do Mínimo";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$IndicadorEstoque_Mnu_menuData['data']['itens']['item_7']['itens']['item_2'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "IndicadorEstoque_Mnu_form_php.php?sc_item_menu=item_2&sc_apl_menu=IndicadorAlmoxarifadoProdutoGeral_Lst&sc_apl_link=" . urlencode($IndicadorEstoque_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-list-ul",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
                                                  'mega_check'     => "N",
                                                  'icon_check'     => "S",
...
$str_label = "Estoque Abaixo do Ponto de Pedido";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$IndicadorEstoque_Mnu_menuData['data']['itens']['item_7']['itens']['item_3'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "IndicadorEstoque_Mnu_form_php.php?sc_item_menu=item_3&sc_apl_menu=IndicadorAlmoxarifadoProdutoGeral_Lst&sc_apl_link=" . urlencode($IndicadorEstoque_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-list-ul",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$IndicadorEstoque_Mnu_menuData['data_tb']['itens']['item_tb_1'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "IndicadorEstoque_Mnu_form_php.php?sc_item_menu=item_tb_1&sc_apl_menu=search&sc_apl_link=" . urlencode($IndicadorEstoque_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$IndicadorEstoque_Mnu_menuData['data_tb']['itens']['item_tb_2'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "IndicadorEstoque_Mnu_form_php.php?sc_item_menu=item_tb_2&sc_apl_menu=languages&sc_apl_link=" . urlencode($IndicadorEstoque_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$IndicadorEstoque_Mnu_menuData['data_tb']['itens']['item_tb_3'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "IndicadorEstoque_Mnu_form_php.php?sc_item_menu=item_tb_3&sc_apl_menu=themes&sc_apl_link=" . urlencode($IndicadorEstoque_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$IndicadorEstoque_Mnu_menuData['data_tb']['itens']['item_tb_4'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "IndicadorEstoque_Mnu_form_php.php?sc_item_menu=item_tb_4&sc_apl_menu=shortcuts&sc_apl_link=" . urlencode($IndicadorEstoque_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-grip-vertical",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$IndicadorEstoque_Mnu_menuData['data_tb']['itens']['item_tb_5'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "IndicadorEstoque_Mnu_form_php.php?sc_item_menu=item_tb_5&sc_apl_menu=notification&sc_apl_link=" . urlencode($IndicadorEstoque_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-bell",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['IndicadorEstoque_Mnu']))
{
    $IndicadorEstoque_Mnu_menuData['data']['itens'] = $_SESSION['scriptcase']['sc_def_menu']['IndicadorEstoque_Mnu'];
}
if (isset($_SESSION['scriptcase']['sc_usermenu']['IndicadorEstoque_Mnu']))
{
    $IndicadorEstoque_Mnu_menuData['data_user']['itens'] = $_SESSION['scriptcase']['sc_usermenu']['IndicadorEstoque_Mnu'];
}
if (isset($_SESSION['scriptcase']['sc_def_shortcuts']['IndicadorEstoque_Mnu']) && !empty($_SESSION['scriptcase']['sc_def_shortcuts']['IndicadorEstoque_Mnu']))
{
    $IndicadorEstoque_Mnu_menuData['shortcuts'] = $_SESSION['scriptcase']['sc_def_shortcuts']['IndicadorEstoque_Mnu'];
}
if (is_file("IndicadorEstoque_Mnu_help.txt"))
{
    $Arq_WebHelp = file("IndicadorEstoque_Mnu_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $IndicadorEstoque_Mnu_menuData['data'][] = array(
                    ...
                    'target'   => "" . $this->IndicadorEstoque_Mnu_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['IndicadorEstoque_Mnu']) && !empty($_SESSION['scriptcase']['sc_menu_del']['IndicadorEstoque_Mnu']))
{
    sc_menu_delete($IndicadorEstoque_Mnu_menuData['data'], $_SESSION['scriptcase']['sc_menu_del']['IndicadorEstoque_Mnu']);
    sc_menu_delete($IndicadorEstoque_Mnu_menuData['data_user'], $_SESSION['scriptcase']['sc_menu_del']['IndicadorEstoque_Mnu']);
}
if (isset($_SESSION['scriptcase']['sc_menu_disable']['IndicadorEstoque_Mnu']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['IndicadorEstoque_Mnu']))
{
    sc_menu_disable($IndicadorEstoque_Mnu_menuData['data'], $_SESSION['scriptcase']['sc_menu_disable']['IndicadorEstoque_Mnu']);
    sc_menu_disable($IndicadorEstoque_Mnu_menuData['data_user'], $_SESSION['scriptcase']['sc_menu_disable']['IndicadorEstoque_Mnu']);
}
...
<head>
 <title>IndicadorEstoque_Mnu</title>
 <META http-equiv="Content-Type" content="text/html; charset=<?php echo $_SESSION['scriptcase']['charset_html'] ?>" />
 <?php
 ...
 ?> 
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_prod']; ?>/third/font-awesome/6/css/all.min.css" type="text/css" media="screen" />
<style>
   .scTabText {
   }    <?php
...
/* Arquivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_prod']; ?>/third/lineicons/web-font-files/lineicons.css" /> 
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_prod']; ?>/third/Fuse/dist/fuse.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="IndicadorEstoque_Mnu_message.js"></script>
...
?>
<script>
Iframe_atual = "IndicadorEstoque_Mnu_iframe";
...
{
  if (str_id != "iframe_IndicadorEstoque_Mnu")
  {
      str_id        = str_id.replace("IndicadorEstoque_Mnu_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    ...
    if(str_target != '_blank' && $('#iframe_IndicadorEstoque_Mnu').length)
        $('#iframe_IndicadorEstoque_Mnu')[0].contentWindow.focus();
  }
}
</script>
<div id='main_menu_table' class='scMenuHMoldura'>
    <?php echo $this->IndicadorEstoque_Mnu_MenuH($IndicadorEstoque_Mnu_menuData, $path_imag_cab, $strAlign); ?>
    <div id='idMenuDown'>
        <div id='idMenuRightSide'>
    <div id="Iframe_control" style=''>
      <iframe id="iframe_IndicadorEstoque_Mnu" name="IndicadorEstoque_Mnu_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: ;"  src="<?php echo ($NM_scr_iframe != "" ? $NM_scr_iframe : "IndicadorEstoque_Mnu_pag_ini.php"); ?>"></iframe>
...
function IndicadorEstoque_Mnu_Header()
{
?>
    
<?php
}function IndicadorEstoque_Mnu_MenuH($IndicadorEstoque_Mnu_menuData, $path_imag_cab, $strAlign)
{
?>
    <div id='idMenuLine' class='scMenuArea'>
        <?php echo $this->IndicadorEstoque_Mnu_escreveMenu($IndicadorEstoque_Mnu_menuData, $path_imag_cab, $strAlign); ?>
    </div>
<?php
}
function IndicadorEstoque_Mnu_Footer()
{
?>
    
<?php
}
function IndicadorEstoque_Mnu_escreveMenuRec($arr_menu, $arr_menu_apl, $path_imag_cab = '')
{
    ...
    $menu_data = json_decode('{"theme":"light-gray","layout":"V","header_string":"","header_string_pos":"H","check_split":"S","check_toolbar":"N","check_show_search_path":"S","check_shortcut_label":"N","check_start_expanded":"S","check_use_loader":"S","should_reload":"S","layout_usr_pos":"out","usercheck":"N","username":"","userimage":"","userdesc":"","logo":"","logo_compact":"","pick_themes":[],"shortcuts":[],"items":[{"text":"Almoxarifado","app":"","icon":"fas fa-list-check","icon_check":"S","id":"item_6","hint":"","link_target":"self","fav_check":"N","mega_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"children":[{"text":"Posi\u00e7\u00e3o de Estoque por Almoxarifado","app":"estoque_almoxarifado_ctr","icon":"fas fa-boxes","icon_check":"S","id":"item_1","hint":"","link_target":"self","fav_check":"N","mega_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"}],"target":"_self"},{"text":"Estoque Consolidado","app":"","icon":"fas fa-grip-vertical","icon_check":"S","id":"item_7","hint":"","link_target":"self","fav_check":"N","mega_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"children":[{"text":"Posi\u00e7\u00e3o Geral de Estoque","app":"IndicadorAlmoxarifadoProdutoGeral_Lst","icon":"fas fa-list-check","icon_check":"S","id":"item_8","hint":"","link_target":"self","fav_check":"N","mega_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Estoque Abaixo do M\u00ednimo","app":"IndicadorAlmoxarifadoProdutoGeral_Lst","icon":"fas fa-list-ul","icon_check":"S","id":"item_2","hint":"","link_target":"self","fav_check":"N","mega_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Estoque Abaixo do Ponto de Pedido","app":"IndicadorAlmoxarifadoProdutoGeral_Lst","icon":"fas fa-list-ul","icon_check":"S","id":"item_3","hint":"","link_target":"self","fav_check":"N","mega_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"}],"target":"_self"}],"user_items":[],"tb_items":[{"text":"Filtro","app":"search","icon":"fas fa-search","icon_check":"S","display":"N","id":"item_tb_1","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"},{"text":"Idiomas","app":"languages","icon":"fas fa-globe","icon_check":"S","display":"N","id":"item_tb_2","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"},{"text":"Temas","app":"themes","icon":"fas fa-paint-roller","icon_check":"S","display":"N","id":"item_tb_3","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"},{"text":"Atalhos","app":"shortcuts","icon":"fas fa-grip-vertical","icon_check":"S","display":"N","id":"item_tb_4","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"},{"text":"Notifica\u00e7\u00f5es","app":"notification","icon":"fas fa-bell","icon_check":"S","display":"N","id":"item_tb_5","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"}],"font_string":"Open Sans","notif_login_var":"\" . $_SESSION[\'usr_login\'] . \"","notif_data":{"notif_table":"notif_notifications","notif_id":"notif_id","notif_title":"notif_title","notif_message":"notif_message","notif_dtexpire":"notif_dtexpire","notif_login_sender":"notif_login_sender","notif_categ":"notif_categ","notif_type":"notif_type","notif_link":"notif_link","inbox_table":"notif_inbox","inbox_field_notif_id":"notif_id","inbox_field_ontop":"notif_ontop","inbox_field_userid":"login","inbox_field_isread":"notif_isread","inbox_field_read_date":"notif_dtread","inbox_field_sent_date":"notif_dtsent","inbox_field_tag":"notif_tags","inbox_field_important":"notif_important","user_table":"sec_users","user_login":"login","user_fullname":"name","user_image":"picture","notif_connection":""},"notif_open_all_app":"","notif_refresh_interval":"10000","notif_limit":"10","open_itens_tab":"N"}', true);
    ...
    $apl_link_build = "IndicadorEstoque_Mnu_form_php.php?sc_item_menu=notif_app_link&sc_apl_menu=###APPNAME###&sc_apl_link=" . urlencode($arr_menu_apl['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_usa_grupo'];

    $apl_default          = '';
    $apl_default_location = '';
    $apl_name_ref_sc = 'IndicadorEstoque_Mnu';
    ...
    {
        $apl_default = "IndicadorEstoque_Mnu_form_php.php?sc_item_menu=IndicadorEstoque_Mnu&sc_apl_menu=" . $apl_default . "&sc_apl_link=" . urlencode($arr_menu_apl['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_usa_grupo'];
    }
    if (isset($menu_data['notif_open_all_app']) && !empty($menu_data['notif_open_all_app']))
    {
        $menu_data['notif_open_all_app'] = "IndicadorEstoque_Mnu_form_php.php?sc_item_menu=notif_see_all&sc_apl_menu=" . $menu_data['notif_open_all_app'] . "&sc_apl_link=" . urlencode($arr_menu_apl['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_usa_grupo'];
    }
...
<span class="header-string-m-text"><?php echo ""; ?></span>
          <?php
...
}function IndicadorEstoque_Mnu_escreveMenu($arr_menu_apl, $path_imag_cab = '', $strAlign = '')
{
        ...
        <div class='menu menu--horizontal'>
            ...
            <div class='menu__container scMenuHTableCssAlt'>
                <div class='menu__layer'>
                    <?php
                    $this->IndicadorEstoque_Mnu_escreveMenuRec($arr_menu, $arr_menu_apl, $path_imag_cab, 'menu__list');
                    ?>
                </div>
            </div>
        </div><?php
}
function IndicadorEstoque_Mnu_target($str_target)
{
    ...
    {
        return 'IndicadorEstoque_Mnu_iframe';
    }
}
   ...
   {
        $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['sc_init'][$apl_menu] = 1;
        return  1;
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_imag_temp'] . "/sc_apl_default_LIGA_InfoTIME.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['glo_nm_path_imag_temp'] . "/sc_apl_default_LIGA_InfoTIME.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "IndicadorEstoque_Mnu") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_LIGA_InfoTIME'])) {
            $_SESSION['scriptcase']['IndicadorEstoque_Mnu']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_LIGA_InfoTIME'];
        }
    }
}
...
$contr_IndicadorEstoque_Mnu = new IndicadorEstoque_Mnu_class;
$contr_IndicadorEstoque_Mnu->IndicadorEstoque_Mnu_menu();
