<?php
//
class LancamentoDespesa_Recorrente_Frm_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->Refresh_aba_menu)) {
          $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Recorrente_Frm']['Refresh_aba_menu'] = $this->Refresh_aba_menu;
      }
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          $_POST['nmgp_opcao'] = "novo";
          $this->nmgp_opcao    = "novo";
          $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Recorrente_Frm']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Recorrente_Frm']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Recorrente_Frm']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Recorrente_Frm']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Recorrente_Frm']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_LancamentoDespesa_Recorrente_Frm($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Recorrente_Frm']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Recorrente_Frm']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Recorrente_Frm']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Recorrente_Frm']['sc_redir_insert'] = $this->sc_redir_insert;
              unset($_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Recorrente_Frm']['opc_ant']);
          }
          if (!isset($this->varIdLancamentoDespesa) && isset($this->varidlancamentodespesa)) 
          {
              $this->varIdLancamentoDespesa = $this->varidlancamentodespesa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Recorrente_Frm']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Recorrente_Frm']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Recorrente_Frm']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Recorrente_Frm']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Recorrente_Frm']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Recorrente_Frm']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Recorrente_Frm']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Recorrente_Frm']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Recorrente_Frm']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Recorrente_Frm']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new LancamentoDespesa_Recorrente_Frm_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['initialize'])
          {
              $_SESSION['scriptcase']['LancamentoDespesa_Recorrente_Frm']['contr_erro'] = 'on';
     ...
     $nm_select = $delete_sql; 
      ...
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         ...
         if ($rf === false)
         {
             ...
             if ($this->NM_ajax_flag)
             {
                LancamentoDespesa_Recorrente_Frm_pack_ajax_response();
             }
             exit;
         }
         $rf->Close();
...
$_SESSION['scriptcase']['LancamentoDespesa_Recorrente_Frm']['contr_erro'] = 'off';
          }
          $this->Ini->init2();
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Recorrente_Frm']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['LancamentoDespesa_Recorrente_Frm']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['LancamentoDespesa_Recorrente_Frm'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['LancamentoDespesa_Recorrente_Frm']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['LancamentoDespesa_Recorrente_Frm']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('LancamentoDespesa_Recorrente_Frm') . "/LancamentoDespesa_Recorrente_Frm.php";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['LancamentoDespesa_Recorrente_Frm']['label'] = "Geração de recorrências de contas a pagar (receitas)";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "LancamentoDespesa_Recorrente_Frm")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['LancamentoDespesa_Recorrente_Frm']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['LancamentoDespesa_Recorrente_Frm'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }

      $this->Ini->cor_grid_par = $this->Ini->cor_grid_impar;
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "LancamentoDespesa_Recorrente_Frm.php"; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_orig'] = " where (IdLancamentoDespesa = '" . $_SESSION['varIdLancamentoDespesa'] . "')";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_pesq'] = " where (IdLancamentoDespesa = '" . $_SESSION['varIdLancamentoDespesa'] . "')";
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Recorrente_Frm']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['LancamentoDespesa_Recorrente_Frm'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['LancamentoDespesa_Recorrente_Frm'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("LancamentoDespesa_Recorrente_Frm", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'LancamentoDespesa_Recorrente_Frm/LancamentoDespesa_Recorrente_Frm_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'LancamentoDespesa_Recorrente_Frm_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'LancamentoDespesa_Recorrente_Frm_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'LancamentoDespesa_Recorrente_Frm_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'LancamentoDespesa_Recorrente_Frm/LancamentoDespesa_Recorrente_Frm_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "LancamentoDespesa_Recorrente_Frm_erro.class.php"); 
      }
      $this->Erro      = new LancamentoDespesa_Recorrente_Frm_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['opcao']))
         { 
             if ($this->idlancamentodespesa != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Recorrente_Frm']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['GerarRecorrencia'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['botoes']['GerarRecorrencia'];
          $this->nmgp_botoes['GerarSimulacao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['botoes']['GerarSimulacao'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            if ('ajax_check_file' == $this->nmgp_opcao ){
                 ...
                 global $bol_api_prod; 
                 $bol_api_prod = true; 
                 if (isset($_SESSION['scriptcase']['LancamentoDespesa_Recorrente_Frm']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['LancamentoDespesa_Recorrente_Frm']['glo_nm_conexao'])) 
                 { 
                     $bol_api_prod = false;
                 } 
            ...
            $out1_img_cache = $_SESSION['scriptcase']['LancamentoDespesa_Recorrente_Frm']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['LancamentoDespesa_Recorrente_Frm']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "LancamentoDespesa_Recorrente_Frm.php"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      if ($this->nmgp_opcao == "incluir") {
          $this->idfornecedor = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idfornecedor'];
      if ('' !== $this->idfornecedor || (!empty($format_fields) && isset($format_fields['idfornecedor'])))
      {
          ...
          $this->idplanoconta = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idplanoconta'];
      if ('' !== $this->idplanoconta || (!empty($format_fields) && isset($format_fields['idplanoconta'])))
      {
          ...
          $this->idcontacaixa = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idcontacaixa'];
      if ('' !== $this->idcontacaixa || (!empty($format_fields) && isset($format_fields['idcontacaixa'])))
      {
          ...
          $this->dataprevisao = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['dataprevisao'];
...
{ 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idfornecedor']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idfornecedor'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idfornecedor']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idfornecedor'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(LancamentoDespesa_Recorrente_Frm_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', LancamentoDespesa_Recorrente_Frm_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idfornecedor'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
{ 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idcontacaixa']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idcontacaixa'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idcontacaixa']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idcontacaixa'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idcontacaixa'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
{ 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idplanoconta']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idplanoconta'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idplanoconta']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idplanoconta'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idplanoconta'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
{ 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idempresa']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idempresa'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idempresa']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idempresa'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idempresa'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
{ 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idcliente']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idcliente'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idcliente']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idcliente'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idcliente'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
{ 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idcolaborador']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idcolaborador'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idcolaborador']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idcolaborador'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_idcolaborador'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_select']['idfornecedor']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->idfornecedor = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_select']['idfornecedor'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_select']['idplanoconta']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->idplanoconta = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_select']['idplanoconta'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_select']['idcontacaixa']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->idcontacaixa = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_select']['idcontacaixa'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_select']['dataprevisao']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->dataprevisao = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_select']['dataprevisao'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "LancamentoDespesa_Recorrente_Frm.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm'][$path_doc_md5][1] = $Zip_name;
?><!DOCTYPE html>
...
<form name="Fdown" method="get" action="LancamentoDespesa_Recorrente_Frm_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="LancamentoDespesa_Recorrente_Frm"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="LancamentoDespesa_Recorrente_Frm.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
<?php
include_once("LancamentoDespesa_Recorrente_Frm_sajax_js.php");
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->tiporecorrencia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['tiporecorrencia']))
          {
              $varloc_btn_php['tiporecorrencia'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['tiporecorrencia'];
          }
          if (!isset($this->qtdrecorrencia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['qtdrecorrencia']))
          {
              $varloc_btn_php['qtdrecorrencia'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['qtdrecorrencia'];
          }
          if (!isset($this->tiporecorrencia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['tiporecorrencia']))
          {
              $varloc_btn_php['tiporecorrencia'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['tiporecorrencia'];
          ...
          if (!isset($this->idlancamentodespesa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idlancamentodespesa']))
          {
              $varloc_btn_php['idlancamentodespesa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idlancamentodespesa'];
          }
          if (!isset($this->meus_dados) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['meus_dados']))
          {
              $varloc_btn_php['meus_dados'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['meus_dados'];
          }
          if (!isset($this->meus_dados_erro) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['meus_dados_erro']))
          {
              $varloc_btn_php['meus_dados_erro'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['meus_dados_erro'];
          }
          if (!isset($this->meus_dados) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['meus_dados']))
          {
              $varloc_btn_php['meus_dados'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['meus_dados'];
      ...
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = "LancamentoDespesa_Recorrente_Frm.php";
      }
      $nm_f_saida = "LancamentoDespesa_Recorrente_Frm_fim.php";
...
if ($msg != '') {
	...
	$sql = "SELECT IdTenacidade, IdFornecedor, IdContaCaixa, IdPlanoConta, IdEmpresa, IdLancamentoDespesa, DataPrevisao, ValorPrevisao, DataCompetencia, IdTipoAgente, IdCliente, IdColaborador, Parcela, IdSituacaoDocumento FROM _lancamentodespesarecorrente WHERE IdLancamentoDespesa = '$this->idlancamentodespesa'";
...
<?php
      ...
      else
      {
          ...
          if (!isset($this->dataprevisao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['dataprevisao']))
          {
              $varloc_btn_php['dataprevisao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['dataprevisao'];
          }
          if (!isset($this->dataprevisao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['dataprevisao']))
          {
              $varloc_btn_php['dataprevisao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['dataprevisao'];
          }
          if (!isset($this->idfornecedor) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idfornecedor']))
          {
              $varloc_btn_php['idfornecedor'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idfornecedor'];
          }
          if (!isset($this->idfornecedor) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idfornecedor']))
          {
              $varloc_btn_php['idfornecedor'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idfornecedor'];
          }
          if (!isset($this->idcliente) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idcliente']))
          {
              $varloc_btn_php['idcliente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idcliente'];
          }
          if (!isset($this->idcliente) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idcliente']))
          {
              $varloc_btn_php['idcliente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idcliente'];
          }
          if (!isset($this->idcolaborador) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idcolaborador']))
          {
              $varloc_btn_php['idcolaborador'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idcolaborador'];
          }
          if (!isset($this->idcolaborador) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idcolaborador']))
          {
              $varloc_btn_php['idcolaborador'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idcolaborador'];
          ...
          if (!isset($this->idcontacaixa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idcontacaixa']))
          {
              $varloc_btn_php['idcontacaixa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idcontacaixa'];
          }
          if (!isset($this->idplanoconta) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idplanoconta']))
          {
              $varloc_btn_php['idplanoconta'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idplanoconta'];
          }
          if (!isset($this->idempresa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idempresa']))
          {
              $varloc_btn_php['idempresa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idempresa'];
          }
          if (!isset($this->idlancamentodespesa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idlancamentodespesa']))
          {
              $varloc_btn_php['idlancamentodespesa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idlancamentodespesa'];
          }
          if (!isset($this->idtipoagente) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idtipoagente']))
          {
              $varloc_btn_php['idtipoagente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['idtipoagente'];
          }
          if (!isset($this->datainclusao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['datainclusao']))
          {
              $varloc_btn_php['datainclusao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['datainclusao'];
          }
          if (!isset($this->valorprevisao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['valorprevisao']))
          {
              $varloc_btn_php['valorprevisao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['valorprevisao'];
          }
          if (!isset($this->historico) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['historico']))
          {
              $varloc_btn_php['historico'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['historico'];
          }
          if (!isset($this->tiporecorrencia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['tiporecorrencia']))
          {
              $varloc_btn_php['tiporecorrencia'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form']['tiporecorrencia'];
      ...
      $nm_f_saida = "LancamentoDespesa_Recorrente_Frm.php";
      nm_limpa_numero($this->idfornecedor, $this->field_config['idfornecedor']['symbol_grp']) ; 
      nm_limpa_numero($this->idcliente, $this->field_config['idcliente']['symbol_grp']) ; 
      nm_limpa_numero($this->idcolaborador, $this->field_config['idcolaborador']['symbol_grp']) ; 
      nm_limpa_numero($this->idplanoconta, $this->field_config['idplanoconta']['symbol_grp']) ; 
...
if ($msg == '') {
 ...
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('LancamentoDespesa_Recorrente_Frm') . "/LancamentoDespesa_Recorrente_Frm.php", $this->nm_location, "varTipoRecorrencia?#?" . NM_encode_input($this->tiporecorrencia ) . "?@?" . "varQtdRecorrencia?#?" . NM_encode_input($this->qtdrecorrencia ) . "?@?" . "varAcao?#?" . NM_encode_input("2") . "?@?","_self", '', 440, 630);
 };
}
if (isset($this->sc_temp_varAcao)) { $_SESSION['varAcao'] = $this->sc_temp_varAcao;}
if (isset($this->sc_temp_varTipoRecorrencia)) { $_SESSION['varTipoRecorrencia'] = $this->sc_temp_varTipoRecorrencia;}
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['csrf_token']) && $this->scCsrfGetToken() != $this->csrf_token)
     {
          $this->Campos_Mens_erro .= (empty($this->Campos_Mens_erro)) ? "" : "<br />";
          $this->Campos_Mens_erro .= "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_LancamentoDespesa_Recorrente_Frm']) || !is_array($this->NM_ajax_info['errList']['geral_LancamentoDespesa_Recorrente_Frm']))
              {
                  $this->NM_ajax_info['errList']['geral_LancamentoDespesa_Recorrente_Frm'] = array();
              }
              $this->NM_ajax_info['errList']['geral_LancamentoDespesa_Recorrente_Frm'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idlancamentodespesa']['keyVal'] = LancamentoDespesa_Recorrente_Frm_pack_protect_string($this->nmgp_dados_form['idlancamentodespesa']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['_LancamentoDespesaRecorrente_Lst_script_case_init'] ]['_LancamentoDespesaRecorrente_Lst']['embutida_form_full'] = false;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['_LancamentoDespesaRecorrente_Lst_script_case_init'] ]['_LancamentoDespesaRecorrente_Lst']['embutida_form']       = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['_LancamentoDespesaRecorrente_Lst_script_case_init'] ]['_LancamentoDespesaRecorrente_Lst']['embutida_pai']        = "LancamentoDespesa_Recorrente_Frm";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['_LancamentoDespesaRecorrente_Lst_script_case_init'] ]['_LancamentoDespesaRecorrente_Lst']['embutida_form_parms'] = "varidlancamentodespesa*scin" . $this->nmgp_dados_form['idlancamentodespesa'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinPARCIAL*scoutNMSC_cab*scinN*scoutlink_remove_margin*scinok*scoutlink_remove_border*scinok*scoutlink_remove_background*scinno*scout";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['_LancamentoDespesaRecorrente_Lst_script_case_init'] ]['_LancamentoDespesaRecorrente_Lst']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['_LancamentoDespesaRecorrente_Lst_script_case_init'] ]['_LancamentoDespesaRecorrente_Lst']['total']);
          }
   } // ajax_return_values
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][LancamentoDespesa_Recorrente_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idfornecedor))]) ? $aLookup[0][LancamentoDespesa_Recorrente_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idfornecedor))] : "";
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][LancamentoDespesa_Recorrente_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idcliente))]) ? $aLookup[0][LancamentoDespesa_Recorrente_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idcliente))] : "";
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][LancamentoDespesa_Recorrente_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idcolaborador))]) ? $aLookup[0][LancamentoDespesa_Recorrente_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idcolaborador))] : "";
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][LancamentoDespesa_Recorrente_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idplanoconta))]) ? $aLookup[0][LancamentoDespesa_Recorrente_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idplanoconta))] : "";
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][LancamentoDespesa_Recorrente_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idcontacaixa))]) ? $aLookup[0][LancamentoDespesa_Recorrente_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idcontacaixa))] : "";
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][LancamentoDespesa_Recorrente_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idempresa))]) ? $aLookup[0][LancamentoDespesa_Recorrente_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idempresa))] : "";
...
$aLookup[] = array(LancamentoDespesa_Recorrente_Frm_pack_protect_string('1') => str_replace('<', '&lt;',LancamentoDespesa_Recorrente_Frm_pack_protect_string("Quinzenal")));
$aLookup[] = array(LancamentoDespesa_Recorrente_Frm_pack_protect_string('2') => str_replace('<', '&lt;',LancamentoDespesa_Recorrente_Frm_pack_protect_string("Mensal")));
$aLookup[] = array(LancamentoDespesa_Recorrente_Frm_pack_protect_string('3') => str_replace('<', '&lt;',LancamentoDespesa_Recorrente_Frm_pack_protect_string("Bimestral")));
$aLookup[] = array(LancamentoDespesa_Recorrente_Frm_pack_protect_string('4') => str_replace('<', '&lt;',LancamentoDespesa_Recorrente_Frm_pack_protect_string("Trimestral")));
$aLookup[] = array(LancamentoDespesa_Recorrente_Frm_pack_protect_string('5') => str_replace('<', '&lt;',LancamentoDespesa_Recorrente_Frm_pack_protect_string("Semestral")));
$aLookup[] = array(LancamentoDespesa_Recorrente_Frm_pack_protect_string('6') => str_replace('<', '&lt;',LancamentoDespesa_Recorrente_Frm_pack_protect_string("Anual")));
$_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_tiporecorrencia'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_tiporecorrencia'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_tiporecorrencia'][] = '3';
$_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_tiporecorrencia'][] = '4';
$_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_tiporecorrencia'][] = '5';
$_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Lookup_tiporecorrencia'][] = '6';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['tiporecorrencia']['valList'][$i] = LancamentoDespesa_Recorrente_Frm_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_recorrentetemp($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['upload_dir'][$fieldName][] = $newName;
  ...
  function nm_proc_onload($bFormat = true)
  {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Field_no_validate'] = array();
...
$_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['Field_disabled_macro']['idempresa'] = array('I'=>array(),'U'=>array());
;
...
if ($msg != '') {
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_LancamentoDespesa_Recorrente_Frm';
...
$_SESSION['scriptcase']['LancamentoDespesa_Recorrente_Frm']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              $this->nmgp_refresh_fields = array_diff(array('idfornecedor', 'idcliente', 'idcolaborador', 'idplanoconta', 'idcontacaixa', 'idempresa', 'dataprevisao', 'valorprevisao', 'datacompetencia', 'idlancamentodespesa', 'tiporecorrencia', 'qtdrecorrencia', 'recorrentetemp'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['parms'] = "idlancamentodespesa?#?$this->idlancamentodespesa?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (!empty($sc_where))
              {
                  if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['reg_start'] < $qt_geral_reg_LancamentoDespesa_Recorrente_Frm;
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['opcao']   = '';
          }
      } 
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['_LancamentoDespesaRecorrente_Lst']['embutida_parms'] = "varidlancamentodespesa*scin" . $this->nmgp_dados_form['idlancamentodespesa'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinPARCIAL*scoutNMSC_cab*scinN*scoutlink_remove_margin*scinok*scoutlink_remove_border*scinok*scoutlink_remove_background*scinno*scout";
  }
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("LancamentoDespesa_Recorrente_Frm_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dyn_search_cache']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_filter_form'] . " and ((IdLancamentoDespesa = '" . $_SESSION['varIdLancamentoDespesa'] . "')) and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_LancamentoDespesa_Recorrente_Frm = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['total'] = $qt_geral_reg_LancamentoDespesa_Recorrente_Frm;
      $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          LancamentoDespesa_Recorrente_Frm_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "LancamentoDespesa_Recorrente_Frm_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['nm_run_menu'] = 2;
       $nmgp_saida_form = "LancamentoDespesa_Recorrente_Frm_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Recorrente_Frm']['ordem_ord'] == " desc") {
