<?php
//
class LancamentoDespesa_Extender_Frm_apl
{
   ...
   var $idlancamentodespesapai;
   var $idlancamentodespesapai_1;
   ...
   var $idusuarioagendamento;
   var $idusuarioagendamento_1;
   var $idusuariorealizacao;
   var $idusuariorealizacao_1;
   var $idusuariobaixa;
   var $idusuariobaixa_1;
   var $idlancamentodespesarecorrente;
   var $idlancamentodespesarecorrente_1;
   var $idtipoagente;
   var $idcliente;
   var $idcolaborador;
   ...
   var $nomearquivonotafiscal;
   var $nomereferencianotafiscal;
   var $nomearquivocomprovante;
   var $nomereferenciacomprovante;
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['idlancamentodespesa']))
          {
              $this->idlancamentodespesa = $this->NM_ajax_info['param']['idlancamentodespesa'];
          }
      ...
      if (isset($this->varIdLancamentoDespesa) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['varIdLancamentoDespesa'] = $this->varIdLancamentoDespesa;
      }
      ...
      if (isset($this->varVetParcelas) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['varVetParcelas'] = $this->varVetParcelas;
      }
      ...
      if (isset($this->varTipo) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['varTipo'] = $this->varTipo;
      }
      if (isset($this->varQtdParcelas) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['varQtdParcelas'] = $this->varQtdParcelas;
      }
      ...
      if (isset($_POST["varIdLancamentoDespesa"]) && isset($this->varIdLancamentoDespesa)) 
      {
          $_SESSION['varIdLancamentoDespesa'] = $this->varIdLancamentoDespesa;
      }
      ...
      if (isset($_POST["varVetParcelas"]) && isset($this->varVetParcelas)) 
      {
          $_SESSION['varVetParcelas'] = $this->varVetParcelas;
      }
      if (!isset($_POST["varVetParcelas"]) && isset($_POST["varvetparcelas"])) 
      {
          $_SESSION['varVetParcelas'] = $_POST["varvetparcelas"];
      }
      ...
      if (isset($_POST["varTipo"]) && isset($this->varTipo)) 
      {
          $_SESSION['varTipo'] = $this->varTipo;
      }
      if (!isset($_POST["varTipo"]) && isset($_POST["vartipo"])) 
      {
          $_SESSION['varTipo'] = $_POST["vartipo"];
      }
      if (isset($_POST["varQtdParcelas"]) && isset($this->varQtdParcelas)) 
      {
          $_SESSION['varQtdParcelas'] = $this->varQtdParcelas;
      }
      if (!isset($_POST["varQtdParcelas"]) && isset($_POST["varqtdparcelas"])) 
      {
          $_SESSION['varQtdParcelas'] = $_POST["varqtdparcelas"];
      }
      ...
      if (isset($_GET["varIdLancamentoDespesa"]) && isset($this->varIdLancamentoDespesa)) 
      {
          $_SESSION['varIdLancamentoDespesa'] = $this->varIdLancamentoDespesa;
      }
      ...
      if (isset($_GET["varVetParcelas"]) && isset($this->varVetParcelas)) 
      {
          $_SESSION['varVetParcelas'] = $this->varVetParcelas;
      }
      if (!isset($_GET["varVetParcelas"]) && isset($_GET["varvetparcelas"])) 
      {
          $_SESSION['varVetParcelas'] = $_GET["varvetparcelas"];
      }
      ...
      if (isset($_GET["varTipo"]) && isset($this->varTipo)) 
      {
          $_SESSION['varTipo'] = $this->varTipo;
      }
      if (!isset($_GET["varTipo"]) && isset($_GET["vartipo"])) 
      {
          $_SESSION['varTipo'] = $_GET["vartipo"];
      }
      if (isset($_GET["varQtdParcelas"]) && isset($this->varQtdParcelas)) 
      {
          $_SESSION['varQtdParcelas'] = $this->varQtdParcelas;
      }
      if (!isset($_GET["varQtdParcelas"]) && isset($_GET["varqtdparcelas"])) 
      {
          $_SESSION['varQtdParcelas'] = $_GET["varqtdparcelas"];
      }
      ...
      if (isset($this->Refresh_aba_menu)) {
          $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['Refresh_aba_menu'] = $this->Refresh_aba_menu;
      }
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          $_POST['nmgp_opcao'] = "novo";
          $this->nmgp_opcao    = "novo";
          $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_LancamentoDespesa_Extender_Frm($cadapar[1]);
          ...
          if (!isset($this->varIdLancamentoDespesa) && isset($this->varidlancamentodespesa)) 
          {
              $this->varIdLancamentoDespesa = $this->varidlancamentodespesa;
          }
          if (isset($this->varIdLancamentoDespesa)) 
          {
              $_SESSION['varIdLancamentoDespesa'] = $this->varIdLancamentoDespesa;
          }
          ...
          if (!isset($this->varVetParcelas) && isset($this->varvetparcelas)) 
          {
              $this->varVetParcelas = $this->varvetparcelas;
          }
          if (isset($this->varVetParcelas)) 
          {
              $_SESSION['varVetParcelas'] = $this->varVetParcelas;
          }
          ...
          if (!isset($this->varTipo) && isset($this->vartipo)) 
          {
              $this->varTipo = $this->vartipo;
          }
          if (isset($this->varTipo)) 
          {
              $_SESSION['varTipo'] = $this->varTipo;
          }
          if (!isset($this->varQtdParcelas) && isset($this->varqtdparcelas)) 
          {
              $this->varQtdParcelas = $this->varqtdparcelas;
          }
          if (isset($this->varQtdParcelas)) 
          {
              $_SESSION['varQtdParcelas'] = $this->varQtdParcelas;
          }
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['_LancamentoDespesaRecorrente_Frm_script_case_init'] ]['_LancamentoDespesaRecorrente_Frm']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['_LancamentoDespesaRecorrente_Frm_script_case_init'] ]['_LancamentoDespesaRecorrente_Frm']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['sc_redir_insert'] = $this->sc_redir_insert;
              unset($_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['opc_ant']);
          }
          if (!isset($this->varIdLancamentoDespesa) && isset($this->varidlancamentodespesa)) 
          {
              $this->varIdLancamentoDespesa = $this->varidlancamentodespesa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new LancamentoDespesa_Extender_Frm_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['initialize'])
          {
              $_SESSION['scriptcase']['LancamentoDespesa_Extender_Frm']['contr_erro'] = 'on';
if (!isset($this->sc_temp_varIdLancamentoDespesa)) {$this->sc_temp_varIdLancamentoDespesa = (isset($_SESSION['varIdLancamentoDespesa'])) ? $_SESSION['varIdLancamentoDespesa'] : "";}
...
if (!isset($this->sc_temp_varVetParcelas)) {$this->sc_temp_varVetParcelas = (isset($_SESSION['varVetParcelas'])) ? $_SESSION['varVetParcelas'] : "";}
  if (!isset($this->sc_temp_varVetParcelas)) {
	$this->varVetParcelas = array();;
	 if (isset($this->varVetParcelas)) {$this->sc_temp_varVetParcelas = $this->varVetParcelas;}
;	
} else {
	$this->sc_temp_varVetParcelas = array();	
}
...
$delete_where  = "IdTenacidade = '$this->sc_temp_varIdTenacidade' AND IdLancamentoDespesa = '$this->sc_temp_varIdLancamentoDespesa'";
     ...
     $nm_select = $delete_sql; 
      ...
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         ...
         if ($rf === false)
         {
             ...
             if ($this->NM_ajax_flag)
             {
                LancamentoDespesa_Extender_Frm_pack_ajax_response();
             }
             exit;
         }
         $rf->Close();
...
if (isset($this->sc_temp_varVetParcelas)) { $_SESSION['varVetParcelas'] = $this->sc_temp_varVetParcelas;}
...
if (isset($this->sc_temp_varIdLancamentoDespesa)) { $_SESSION['varIdLancamentoDespesa'] = $this->sc_temp_varIdLancamentoDespesa;}
$_SESSION['scriptcase']['LancamentoDespesa_Extender_Frm']['contr_erro'] = 'off';
          }
          $this->Ini->init2();
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['LancamentoDespesa_Extender_Frm']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['LancamentoDespesa_Extender_Frm']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['LancamentoDespesa_Extender_Frm'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['LancamentoDespesa_Extender_Frm']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['LancamentoDespesa_Extender_Frm']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('LancamentoDespesa_Extender_Frm') . "/LancamentoDespesa_Extender_Frm.php";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['LancamentoDespesa_Extender_Frm']['label'] = "Geração de recorrências de contas a pagar (receitas)";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "LancamentoDespesa_Extender_Frm")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $this->Db = $this->Ini->Db; 
      $this->nm_new_label['tiporecorrencia'] = 'Recorrência*';
      ...
      $this->arr_buttons['gerarrecorrencia']['style']            = "success_sm";
      ...
      $this->arr_buttons['gerarsimulacao']['style']            = "success_sm";
      ...
      $_SESSION['scriptcase']['error_icon']['LancamentoDespesa_Extender_Frm']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['LancamentoDespesa_Extender_Frm'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }

      $this->Ini->cor_grid_par = $this->Ini->cor_grid_impar;
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "LancamentoDespesa_Extender_Frm.php"; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_orig'] = " where (IdLancamentoDespesa = '" . $_SESSION['varIdLancamentoDespesa'] . "')";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_pesq'] = " where (IdLancamentoDespesa = '" . $_SESSION['varIdLancamentoDespesa'] . "')";
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['LancamentoDespesa_Extender_Frm']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['LancamentoDespesa_Extender_Frm'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['LancamentoDespesa_Extender_Frm'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form'];
          ...
          if (!isset($this->idcheque)){$this->idcheque = $this->nmgp_dados_form['idcheque'];} 
          if (!isset($this->idcontacaixaregistro)){$this->idcontacaixaregistro = $this->nmgp_dados_form['idcontacaixaregistro'];} 
          if (!isset($this->idlancamentodespesapai)){$this->idlancamentodespesapai = $this->nmgp_dados_form['idlancamentodespesapai'];} 
          ...
          if (!isset($this->idusuarioagendamento)){$this->idusuarioagendamento = $this->nmgp_dados_form['idusuarioagendamento'];} 
          ...
          if (!isset($this->idlancamentodespesarecorrente)){$this->idlancamentodespesarecorrente = $this->nmgp_dados_form['idlancamentodespesarecorrente'];} 
          ...
          if (!isset($this->dataagendamento)){$this->dataagendamento = $this->nmgp_dados_form['dataagendamento'];} 
          ...
          if (!isset($this->nomearquivoboleto)){$this->nomearquivoboleto = $this->nmgp_dados_form['nomearquivoboleto'];} 
          if (!isset($this->nomereferenciaboleto)){$this->nomereferenciaboleto = $this->nmgp_dados_form['nomereferenciaboleto'];} 
          if (!isset($this->nomearquivonotafiscal)){$this->nomearquivonotafiscal = $this->nmgp_dados_form['nomearquivonotafiscal'];} 
          if (!isset($this->nomereferencianotafiscal)){$this->nomereferencianotafiscal = $this->nmgp_dados_form['nomereferencianotafiscal'];} 
          if (!isset($this->nomearquivocomprovante)){$this->nomearquivocomprovante = $this->nmgp_dados_form['nomearquivocomprovante'];} 
          if (!isset($this->nomereferenciacomprovante)){$this->nomereferenciacomprovante = $this->nmgp_dados_form['nomereferenciacomprovante'];} 
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("LancamentoDespesa_Extender_Frm", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'LancamentoDespesa_Extender_Frm/LancamentoDespesa_Extender_Frm_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'LancamentoDespesa_Extender_Frm_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'LancamentoDespesa_Extender_Frm_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'LancamentoDespesa_Extender_Frm_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'LancamentoDespesa_Extender_Frm/LancamentoDespesa_Extender_Frm_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "LancamentoDespesa_Extender_Frm_erro.class.php"); 
      }
      $this->Erro      = new LancamentoDespesa_Extender_Frm_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['opcao']))
         { 
             if ($this->idlancamentodespesa != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['LancamentoDespesa_Extender_Frm']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['GerarRecorrencia'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['botoes']['GerarRecorrencia'];
          $this->nmgp_botoes['GerarSimulacao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['botoes']['GerarSimulacao'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['_LancamentoDespesaRecorrente_Frm_script_case_init'] ]['_LancamentoDespesaRecorrente_Frm']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['_LancamentoDespesaRecorrente_Frm_script_case_init'] ]['_LancamentoDespesaRecorrente_Frm']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['_LancamentoDespesaRecorrente_Frm_script_case_init'] ]['_LancamentoDespesaRecorrente_Frm']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['_LancamentoDespesaRecorrente_Frm_script_case_init'] ]['_LancamentoDespesaRecorrente_Frm']['total']);
          $detailAppObject = "_LancamentoDespesaRecorrente_Frm_apl";
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('_LancamentoDespesaRecorrente_Frm') . "/_LancamentoDespesaRecorrente_Frm.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('_LancamentoDespesaRecorrente_Frm') . "/_LancamentoDespesaRecorrente_Frm_apl.php");
          $this->_LancamentoDespesaRecorrente_Frm = new $detailAppObject;
      }
      ...
      $this->sc_evento = $this->nmgp_opcao;
            if ('ajax_check_file' == $this->nmgp_opcao ){
                 ...
                 global $bol_api_prod; 
                 $bol_api_prod = true; 
                 if (isset($_SESSION['scriptcase']['LancamentoDespesa_Extender_Frm']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['LancamentoDespesa_Extender_Frm']['glo_nm_conexao'])) 
                 { 
                     $bol_api_prod = false;
                 } 
            ...
            $out1_img_cache = $_SESSION['scriptcase']['LancamentoDespesa_Extender_Frm']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['LancamentoDespesa_Extender_Frm']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      if (isset($this->idlancamentodespesa)) { $this->nm_limpa_alfa($this->idlancamentodespesa); }
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "LancamentoDespesa_Extender_Frm.php"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      //-- idlancamentodespesa
      $this->field_config['idlancamentodespesa']               = array();
      $this->field_config['idlancamentodespesa']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['idlancamentodespesa']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['idlancamentodespesa']['symbol_dec'] = '';
      $this->field_config['idlancamentodespesa']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['idlancamentodespesa']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- qtdparcelas
      ...
      //-- dataagendamento
      $this->field_config['dataagendamento']                 = array();
      $this->field_config['dataagendamento']['date_format']  = $_SESSION['scriptcase']['reg_conf']['date_format'] . ';' . $_SESSION['scriptcase']['reg_conf']['time_format'];
      $this->field_config['dataagendamento']['date_sep']     = $_SESSION['scriptcase']['reg_conf']['date_sep'];
      $this->field_config['dataagendamento']['time_sep']     = $_SESSION['scriptcase']['reg_conf']['time_sep'];
      $this->field_config['dataagendamento']['date_display'] = "ddmmaaaa;hhiiss";
      $this->new_date_format('DH', 'dataagendamento');
      //-- datarealizacao
   ...
   function controle()
   {
      ...
      if ($this->nmgp_opcao == "incluir") {
          $this->idfornecedor = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idfornecedor'];
      if ('' !== $this->idfornecedor || (!empty($format_fields) && isset($format_fields['idfornecedor'])))
      {
          ...
          $this->idplanoconta = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idplanoconta'];
      if ('' !== $this->idplanoconta || (!empty($format_fields) && isset($format_fields['idplanoconta'])))
      {
          ...
          $this->idcontacaixa = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idcontacaixa'];
      if ('' !== $this->idcontacaixa || (!empty($format_fields) && isset($format_fields['idcontacaixa'])))
      {
          ...
          $this->dataprevisao = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['dataprevisao'];
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_idlancamentodespesa' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'idlancamentodespesa');
          }
...
{ 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idfornecedor']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idfornecedor'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idfornecedor']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idfornecedor'] = array(); 
    }
   ...
   $old_value_idlancamentodespesa = $this->idlancamentodespesa;
   ...
   $unformatted_value_idlancamentodespesa = $this->idlancamentodespesa;
   ...
   $this->idlancamentodespesa = $old_value_idlancamentodespesa;
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(LancamentoDespesa_Extender_Frm_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', LancamentoDespesa_Extender_Frm_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idfornecedor'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
{ 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idcontacaixa']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idcontacaixa'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idcontacaixa']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idcontacaixa'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idcontacaixa'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
{ 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idplanoconta']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idplanoconta'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idplanoconta']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idplanoconta'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idplanoconta'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
{ 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idempresa']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idempresa'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idempresa']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idempresa'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idempresa'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
{ 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idcliente']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idcliente'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idcliente']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idcliente'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idcliente'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
{ 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idcolaborador']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idcolaborador'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idcolaborador']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idcolaborador'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_idcolaborador'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_select']['idfornecedor']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->idfornecedor = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_select']['idfornecedor'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_select']['idplanoconta']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->idplanoconta = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_select']['idplanoconta'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_select']['idcontacaixa']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->idcontacaixa = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_select']['idcontacaixa'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_select']['dataprevisao']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->dataprevisao = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_select']['dataprevisao'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "LancamentoDespesa_Extender_Frm.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm'][$path_doc_md5][1] = $Zip_name;
?><!DOCTYPE html>
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo strip_tags("Geração de recorrências de contas a pagar (receitas)") ?></TITLE>
...
<form name="Fdown" method="get" action="LancamentoDespesa_Extender_Frm_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="LancamentoDespesa_Extender_Frm"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="LancamentoDespesa_Extender_Frm.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
<?php
include_once("LancamentoDespesa_Extender_Frm_sajax_js.php");
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->tiporecorrencia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['tiporecorrencia']))
          {
              $varloc_btn_php['tiporecorrencia'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['tiporecorrencia'];
          }
          if (!isset($this->qtdparcelas) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['qtdparcelas']))
          {
              $varloc_btn_php['qtdparcelas'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['qtdparcelas'];
          }
          if (!isset($this->tiporecorrencia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['tiporecorrencia']))
          {
              $varloc_btn_php['tiporecorrencia'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['tiporecorrencia'];
          ...
          if (!isset($this->idlancamentodespesa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idlancamentodespesa']))
          {
              $varloc_btn_php['idlancamentodespesa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idlancamentodespesa'];
          }
          if (!isset($this->idlancamentodespesa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idlancamentodespesa']))
          {
              $varloc_btn_php['idlancamentodespesa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idlancamentodespesa'];
          }
          if (!isset($this->checagem) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['checagem']))
          {
              $varloc_btn_php['checagem'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['checagem'];
          }
          if (!isset($this->checagem_erro) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['checagem_erro']))
          {
              $varloc_btn_php['checagem_erro'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['checagem_erro'];
          }
          if (!isset($this->checagem) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['checagem']))
          {
              $varloc_btn_php['checagem'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['checagem'];
          }
          if (!isset($this->meus_dados) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['meus_dados']))
          {
              $varloc_btn_php['meus_dados'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['meus_dados'];
          }
          if (!isset($this->meus_dados_erro) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['meus_dados_erro']))
          {
              $varloc_btn_php['meus_dados_erro'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['meus_dados_erro'];
          }
          if (!isset($this->meus_dados) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['meus_dados']))
          {
              $varloc_btn_php['meus_dados'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['meus_dados'];
          ...
          if (!isset($this->valorprevisao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['valorprevisao']))
          {
              $varloc_btn_php['valorprevisao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['valorprevisao'];
          }
          if (!isset($this->qtdparcelas) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['qtdparcelas']))
          {
              $varloc_btn_php['qtdparcelas'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['qtdparcelas'];
          ...
          if (!isset($this->listarateio) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['listarateio']))
          {
              $varloc_btn_php['listarateio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['listarateio'];
          }
          if (!isset($this->listarateio_erro) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['listarateio_erro']))
          {
              $varloc_btn_php['listarateio_erro'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['listarateio_erro'];
          }
          if (!isset($this->listarateio) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['listarateio']))
          {
              $varloc_btn_php['listarateio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['listarateio'];
      ...
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = "LancamentoDespesa_Extender_Frm.php";
      }
      $nm_f_saida = "LancamentoDespesa_Extender_Frm_fim.php";
      ...
      nm_limpa_numero($this->idlancamentodespesa, $this->field_config['idlancamentodespesa']['symbol_grp']) ; 
...
if (!isset($this->sc_temp_varTipo)) {$this->sc_temp_varTipo = (isset($_SESSION['varTipo'])) ? $_SESSION['varTipo'] : "";}
if (!isset($this->sc_temp_varQtdParcelas)) {$this->sc_temp_varQtdParcelas = (isset($_SESSION['varQtdParcelas'])) ? $_SESSION['varQtdParcelas'] : "";}
...
if ($msg != '') {
	...
	$this->sc_temp_varQtdParcelas = $this->qtdparcelas ;
	} else {
	$sql = "SELECT IdTenacidade, IdFornecedor, IdContaCaixa, IdPlanoConta, IdEmpresa, IdLancamentoDespesa, DataPrevisao, ValorPrevisao, DataCompetencia, IdTipoAgente, IdCliente, IdColaborador, Parcela, IdSituacaoDocumento, Historico FROM _lancamentodespesarecorrente WHERE IdLancamentoDespesa = '$this->idlancamentodespesa'";
	...
	$check_table = 'lancamentodespesarateio';
	$check_where = "IdLancamentoDespesa = '$this->idlancamentodespesa' AND Validado = 'S'"; 
	...
	$check_sql = 'SELECT *'
      ...
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($this->checagem = $this->Db->Execute($nm_select)) 
      { }
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->checagem = false;
          $this->checagem_erro = $this->Db->ErrorMsg();
      } 


	if (false == $this->checagem ) {
		
		$msg = $msg . "Erro de acesso. Mensagem = " . $this->checagem_erro ;

	} elseif ($this->checagem->EOF) {
	...
	if ( $this->meus_dados  === false ) {
		...
		while ( !$this->meus_dados->EOF ) {
			...
			$IdLancamentoDespesa 	= $this->meus_dados->fields[5];
			...
			$varHistorico			= $this->meus_dados->fields[14];
			...
			if ($this->sc_temp_varTipo == 'Parcelar') {
				$valorPrevisao = round( $this->valorprevisao  / $this->qtdparcelas  * 100 / 100, 2);
				$qtdParcela = $this->qtdparcelas ;
				$idLancamentoDespesaPai = $this->idlancamentodespesa ;
				$idLancamentoDespesaRecorrente = 'NULL';
			} else {
				$valorPrevisao = $this->valorprevisao ;
				$qtdParcela = 1;
				$Parcela = 1;
				$idLancamentoDespesaPai = 'NULL';
				$idLancamentoDespesaRecorrente = $this->idlancamentodespesa ;
			}			
			
			$insert_table  = 'lancamentodespesa';
			$insert_fields = array(
				 ...
				 'IdEmpresa' 						=> "'$IdEmpresa'",
				 'IdLancamentoDespesaRecorrente'	=> "$idLancamentoDespesaRecorrente",
				 'IdLancamentoDespesaPai'			=> "$idLancamentoDespesaPai",
    ...
    $this->Ini->sc_tem_trans_banco = false;
      ...
      { 
          ...
          { 
                 ...
                 { 
                      $this->datasetregistro[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->datasetregistro = false;
          $this->datasetregistro_erro = $this->Db->ErrorMsg();
      } 

				$varDespesaInserida = $this->datasetregistro[0][0];
				
				$sql = "SELECT IdTenacidade, IdEmpresa, IdPlanoConta, ValorRateio FROM lancamentodespesarateio WHERE IdLancamentoDespesa = '$this->idlancamentodespesa' AND Validado = 'S'";
				 
      $nm_select = $sql; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($this->listarateio = $this->Db->Execute($nm_select)) 
      { }
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->listarateio = false;
          $this->listarateio_erro = $this->Db->ErrorMsg();
      } 
	
				
				if ($this->listarateio  === false ) {
					
					$msg = $msg . "Erro de acesso. Mensagem = " . $this->listarateio_erro ;
					
				} else {
					
					while (!$this->listarateio->EOF) {
						
						$varIdTenacidade = $this->listarateio->fields[0];
						$varIdEmpresa	 = $this->listarateio->fields[1];
						$varIdPlanoConta = $this->listarateio->fields[2];
						$varValorRateio	 = $this->listarateio->fields[3];
						
						if ($this->sc_temp_varTipo == 'Parcelar') {
							
							$varValorRateio = round( $varValorRateio / $this->qtdparcelas  * 100 / 100, 2);					
							
						}
						
						$insert_table  = 'lancamentodespesarateio';
						$insert_fields = array(
							 'IdTenacidade' 					=> "$varIdTenacidade",
							 'IdEmpresa' 						=> "$varIdEmpresa",
							 'IdPlanoConta'						=> "$varIdPlanoConta",
							 'IdLancamentoDespesa'				=> "$varDespesaInserida",
						     'ValorRateio'						=> "$varValorRateio",
							 'DataHoraInclusao' 				=> "'$dataInclusao'",
							 'Validado'							=> "'S'",
							 'IdUsuarioAuditoria' 				=> "'$this->sc_temp_varIdUsuario'",
							 'EnderecoIpAuditoria' 				=> "'$enderecoIP'",
							 'NomeAplicacaoAuditoria' 			=> "'$nomeAplicacao'",
						...
						if ($this->Ini->sc_tem_trans_banco)
{
    ...
    $this->Ini->sc_tem_trans_banco = false;
						...
						$this->listarateio->MoveNext();	
						
					}
					
					$this->listarateio->Close();		
		...
		$update_where  = "IdLancamentoDespesa = '$this->idlancamentodespesa'";
		$update_fields = array(
			 "IdLancamentoDespesaRecorrente = $idLancamentoDespesaRecorrente",
			 "IdLancamentoDespesaPai 		= $idLancamentoDespesaPai",
			 "Parcela 						= '1'",
...
if (isset($this->sc_temp_varQtdParcelas)) { $_SESSION['varQtdParcelas'] = $this->sc_temp_varQtdParcelas;}
if (isset($this->sc_temp_varTipo)) { $_SESSION['varTipo'] = $this->sc_temp_varTipo;}
...
?>
      ...
      <input type=hidden name="script_case_init" value="<?php  echo $this->form_encode_input($this->Ini->sc_page); ?>"/>
      <input type=hidden name="idlancamentodespesa" value="<?php echo $this->form_encode_input($this->idlancamentodespesa) ?>"/>
...
<?php
      ...
      else
      {
          ...
          if (!isset($this->dataprevisao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['dataprevisao']))
          {
              $varloc_btn_php['dataprevisao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['dataprevisao'];
          }
          if (!isset($this->dataprevisao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['dataprevisao']))
          {
              $varloc_btn_php['dataprevisao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['dataprevisao'];
          }
          if (!isset($this->idfornecedor) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idfornecedor']))
          {
              $varloc_btn_php['idfornecedor'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idfornecedor'];
          }
          if (!isset($this->idfornecedor) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idfornecedor']))
          {
              $varloc_btn_php['idfornecedor'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idfornecedor'];
          }
          if (!isset($this->idcliente) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idcliente']))
          {
              $varloc_btn_php['idcliente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idcliente'];
          }
          if (!isset($this->idcliente) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idcliente']))
          {
              $varloc_btn_php['idcliente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idcliente'];
          }
          if (!isset($this->idcolaborador) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idcolaborador']))
          {
              $varloc_btn_php['idcolaborador'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idcolaborador'];
          }
          if (!isset($this->idcolaborador) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idcolaborador']))
          {
              $varloc_btn_php['idcolaborador'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idcolaborador'];
          ...
          if (!isset($this->datacompetencia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['datacompetencia']))
          {
              $varloc_btn_php['datacompetencia'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['datacompetencia'];
          }
          if (!isset($this->idcontacaixa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idcontacaixa']))
          {
              $varloc_btn_php['idcontacaixa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idcontacaixa'];
          }
          if (!isset($this->idplanoconta) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idplanoconta']))
          {
              $varloc_btn_php['idplanoconta'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idplanoconta'];
          }
          if (!isset($this->idempresa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idempresa']))
          {
              $varloc_btn_php['idempresa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idempresa'];
          }
          if (!isset($this->idlancamentodespesa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idlancamentodespesa']))
          {
              $varloc_btn_php['idlancamentodespesa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idlancamentodespesa'];
          }
          if (!isset($this->idtipoagente) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idtipoagente']))
          {
              $varloc_btn_php['idtipoagente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['idtipoagente'];
          }
          if (!isset($this->datainclusao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['datainclusao']))
          {
              $varloc_btn_php['datainclusao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['datainclusao'];
          }
          if (!isset($this->historico) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['historico']))
          {
              $varloc_btn_php['historico'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['historico'];
          }
          if (!isset($this->tiporecorrencia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['tiporecorrencia']))
          {
              $varloc_btn_php['tiporecorrencia'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form']['tiporecorrencia'];
      ...
      $nm_f_saida = "LancamentoDespesa_Extender_Frm.php";
      nm_limpa_numero($this->idfornecedor, $this->field_config['idfornecedor']['symbol_grp']) ; 
      nm_limpa_numero($this->idcliente, $this->field_config['idcliente']['symbol_grp']) ; 
      nm_limpa_numero($this->idcolaborador, $this->field_config['idcolaborador']['symbol_grp']) ; 
      nm_limpa_numero($this->idplanoconta, $this->field_config['idplanoconta']['symbol_grp']) ; 
	...
	if ($this->Ini->sc_tem_trans_banco)
{
	...
	if ($this->sc_temp_varTipo == 'Parcelar') {
		...
		$this->sc_temp_varVetParcelas[1] = $this->valorprevisao ;
	}
	for ($i = 2; $i <= $this->qtdparcelas ; $i++) {
		if ($this->sc_temp_varTipo == 'Parcelar') {
			$valorPrevisao = $this->sc_temp_varVetParcelas[$i];
		} else {
			$valorPrevisao = $this->valorprevisao ;
		}
      ...
      ;
		...
		if ($this->sc_temp_varTipo == 'Parcelar') {
			$dataCompetencia = $this->datacompetencia  . ' 00:00:00';
		} else {
		...
		$insert_fields = array( 
			 ...
			 'IdLancamentoDespesa'				=> "'$this->idlancamentodespesa'",
...
if ($msg == '') {
 ...
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('LancamentoDespesa_Extender_Frm') . "/LancamentoDespesa_Extender_Frm.php", $this->nm_location, "varTipoRecorrencia?#?" . NM_encode_input($this->tiporecorrencia ) . "?@?" . "varQtdParcelas?#?" . NM_encode_input($this->qtdparcelas ) . "?@?" . "varAcao?#?" . NM_encode_input("2") . "?@?" . "varTipo?#?" . NM_encode_input($this->sc_temp_varTipo) . "?@?","_self", '', 440, 630);
 };
}
if (isset($this->sc_temp_varTipo)) { $_SESSION['varTipo'] = $this->sc_temp_varTipo;}
if (isset($this->sc_temp_varAcao)) { $_SESSION['varAcao'] = $this->sc_temp_varAcao;}
...
?>
      ...
      <input type=hidden name="datacompetencia" value="<?php echo $this->form_encode_input($this->datacompetencia) ?>"/>
      <input type=hidden name="idlancamentodespesa" value="<?php echo $this->form_encode_input($this->idlancamentodespesa) ?>"/>
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           ...
           case 'idcontacaixaregistro':
               ...
               break;
           case 'idlancamentodespesapai':
               return "Id Lancamento Despesa Pai";
               break;
           ...
           case 'idusuarioprevisao':
               ...
               break;
           case 'idusuarioagendamento':
               return "Id Usuario Agendamento";
               break;
           ...
           case 'idusuariobaixa':
               ...
               break;
           case 'idlancamentodespesarecorrente':
               return "Id Lancamento Despesa Recorrente";
               break;
           case 'idtipoagente':
           ...
           case 'nomearquivoboleto':
               return "Nome Arquivo Boleto";
               break;
           case 'nomereferenciaboleto':
               return "Nome Referencia Boleto";
               break;
           case 'nomearquivonotafiscal':
               return "Nome Arquivo Nota Fiscal";
               break;
           case 'nomereferencianotafiscal':
               return "Nome Referencia Nota Fiscal";
               break;
           case 'nomearquivocomprovante':
               return "Nome Arquivo Comprovante";
               break;
           case 'nomereferenciacomprovante':
               return "Nome Referencia Comprovante";
               break;
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['csrf_token']) && $this->scCsrfGetToken() != $this->csrf_token)
     {
          $this->Campos_Mens_erro .= (empty($this->Campos_Mens_erro)) ? "" : "<br />";
          $this->Campos_Mens_erro .= "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_LancamentoDespesa_Extender_Frm']) || !is_array($this->NM_ajax_info['errList']['geral_LancamentoDespesa_Extender_Frm']))
              {
                  $this->NM_ajax_info['errList']['geral_LancamentoDespesa_Extender_Frm'] = array();
              }
              $this->NM_ajax_info['errList']['geral_LancamentoDespesa_Extender_Frm'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "datacompetencia";

      if ((!is_array($filtro) && ('' == $filtro || 'idlancamentodespesa' == $filtro)) || (is_array($filtro) && in_array('idlancamentodespesa', $filtro)))
        $this->ValidateField_idlancamentodespesa($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "idlancamentodespesa";
...
//---
    ...
    function ValidateField_valorprevisao(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "Vr. Previsão: " . $this->Ini->Nm_lang['lang_errm_size']; 
    ...
    function ValidateField_datacompetencia(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      $trab_dt_min = ""; 
      $trab_dt_max = ""; 
      if ($this->nmgp_opcao == "incluir" || 'validate_datacompetencia' == $this->NM_ajax_opcao)
      { 
    ...
    function ValidateField_idlancamentodespesa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['idlancamentodespesa'])) {
          nm_limpa_numero($this->idlancamentodespesa, $this->field_config['idlancamentodespesa']['symbol_grp']) ; 
          return;
      }
      if ($this->idlancamentodespesa === "" || is_null($this->idlancamentodespesa))  
      { 
          $this->idlancamentodespesa = 0;
      } 
      nm_limpa_numero($this->idlancamentodespesa, $this->field_config['idlancamentodespesa']['symbol_grp']) ; 
      if ($this->nmgp_opcao == "incluir" || 'validate_idlancamentodespesa' == $this->NM_ajax_opcao)
      { 
          if ($this->idlancamentodespesa != '')  
          { 
              $iTestSize = 19;
              if (strlen($this->idlancamentodespesa) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Id.: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['idlancamentodespesa']))
                  {
                      $Campos_Erros['idlancamentodespesa'] = array();
                  }
                  $Campos_Erros['idlancamentodespesa'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['idlancamentodespesa']) || !is_array($this->NM_ajax_info['errList']['idlancamentodespesa']))
                  {
                      $this->NM_ajax_info['errList']['idlancamentodespesa'] = array();
                  }
                  $this->NM_ajax_info['errList']['idlancamentodespesa'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->idlancamentodespesa, 19, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Id.; " ; 
                  if (!isset($Campos_Erros['idlancamentodespesa']))
                  ...
                  $Campos_Erros['idlancamentodespesa'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['idlancamentodespesa']) || !is_array($this->NM_ajax_info['errList']['idlancamentodespesa']))
                  {
                      $this->NM_ajax_info['errList']['idlancamentodespesa'] = array();
                  }
                  $this->NM_ajax_info['errList']['idlancamentodespesa'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'idlancamentodespesa';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_idlancamentodespesa
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['idlancamentodespesa'] = $this->idlancamentodespesa;
    ...
    $this->nmgp_dados_form['idcheque'] = $this->idcheque;
    $this->nmgp_dados_form['idcontacaixaregistro'] = $this->idcontacaixaregistro;
    $this->nmgp_dados_form['idlancamentodespesapai'] = $this->idlancamentodespesapai;
    ...
    $this->nmgp_dados_form['idusuarioagendamento'] = $this->idusuarioagendamento;
    $this->nmgp_dados_form['idusuariorealizacao'] = $this->idusuariorealizacao;
    $this->nmgp_dados_form['idusuariobaixa'] = $this->idusuariobaixa;
    $this->nmgp_dados_form['idlancamentodespesarecorrente'] = $this->idlancamentodespesarecorrente;
    ...
    $this->nmgp_dados_form['dataagendamento'] = $this->dataagendamento;
    ...
    $this->nmgp_dados_form['nomearquivonotafiscal'] = $this->nomearquivonotafiscal;
    $this->nmgp_dados_form['nomereferencianotafiscal'] = $this->nomereferencianotafiscal;
    $this->nmgp_dados_form['nomearquivocomprovante'] = $this->nomearquivocomprovante;
    $this->nmgp_dados_form['nomereferenciacomprovante'] = $this->nomereferenciacomprovante;
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_form'] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      nm_limpa_data($this->datacompetencia, $this->field_config['datacompetencia']['date_sep']) ; 
      $this->Before_unformat['idlancamentodespesa'] = $this->idlancamentodespesa;
      nm_limpa_numero($this->idlancamentodespesa, $this->field_config['idlancamentodespesa']['symbol_grp']) ; 
      ...
      $this->Before_unformat['dataagendamento'] = $this->dataagendamento;
      $this->Before_unformat['dataagendamento_hora'] = $this->dataagendamento_hora;
      nm_limpa_data($this->dataagendamento, $this->field_config['dataagendamento']['date_sep']) ; 
      nm_limpa_hora($this->dataagendamento_hora, $this->field_config['dataagendamento']['time_sep']) ; 
   ...
   function nm_clear_val($Nome_Campo)
   {
      ...
      if ($Nome_Campo == "idlancamentodespesa")
      {
          nm_limpa_numero($this->idlancamentodespesa, $this->field_config['idlancamentodespesa']['symbol_grp']) ; 
      }
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      ...
      if ('' !== $this->idlancamentodespesa || (!empty($format_fields) && isset($format_fields['idlancamentodespesa'])))
      {
          nmgp_Form_Num_Val($this->idlancamentodespesa, $this->field_config['idlancamentodespesa']['symbol_grp'], $this->field_config['idlancamentodespesa']['symbol_dec'], "0", "S", $this->field_config['idlancamentodespesa']['format_neg'], "", "", "-", $this->field_config['idlancamentodespesa']['symbol_fmt']) ; 
      }
...
//
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_idlancamentodespesa();
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idlancamentodespesa']['keyVal'] = LancamentoDespesa_Extender_Frm_pack_protect_string($this->nmgp_dados_form['idlancamentodespesa']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['_LancamentoDespesaRecorrente_Frm_script_case_init'] ]['_LancamentoDespesaRecorrente_Frm']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['_LancamentoDespesaRecorrente_Frm_script_case_init'] ]['_LancamentoDespesaRecorrente_Frm']['total']);
          }
   } // ajax_return_values
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][LancamentoDespesa_Extender_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idfornecedor))]) ? $aLookup[0][LancamentoDespesa_Extender_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idfornecedor))] : "";
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][LancamentoDespesa_Extender_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idcliente))]) ? $aLookup[0][LancamentoDespesa_Extender_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idcliente))] : "";
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][LancamentoDespesa_Extender_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idcolaborador))]) ? $aLookup[0][LancamentoDespesa_Extender_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idcolaborador))] : "";
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][LancamentoDespesa_Extender_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idplanoconta))]) ? $aLookup[0][LancamentoDespesa_Extender_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idplanoconta))] : "";
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][LancamentoDespesa_Extender_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idcontacaixa))]) ? $aLookup[0][LancamentoDespesa_Extender_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idcontacaixa))] : "";
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][LancamentoDespesa_Extender_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idempresa))]) ? $aLookup[0][LancamentoDespesa_Extender_Frm_pack_protect_string(NM_charset_to_utf8($unformatted_value_idempresa))] : "";
   ...
   function ajax_return_values_datacompetencia($bForce = false)
   {
          ...
          $this->NM_ajax_info['fldList']['datacompetencia'] = array(
               ...
               'type'    => 'label',
               'valList' => array($sTmpValue),
               'labList' => array($this->form_format_readonly("datacompetencia", $this->form_encode_input($sTmpValue))),
              );
          }
   }

          //----- idlancamentodespesa
   function ajax_return_values_idlancamentodespesa($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("idlancamentodespesa", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->idlancamentodespesa);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['idlancamentodespesa'] = array(
                       'row'    => '',
               'type'    => 'label',
               'valList' => array($sTmpValue),
               'labList' => array($this->form_format_readonly("idlancamentodespesa", $this->form_encode_input($sTmpValue))),
              );
          }
   }
...
$aLookup[] = array(LancamentoDespesa_Extender_Frm_pack_protect_string('1') => str_replace('<', '&lt;',LancamentoDespesa_Extender_Frm_pack_protect_string("Quinzenal")));
$aLookup[] = array(LancamentoDespesa_Extender_Frm_pack_protect_string('2') => str_replace('<', '&lt;',LancamentoDespesa_Extender_Frm_pack_protect_string("Mensal")));
$aLookup[] = array(LancamentoDespesa_Extender_Frm_pack_protect_string('3') => str_replace('<', '&lt;',LancamentoDespesa_Extender_Frm_pack_protect_string("Bimestral")));
$aLookup[] = array(LancamentoDespesa_Extender_Frm_pack_protect_string('4') => str_replace('<', '&lt;',LancamentoDespesa_Extender_Frm_pack_protect_string("Trimestral")));
$aLookup[] = array(LancamentoDespesa_Extender_Frm_pack_protect_string('5') => str_replace('<', '&lt;',LancamentoDespesa_Extender_Frm_pack_protect_string("Semestral")));
$aLookup[] = array(LancamentoDespesa_Extender_Frm_pack_protect_string('6') => str_replace('<', '&lt;',LancamentoDespesa_Extender_Frm_pack_protect_string("Anual")));
$_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_tiporecorrencia'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_tiporecorrencia'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_tiporecorrencia'][] = '3';
$_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_tiporecorrencia'][] = '4';
$_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_tiporecorrencia'][] = '5';
$_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Lookup_tiporecorrencia'][] = '6';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['tiporecorrencia']['valList'][$i] = LancamentoDespesa_Extender_Frm_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_recorrentetemp($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['upload_dir'][$fieldName][] = $newName;
  ...
  function nm_proc_onload($bFormat = true)
  {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Field_no_validate'] = array();
...
if (!isset($this->sc_temp_varTipo)) {$this->sc_temp_varTipo = (isset($_SESSION['varTipo'])) ? $_SESSION['varTipo'] : "";}
  if ($this->sc_temp_varTipo == 'Parcelar') {
	$sc_tmp_field_name = 'tiporecorrencia';
$this->NM_ajax_info['fieldLabel'][$sc_tmp_field_name] = $this->nm_new_label[$sc_tmp_field_name] = "Parcelamento*";
	$this->sc_btn_label("GerarRecorrencia", "Gerar parcelamento");		
}
...
$_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['Field_disabled_macro']['idempresa'] = array('I'=>array(),'U'=>array());
;
...
if ($this->sc_temp_varAcao == 1 || $this->sc_temp_varAcao == 2) {
	...
	if (isset($this->sc_temp_varQtdParcelas)) {
		$this->qtdparcelas  = $this->sc_temp_varQtdParcelas;
	}
	...
	if ($this->sc_temp_varAcao == 2) {
		$sql = "SELECT COUNT(*) FROM _lancamentodespesarecorrente WHERE IdTenacidade = '$this->sc_temp_varIdTenacidade' AND IdLancamentoDespesa = '$this->sc_temp_varIdLancamentoDespesa'";
...
if ($msg != '') {
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_LancamentoDespesa_Extender_Frm';
...
$_SESSION['scriptcase']['LancamentoDespesa_Extender_Frm']['contr_erro'] = 'off'; 
      ...
      {
          $this->dataagendamento_hora = $this->dataagendamento;
      }
...
//----------- 
   ...
   { 
    ...
    if ("excluir" == $this->nmgp_opcao) {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      {
          $sc_cmd_dependency = "SELECT COUNT(*) AS countTest FROM lancamentodespesa WHERE IdLancamentoDespesa = '" . $this->idlancamentodespesa  . "'";
      }
      else
      {
          $sc_cmd_dependency = "SELECT COUNT(*) AS countTest FROM lancamentodespesa WHERE IdLancamentoDespesa = '" . $this->idlancamentodespesa  . "'";
...
$_SESSION['scriptcase']['LancamentoDespesa_Extender_Frm']['contr_erro'] = 'off'; 
      ...
      $NM_val_form['idlancamentodespesa'] = $this->idlancamentodespesa;
      ...
      $NM_val_form['idcheque'] = $this->idcheque;
      $NM_val_form['idcontacaixaregistro'] = $this->idcontacaixaregistro;
      $NM_val_form['idlancamentodespesapai'] = $this->idlancamentodespesapai;
      ...
      $NM_val_form['idusuarioagendamento'] = $this->idusuarioagendamento;
      $NM_val_form['idusuariorealizacao'] = $this->idusuariorealizacao;
      $NM_val_form['idusuariobaixa'] = $this->idusuariobaixa;
      $NM_val_form['idlancamentodespesarecorrente'] = $this->idlancamentodespesarecorrente;
      ...
      $NM_val_form['dataagendamento'] = $this->dataagendamento;
      ...
      $NM_val_form['nomearquivonotafiscal'] = $this->nomearquivonotafiscal;
      $NM_val_form['nomereferencianotafiscal'] = $this->nomereferencianotafiscal;
      $NM_val_form['nomearquivocomprovante'] = $this->nomearquivocomprovante;
      $NM_val_form['nomereferenciacomprovante'] = $this->nomereferenciacomprovante;
      ...
      if ($this->idcheque === "" || is_null($this->idcheque))  
      { 
          $this->idcheque = 0;
          $this->sc_force_zero[] = 'idcheque';
      } 
      ...
      if ($this->idlancamentodespesapai === "" || is_null($this->idlancamentodespesapai))  
      { 
          $this->idlancamentodespesapai = 0;
          $this->sc_force_zero[] = 'idlancamentodespesapai';
      } 
      ...
      if ($this->idusuarioagendamento === "" || is_null($this->idusuarioagendamento))  
      { 
          $this->idusuarioagendamento = 0;
          $this->sc_force_zero[] = 'idusuarioagendamento';
      } 
      ...
      if ($this->idlancamentodespesarecorrente === "" || is_null($this->idlancamentodespesarecorrente))  
      { 
          $this->idlancamentodespesarecorrente = 0;
          $this->sc_force_zero[] = 'idlancamentodespesarecorrente';
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "incluir") 
      {
          ...
          { 
              ...
              $this->NM_val_null[] = "dataagendamento";
          } 
          ...
          $this->nomearquivonotafiscal_before_qstr = $this->nomearquivonotafiscal;
          $this->nomearquivonotafiscal = substr($this->Db->qstr($this->nomearquivonotafiscal), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->nomearquivonotafiscal = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->nomearquivonotafiscal);
          }
          if ($this->nomearquivonotafiscal == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->nomearquivonotafiscal = "null"; 
              $this->NM_val_null[] = "nomearquivonotafiscal";
          } 
          $this->nomereferencianotafiscal_before_qstr = $this->nomereferencianotafiscal;
          $this->nomereferencianotafiscal = substr($this->Db->qstr($this->nomereferencianotafiscal), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->nomereferencianotafiscal = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->nomereferencianotafiscal);
          }
          if ($this->nomereferencianotafiscal == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->nomereferencianotafiscal = "null"; 
              $this->NM_val_null[] = "nomereferencianotafiscal";
          } 
          $this->nomearquivocomprovante_before_qstr = $this->nomearquivocomprovante;
          $this->nomearquivocomprovante = substr($this->Db->qstr($this->nomearquivocomprovante), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->nomearquivocomprovante = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->nomearquivocomprovante);
          }
          if ($this->nomearquivocomprovante == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->nomearquivocomprovante = "null"; 
              $this->NM_val_null[] = "nomearquivocomprovante";
          } 
          $this->nomereferenciacomprovante_before_qstr = $this->nomereferenciacomprovante;
          $this->nomereferenciacomprovante = substr($this->Db->qstr($this->nomereferenciacomprovante), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->nomereferenciacomprovante = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->nomereferenciacomprovante);
          }
          if ($this->nomereferenciacomprovante == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->nomereferenciacomprovante = "null"; 
              $this->NM_val_null[] = "nomereferenciacomprovante";
          } 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select count(*) AS countTest from " . $this->Ini->nm_tabela . " where IdLancamentoDespesa = $this->idlancamentodespesa ";
              $rs1 = $this->Db->Execute("select count(*) AS countTest from " . $this->Ini->nm_tabela . " where IdLancamentoDespesa = $this->idlancamentodespesa "); 
          }  
          else  
          {
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select count(*) AS countTest from " . $this->Ini->nm_tabela . " where IdLancamentoDespesa = $this->idlancamentodespesa ";
          ...
          { 
              ...
              $Prep_Tst = (isset($NM_val_form['idcheque']) && $NM_val_form['idcheque'] == "null"  && $this->nmgp_dados_select['idcheque'] == "") ? "null" : $this->nmgp_dados_select['idcheque'];
              if (isset($NM_val_form['idcheque']) && $NM_val_form['idcheque'] != $Prep_Tst) 
              { 
                  $SC_fields_update[] = "IdCheque = $this->idcheque"; 
              } 
              ...
              $Prep_Tst = (isset($NM_val_form['idlancamentodespesapai']) && $NM_val_form['idlancamentodespesapai'] == "null"  && $this->nmgp_dados_select['idlancamentodespesapai'] == "") ? "null" : $this->nmgp_dados_select['idlancamentodespesapai'];
              if (isset($NM_val_form['idlancamentodespesapai']) && $NM_val_form['idlancamentodespesapai'] != $Prep_Tst) 
              { 
                  $SC_fields_update[] = "IdLancamentoDespesaPai = $this->idlancamentodespesapai"; 
              } 
              ...
              $Prep_Tst = (isset($NM_val_form['idusuarioagendamento']) && $NM_val_form['idusuarioagendamento'] == "null"  && $this->nmgp_dados_select['idusuarioagendamento'] == "") ? "null" : $this->nmgp_dados_select['idusuarioagendamento'];
              if (isset($NM_val_form['idusuarioagendamento']) && $NM_val_form['idusuarioagendamento'] != $Prep_Tst) 
              { 
                  $SC_fields_update[] = "IdUsuarioAgendamento = $this->idusuarioagendamento"; 
              } 
              ...
              $Prep_Tst = (isset($NM_val_form['idlancamentodespesarecorrente']) && $NM_val_form['idlancamentodespesarecorrente'] == "null"  && $this->nmgp_dados_select['idlancamentodespesarecorrente'] == "") ? "null" : $this->nmgp_dados_select['idlancamentodespesarecorrente'];
              if (isset($NM_val_form['idlancamentodespesarecorrente']) && $NM_val_form['idlancamentodespesarecorrente'] != $Prep_Tst) 
              { 
                  $SC_fields_update[] = "IdLancamentoDespesaRecorrente = $this->idlancamentodespesarecorrente"; 
              } 
              ...
              $Prep_Tst = (isset($NM_val_form['dataagendamento']) && $NM_val_form['dataagendamento'] == "null"  && $this->nmgp_dados_select['dataagendamento'] == "") ? "null" : $this->nmgp_dados_select['dataagendamento'];
              if (isset($NM_val_form['dataagendamento']) && $NM_val_form['dataagendamento'] != $Prep_Tst) 
              { 
                  if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
                  { 
                      $SC_fields_update[] = "DataAgendamento = #$this->dataagendamento#"; 
                  } 
                  else
                  { 
                      $SC_fields_update[] = "DataAgendamento = " . $this->Ini->date_delim . $this->dataagendamento . $this->Ini->date_delim1 . ""; 
                  } 
              } 
              ...
              $Prep_Tst = (isset($NM_val_form['nomearquivoboleto']) && $NM_val_form['nomearquivoboleto'] == "null"  && $this->nmgp_dados_select['nomearquivoboleto'] == "") ? "null" : $this->nmgp_dados_select['nomearquivoboleto'];
              if (isset($NM_val_form['nomearquivoboleto']) && $NM_val_form['nomearquivoboleto'] != $Prep_Tst) 
              { 
                  $SC_fields_update[] = "NomeArquivoBoleto = '$this->nomearquivoboleto'"; 
              } 
              $Prep_Tst = (isset($NM_val_form['nomereferenciaboleto']) && $NM_val_form['nomereferenciaboleto'] == "null"  && $this->nmgp_dados_select['nomereferenciaboleto'] == "") ? "null" : $this->nmgp_dados_select['nomereferenciaboleto'];
              if (isset($NM_val_form['nomereferenciaboleto']) && $NM_val_form['nomereferenciaboleto'] != $Prep_Tst) 
              { 
                  $SC_fields_update[] = "NomeReferenciaBoleto = '$this->nomereferenciaboleto'"; 
              } 
              $Prep_Tst = (isset($NM_val_form['nomearquivonotafiscal']) && $NM_val_form['nomearquivonotafiscal'] == "null"  && $this->nmgp_dados_select['nomearquivonotafiscal'] == "") ? "null" : $this->nmgp_dados_select['nomearquivonotafiscal'];
              if (isset($NM_val_form['nomearquivonotafiscal']) && $NM_val_form['nomearquivonotafiscal'] != $Prep_Tst) 
              { 
                  $SC_fields_update[] = "NomeArquivoNotaFiscal = '$this->nomearquivonotafiscal'"; 
              } 
              $Prep_Tst = (isset($NM_val_form['nomereferencianotafiscal']) && $NM_val_form['nomereferencianotafiscal'] == "null"  && $this->nmgp_dados_select['nomereferencianotafiscal'] == "") ? "null" : $this->nmgp_dados_select['nomereferencianotafiscal'];
              if (isset($NM_val_form['nomereferencianotafiscal']) && $NM_val_form['nomereferencianotafiscal'] != $Prep_Tst) 
              { 
                  $SC_fields_update[] = "NomeReferenciaNotaFiscal = '$this->nomereferencianotafiscal'"; 
              } 
              $Prep_Tst = (isset($NM_val_form['nomearquivocomprovante']) && $NM_val_form['nomearquivocomprovante'] == "null"  && $this->nmgp_dados_select['nomearquivocomprovante'] == "") ? "null" : $this->nmgp_dados_select['nomearquivocomprovante'];
              if (isset($NM_val_form['nomearquivocomprovante']) && $NM_val_form['nomearquivocomprovante'] != $Prep_Tst) 
              { 
                  $SC_fields_update[] = "NomeArquivoComprovante = '$this->nomearquivocomprovante'"; 
              } 
              $Prep_Tst = (isset($NM_val_form['nomereferenciacomprovante']) && $NM_val_form['nomereferenciacomprovante'] == "null"  && $this->nmgp_dados_select['nomereferenciacomprovante'] == "") ? "null" : $this->nmgp_dados_select['nomereferenciacomprovante'];
              if (isset($NM_val_form['nomereferenciacomprovante']) && $NM_val_form['nomereferenciacomprovante'] != $Prep_Tst) 
              { 
                  $SC_fields_update[] = "NomeReferenciaComprovante = '$this->nomereferenciacomprovante'"; 
              } 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
                  $comando .= " WHERE IdLancamentoDespesa = $this->idlancamentodespesa ";  
              }  
              else  
              {
                  $comando .= " WHERE IdLancamentoDespesa = $this->idlancamentodespesa ";  
              ...
              $this->nomearquivonotafiscal = $this->nomearquivonotafiscal_before_qstr;
              $this->nomereferencianotafiscal = $this->nomereferencianotafiscal_before_qstr;
              $this->nomearquivocomprovante = $this->nomearquivocomprovante_before_qstr;
              $this->nomereferenciacomprovante = $this->nomereferenciacomprovante_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }


              if     (isset($NM_val_form) && isset($NM_val_form['idlancamentodespesa'])) { $this->idlancamentodespesa = $NM_val_form['idlancamentodespesa']; }
              elseif (isset($this->idlancamentodespesa)) { $this->nm_limpa_alfa($this->idlancamentodespesa); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('idfornecedor', 'idcliente', 'idcolaborador', 'idplanoconta', 'idcontacaixa', 'idempresa', 'dataprevisao', 'valorprevisao', 'datacompetencia', 'idlancamentodespesa', 'tiporecorrencia', 'qtdparcelas', 'recorrentetemp'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          { 
              $NM_seq_auto = "NULL, ";
              $NM_cmp_auto = "IdLancamentoDespesa, ";
          } 
          $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(IdLancamentoDespesa) from " . $this->Ini->nm_tabela; 
          $comando = "select max(IdLancamentoDespesa) from " . $this->Ini->nm_tabela; 
          $rs = $this->Db->Execute($comando); 
          if ($rs === false && !$rs->EOF)  
          { 
          ...
          $this->idlancamentodespesa_before_qstr = $this->idlancamentodespesa = $rs->fields[0] + 1;
          $rs->Close(); 
          $bInsertOk = true;
          $aInsertOk = array(); 
          $bInsertOk = $bInsertOk && empty($aInsertOk);
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              { 
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (IdTenacidade, IdFornecedor, IdContaCaixa, IdPlanoConta, IdSituacaoDocumento, IdTipoEspecie, IdEmpresa, IdCheque, IdContaCaixaRegistro, IdLancamentoDespesaPai, IdContaCaixaTransferencia, IdUsuarioInclusao, IdUsuarioPrevisao, IdUsuarioAgendamento, IdUsuarioRealizacao, IdUsuarioBaixa, IdLancamentoDespesaRecorrente, IdTipoAgente, IdCliente, IdColaborador, IdUsuarioAuditoria, Parcela, DataInclusao, DataPrevisao, ValorPrevisao, DataAgendamento, DataRealizacao, NumeroDocumento, ContaContabil, DataBaixa, DataCompetencia, Historico, Observacoes, NomeArquivoBoleto, NomeReferenciaBoleto, NomeArquivoNotaFiscal, NomeReferenciaNotaFiscal, NomeArquivoComprovante, NomeReferenciaComprovante, FechamentoFinanceiro, EnderecoIpAuditoria, NomeAplicacaoAuditoria $compl_insert) VALUES ($this->idtenacidade, $this->idfornecedor, $this->idcontacaixa, $this->idplanoconta, $this->idsituacaodocumento, $this->idtipoespecie, $this->idempresa, $this->idcheque, $this->idcontacaixaregistro, $this->idlancamentodespesapai, $this->idcontacaixatransferencia, $this->idusuarioinclusao, $this->idusuarioprevisao, $this->idusuarioagendamento, $this->idusuariorealizacao, $this->idusuariobaixa, $this->idlancamentodespesarecorrente, $this->idtipoagente, $this->idcliente, $this->idcolaborador, $this->idusuarioauditoria, $this->parcela, #$this->datainclusao#, #$this->dataprevisao#, $this->valorprevisao, #$this->dataagendamento#, #$this->datarealizacao#, '$this->numerodocumento', '$this->contacontabil', #$this->databaixa#, #$this->datacompetencia#, '$this->historico', '$this->observacoes', '$this->nomearquivoboleto', '$this->nomereferenciaboleto', '$this->nomearquivonotafiscal', '$this->nomereferencianotafiscal', '$this->nomearquivocomprovante', '$this->nomereferenciacomprovante', '$this->fechamentofinanceiro', '$this->enderecoipauditoria', '$this->nomeaplicacaoauditoria' $compl_insert_val)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $compl_insert     = ""; 
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "IdTenacidade, IdFornecedor, IdContaCaixa, IdPlanoConta, IdSituacaoDocumento, IdTipoEspecie, IdEmpresa, IdCheque, IdContaCaixaRegistro, IdLancamentoDespesaPai, IdContaCaixaTransferencia, IdUsuarioInclusao, IdUsuarioPrevisao, IdUsuarioAgendamento, IdUsuarioRealizacao, IdUsuarioBaixa, IdLancamentoDespesaRecorrente, IdTipoAgente, IdCliente, IdColaborador, IdUsuarioAuditoria, Parcela, DataInclusao, DataPrevisao, ValorPrevisao, DataAgendamento, DataRealizacao, NumeroDocumento, ContaContabil, DataBaixa, DataCompetencia, Historico, Observacoes, NomeArquivoBoleto, NomeReferenciaBoleto, NomeArquivoNotaFiscal, NomeReferenciaNotaFiscal, NomeArquivoComprovante, NomeReferenciaComprovante, FechamentoFinanceiro, EnderecoIpAuditoria, NomeAplicacaoAuditoria $compl_insert) VALUES (" . $NM_seq_auto . "$this->idtenacidade, $this->idfornecedor, $this->idcontacaixa, $this->idplanoconta, $this->idsituacaodocumento, $this->idtipoespecie, $this->idempresa, $this->idcheque, $this->idcontacaixaregistro, $this->idlancamentodespesapai, $this->idcontacaixatransferencia, $this->idusuarioinclusao, $this->idusuarioprevisao, $this->idusuarioagendamento, $this->idusuariorealizacao, $this->idusuariobaixa, $this->idlancamentodespesarecorrente, $this->idtipoagente, $this->idcliente, $this->idcolaborador, $this->idusuarioauditoria, $this->parcela, " . $this->Ini->date_delim . $this->datainclusao . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->dataprevisao . $this->Ini->date_delim1 . ", $this->valorprevisao, " . $this->Ini->date_delim . $this->dataagendamento . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->datarealizacao . $this->Ini->date_delim1 . ", '$this->numerodocumento', '$this->contacontabil', " . $this->Ini->date_delim . $this->databaixa . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->datacompetencia . $this->Ini->date_delim1 . ", '$this->historico', '$this->observacoes', '$this->nomearquivoboleto', '$this->nomereferenciaboleto', '$this->nomearquivonotafiscal', '$this->nomereferencianotafiscal', '$this->nomearquivocomprovante', '$this->nomereferenciacomprovante', '$this->fechamentofinanceiro', '$this->enderecoipauditoria', '$this->nomeaplicacaoauditoria' $compl_insert_val)"; 
              }
              ...
              { 
                  ...
                  $this->idlancamentodespesa =  $rsy->fields[0];
                 $rsy->Close(); 
              } 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      if ($this->nmgp_opcao == "excluir") 
      { 
          $this->idlancamentodespesa = substr($this->Db->qstr($this->idlancamentodespesa), 1, -1); 
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "DELETE FROM " . $this->Ini->nm_tabela . " where IdLancamentoDespesa = $this->idlancamentodespesa "; 
                  $rs = $this->Db->Execute("DELETE FROM " . $this->Ini->nm_tabela . " where IdLancamentoDespesa = $this->idlancamentodespesa "); 
              }  
              else  
              {
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "DELETE FROM " . $this->Ini->nm_tabela . " where IdLancamentoDespesa = $this->idlancamentodespesa "; 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['parms'] = "idlancamentodespesa?#?$this->idlancamentodespesa?@?"; 
      }
      $this->NM_commit_db(); 
      if ($this->sc_evento != "insert" && $this->sc_evento != "update" && $this->sc_evento != "delete")
      { 
          $this->idlancamentodespesa = null === $this->idlancamentodespesa ? null : substr($this->Db->qstr($this->idlancamentodespesa), 1, -1); 
      } 
      if (isset($this->NM_where_filter))
      {
          $this->NM_where_filter = str_replace("@percent@", "%", $this->NM_where_filter);
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          $nmgp_select = "SELECT IdLancamentoDespesa, IdTenacidade, IdFornecedor, IdContaCaixa, IdPlanoConta, IdSituacaoDocumento, IdTipoEspecie, IdEmpresa, IdCheque, IdContaCaixaRegistro, IdLancamentoDespesaPai, IdContaCaixaTransferencia, IdUsuarioInclusao, IdUsuarioPrevisao, IdUsuarioAgendamento, IdUsuarioRealizacao, IdUsuarioBaixa, IdLancamentoDespesaRecorrente, IdTipoAgente, IdCliente, IdColaborador, IdUsuarioAuditoria, Parcela, DataInclusao, DataPrevisao, ValorPrevisao, DataAgendamento, DataRealizacao, ValorAcrescimo, ValorDesconto, ValorMulta, ValorJuros, ValorRealizacao, NumeroDocumento, ContaContabil, DataBaixa, DataCompetencia, Historico, Observacoes, NomeArquivoBoleto, NomeReferenciaBoleto, NomeArquivoNotaFiscal, NomeReferenciaNotaFiscal, NomeArquivoComprovante, NomeReferenciaComprovante, FechamentoFinanceiro, EnderecoIpAuditoria, NomeAplicacaoAuditoria from " . $this->Ini->nm_tabela ; 
          $aWhere = array();
          $aWhere[] = "(IdLancamentoDespesa = '" . $_SESSION['varIdLancamentoDespesa'] . "')";
          $aWhere[] = $sc_where_filter;
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (!empty($sc_where))
              {
                  if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
                  {
                     $aWhere[] = "IdLancamentoDespesa = $this->idlancamentodespesa"; 
                  }  
                  else  
                  {
                     $aWhere[] = "IdLancamentoDespesa = $this->idlancamentodespesa"; 
          ...
          $sc_order_by = "";
          $sc_order_by = "IdLancamentoDespesa";
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['empty_filter'] = true;
                  return; 
              }
          ...
          if ($this->nmgp_opcao != "novo") 
          { 
              $this->idlancamentodespesa = $rs->fields[0] ; 
              $this->nmgp_dados_select['idlancamentodespesa'] = $this->idlancamentodespesa;
              ...
              $this->idcheque = $rs->fields[8] ; 
              $this->nmgp_dados_select['idcheque'] = $this->idcheque;
              $this->idcontacaixaregistro = $rs->fields[9] ; 
              $this->nmgp_dados_select['idcontacaixaregistro'] = $this->idcontacaixaregistro;
              $this->idlancamentodespesapai = $rs->fields[10] ; 
              $this->nmgp_dados_select['idlancamentodespesapai'] = $this->idlancamentodespesapai;
              ...
              $this->idusuarioinclusao = $rs->fields[12] ; 
              $this->nmgp_dados_select['idusuarioinclusao'] = $this->idusuarioinclusao;
              $this->idusuarioprevisao = $rs->fields[13] ; 
              $this->nmgp_dados_select['idusuarioprevisao'] = $this->idusuarioprevisao;
              $this->idusuarioagendamento = $rs->fields[14] ; 
              $this->nmgp_dados_select['idusuarioagendamento'] = $this->idusuarioagendamento;
              ...
              $this->idlancamentodespesarecorrente = $rs->fields[17] ; 
              $this->nmgp_dados_select['idlancamentodespesarecorrente'] = $this->idlancamentodespesarecorrente;
              $this->idtipoagente = $rs->fields[18] ; 
              $this->nmgp_dados_select['idtipoagente'] = $this->idtipoagente;
              $this->idcliente = $rs->fields[19] ; 
              ...
              $this->dataagendamento = $rs->fields[26] ; 
              if (substr($this->dataagendamento, 10, 1) == "-") 
              { 
                 $this->dataagendamento = substr($this->dataagendamento, 0, 10) . " " . substr($this->dataagendamento, 11);
              } 
              if (substr($this->dataagendamento, 13, 1) == ".") 
              { 
                 $this->dataagendamento = substr($this->dataagendamento, 0, 13) . ":" . substr($this->dataagendamento, 14, 2) . ":" . substr($this->dataagendamento, 17);
              } 
              $this->nmgp_dados_select['dataagendamento'] = $this->dataagendamento;
              $this->datarealizacao = $rs->fields[27] ; 
              ...
              $this->datacompetencia = $rs->fields[36] ; 
              $this->nmgp_dados_select['datacompetencia'] = $this->datacompetencia;
              $this->historico = $rs->fields[37] ; 
              $this->nmgp_dados_select['historico'] = $this->historico;
              $this->observacoes = $rs->fields[38] ; 
              $this->nmgp_dados_select['observacoes'] = $this->observacoes;
              $this->nomearquivoboleto = $rs->fields[39] ; 
              $this->nmgp_dados_select['nomearquivoboleto'] = $this->nomearquivoboleto;
              $this->nomereferenciaboleto = $rs->fields[40] ; 
              $this->nmgp_dados_select['nomereferenciaboleto'] = $this->nomereferenciaboleto;
              $this->nomearquivonotafiscal = $rs->fields[41] ; 
              $this->nmgp_dados_select['nomearquivonotafiscal'] = $this->nomearquivonotafiscal;
              $this->nomereferencianotafiscal = $rs->fields[42] ; 
              $this->nmgp_dados_select['nomereferencianotafiscal'] = $this->nomereferencianotafiscal;
              $this->nomearquivocomprovante = $rs->fields[43] ; 
              $this->nmgp_dados_select['nomearquivocomprovante'] = $this->nomearquivocomprovante;
              $this->nomereferenciacomprovante = $rs->fields[44] ; 
              $this->nmgp_dados_select['nomereferenciacomprovante'] = $this->nomereferenciacomprovante;
              $this->fechamentofinanceiro = $rs->fields[45] ; 
              $this->nmgp_dados_select['fechamentofinanceiro'] = $this->fechamentofinanceiro;
              $this->enderecoipauditoria = $rs->fields[46] ; 
              $this->nmgp_dados_select['enderecoipauditoria'] = $this->enderecoipauditoria;
              $this->nomeaplicacaoauditoria = $rs->fields[47] ; 
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $this->idcheque = (string)$this->idcheque; 
              ...
              $this->idusuarioagendamento = (string)$this->idusuarioagendamento; 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['reg_start'] < $qt_geral_reg_LancamentoDespesa_Extender_Frm;
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              $this->nmgp_dados_form["idusuarioprevisao"] = $this->idusuarioprevisao;
              $this->idusuarioagendamento = "";  
              $this->nmgp_dados_form["idusuarioagendamento"] = $this->idusuarioagendamento;
              $this->idusuariorealizacao = "";  
              $this->nmgp_dados_form["idusuariorealizacao"] = $this->idusuariorealizacao;
              $this->idusuariobaixa = "";  
              $this->nmgp_dados_form["idusuariobaixa"] = $this->idusuariobaixa;
              $this->idlancamentodespesarecorrente = "";  
              $this->nmgp_dados_form["idlancamentodespesarecorrente"] = $this->idlancamentodespesarecorrente;
              $this->idtipoagente = "";  
              $this->nmgp_dados_form["idtipoagente"] = $this->idtipoagente;
              $this->idcliente = "";  
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['_LancamentoDespesaRecorrente_Frm']['embutida_parms'] = "varidlancamentodespesa*scin" . $this->nmgp_dados_form['idlancamentodespesa'] . "*scoutSC_glo_par_vartipo*scinvarTipo*scoutNM_btn_insert*scinN*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinS*scoutlink_remove_margin*scinok*scoutlink_remove_border*scinok*scoutlink_remove_background*scinok*scout";
  }
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
$this->sc_temp_varQtdRecorrencia = $qtdrecorrencia ;
...
$valorTotalAtual = 0;
$valorParcela = $this->valorprevisao  / $this->qtdparcelas ;

for ($i = 1; $i <= $this->qtdparcelas ; $i++) {
	$valorParcela = round($valorParcela * 100 / 100, 2);
	
	if ($i < $this->qtdparcelas ) {
		$valorParcela = round($this->valorprevisao  / $this->qtdparcelas  * 100) / 100;
		$valorTotalAtual = $valorTotalAtual + $valorParcela;
	} else {
		$valorParcela = $this->valorprevisao  - $valorTotalAtual;
	}
	$this->sc_temp_varVetParcelas[$i] = $valorParcela;
}
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("LancamentoDespesa_Extender_Frm_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dyn_search_cache']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['empty_filter']);
      ...
      foreach ($fields as $field) {
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "IdLancamentoDespesa", $arg_search, str_replace(",", ".", $data_search), "BIGINT", false);
          }
          if ($field == "SC_all_Cmp") 
          {
          ...
          if ($field == "SC_all_Cmp") 
          {
              $data_lookup = $this->SC_lookup_idcheque($arg_search, $data_search);
              if (is_array($data_lookup) && !empty($data_lookup)) 
              {
                  $this->SC_monta_condicao($comando, "IdCheque", $arg_search, $data_lookup, "BIGINT", false);
              }
          }
          if ($field == "SC_all_Cmp") 
          {
          ...
          if ($field == "SC_all_Cmp") 
          {
              $data_lookup = $this->SC_lookup_idlancamentodespesapai($arg_search, $data_search);
              if (is_array($data_lookup) && !empty($data_lookup)) 
              {
                  $this->SC_monta_condicao($comando, "IdLancamentoDespesaPai", $arg_search, $data_lookup, "BIGINT", false);
              }
          }
          if ($field == "SC_all_Cmp") 
          {
          ...
          if ($field == "SC_all_Cmp") 
          {
              $data_lookup = $this->SC_lookup_idusuarioagendamento($arg_search, $data_search);
              if (is_array($data_lookup) && !empty($data_lookup)) 
              {
                  $this->SC_monta_condicao($comando, "IdUsuarioAgendamento", $arg_search, $data_lookup, "BIGINT", false);
              }
          }
          if ($field == "SC_all_Cmp") 
          {
          ...
          if ($field == "SC_all_Cmp") 
          {
              $data_lookup = $this->SC_lookup_idlancamentodespesarecorrente($arg_search, $data_search);
              if (is_array($data_lookup) && !empty($data_lookup)) 
              {
                  $this->SC_monta_condicao($comando, "IdLancamentoDespesaRecorrente", $arg_search, $data_lookup, "BIGINT", false);
              }
          }
          if ($field == "SC_all_Cmp") 
          {
          ...
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "NomeArquivoBoleto", $arg_search, $data_search, "VARCHAR", false);
          }
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "NomeReferenciaBoleto", $arg_search, $data_search, "VARCHAR", false);
          }
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "NomeArquivoNotaFiscal", $arg_search, $data_search, "VARCHAR", false);
          }
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "NomeReferenciaNotaFiscal", $arg_search, $data_search, "VARCHAR", false);
          }
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "NomeArquivoComprovante", $arg_search, $data_search, "VARCHAR", false);
          }
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "NomeReferenciaComprovante", $arg_search, $data_search, "VARCHAR", false);
          }
          if ($field == "SC_all_Cmp") 
          {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_filter_form'] . " and ((IdLancamentoDespesa = '" . $_SESSION['varIdLancamentoDespesa'] . "')) and (" . $comando . ")";
      }
      else
      {
          $sc_where = " where (IdLancamentoDespesa = '" . $_SESSION['varIdLancamentoDespesa'] . "') and (" . $comando . ")";
      }
      ...
      $qt_geral_reg_LancamentoDespesa_Extender_Frm = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['total'] = $qt_geral_reg_LancamentoDespesa_Extender_Frm;
      $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          LancamentoDespesa_Extender_Frm_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      $nm_numeric[] = "idlancamentodespesa";$nm_numeric[] = "idtenacidade";$nm_numeric[] = "idfornecedor";$nm_numeric[] = "idcontacaixa";$nm_numeric[] = "idplanoconta";$nm_numeric[] = "idsituacaodocumento";$nm_numeric[] = "idtipoespecie";$nm_numeric[] = "idempresa";$nm_numeric[] = "idcheque";$nm_numeric[] = "idcontacaixaregistro";$nm_numeric[] = "idlancamentodespesapai";$nm_numeric[] = "idcontacaixatransferencia";$nm_numeric[] = "idusuarioinclusao";$nm_numeric[] = "idusuarioprevisao";$nm_numeric[] = "idusuarioagendamento";$nm_numeric[] = "idusuariorealizacao";$nm_numeric[] = "idusuariobaixa";$nm_numeric[] = "idlancamentodespesarecorrente";$nm_numeric[] = "idtipoagente";$nm_numeric[] = "idcliente";$nm_numeric[] = "idcolaborador";$nm_numeric[] = "idusuarioauditoria";$nm_numeric[] = "parcela";$nm_numeric[] = "valorprevisao";$nm_numeric[] = "valoracrescimo";$nm_numeric[] = "valordesconto";$nm_numeric[] = "valormulta";$nm_numeric[] = "valorjuros";$nm_numeric[] = "valorrealizacao";$nm_numeric[] = "";
      ...
      $Nm_datas["datainclusao"] = "datetime";$Nm_datas["dataprevisao"] = "datetime";$Nm_datas["dataagendamento"] = "datetime";$Nm_datas["datarealizacao"] = "datetime";$Nm_datas["databaixa"] = "datetime";$Nm_datas["datacompetencia"] = "date";
         ...
         if (isset($Nm_datas[$campo_join]))
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['SC_sep_date1'];
              }
          }
   ...
   function SC_lookup_idcheque($condicao, $campo)
   {
       $result = array();
       $campo_orig = $campo;
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       if (isset($this->Ini->nm_bases_postgres) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres) && ($condicao == "eq" || $condicao == "qp" || $condicao == "np" || $condicao == "ii" || $condicao == "df"))
       {
           $nm_comando = "SELECT IdCheque, IdCheque FROM cheque WHERE (CAST (IdCheque AS TEXT) LIKE '%$campo%')" ; 
       }
       else
       {
           $nm_comando = "SELECT IdCheque, IdCheque FROM cheque WHERE (#cmp_iIdCheque#cmp_f#cmp_apos LIKE '%#arg_i" . $campo . "#arg_f%'#arg_apos)" ; 
       }
       if ($condicao == "ii")
       {
           $nm_comando = str_replace("LIKE '%#arg_i" . $campo . "#arg_f%'", "LIKE '#arg_i" . $campo . "#arg_f%'", $nm_comando);
   ...
   function SC_lookup_idlancamentodespesapai($condicao, $campo)
   {
       $result = array();
       $campo_orig = $campo;
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       if (isset($this->Ini->nm_bases_postgres) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres) && ($condicao == "eq" || $condicao == "qp" || $condicao == "np" || $condicao == "ii" || $condicao == "df"))
       {
           $nm_comando = "SELECT IdLancamentoDespesa, IdLancamentoDespesa FROM lancamentodespesa WHERE (CAST (IdLancamentoDespesa AS TEXT) LIKE '%$campo%')" ; 
       }
       else
       {
           $nm_comando = "SELECT IdLancamentoDespesa, IdLancamentoDespesa FROM lancamentodespesa WHERE (#cmp_iIdLancamentoDespesa#cmp_f#cmp_apos LIKE '%#arg_i" . $campo . "#arg_f%'#arg_apos)" ; 
       }
       if ($condicao == "ii")
       {
           $nm_comando = str_replace("LIKE '%#arg_i" . $campo . "#arg_f%'", "LIKE '#arg_i" . $campo . "#arg_f%'", $nm_comando);
   ...
   function SC_lookup_idusuarioagendamento($condicao, $campo)
   {
       $result = array();
       $campo_orig = $campo;
       $campo  = substr($this->Db->qstr($campo), 1, -1);
   ...
   function SC_lookup_idlancamentodespesarecorrente($condicao, $campo)
   {
       $result = array();
       $campo_orig = $campo;
       $campo  = substr($this->Db->qstr($campo), 1, -1);
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "LancamentoDespesa_Extender_Frm_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['nm_run_menu'] = 2;
       $nmgp_saida_form = "LancamentoDespesa_Extender_Frm_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['_LancamentoDespesaRecorrente_Frm']['reg_start'] = "";
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['_LancamentoDespesaRecorrente_Frm']['total']);
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function sc_btn_label($buttonName, $buttonLabel)
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['btn_label'][$buttonName] = $buttonLabel;
    } // sc_btn_label
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['link_info']['compact_mode']) {
            return;
        }
?>
...
<div style="width: 100%">
 ...
 <div style="height:25px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: solid; border-color:#72c045; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "Geração de recorrências de contas a pagar (receitas)"; } else { echo "Geração de recorrências de contas a pagar (receitas)"; } ?></span></td>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['LancamentoDespesa_Extender_Frm']['ordem_ord'] == " desc") {
