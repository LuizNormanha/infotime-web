<?php
include_once('FornecedorGestao_Mnu_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_prod']      = "";
    $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_perfil']         = "ligasistemas";
    $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_usa_grupo']      = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class FornecedorGestao_Mnu_class
{
  var $Db;
  var $sc_charset;
  var $force_mobile;
 ...
 function FornecedorGestao_Mnu_menu()
 {
    global $FornecedorGestao_Mnu_menuData, $nm_data_fixa;
 ...
 if (isset($_REQUEST["ajax_notif_request"]))    { 
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['FornecedorGestao_Mnu']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "FornecedorGestao_Mnu/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_imag_temp'];
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/FornecedorGestao_Mnu_erro.php");
}
include_once(dirname(__FILE__) . "/FornecedorGestao_Mnu_erro.class.php"); 
$this->Erro = new FornecedorGestao_Mnu_erro();
$str_path = substr($_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_conexao']);
}

/* Definição dos Caminhos */
$FornecedorGestao_Mnu_menuData         = array();
$FornecedorGestao_Mnu_menuData['path'] = array();
$FornecedorGestao_Mnu_menuData['url']  = array();
$FornecedorGestao_Mnu_menuData['data'] = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $FornecedorGestao_Mnu_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $FornecedorGestao_Mnu_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $FornecedorGestao_Mnu_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $FornecedorGestao_Mnu_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$FornecedorGestao_Mnu_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$FornecedorGestao_Mnu_menuData['url']['web']   = str_replace("\\", '/', $FornecedorGestao_Mnu_menuData['url']['web']);
$FornecedorGestao_Mnu_menuData['path']['root'] = substr($FornecedorGestao_Mnu_menuData['path']['sys'],  0, -1 * strlen($FornecedorGestao_Mnu_menuData['url']['web']));
$FornecedorGestao_Mnu_menuData['path']['app']  = substr($FornecedorGestao_Mnu_menuData['path']['sys'],  0, strrpos($FornecedorGestao_Mnu_menuData['path']['sys'],  '/'));
$FornecedorGestao_Mnu_menuData['path']['link'] = substr($FornecedorGestao_Mnu_menuData['path']['app'],  0, strrpos($FornecedorGestao_Mnu_menuData['path']['app'],  '/'));
$FornecedorGestao_Mnu_menuData['path']['link'] = substr($FornecedorGestao_Mnu_menuData['path']['link'], 0, strrpos($FornecedorGestao_Mnu_menuData['path']['link'], '/')) . '/';
$FornecedorGestao_Mnu_menuData['path']['app'] .= '/';
$FornecedorGestao_Mnu_menuData['url']['app']   = substr($FornecedorGestao_Mnu_menuData['url']['web'],  0, strrpos($FornecedorGestao_Mnu_menuData['url']['web'],  '/'));
$FornecedorGestao_Mnu_menuData['url']['link']  = substr($FornecedorGestao_Mnu_menuData['url']['app'],  0, strrpos($FornecedorGestao_Mnu_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_usa_grupo'] == "S")
{
    $FornecedorGestao_Mnu_menuData['url']['link']  = substr($FornecedorGestao_Mnu_menuData['url']['link'], 0, strrpos($FornecedorGestao_Mnu_menuData['url']['link'], '/'));
}
$FornecedorGestao_Mnu_menuData['url']['link']  .= '/';
$FornecedorGestao_Mnu_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['FornecedorGestao_Mnu']['sc_apl_link'] = $FornecedorGestao_Mnu_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['FornecedorGestao_Mnu']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['FornecedorGestao_Mnu']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['FornecedorGestao_Mnu']['actual_lang']) || $_SESSION['scriptcase']['FornecedorGestao_Mnu']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['FornecedorGestao_Mnu']['actual_lang'] = $this->str_lang;
...
include_once("FornecedorGestao_Mnu_toolbar.php");
...
if ($_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "FornecedorGestao_Mnu";
     $_SESSION['scriptcase']['menu_apls']['FornecedorGestao_Mnu'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_conexao']) && $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_perfil']) && $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['FornecedorGestao_Mnu']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['FornecedorGestao_Mnu']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['FornecedorGestao_Mnu']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['FornecedorGestao_Mnu']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['FornecedorGestao_Mnu']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['FornecedorGestao_Mnu']['init']))
{
    $_SESSION['sc_session'][1]['FornecedorGestao_Mnu']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['FornecedorGestao_Mnu']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['FornecedorGestao_Mnu']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_FornecedorGestao_Mnu'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_FornecedorGestao_Mnu'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_FornecedorGestao_Mnu'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
{
    if(function_exists("nm_check_perfil_exists")) nm_check_perfil_exists($path_libs, $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_prod']);
    $_SESSION['sc_session'][1]['SC_Check_Perfil'] = true;
}
$nm_falta_var    = ""; 
$nm_falta_var_db = ""; 
if (isset($_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_conexao']))
{
    db_conect_devel($_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_prod'], 'LIGA_InfoTIME', 2); 
}
if (isset($_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_perfil']))
{
   $_SESSION['scriptcase']['glo_perfil'] = $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_perfil'];
}
...
if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
{
    ...
    if (strlen($SC_temp) == 2)
    {
       $_SESSION['scriptcase']['FornecedorGestao_Mnu']['SC_sep_date']  = substr($SC_temp, 0, 1); 
       $_SESSION['scriptcase']['FornecedorGestao_Mnu']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
   }
   else
    {
       $_SESSION['scriptcase']['FornecedorGestao_Mnu']['SC_sep_date']  = $SC_temp; 
       $_SESSION['scriptcase']['FornecedorGestao_Mnu']['SC_sep_date1'] = $SC_temp; 
   }
}
...
if (!empty($nm_falta_var) || !empty($nm_falta_var_db))
{
    ...
    { 
        if (isset($_SESSION['sc_session'][1]['FornecedorGestao_Mnu']['sc_outra_jan']) && $_SESSION['sc_session'][1]['FornecedorGestao_Mnu']['sc_outra_jan'])
        {
...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
 $glo_senha_protect = (isset($_SESSION['scriptcase']['glo_senha_protect'])) ? $_SESSION['scriptcase']['glo_senha_protect'] : "S";
if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_conexao']))
{ 
   $this->Db = db_conect_devel($_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_prod'], 'LIGA_InfoTIME'); 
} 
else 
{ 
...
//
      $_SESSION['scriptcase']['FornecedorGestao_Mnu']['contr_erro'] = 'on';
  ?>
<style>
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'FornecedorGestao_Mnu'))
{
    $_SESSION['sc_session'][1]['FornecedorGestao_Mnu']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_FornecedorGestao_Mnu'] = "javascript:window.close()";
}
...
if(is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/Fornecedor_Frm_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/Fornecedor_Frm_ini.php");
    ...
    {
      if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Fornecedor_Frm']))
      {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/FornecedorComunicacao_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/FornecedorComunicacao_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['FornecedorComunicacao_Lst']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/FornecedorContato_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/FornecedorContato_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['FornecedorContato_Lst']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/FornecedorDocumento_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/FornecedorDocumento_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['FornecedorDocumento_Lst']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/FornecedorPlanoConta_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/FornecedorPlanoConta_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['FornecedorPlanoConta_Lst']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/Fornecedor_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/Fornecedor_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Fornecedor_Lst']))
        {
...
if (!isset($_SESSION['varIdFornecedorSel'])) {$_SESSION['varIdFornecedorSel'] = "";}
if (!isset($this->sc_temp_varIdFornecedorSel)) {$this->sc_temp_varIdFornecedorSel = (isset($_SESSION['varIdFornecedorSel'])) ? $_SESSION['varIdFornecedorSel'] : "";}
  $check_sql = "SELECT NomeFantasia, Cnpj, Cidade, Estado, Telefone"
   . " FROM fornecedor"
...
if (isset($this->rs[0][0])) {
    ...
    $NomeFantasia = 'Fornecedor não cadastrado';
}
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_FornecedorGestao_Mnu'];

$FornecedorGestao_Mnu_menuData['data'] = array();
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["Fornecedor_Frm"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["Fornecedor_Frm"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$FornecedorGestao_Mnu_menuData['data']['itens']['item_4'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "FornecedorGestao_Mnu_form_php.php?sc_item_menu=item_4&sc_apl_menu=Fornecedor_Frm&sc_apl_link=" . urlencode($FornecedorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  ...
                                                  'icon_check'     => "S",
                                                  'id'     => "item_4",
                                                  'target'      => $this->FornecedorGestao_Mnu_target('_self'),
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["FornecedorComunicacao_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["FornecedorComunicacao_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$FornecedorGestao_Mnu_menuData['data']['itens']['item_3'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "FornecedorGestao_Mnu_form_php.php?sc_item_menu=item_3&sc_apl_menu=FornecedorComunicacao_Lst&sc_apl_link=" . urlencode($FornecedorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "far fa-comment-alt",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
                                                  'mega_check'     => "N",
                                                  'icon_check'     => "S",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["FornecedorContato_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["FornecedorContato_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$FornecedorGestao_Mnu_menuData['data']['itens']['item_5'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "FornecedorGestao_Mnu_form_php.php?sc_item_menu=item_5&sc_apl_menu=FornecedorContato_Lst&sc_apl_link=" . urlencode($FornecedorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["FornecedorDocumento_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["FornecedorDocumento_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$FornecedorGestao_Mnu_menuData['data']['itens']['item_2'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "FornecedorGestao_Mnu_form_php.php?sc_item_menu=item_2&sc_apl_menu=FornecedorDocumento_Lst&sc_apl_link=" . urlencode($FornecedorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["FornecedorPlanoConta_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["FornecedorPlanoConta_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$FornecedorGestao_Mnu_menuData['data']['itens']['item_6'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "FornecedorGestao_Mnu_form_php.php?sc_item_menu=item_6&sc_apl_menu=FornecedorPlanoConta_Lst&sc_apl_link=" . urlencode($FornecedorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-list",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["Fornecedor_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["Fornecedor_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$FornecedorGestao_Mnu_menuData['data']['itens']['item_7'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "FornecedorGestao_Mnu_form_php.php?sc_item_menu=item_7&sc_apl_menu=Fornecedor_Lst&sc_apl_link=" . urlencode($FornecedorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$FornecedorGestao_Mnu_menuData['data_tb']['itens']['item_tb_1'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "FornecedorGestao_Mnu_form_php.php?sc_item_menu=item_tb_1&sc_apl_menu=search&sc_apl_link=" . urlencode($FornecedorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$FornecedorGestao_Mnu_menuData['data_tb']['itens']['item_tb_2'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "FornecedorGestao_Mnu_form_php.php?sc_item_menu=item_tb_2&sc_apl_menu=languages&sc_apl_link=" . urlencode($FornecedorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$FornecedorGestao_Mnu_menuData['data_tb']['itens']['item_tb_3'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "FornecedorGestao_Mnu_form_php.php?sc_item_menu=item_tb_3&sc_apl_menu=themes&sc_apl_link=" . urlencode($FornecedorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$FornecedorGestao_Mnu_menuData['data_tb']['itens']['item_tb_4'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "FornecedorGestao_Mnu_form_php.php?sc_item_menu=item_tb_4&sc_apl_menu=shortcuts&sc_apl_link=" . urlencode($FornecedorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['FornecedorGestao_Mnu']))
{
    $FornecedorGestao_Mnu_menuData['data']['itens'] = $_SESSION['scriptcase']['sc_def_menu']['FornecedorGestao_Mnu'];
}
if (isset($_SESSION['scriptcase']['sc_usermenu']['FornecedorGestao_Mnu']))
{
    $FornecedorGestao_Mnu_menuData['data_user']['itens'] = $_SESSION['scriptcase']['sc_usermenu']['FornecedorGestao_Mnu'];
}
if (isset($_SESSION['scriptcase']['sc_def_shortcuts']['FornecedorGestao_Mnu']) && !empty($_SESSION['scriptcase']['sc_def_shortcuts']['FornecedorGestao_Mnu']))
{
    $FornecedorGestao_Mnu_menuData['shortcuts'] = $_SESSION['scriptcase']['sc_def_shortcuts']['FornecedorGestao_Mnu'];
}
if (is_file("FornecedorGestao_Mnu_help.txt"))
{
    $Arq_WebHelp = file("FornecedorGestao_Mnu_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $FornecedorGestao_Mnu_menuData['data'][] = array(
                    ...
                    'target'   => "" . $this->FornecedorGestao_Mnu_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['FornecedorGestao_Mnu']) && !empty($_SESSION['scriptcase']['sc_menu_del']['FornecedorGestao_Mnu']))
{
    sc_menu_delete($FornecedorGestao_Mnu_menuData['data'], $_SESSION['scriptcase']['sc_menu_del']['FornecedorGestao_Mnu']);
    sc_menu_delete($FornecedorGestao_Mnu_menuData['data_user'], $_SESSION['scriptcase']['sc_menu_del']['FornecedorGestao_Mnu']);
}
if (isset($_SESSION['scriptcase']['sc_menu_disable']['FornecedorGestao_Mnu']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['FornecedorGestao_Mnu']))
{
    sc_menu_disable($FornecedorGestao_Mnu_menuData['data'], $_SESSION['scriptcase']['sc_menu_disable']['FornecedorGestao_Mnu']);
    sc_menu_disable($FornecedorGestao_Mnu_menuData['data_user'], $_SESSION['scriptcase']['sc_menu_disable']['FornecedorGestao_Mnu']);
}
...
<head>
 <title>FornecedorGestao_Mnu</title>
 ...
 ?> 
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_prod']; ?>/third/font-awesome/6/css/all.min.css" type="text/css" media="screen" />
<style>
   .scTabText {
   }    <?php
...
/* Arquivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_prod']; ?>/third/lineicons/web-font-files/lineicons.css" /> 
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_prod']; ?>/third/Fuse/dist/fuse.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="FornecedorGestao_Mnu_message.js"></script>
...
?>
<script>
Iframe_atual = "FornecedorGestao_Mnu_iframe";
...
{
  if (str_id != "iframe_FornecedorGestao_Mnu")
  {
      str_id        = str_id.replace("FornecedorGestao_Mnu_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_FornecedorGestao_Mnu', 'FornecedorGestao_Mnu');
    //test link type
    ...
    if(str_target != '_blank' && $('#iframe_FornecedorGestao_Mnu').length)
        $('#iframe_FornecedorGestao_Mnu')[0].contentWindow.focus();
  }
}
</script>
<div id='main_menu_table' class='scMenuHMoldura'>
    <?php echo $this->FornecedorGestao_Mnu_MenuH($FornecedorGestao_Mnu_menuData, $path_imag_cab, $strAlign); ?>
    <div id='idMenuDown'>
        <div id='idMenuRightSide'>
    <div id="Iframe_control" style=''>
<?php
$SCR  = "";
$link_default = " onclick=\"openMenuItem('iframe_FornecedorGestao_Mnu');\" item-href=\"FornecedorGestao_Mnu_form_php.php?sc_item_menu=FornecedorGestao_Mnu&sc_apl_menu=Fornecedor_Frm&sc_apl_link=" . urlencode($FornecedorGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_usa_grupo'] . "\"  item-target=\"FornecedorGestao_Mnu_iframe\"";
?>
      <iframe id="iframe_FornecedorGestao_Mnu" name="FornecedorGestao_Mnu_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: ;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
...
function FornecedorGestao_Mnu_Header()
{
?>
    
<?php
}function FornecedorGestao_Mnu_MenuH($FornecedorGestao_Mnu_menuData, $path_imag_cab, $strAlign)
{
?>
    <div id='idMenuLine' class='scMenuArea'>
        <?php echo $this->FornecedorGestao_Mnu_escreveMenu($FornecedorGestao_Mnu_menuData, $path_imag_cab, $strAlign); ?>
    </div>
<?php
}
function FornecedorGestao_Mnu_Footer()
{
?>
    
<?php
}
function FornecedorGestao_Mnu_escreveMenuRec($arr_menu, $arr_menu_apl, $path_imag_cab = '')
{
    ...
    $menu_data = json_decode('{"theme":"light-gray","layout":"V","header_string":"\" . $_SESSION[\'varNomeFantasia\'] . \"","header_string_pos":"H","check_split":"N","check_toolbar":"N","check_show_search_path":"N","check_shortcut_label":"N","check_start_expanded":"S","check_use_loader":"S","should_reload":"S","layout_usr_pos":"in","usercheck":"N","username":"","userimage":"","userdesc":"","logo":"","logo_compact":"","pick_themes":[],"shortcuts":[],"items":[{"text":"Cadastro","app":"Fornecedor_Frm","hint":"","icon":"far fa-address-card","icon_check":"S","id":"item_4","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Comunica\u00e7\u00f5es","app":"FornecedorComunicacao_Lst","hint":"","icon":"far fa-comment-alt","icon_check":"S","id":"item_3","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Contatos","app":"FornecedorContato_Lst","hint":"","icon":"fas fa-users","icon_check":"S","id":"item_5","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Documentos","app":"FornecedorDocumento_Lst","hint":"","icon":"far fa-file-alt","icon_check":"S","id":"item_2","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Plano de Contas","app":"FornecedorPlanoConta_Lst","hint":"","icon":"fas fa-list","icon_check":"S","id":"item_6","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Sair","app":"Fornecedor_Lst","icon":"fas fa-sign-out-alt","icon_check":"S","id":"item_7","hint":"","link_target":"parente","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"}],"user_items":[],"tb_items":[{"text":"Filtro","app":"search","icon":"fas fa-search","icon_check":"S","display":"N","id":"item_tb_1","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"},{"text":"Idiomas","app":"languages","icon":"fas fa-globe","icon_check":"S","display":"N","id":"item_tb_2","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"},{"text":"Temas","app":"themes","icon":"fas fa-paint-roller","icon_check":"S","display":"N","id":"item_tb_3","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"},{"text":"Atalhos","app":"shortcuts","icon":"fas fa-grip-vertical","icon_check":"S","display":"N","id":"item_tb_4","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"}],"open_itens_tab":"N"}', true);
    ...
    $apl_link_build = "FornecedorGestao_Mnu_form_php.php?sc_item_menu=notif_app_link&sc_apl_menu=###APPNAME###&sc_apl_link=" . urlencode($arr_menu_apl['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_usa_grupo'];

    $apl_default          = 'Fornecedor_Frm';
    $apl_default_location = 'N';
    $apl_name_ref_sc = 'FornecedorGestao_Mnu';
    ...
    {
        $apl_default = "FornecedorGestao_Mnu_form_php.php?sc_item_menu=FornecedorGestao_Mnu&sc_apl_menu=" . $apl_default . "&sc_apl_link=" . urlencode($arr_menu_apl['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_usa_grupo'];
    }
    if (isset($menu_data['notif_open_all_app']) && !empty($menu_data['notif_open_all_app']))
    {
        $menu_data['notif_open_all_app'] = "FornecedorGestao_Mnu_form_php.php?sc_item_menu=notif_see_all&sc_apl_menu=" . $menu_data['notif_open_all_app'] . "&sc_apl_link=" . urlencode($arr_menu_apl['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_usa_grupo'];
    }
...
}function FornecedorGestao_Mnu_escreveMenu($arr_menu_apl, $path_imag_cab = '', $strAlign = '')
{
        ...
        <div class='menu menu--horizontal'>
            ...
            <div class='menu__container scMenuHTableCssAlt'>
                <div class='menu__layer'>
                    <?php
                    $this->FornecedorGestao_Mnu_escreveMenuRec($arr_menu, $arr_menu_apl, $path_imag_cab, 'menu__list');
                    ?>
                </div>
            </div>
        </div><?php
}
function FornecedorGestao_Mnu_target($str_target)
{
    ...
    {
        return 'FornecedorGestao_Mnu_iframe';
    }
}
   ...
   {
        $_SESSION['scriptcase']['FornecedorGestao_Mnu']['sc_init'][$apl_menu] = 1;
        return  1;
   }
function FormatarDados($parValor, $parMascara)
{ global $FornecedorGestao_Mnu_menuData;
$_SESSION['scriptcase']['FornecedorGestao_Mnu']['contr_erro'] = 'on';
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_imag_temp'] . "/sc_apl_default_LIGA_InfoTIME.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['FornecedorGestao_Mnu']['glo_nm_path_imag_temp'] . "/sc_apl_default_LIGA_InfoTIME.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "FornecedorGestao_Mnu") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['FornecedorGestao_Mnu']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['FornecedorGestao_Mnu']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['FornecedorGestao_Mnu']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_LIGA_InfoTIME'])) {
            $_SESSION['scriptcase']['FornecedorGestao_Mnu']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_LIGA_InfoTIME'];
        }
    }
}
...
$contr_FornecedorGestao_Mnu = new FornecedorGestao_Mnu_class;
$contr_FornecedorGestao_Mnu->FornecedorGestao_Mnu_menu();
