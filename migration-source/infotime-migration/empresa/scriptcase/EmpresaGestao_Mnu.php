<?php
include_once('EmpresaGestao_Mnu_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_prod']      = "";
    $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_perfil']         = "ligasistemas";
    $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_usa_grupo']      = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class EmpresaGestao_Mnu_class
{
  var $Db;
  var $sc_charset;
  var $force_mobile;
 ...
 function EmpresaGestao_Mnu_menu()
 {
    global $EmpresaGestao_Mnu_menuData, $nm_data_fixa;
 ...
 if (isset($_REQUEST["ajax_notif_request"]))    { 
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['EmpresaGestao_Mnu']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "EmpresaGestao_Mnu/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_imag_temp'];
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/EmpresaGestao_Mnu_erro.php");
}
include_once(dirname(__FILE__) . "/EmpresaGestao_Mnu_erro.class.php"); 
$this->Erro = new EmpresaGestao_Mnu_erro();
$str_path = substr($_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_conexao']);
}

/* Definição dos Caminhos */
$EmpresaGestao_Mnu_menuData         = array();
$EmpresaGestao_Mnu_menuData['path'] = array();
$EmpresaGestao_Mnu_menuData['url']  = array();
$EmpresaGestao_Mnu_menuData['data'] = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $EmpresaGestao_Mnu_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $EmpresaGestao_Mnu_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $EmpresaGestao_Mnu_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $EmpresaGestao_Mnu_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$EmpresaGestao_Mnu_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$EmpresaGestao_Mnu_menuData['url']['web']   = str_replace("\\", '/', $EmpresaGestao_Mnu_menuData['url']['web']);
$EmpresaGestao_Mnu_menuData['path']['root'] = substr($EmpresaGestao_Mnu_menuData['path']['sys'],  0, -1 * strlen($EmpresaGestao_Mnu_menuData['url']['web']));
$EmpresaGestao_Mnu_menuData['path']['app']  = substr($EmpresaGestao_Mnu_menuData['path']['sys'],  0, strrpos($EmpresaGestao_Mnu_menuData['path']['sys'],  '/'));
$EmpresaGestao_Mnu_menuData['path']['link'] = substr($EmpresaGestao_Mnu_menuData['path']['app'],  0, strrpos($EmpresaGestao_Mnu_menuData['path']['app'],  '/'));
$EmpresaGestao_Mnu_menuData['path']['link'] = substr($EmpresaGestao_Mnu_menuData['path']['link'], 0, strrpos($EmpresaGestao_Mnu_menuData['path']['link'], '/')) . '/';
$EmpresaGestao_Mnu_menuData['path']['app'] .= '/';
$EmpresaGestao_Mnu_menuData['url']['app']   = substr($EmpresaGestao_Mnu_menuData['url']['web'],  0, strrpos($EmpresaGestao_Mnu_menuData['url']['web'],  '/'));
$EmpresaGestao_Mnu_menuData['url']['link']  = substr($EmpresaGestao_Mnu_menuData['url']['app'],  0, strrpos($EmpresaGestao_Mnu_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_usa_grupo'] == "S")
{
    $EmpresaGestao_Mnu_menuData['url']['link']  = substr($EmpresaGestao_Mnu_menuData['url']['link'], 0, strrpos($EmpresaGestao_Mnu_menuData['url']['link'], '/'));
}
$EmpresaGestao_Mnu_menuData['url']['link']  .= '/';
$EmpresaGestao_Mnu_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['EmpresaGestao_Mnu']['sc_apl_link'] = $EmpresaGestao_Mnu_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['EmpresaGestao_Mnu']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['EmpresaGestao_Mnu']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['EmpresaGestao_Mnu']['actual_lang']) || $_SESSION['scriptcase']['EmpresaGestao_Mnu']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['EmpresaGestao_Mnu']['actual_lang'] = $this->str_lang;
...
include_once("EmpresaGestao_Mnu_toolbar.php");
...
if ($_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "EmpresaGestao_Mnu";
     $_SESSION['scriptcase']['menu_apls']['EmpresaGestao_Mnu'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_conexao']) && $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_perfil']) && $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['EmpresaGestao_Mnu']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['EmpresaGestao_Mnu']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['EmpresaGestao_Mnu']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['EmpresaGestao_Mnu']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['EmpresaGestao_Mnu']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['EmpresaGestao_Mnu']['init']))
{
    $_SESSION['sc_session'][1]['EmpresaGestao_Mnu']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['EmpresaGestao_Mnu']['init'];
...
if (!isset($varDescricaoEmpresa) && isset($vardescricaoempresa)) 
{
    $_SESSION["varDescricaoEmpresa"] = $vardescricaoempresa;
}
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['EmpresaGestao_Mnu']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_EmpresaGestao_Mnu'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_EmpresaGestao_Mnu'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_EmpresaGestao_Mnu'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
{ 
    $_SESSION['scriptcase']['sc_apl_seg']['EmpresaGestao_Mnu'] = "on";
} 
if (!isset($_SESSION['scriptcase']['EmpresaGestao_Mnu']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['EmpresaGestao_Mnu']) || $_SESSION['scriptcase']['sc_apl_seg']['EmpresaGestao_Mnu'] != "on"))
{ 
...
{
    if(function_exists("nm_check_perfil_exists")) nm_check_perfil_exists($path_libs, $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_prod']);
    $_SESSION['sc_session'][1]['SC_Check_Perfil'] = true;
}
$nm_falta_var    = ""; 
$nm_falta_var_db = ""; 
if (isset($_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_conexao']))
{
    db_conect_devel($_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_prod'], 'LIGA_InfoTIME', 2); 
}
if (isset($_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_perfil']))
{
   $_SESSION['scriptcase']['glo_perfil'] = $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_perfil'];
}
...
if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
{
    ...
    if (strlen($SC_temp) == 2)
    {
       $_SESSION['scriptcase']['EmpresaGestao_Mnu']['SC_sep_date']  = substr($SC_temp, 0, 1); 
       $_SESSION['scriptcase']['EmpresaGestao_Mnu']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
   }
   else
    {
       $_SESSION['scriptcase']['EmpresaGestao_Mnu']['SC_sep_date']  = $SC_temp; 
       $_SESSION['scriptcase']['EmpresaGestao_Mnu']['SC_sep_date1'] = $SC_temp; 
   }
}
...
if (!empty($nm_falta_var) || !empty($nm_falta_var_db))
{
    ...
    { 
        if (isset($_SESSION['sc_session'][1]['EmpresaGestao_Mnu']['sc_outra_jan']) && $_SESSION['sc_session'][1]['EmpresaGestao_Mnu']['sc_outra_jan'])
        {
...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
 $glo_senha_protect = (isset($_SESSION['scriptcase']['glo_senha_protect'])) ? $_SESSION['scriptcase']['glo_senha_protect'] : "S";
if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_conexao']))
{ 
   $this->Db = db_conect_devel($_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_prod'], 'LIGA_InfoTIME'); 
} 
else 
{ 
...
//
      $_SESSION['scriptcase']['EmpresaGestao_Mnu']['contr_erro'] = 'on';
  ?>
<style>
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'EmpresaGestao_Mnu'))
{
    $_SESSION['sc_session'][1]['EmpresaGestao_Mnu']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_EmpresaGestao_Mnu'] = "javascript:window.close()";
}
...
if(is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/Empresa_Frm_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/Empresa_Frm_ini.php");
    ...
    {
      if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Empresa_Frm']))
      {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/EmpresaDocumento_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/EmpresaDocumento_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['EmpresaDocumento_Lst']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/EmpresaNotaFiscal_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/EmpresaNotaFiscal_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['EmpresaNotaFiscal_Lst']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['EmpresaNotaFiscal_Lst'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/EmpresaSenha_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/EmpresaSenha_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['EmpresaSenha_Lst']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/Empresa_Lst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/Empresa_Lst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Empresa_Lst']))
        {
...
/* Itens do Menu */
$_SESSION['scriptcase']['EmpresaGestao_Mnu']['contr_erro'] = 'on';
if (!isset($_SESSION['varDescricaoEmpresa'])) {$_SESSION['varDescricaoEmpresa'] = "";}
if (!isset($this->sc_temp_varDescricaoEmpresa)) {$this->sc_temp_varDescricaoEmpresa = (isset($_SESSION['varDescricaoEmpresa'])) ? $_SESSION['varDescricaoEmpresa'] : "";}
...
if (!isset($_SESSION['varIdEmpresaSel'])) {$_SESSION['varIdEmpresaSel'] = "";}
if (!isset($this->sc_temp_varIdEmpresaSel)) {$this->sc_temp_varIdEmpresaSel = (isset($_SESSION['varIdEmpresaSel'])) ? $_SESSION['varIdEmpresaSel'] : "";}
  $check_sql = "SELECT NomeFantasia, Cnpj, Cidade, Estado, Telefone, TipoEmpresa"
   . " FROM empresa"
   . " WHERE IdEmpresa = '" . $this->sc_temp_varIdEmpresaSel . "'";
...
elseif ($TipoEmpresa == "F") {
	$TipoEmpresa = "Filial";
}
else {
	$TipoEmpresa = "Tipo inválido";
}
$this->sc_temp_varNomeFantasia = $NomeFantasia;
$Cnpj = $this->FormatarDados($Cnpj, '##.###.###/####-##');
$this->sc_temp_varDescricaoEmpresa = '
<style>
table, td, th {
...
<table class="scGridTabela">
    <tr>
        <td><p style="color: #6c757d; background-color: #e3eaef"><b> Nome fantasia </b></p></td>
        ...
        <td><p style="color: #6c757d; background-color: #e3eaef"><b> Tipo empresa</b></p></td>
    </tr>
    <tr>
        ...
        <td><font size="2" color="#313a46"><b>' . $TipoEmpresa . ' </font></td>
	</tr>
</table>
</div>
';
if (isset($this->sc_temp_varIdEmpresaSel)) {$_SESSION['varIdEmpresaSel'] = $this->sc_temp_varIdEmpresaSel;}
if (isset($this->sc_temp_varNomeFantasia)) {$_SESSION['varNomeFantasia'] = $this->sc_temp_varNomeFantasia;}
if (isset($this->sc_temp_varDescricaoEmpresa)) {$_SESSION['varDescricaoEmpresa'] = $this->sc_temp_varDescricaoEmpresa;}
$_SESSION['scriptcase']['EmpresaGestao_Mnu']['contr_erro'] = 'off';

$sOutputBuffer = ob_get_contents();
ob_end_clean();

$saida_apl = $_SESSION['scriptcase']['sc_saida_EmpresaGestao_Mnu'];

$EmpresaGestao_Mnu_menuData['data'] = array();
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["Empresa_Frm"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["Empresa_Frm"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$EmpresaGestao_Mnu_menuData['data']['itens']['item_1'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "EmpresaGestao_Mnu_form_php.php?sc_item_menu=item_1&sc_apl_menu=Empresa_Frm&sc_apl_link=" . urlencode($EmpresaGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-city",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
                                                  ...
                                                  'icon_check'     => "S",
                                                  'id'     => "item_1",
                                                  'target'      => $this->EmpresaGestao_Mnu_target('_self'),
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["EmpresaDocumento_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["EmpresaDocumento_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$EmpresaGestao_Mnu_menuData['data']['itens']['item_2'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "EmpresaGestao_Mnu_form_php.php?sc_item_menu=item_2&sc_apl_menu=EmpresaDocumento_Lst&sc_apl_link=" . urlencode($EmpresaGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-list",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["EmpresaNotaFiscal_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["EmpresaNotaFiscal_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Nota Fiscal";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$EmpresaGestao_Mnu_menuData['data']['itens']['item_5'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "EmpresaGestao_Mnu_form_php.php?sc_item_menu=item_5&sc_apl_menu=EmpresaNotaFiscal_Lst&sc_apl_link=" . urlencode($EmpresaGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["EmpresaSenha_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["EmpresaSenha_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$EmpresaGestao_Mnu_menuData['data']['itens']['item_3'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "EmpresaGestao_Mnu_form_php.php?sc_item_menu=item_3&sc_apl_menu=EmpresaSenha_Lst&sc_apl_link=" . urlencode($EmpresaGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-key",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']["Empresa_Lst"]) || strtolower($_SESSION['scriptcase']['sc_apl_seg']["Empresa_Lst"]) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$EmpresaGestao_Mnu_menuData['data']['itens']['item_4'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "EmpresaGestao_Mnu_form_php.php?sc_item_menu=item_4&sc_apl_menu=Empresa_Lst&sc_apl_link=" . urlencode($EmpresaGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$EmpresaGestao_Mnu_menuData['data_tb']['itens']['item_tb_1'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "EmpresaGestao_Mnu_form_php.php?sc_item_menu=item_tb_1&sc_apl_menu=search&sc_apl_link=" . urlencode($EmpresaGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$EmpresaGestao_Mnu_menuData['data_tb']['itens']['item_tb_2'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "EmpresaGestao_Mnu_form_php.php?sc_item_menu=item_tb_2&sc_apl_menu=languages&sc_apl_link=" . urlencode($EmpresaGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$EmpresaGestao_Mnu_menuData['data_tb']['itens']['item_tb_3'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "EmpresaGestao_Mnu_form_php.php?sc_item_menu=item_tb_3&sc_apl_menu=themes&sc_apl_link=" . urlencode($EmpresaGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$EmpresaGestao_Mnu_menuData['data_tb']['itens']['item_tb_4'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "EmpresaGestao_Mnu_form_php.php?sc_item_menu=item_tb_4&sc_apl_menu=shortcuts&sc_apl_link=" . urlencode($EmpresaGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['EmpresaGestao_Mnu']))
{
    $EmpresaGestao_Mnu_menuData['data']['itens'] = $_SESSION['scriptcase']['sc_def_menu']['EmpresaGestao_Mnu'];
}
if (isset($_SESSION['scriptcase']['sc_usermenu']['EmpresaGestao_Mnu']))
{
    $EmpresaGestao_Mnu_menuData['data_user']['itens'] = $_SESSION['scriptcase']['sc_usermenu']['EmpresaGestao_Mnu'];
}
if (isset($_SESSION['scriptcase']['sc_def_shortcuts']['EmpresaGestao_Mnu']) && !empty($_SESSION['scriptcase']['sc_def_shortcuts']['EmpresaGestao_Mnu']))
{
    $EmpresaGestao_Mnu_menuData['shortcuts'] = $_SESSION['scriptcase']['sc_def_shortcuts']['EmpresaGestao_Mnu'];
}
if (is_file("EmpresaGestao_Mnu_help.txt"))
{
    $Arq_WebHelp = file("EmpresaGestao_Mnu_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $EmpresaGestao_Mnu_menuData['data'][] = array(
                    ...
                    'target'   => "" . $this->EmpresaGestao_Mnu_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['EmpresaGestao_Mnu']) && !empty($_SESSION['scriptcase']['sc_menu_del']['EmpresaGestao_Mnu']))
{
    sc_menu_delete($EmpresaGestao_Mnu_menuData['data'], $_SESSION['scriptcase']['sc_menu_del']['EmpresaGestao_Mnu']);
    sc_menu_delete($EmpresaGestao_Mnu_menuData['data_user'], $_SESSION['scriptcase']['sc_menu_del']['EmpresaGestao_Mnu']);
}
if (isset($_SESSION['scriptcase']['sc_menu_disable']['EmpresaGestao_Mnu']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['EmpresaGestao_Mnu']))
{
    sc_menu_disable($EmpresaGestao_Mnu_menuData['data'], $_SESSION['scriptcase']['sc_menu_disable']['EmpresaGestao_Mnu']);
    sc_menu_disable($EmpresaGestao_Mnu_menuData['data_user'], $_SESSION['scriptcase']['sc_menu_disable']['EmpresaGestao_Mnu']);
}
...
<head>
 ...
 ?> 
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_prod']; ?>/third/font-awesome/6/css/all.min.css" type="text/css" media="screen" />
<style>
   .scTabText {
   }    <?php
...
/* Arquivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_prod']; ?>/third/lineicons/web-font-files/lineicons.css" /> 
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_prod']; ?>/third/Fuse/dist/fuse.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="EmpresaGestao_Mnu_message.js"></script>
...
?>
<script>
Iframe_atual = "EmpresaGestao_Mnu_iframe";
...
{
  if (str_id != "iframe_EmpresaGestao_Mnu")
  {
      str_id        = str_id.replace("EmpresaGestao_Mnu_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_EmpresaGestao_Mnu', 'EmpresaGestao_Mnu');
    //test link type
    ...
    if(str_target != '_blank' && $('#iframe_EmpresaGestao_Mnu').length)
        $('#iframe_EmpresaGestao_Mnu')[0].contentWindow.focus();
  }
}
</script>
<div id='main_menu_table' class='scMenuHMoldura'>
    <?php echo $this->EmpresaGestao_Mnu_MenuH($EmpresaGestao_Mnu_menuData, $path_imag_cab, $strAlign); ?>
    <div id='idMenuDown'>
        <div id='idMenuRightSide'>
    <div id="Iframe_control" style=''>
<?php
$SCR  = "";
$link_default = " onclick=\"openMenuItem('iframe_EmpresaGestao_Mnu');\" item-href=\"EmpresaGestao_Mnu_form_php.php?sc_item_menu=EmpresaGestao_Mnu&sc_apl_menu=Empresa_Frm&sc_apl_link=" . urlencode($EmpresaGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_usa_grupo'] . "\"  item-target=\"EmpresaGestao_Mnu_iframe\"";
?>
      <iframe id="iframe_EmpresaGestao_Mnu" name="EmpresaGestao_Mnu_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: ;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
...
function EmpresaGestao_Mnu_Header()
{
?>
    
<?php
}function EmpresaGestao_Mnu_MenuH($EmpresaGestao_Mnu_menuData, $path_imag_cab, $strAlign)
{
?>
    <div id='idMenuLine' class='scMenuArea'>
        <?php echo $this->EmpresaGestao_Mnu_escreveMenu($EmpresaGestao_Mnu_menuData, $path_imag_cab, $strAlign); ?>
    </div>
<?php
}
function EmpresaGestao_Mnu_Footer()
{
?>
    
<?php
}
function EmpresaGestao_Mnu_escreveMenuRec($arr_menu, $arr_menu_apl, $path_imag_cab = '')
{
    ...
    $menu_data = json_decode('{"theme":"light-gray","layout":"V","header_string":"\" . $_SESSION[\'varNomeFantasia\'] . \"","header_string_pos":"H","check_split":"S","check_toolbar":"N","check_show_search_path":"S","check_shortcut_label":"N","check_start_expanded":"S","check_use_loader":"S","should_reload":"S","layout_usr_pos":"out","usercheck":"N","username":"","userimage":"","userdesc":"","logo":"","logo_compact":"","pick_themes":[],"shortcuts":[],"items":[{"text":"Cadastro","app":"Empresa_Frm","hint":"","icon":"fas fa-city","icon_check":"S","id":"item_1","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Documentos","app":"EmpresaDocumento_Lst","hint":"","icon":"fas fa-list","icon_check":"S","id":"item_2","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Nota Fiscal","app":"EmpresaNotaFiscal_Lst","hint":"","icon":"far fa-file-alt","icon_check":"S","id":"item_5","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Senhas","app":"EmpresaSenha_Lst","hint":"","icon":"fas fa-key","icon_check":"S","id":"item_3","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Sair","app":"Empresa_Lst","hint":"","icon":"fas fa-sign-out-alt","icon_check":"S","id":"item_4","link_target":"parente","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"}],"user_items":[],"tb_items":[{"text":"Filtro","app":"search","icon":"fas fa-search","icon_check":"S","display":"N","id":"item_tb_1","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"},{"text":"Idiomas","app":"languages","icon":"fas fa-globe","icon_check":"S","display":"N","id":"item_tb_2","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"},{"text":"Temas","app":"themes","icon":"fas fa-paint-roller","icon_check":"S","display":"N","id":"item_tb_3","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"},{"text":"Atalhos","app":"shortcuts","icon":"fas fa-grip-vertical","icon_check":"S","display":"N","id":"item_tb_4","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"}],"open_itens_tab":"N"}', true);
    ...
    $apl_link_build = "EmpresaGestao_Mnu_form_php.php?sc_item_menu=notif_app_link&sc_apl_menu=###APPNAME###&sc_apl_link=" . urlencode($arr_menu_apl['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_usa_grupo'];

    $apl_default          = 'Empresa_Frm';
    $apl_default_location = 'N';
    $apl_name_ref_sc = 'EmpresaGestao_Mnu';
    ...
    {
        $apl_default = "EmpresaGestao_Mnu_form_php.php?sc_item_menu=EmpresaGestao_Mnu&sc_apl_menu=" . $apl_default . "&sc_apl_link=" . urlencode($arr_menu_apl['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_usa_grupo'];
    }
    if (isset($menu_data['notif_open_all_app']) && !empty($menu_data['notif_open_all_app']))
    {
        $menu_data['notif_open_all_app'] = "EmpresaGestao_Mnu_form_php.php?sc_item_menu=notif_see_all&sc_apl_menu=" . $menu_data['notif_open_all_app'] . "&sc_apl_link=" . urlencode($arr_menu_apl['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_usa_grupo'];
    }
...
}function EmpresaGestao_Mnu_escreveMenu($arr_menu_apl, $path_imag_cab = '', $strAlign = '')
{
        ...
        <div class='menu menu--horizontal'>
            ...
            <div class='menu__container scMenuHTableCssAlt'>
                <div class='menu__layer'>
                    <?php
                    $this->EmpresaGestao_Mnu_escreveMenuRec($arr_menu, $arr_menu_apl, $path_imag_cab, 'menu__list');
                    ?>
                </div>
            </div>
        </div><?php
}
function EmpresaGestao_Mnu_target($str_target)
{
    ...
    {
        return 'EmpresaGestao_Mnu_iframe';
    }
}
   ...
   {
        $_SESSION['scriptcase']['EmpresaGestao_Mnu']['sc_init'][$apl_menu] = 1;
        return  1;
   }
function FormatarDados($parValor, $parMascara)
{ global $EmpresaGestao_Mnu_menuData;
$_SESSION['scriptcase']['EmpresaGestao_Mnu']['contr_erro'] = 'on';
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_imag_temp'] . "/sc_apl_default_LIGA_InfoTIME.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['EmpresaGestao_Mnu']['glo_nm_path_imag_temp'] . "/sc_apl_default_LIGA_InfoTIME.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "EmpresaGestao_Mnu") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['EmpresaGestao_Mnu']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['EmpresaGestao_Mnu']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['EmpresaGestao_Mnu']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_LIGA_InfoTIME'])) {
            $_SESSION['scriptcase']['EmpresaGestao_Mnu']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_LIGA_InfoTIME'];
        }
    }
}
...
$contr_EmpresaGestao_Mnu = new EmpresaGestao_Mnu_class;
$contr_EmpresaGestao_Mnu->EmpresaGestao_Mnu_menu();
