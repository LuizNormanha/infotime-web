<?php
   include_once('GerarBoleto_Blk_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_perfil']          = "ligasistemas";
   $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class GerarBoleto_Blk_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "GerarBoleto_Blk"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_dt_criacao   = "20160107"; 
      $this->nm_hr_criacao   = "165039"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['GerarBoleto_Blk']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['GerarBoleto_Blk']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['GerarBoleto_Blk']['save_session']['data'] = '';
      } 
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['sub_cons_schema_all']))
      { 
         $this->str_schema_all    = $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['sub_cons_schema_all'];
         $this->str_schema_filter = $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['sub_cons_schema_filter'];
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/GerarBoleto_Blk';
      ...
      $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['GerarBoleto_Blk']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['GerarBoleto_Blk']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['GerarBoleto_Blk']['actual_lang']) || $_SESSION['scriptcase']['GerarBoleto_Blk']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['GerarBoleto_Blk']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("GerarBoleto_Blk_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['remove_border']   = false;
          $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['remove_background'] = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
              if (isset($_GET['remove_background'])) {
                  $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['remove_background'] = 1 == $_GET['remove_background'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
              if (isset($remove_background)) {
                  $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['remove_background'] = 1 == $remove_background;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["GerarBoleto_Blk"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["GerarBoleto_Blk"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) || isset($link_remove_margin) || isset($link_remove_border) || isset($link_remove_background) || isset($link_margin_top)) {
            $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['link_info'] = array();
        }
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['link_info']['remove_border'] = true;
        }
        if (isset($link_remove_background) && 'ok' == $link_remove_background) {
            $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['link_info']['remove_background'] = true;
        }
        if (isset($link_margin_top) && '' != $link_margin_top) {
            $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['link_info']['margin_top'] = $link_margin_top;
        }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['GerarBoleto_Blk']['session_timeout']['redir']))
      {
      ...
      if (isset($_POST['nm_grid_submit']) && $_POST['nm_grid_submit'] == 1 && isset($_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['csrf_token'] ) && !isset($_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['embutida']) && !isset($_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['embutida_form'])) {
          if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] != $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['csrf_token']) {
              echo "<html>";
              echo "<body>";
              echo "<table align=\"center\" width=\"50%\" border=1 height=\"50px\">";
              echo "<tr>";
      ...
      $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['path_doc'] = $this->path_doc; 
...
<body>
    <div class='ui container' style='padding-top:2rem'>
        <section class='ui message'>
         ...
         echo $str_message;
          if (!$_SESSION['sc_session'][$script_case_init]['GerarBoleto_Blk']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['GerarBoleto_Blk']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['GerarBoleto_Blk']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "GerarBoleto_Blk_erro.class.php"); 
      $this->Erro = new GerarBoleto_Blk_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('GerarBoleto_Blk'); 
// 
      $this->sc_Include($this->path_lib_php . "/nm_functions.php", "", "") ; 
      global $bol_api_prod; 
      $bol_api_prod = true; 
      if (isset($_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_conexao'])) 
      { 
          $bol_api_prod = false; 
      } 
      ...
      if (isset($_SESSION['scriptcase']['GerarBoleto_Blk']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['GerarBoleto_Blk']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['GerarBoleto_Blk']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['GerarBoleto_Blk']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['GerarBoleto_Blk']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['GerarBoleto_Blk']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_conexao']) && $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_perfil']) && $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['GerarBoleto_Blk']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      ...
      if (isset($_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_conexao'], $this->root . $this->path_prod, 'LIGA_InfoTIME', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['embutida'])
      {
...
// 
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['csrf_token']))
       {
           $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['csrf_token'] = $this->scCsrfGenerateToken();
       }

       return $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['csrf_token'];
   }
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['GerarBoleto_Blk']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new GerarBoleto_Blk_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GerarBoleto_Blk']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['GerarBoleto_Blk']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['GerarBoleto_Blk']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['GerarBoleto_Blk'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['GerarBoleto_Blk']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['GerarBoleto_Blk']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('GerarBoleto_Blk') . "/GerarBoleto_Blk.php";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['GerarBoleto_Blk']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "GerarBoleto_Blk.php"; 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['GerarBoleto_Blk']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['GerarBoleto_Blk']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['GerarBoleto_Blk']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "GerarBoleto_Blk_erro.class.php"); 
      $this->Erro      = new GerarBoleto_Blk_erro();
...
//
      ...
      $_SESSION['scriptcase']['GerarBoleto_Blk']['contr_erro'] = 'on';
  ob_start();
for ($i=0;$i<5;$i++) {
$dias_de_prazo_para_pagamento = 5;
$taxa_boleto = 0;
$data_venc = "08/01/2016";
...
$dadosboleto["nosso_numero"] = "1500000001";
$dadosboleto["numero_documento"] = "0123456789";	
$dadosboleto["data_vencimento"] = $data_venc; 
$dadosboleto["data_documento"] = date("d/m/Y"); 
$dadosboleto["data_processamento"] = date("d/m/Y"); 
$dadosboleto["valor_boleto"] = $valor_boleto; 	
$dadosboleto["sacado"] = "LUIZ ANTONIO NORMANHA NOVAES";
$dadosboleto["endereco1"] = "RUA SAO ROMAO, 56";
$dadosboleto["endereco2"] = "BELO HORIZONTE - MG -  CEP: 35514-000";
$dadosboleto["demonstrativo1"] = "Pagamento teste - LIGA Sistemas";
$dadosboleto["demonstrativo2"] = "Mensalidade referente a nonon nonooon nononon<br>Taxa bancária - R$ ".number_format($taxa_boleto, 2, ',', '');
$dadosboleto["demonstrativo3"] = "Boleto - http://www.liga.inf.br";
$dadosboleto["instrucoes1"] = "- Sr. Caixa, cobrar multa de 5% após o vencimento";
$dadosboleto["instrucoes2"] = "- Receber até 10 dias após o vencimento";
$dadosboleto["instrucoes3"] = "- Em caso de dúvidas entre em contato conosco: xxxx@xxxx.com.br";
$dadosboleto["instrucoes4"] = "&nbsp; Emitido pelo sistema INFOTime - www.ls1.com.br/infotime";
$dadosboleto["quantidade"] = "1";
$dadosboleto["valor_unitario"] = "1";
$dadosboleto["aceite"] = "N";		
$dadosboleto["especie"] = "R$";
$dadosboleto["especie_doc"] = "DM";
$dadosboleto["agencia"] = "3494"; 
$dadosboleto["conta"] = "2030"; 	
$dadosboleto["convenio"] = "2193379";  
$dadosboleto["contrato"] = "18670373"; 
...
$dadosboleto["identificacao"] = "LIGA Sistemas de Informática Ltda.";
$dadosboleto["cpf_cnpj"] = "00.325.244/0001-44";
$dadosboleto["endereco"] = "Rua São Romão,56 - São Pedro";
$dadosboleto["cidade_uf"] = "Belo Horizonte / MG";
$dadosboleto["cedente"] = "LIGA Sistemas de Informática Ltda - ME";
...
if ($dadosboleto["formatacao_convenio"] == "7") {
	...
	$nossonumeroLIGA = $this->formata_numero($dadosboleto["nosso_numero"],10,0);
		
	$gerarLinha = "0".$codigobanco.$nummoeda.$fator_vencimento.$valor.$livre_zeros.$convenio.$nossonumeroLIGA.$carteira;
	
	$dv=$this->modulo_11(substr($gerarLinha, 0, 44));	
	
	$linha="$codigobanco$nummoeda$dv$fator_vencimento$valor$livre_zeros$convenio$nossonumeroLIGA$carteira";
    $nossonumeroLIGA = $convenio.$nossonumeroLIGA;
}

if ($dadosboleto["formatacao_convenio"] == "6") {
	$convenio = $this->formata_numero($dadosboleto["convenio"],4,0,"convenio");
...
$dadosboleto["nosso_numero"] = $nossonumeroLIGA;
...
<page backtop="7mm" backbottom="7mm" backleft="8mm" backright="5mm" style="font-size: 9px; font-weight: normal; color:#000033;">
  <table width="704" cellspacing="0" cellpadding="0" border="0">
	...
	<table cellspacing=0 cellpadding=0 border=0>
		<tr>
			<td width=140 class=cp><img src="../_lib/img/logobb.jpg" alt="BB" width="150" height="27"></td>
	...
	<table cellspacing=0 cellpadding=0 border=0>
		<tr>
			<td width=7 height=1><img src='../_lib/img/1.png' width=7 height=1></td>
			<td width=112><img src='../_lib/img/1.png' width=112 height=1></td>
			<td width=7><img src='../_lib/img/1.png' width=7 height=1></td>
			<td width=113><img src='../_lib/img/1.png' width=113 height=1></td>
			<td width=7><img src='../_lib/img/1.png' width=7 height=1></td>
			<td width=53><img src='../_lib/img/1.png' width=53 height=1></td>
			<td width=7><img src='../_lib/img/1.png' width=7 height=1></td>
			<td width=53><img src='../_lib/img/1.png' width=53 height=1></td>
			<td width=7><img src='../_lib/img/1.png' width=7 height=1></td>
			<td width=113><img src='../_lib/img/1.png' width=113 height=1></td>
			<td width=7><img src='../_lib/img/1.png' width=7 height=1></td>
			<td width=180><img src='../_lib/img/1.png' width=180 height=1></td>
		</tr>
		<tr>
		...
		<tr><td colspan=12 height=1><img src='../_lib/img/2.png' width=666 height=1></td></tr>
		<tr>
			<td height=13><img src='../_lib/img/1.png' width=1 height=13></td>
	...
	<table cellspacing=0 cellpadding=0 border=0>
		...
		<tr><td colspan=4><img src='../_lib/img/6.png'  width=665 height=1></td></tr>
	</table>
	&nbsp;<br>
	<table cellspacing=0 cellpadding=0 border=0>
		<tr>
	...
	<table cellspacing=0 cellpadding=0 border=0>
		...
		<tr>
			...
			<td><img src='../_lib/img/b.png'  width=1 height=1></td>			
			<td><img src='../_lib/img/b.png'  width=1 height=1></td>
			<td height=13><img src='../_lib/img/1.png' width=1 height=13></td>
...
<?php
$arquivoGerado = "Boleto_".$dataset[$x][0].".html";
...
$_SESSION['scriptcase']['GerarBoleto_Blk']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_GerarBoleto_Blk($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_imag_temp'] . "/sc_apl_default_LIGA_InfoTIME.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['GerarBoleto_Blk']['glo_nm_path_imag_temp'] . "/sc_apl_default_LIGA_InfoTIME.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "GerarBoleto_Blk") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['GerarBoleto_Blk']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['GerarBoleto_Blk']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['GerarBoleto_Blk']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_LIGA_InfoTIME'])) {
               $_SESSION['scriptcase']['GerarBoleto_Blk']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_LIGA_InfoTIME'];
           }
       }
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['GerarBoleto_Blk']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['GerarBoleto_Blk']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['GerarBoleto_Blk']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "GerarBoleto_Blk";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'GerarBoleto_Blk' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['GerarBoleto_Blk']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['GerarBoleto_Blk']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['GerarBoleto_Blk']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['GerarBoleto_Blk']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['GerarBoleto_Blk']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('GerarBoleto_Blk' == $sReferer || 'GerarBoleto_Blk_' == substr($sReferer, 0, 16))
       {
           $_SESSION['sc_session'][$script_case_init]['GerarBoleto_Blk']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['GerarBoleto_Blk']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['GerarBoleto_Blk']['session_timeout']['lang'];
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'GerarBoleto_Blk')
   {
       $_SESSION['sc_session'][$script_case_init]['GerarBoleto_Blk']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['GerarBoleto_Blk']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/GerarBoleto_Blk_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_GerarBoleto_Blk($cadapar[1]);
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0;  
       ...
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['GerarBoleto_Blk'] = "on";
       } 
       if (!$_SESSION['sc_session'][$script_case_init]['GerarBoleto_Blk']['opc_psq'] && !isset($_SESSION['scriptcase']['GerarBoleto_Blk']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['GerarBoleto_Blk']) || $_SESSION['scriptcase']['sc_apl_seg']['GerarBoleto_Blk'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['GerarBoleto_Blk']['iframe_menu']) ? false : true;
              if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
              {
                  foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
                  {
                      if (in_array("GerarBoleto_Blk", $apls_aba))
                      {
                          $nm_botao_ok = false;
                           break;
                      }
...
<?php
   ...
   $contr_GerarBoleto_Blk = new GerarBoleto_Blk_apl();
   $contr_GerarBoleto_Blk->controle();
//
   function nm_limpa_str_GerarBoleto_Blk(&$str)
   {
   }
?>
