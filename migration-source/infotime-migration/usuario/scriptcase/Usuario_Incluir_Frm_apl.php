...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->varIdEnderecoIpAuditoria) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['varIdEnderecoIpAuditoria'] = $this->varIdEnderecoIpAuditoria;
      }
      if (isset($this->varNomeAplicacaoAuditoria) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['varNomeAplicacaoAuditoria'] = $this->varNomeAplicacaoAuditoria;
      }
      ...
      if (isset($_POST["varIdEnderecoIpAuditoria"]) && isset($this->varIdEnderecoIpAuditoria)) 
      {
          $_SESSION['varIdEnderecoIpAuditoria'] = $this->varIdEnderecoIpAuditoria;
      }
      ...
      if (isset($_POST["varNomeAplicacaoAuditoria"]) && isset($this->varNomeAplicacaoAuditoria)) 
      {
          $_SESSION['varNomeAplicacaoAuditoria'] = $this->varNomeAplicacaoAuditoria;
      }
      ...
      if (isset($_GET["varIdEnderecoIpAuditoria"]) && isset($this->varIdEnderecoIpAuditoria)) 
      {
          $_SESSION['varIdEnderecoIpAuditoria'] = $this->varIdEnderecoIpAuditoria;
      }
      ...
      if (isset($_GET["varNomeAplicacaoAuditoria"]) && isset($this->varNomeAplicacaoAuditoria)) 
      {
          $_SESSION['varNomeAplicacaoAuditoria'] = $this->varNomeAplicacaoAuditoria;
      }
      ...
      if (isset($this->Refresh_aba_menu)) {
          $_SESSION['sc_session'][$script_case_init]['Usuario_Incluir_Frm']['Refresh_aba_menu'] = $this->Refresh_aba_menu;
      }
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          $_POST['nmgp_opcao'] = "novo";
          $this->nmgp_opcao    = "novo";
          $_SESSION['sc_session'][$script_case_init]['Usuario_Incluir_Frm']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['Usuario_Incluir_Frm']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['Usuario_Incluir_Frm']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['Usuario_Incluir_Frm']['embutida_parms'];
      ...
      { 
          ...
          if (!isset($this->varIdEnderecoIpAuditoria) && isset($this->varidenderecoipauditoria)) 
          {
              $this->varIdEnderecoIpAuditoria = $this->varidenderecoipauditoria;
          }
          if (isset($this->varIdEnderecoIpAuditoria)) 
          {
              $_SESSION['varIdEnderecoIpAuditoria'] = $this->varIdEnderecoIpAuditoria;
          }
          if (!isset($this->varNomeAplicacaoAuditoria) && isset($this->varnomeaplicacaoauditoria)) 
          {
              $this->varNomeAplicacaoAuditoria = $this->varnomeaplicacaoauditoria;
          }
          if (isset($this->varNomeAplicacaoAuditoria)) 
          {
              $_SESSION['varNomeAplicacaoAuditoria'] = $this->varNomeAplicacaoAuditoria;
          }
          if (isset($this->NM_where_filter_form))
          {
              $_SESSION['sc_session'][$script_case_init]['Usuario_Incluir_Frm']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['Usuario_Incluir_Frm']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['Usuario_Incluir_Frm']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['Usuario_Incluir_Frm']['sc_redir_insert'] = $this->sc_redir_insert;
              unset($_SESSION['sc_session'][$script_case_init]['Usuario_Incluir_Frm']['opc_ant']);
          }
          if (!isset($this->varIdTenacidade) && isset($this->varidtenacidade)) 
          {
              $this->varIdTenacidade = $this->varidtenacidade;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Usuario_Incluir_Frm']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['Usuario_Incluir_Frm']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['Usuario_Incluir_Frm']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['Usuario_Incluir_Frm']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['Usuario_Incluir_Frm']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['Usuario_Incluir_Frm']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['Usuario_Incluir_Frm']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['Usuario_Incluir_Frm']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['Usuario_Incluir_Frm']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new Usuario_Incluir_Frm_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['initialize'])
          {
              
/*----- Scriptcase Locale: Event onApplicationInit ------*/
$_SESSION['scriptcase']['Usuario_Incluir_Frm']['contr_erro'] = 'on';
if (!isset($this->sc_temp_varNomeAplicacaoAuditoria)) {$this->sc_temp_varNomeAplicacaoAuditoria = (isset($_SESSION['varNomeAplicacaoAuditoria'])) ? $_SESSION['varNomeAplicacaoAuditoria'] : "";}
if (!isset($this->sc_temp_varIdEnderecoIpAuditoria)) {$this->sc_temp_varIdEnderecoIpAuditoria = (isset($_SESSION['varIdEnderecoIpAuditoria'])) ? $_SESSION['varIdEnderecoIpAuditoria'] : "";}
...
if(isset($_GET['a']) && substr($_GET['a'],0,4) == 'new_') {
	$sql = "UPDATE usuario SET Ativo = 'Y', CodigoAtivacao = ''" . 
		     " WHERE CodigoAtivacao = " . $this->Db->qstr($_GET['a']) . ", " .
			 " IdUsuarioAuditoria = $this->sc_temp_varIdUsuario, " . 
			 " IdEnderecoIpAuditoria = '$this->sc_temp_varIdEnderecoIpAuditoria', " .
			 " NomeAplicacaoAuditoria = '$this->sc_temp_varNomeAplicacaoAuditoria'";
 ...
 if (isset($this->sc_temp_varIdEnderecoIpAuditoria)) { $_SESSION['varIdEnderecoIpAuditoria'] = $this->sc_temp_varIdEnderecoIpAuditoria;}
 if (isset($this->sc_temp_varNomeAplicacaoAuditoria)) { $_SESSION['varNomeAplicacaoAuditoria'] = $this->sc_temp_varNomeAplicacaoAuditoria;}
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('s_Login') . "/s_Login.php", $this->nm_location, "", "_self", "ret_self", 440, 630);
 };
}
if (isset($this->sc_temp_varPrimeiraVez)) { $_SESSION['varPrimeiraVez'] = $this->sc_temp_varPrimeiraVez;}
if (isset($this->sc_temp_varIdTenacidade)) { $_SESSION['varIdTenacidade'] = $this->sc_temp_varIdTenacidade;}
...
/*----- END - Scriptcase Locale: Event onApplicationInit ------*/
      ...
      $_SESSION['sc_session'][$script_case_init]['Usuario_Incluir_Frm']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['Usuario_Incluir_Frm']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['Usuario_Incluir_Frm'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Usuario_Incluir_Frm']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Usuario_Incluir_Frm']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('Usuario_Incluir_Frm') . "/Usuario_Incluir_Frm.php";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Usuario_Incluir_Frm']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " Usuário";
      ...
      $_SESSION['scriptcase']['error_icon']['Usuario_Incluir_Frm']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['Usuario_Incluir_Frm'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }

      $this->Ini->cor_grid_par = $this->Ini->cor_grid_impar;
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "Usuario_Incluir_Frm.php"; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Usuario_Incluir_Frm']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['Usuario_Incluir_Frm'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['Usuario_Incluir_Frm'];
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['dados_form'];
          ...
          if (!isset($this->administrador)){$this->administrador = $this->nmgp_dados_form['administrador'];} 
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'Usuario_Incluir_Frm_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'Usuario_Incluir_Frm_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'Usuario_Incluir_Frm/Usuario_Incluir_Frm_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "Usuario_Incluir_Frm_erro.class.php"); 
      }
      $this->Erro      = new Usuario_Incluir_Frm_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opcao']))
         { 
             if ($this->idusuario != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['Usuario_Incluir_Frm']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['Auditoria'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['botoes']['Auditoria'];
          $this->nmgp_botoes['sc_btn_0'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['botoes']['sc_btn_0'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['Usuario_Incluir_Frm']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['Usuario_Incluir_Frm']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "Usuario_Incluir_Frm.php"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "Usuario_Incluir_Frm.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm'][$path_doc_md5][1] = $Zip_name;
?><!DOCTYPE html>
...
<form name="Fdown" method="get" action="Usuario_Incluir_Frm_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="Usuario_Incluir_Frm"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="Usuario_Incluir_Frm.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
<?php
include_once("Usuario_Incluir_Frm_sajax_js.php");
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->idusuario) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['dados_form']['idusuario']))
          {
              $varloc_btn_php['idusuario'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['dados_form']['idusuario'];
          }
      }
      $nm_f_saida = "Usuario_Incluir_Frm.php";
...
if (isset($this->rs[0][0])) {
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_Usuario_Incluir_Frm';
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['csrf_token']) && $this->scCsrfGetToken() != $this->csrf_token)
     {
          $this->Campos_Mens_erro .= (empty($this->Campos_Mens_erro)) ? "" : "<br />";
          $this->Campos_Mens_erro .= "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_Usuario_Incluir_Frm']) || !is_array($this->NM_ajax_info['errList']['geral_Usuario_Incluir_Frm']))
              {
                  $this->NM_ajax_info['errList']['geral_Usuario_Incluir_Frm'] = array();
              }
              $this->NM_ajax_info['errList']['geral_Usuario_Incluir_Frm'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_nome(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['php_cmp_required']['nome']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['php_cmp_required']['nome'] == "on")) 
      { 
          if ($this->nome == "")  
          { 
              $hasError = true;
      ...
      { 
          ...
          if (NM_utf8_strlen($this->nome) < 4) 
          { 
              $hasError = true;
              $Campos_Crit .= "Nome " . $this->Ini->Nm_lang['lang_errm_mnch'] . " 4 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['nome']))
              {
                  $Campos_Erros['nome'] = array();
              }
              $Campos_Erros['nome'][] = $this->Ini->Nm_lang['lang_errm_mnch'] . " 4 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['nome']) || !is_array($this->NM_ajax_info['errList']['nome']))
              {
                  $this->NM_ajax_info['errList']['nome'] = array();
              }
              $this->NM_ajax_info['errList']['nome'][] = $this->Ini->Nm_lang['lang_errm_mnch'] . " 4 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_login(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if (($this->nmgp_opcao == "incluir" || 'validate_login' == $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['php_cmp_required']['login']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['php_cmp_required']['login'] == "on"))
      { 
          if ($this->login == "")  
          { 
              $hasError = true;
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "Login " . $this->Ini->Nm_lang['lang_errm_mnch'] . " 4 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['login']))
              {
                  $Campos_Erros['login'] = array();
              }
    ...
    function ValidateField_email(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['php_cmp_required']['email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['php_cmp_required']['email'] == "on") 
          { 
              $hasError = true;
              $Campos_Falta[] = "E-mail" ; 
              if (!isset($Campos_Erros['email']))
    ...
    function ValidateField_senha(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if (($this->nmgp_opcao == "incluir" || 'validate_senha' == $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['php_cmp_required']['senha']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['php_cmp_required']['senha'] == "on"))
      { 
          if ($this->senha == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_confirm_pswd(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if (($this->nmgp_opcao == "incluir" || 'validate_confirm_pswd' == $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['php_cmp_required']['confirm_pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['php_cmp_required']['confirm_pswd'] == "on"))
      { 
          if ($this->confirm_pswd == "")  
          { 
              $hasError = true;
              $Campos_Falta[] =  "Confirme sua senha" ; 
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "Confirme sua senha " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 32 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['confirm_pswd']))
              {
                  $Campos_Erros['confirm_pswd'] = array();
              }
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "Confirme sua senha " . $this->Ini->Nm_lang['lang_errm_mnch'] . " 4 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['confirm_pswd']))
              {
                  $Campos_Erros['confirm_pswd'] = array();
              }
   ...
   if (isset($this->Field_no_validate['indicadorfinanceiro'])) {
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['Lookup_indicadorfinanceiro']) && !in_array($this->indicadorfinanceiro, $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['Lookup_indicadorfinanceiro']))
          {
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['acessoauditoria'])) {
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['Lookup_acessoauditoria']) && !in_array($this->acessoauditoria, $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['Lookup_acessoauditoria']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_descontomaximoimp(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "Desconto máximo único (%): " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "Desconto máximo único (%); " ; 
                  if (!isset($Campos_Erros['descontomaximoimp']))
                  {
                      $Campos_Erros['descontomaximoimp'] = array();
                  }
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idusuario']['keyVal'] = Usuario_Incluir_Frm_pack_protect_string($this->nmgp_dados_form['idusuario']);
          }
   } // ajax_return_values
...
$aLookup[] = array(Usuario_Incluir_Frm_pack_protect_string('S') => str_replace('<', '&lt;',Usuario_Incluir_Frm_pack_protect_string("Sim")));
$aLookup[] = array(Usuario_Incluir_Frm_pack_protect_string('N') => str_replace('<', '&lt;',Usuario_Incluir_Frm_pack_protect_string("Não")));
$_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['Lookup_indicadorfinanceiro'][] = 'S';
$_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['Lookup_indicadorfinanceiro'][] = 'N';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['indicadorfinanceiro']['valList'][$i] = Usuario_Incluir_Frm_pack_protect_string($v);
          }
...
$aLookup[] = array(Usuario_Incluir_Frm_pack_protect_string('S') => str_replace('<', '&lt;',Usuario_Incluir_Frm_pack_protect_string("Sim")));
$aLookup[] = array(Usuario_Incluir_Frm_pack_protect_string('N') => str_replace('<', '&lt;',Usuario_Incluir_Frm_pack_protect_string("Não")));
$_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['Lookup_acessoauditoria'][] = 'S';
$_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['Lookup_acessoauditoria'][] = 'N';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['acessoauditoria']['valList'][$i] = Usuario_Incluir_Frm_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_nomeaplicacaoauditoria($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['upload_dir'][$fieldName][] = $newName;
  ...
  function nm_proc_onload($bFormat = true)
  {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['Field_no_validate'] = array();
      if ($this->sc_evento == "novo" || $this->sc_evento == "incluir" || ($this->nmgp_opcao == "nada" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opc_ant']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opc_ant'] == "novo") || (isset($GLOBALS['erro_incl']) && 1 == $GLOBALS['erro_incl']))
      {
      }
      else
      {
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->idusuario)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opcao'] = '';
...
/*----- END - Scriptcase Locale: Event onBeforeInsert ------*/
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "IdTenacidade = $this->idtenacidade, IdUsuarioAuditoria = $this->idusuarioauditoria, Nome = '$this->nome', IndicadorFinanceiro = '$this->indicadorfinanceiro', DescontoMaximoImp = $this->descontomaximoimp, DescontoMaximoMes = $this->descontomaximomes, AcessoAuditoria = '$this->acessoauditoria', EnderecoIpAuditoria = '$this->enderecoipauditoria', NomeAplicacaoAuditoria = '$this->nomeaplicacaoauditoria'"; 
              } 
              ...
              $Prep_Tst = (isset($NM_val_form['login']) && $NM_val_form['login'] == "null"  && $this->nmgp_dados_select['login'] == "") ? "null" : $this->nmgp_dados_select['login'];
              if (isset($NM_val_form['login']) && $NM_val_form['login'] != $Prep_Tst) 
              { 
              ...
              $Prep_Tst = (isset($NM_val_form['ativo']) && $NM_val_form['ativo'] == "null"  && $this->nmgp_dados_select['ativo'] == "") ? "null" : $this->nmgp_dados_select['ativo'];
              if (isset($NM_val_form['ativo']) && $NM_val_form['ativo'] != $Prep_Tst) 
              { 
              ...
              $Prep_Tst = (isset($NM_val_form['administrador']) && $NM_val_form['administrador'] == "null"  && $this->nmgp_dados_select['administrador'] == "") ? "null" : $this->nmgp_dados_select['administrador'];
              if (isset($NM_val_form['administrador']) && $NM_val_form['administrador'] != $Prep_Tst) 
              { 
                  $SC_fields_update[] = "Administrador = '$this->administrador'"; 
              } 
             ...
             { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              $this->nmgp_refresh_fields = array_diff(array('nome', 'idusuario', 'login', 'email', 'senha', 'confirm_pswd', 'indicadorfinanceiro', 'acessoauditoria', 'descontomaximoimp', 'descontomaximomes', 'idtenacidade', 'idusuarioauditoria', 'enderecoipauditoria', 'nomeaplicacaoauditoria'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (IdTenacidade, IdUsuarioAuditoria, Nome, Login, Senha, Email, Ativo, IndicadorFinanceiro, CodigoAtivacao, Administrador, DescontoMaximoImp, DescontoMaximoMes, AcessoAuditoria, EnderecoIpAuditoria, NomeAplicacaoAuditoria) VALUES ($this->idtenacidade, $this->idusuarioauditoria, '$this->nome', '$this->login', '$this->senha', '$this->email', '$this->ativo', '$this->indicadorfinanceiro', '$this->codigoativacao', '$this->administrador', $this->descontomaximoimp, $this->descontomaximomes, '$this->acessoauditoria', '$this->enderecoipauditoria', '$this->nomeaplicacaoauditoria')"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
...
/*----- END - Scriptcase Locale: Event onAfterInsert ------*/
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['parms'] = "idusuario?#?$this->idusuario?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          $nmgp_select = "SELECT IdUsuario, IdTenacidade, IdUsuarioAuditoria, Nome, Login, Senha, Email, Ativo, IndicadorFinanceiro, CodigoAtivacao, Administrador, DescontoMaximoImp, DescontoMaximoMes, AcessoAuditoria, EnderecoIpAuditoria, NomeAplicacaoAuditoria from " . $this->Ini->nm_tabela ; 
          $aWhere = array();
          $aWhere[] = $sc_where_filter;
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['dados_select'] = $this->nmgp_dados_select;
...
//-- 
      ...
      { 
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }

//

/*----- Scriptcase Locale: PHP Method: act_code ------*/
...
/*----- END - Scriptcase Locale: PHP Method: act_code ------*/
...
/*----- Scriptcase Locale: PHP Method: send_mail_to_new_user ------*/
...
$update_sql = 'UPDATE usuario'
    . ' SET CodigoAtivacao = ' . $this->Db->qstr($act_code)
...
/*----- END - Scriptcase Locale: PHP Method: send_mail_to_new_user ------*/
...
$_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['Field_disabled_macro']['idtenacidade'] = array('I'=>array(),'U'=>array());
;
			$this->sc_field_readonly("idusuarioauditoria", 'on');
$_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['Field_disabled_macro']['idusuarioauditoria'] = array('I'=>array(),'U'=>array());
;
			$this->sc_field_readonly("enderecoipauditoria", 'on');
$_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['Field_disabled_macro']['enderecoipauditoria'] = array('I'=>array(),'U'=>array());
;
			$this->sc_field_readonly("nomeaplicacaoauditoria", 'on');
$_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['Field_disabled_macro']['nomeaplicacaoauditoria'] = array('I'=>array(),'U'=>array());
;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("Usuario_Incluir_Frm_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        $searchOk = false;
        if ('SC_all_Cmp' == $this->nmgp_fast_search && in_array($field, array("idusuario", "login", "senha", "nome", "email", "ativo", "codigoativacao", "administrador"))) {
            $searchOk = true;
        }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['dyn_search_cache']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['empty_filter']);
      ...
      foreach ($fields as $field) {
          ...
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "Ativo", $arg_search, $data_search, "VARCHAR", false);
          }
          if ($field == "SC_all_Cmp") 
          {
          ...
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "Administrador", $arg_search, $data_search, "VARCHAR", false);
          }
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_Usuario_Incluir_Frm = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['total'] = $qt_geral_reg_Usuario_Incluir_Frm;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          Usuario_Incluir_Frm_pack_ajax_response();
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "Usuario_Incluir_Frm_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['nm_run_menu'] = 2;
       $nmgp_saida_form = "Usuario_Incluir_Frm_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['Usuario_Incluir_Frm']['ordem_ord'] == " desc") {
