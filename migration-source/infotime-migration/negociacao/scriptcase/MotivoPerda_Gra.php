<?php
   include_once('MotivoPerda_Gra_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_perfil']          = "ligasistemas";
   $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class MotivoPerda_Gra_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "MotivoPerda_Gra"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['MotivoPerda_Gra']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['MotivoPerda_Gra']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['MotivoPerda_Gra']['save_session']['data'] = '';
      } 
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['sub_cons_schema_all']))
      { 
         $this->str_schema_all    = $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['sub_cons_schema_all'];
         $this->str_schema_filter = $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['sub_cons_schema_filter'];
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/MotivoPerda_Gra';
      ...
      $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['MotivoPerda_Gra']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['MotivoPerda_Gra']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['MotivoPerda_Gra']['actual_lang']) || $_SESSION['scriptcase']['MotivoPerda_Gra']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['MotivoPerda_Gra']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("MotivoPerda_Gra_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if (!$_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['embutida'])
    {
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['grid_search_add']['cmp'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['grid_search_add']['seq'] = $_POST['seq'];
          $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
    }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['remove_border']   = false;
          $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['remove_background'] = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
              if (isset($_GET['remove_background'])) {
                  $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['remove_background'] = 1 == $_GET['remove_background'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
              if (isset($remove_background)) {
                  $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['remove_background'] = 1 == $remove_background;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["MotivoPerda_Gra"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["MotivoPerda_Gra"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) || isset($link_remove_margin) || isset($link_remove_border) || isset($link_remove_background) || isset($link_margin_top)) {
            $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['link_info'] = array();
        }
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['link_info']['remove_border'] = true;
        }
        if (isset($link_remove_background) && 'ok' == $link_remove_background) {
            $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['link_info']['remove_background'] = true;
        }
        if (isset($link_margin_top) && '' != $link_margin_top) {
            $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['link_info']['margin_top'] = $link_margin_top;
        }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['responsive_chart'] = array(
              'enabled' => true,
              'active'  => true,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['MotivoPerda_Gra']['session_timeout']['redir']))
      {
      ...
      if (isset($_POST['nm_grid_submit']) && $_POST['nm_grid_submit'] == 1 && isset($_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['csrf_token'] ) && !isset($_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['embutida']) && !isset($_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['embutida_form'])) {
          if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] != $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['csrf_token']) {
              echo "<html>";
              echo "<body>";
              echo "<table align=\"center\" width=\"50%\" border=1 height=\"50px\">";
              echo "<tr>";
      ...
      $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['path_doc'] = $this->path_doc; 
...
<body>
    <div class='ui container' style='padding-top:2rem'>
        <section class='ui message'>
         ...
         echo $str_message;
          if (!$_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "MotivoPerda_Gra_erro.class.php"); 
      $this->Erro = new MotivoPerda_Gra_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('MotivoPerda_Gra'); 
// 
      $this->sc_Include($this->path_lib_php . "/nm_functions.php", "", "") ; 
      global $bol_api_prod; 
      $bol_api_prod = true; 
      if (isset($_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_conexao'])) 
      { 
          $bol_api_prod = false; 
      } 
      ...
      if (isset($_SESSION['scriptcase']['MotivoPerda_Gra']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['MotivoPerda_Gra']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['MotivoPerda_Gra']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['MotivoPerda_Gra']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['MotivoPerda_Gra']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['MotivoPerda_Gra']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      {
          $this->nm_tabela = "negociacao n  inner join negociacaopropostafase p on (n.IdNegociacao = p.IdNegociacao and p.IdPropostaFase = 14 and p.IdSituacaoFase = 4 and p.IdNegociacaoMotivoPerda > 0)"; 
      }
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_conexao']) && $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_perfil']) && $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['MotivoPerda_Gra']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      ...
      if (isset($_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['embutida_init']) 
      {
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_conexao'], $this->root . $this->path_prod, 'LIGA_InfoTIME', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['embutida'])
      {
...
// 
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['csrf_token']))
       {
           $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['csrf_token'] = $this->scCsrfGenerateToken();
       }

       return $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['csrf_token'];
   }
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['MotivoPerda_Gra']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
class MotivoPerda_Gra_sub_css
{
   function __construct()
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['MotivoPerda_Gra']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['MotivoPerda_Gra'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class MotivoPerda_Gra_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['MotivoPerda_Gra']))
      { 
          $GLOBALS['nmgp_parms'] = $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['MotivoPerda_Gra'];
          $Parms_form_pdf = true;
      } 
      if ($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida'] || $Parms_form_pdf)
      { 
          ...
          { 
              ...
              foreach ($todo as $param)
              {
                   ...
                   if (1 < sizeof($cadapar))
                   {
                       ...
                       nm_limpa_str_MotivoPerda_Gra($cadapar[1]);
                       nm_protect_num_MotivoPerda_Gra($cadapar[0], $cadapar[1]);
                       if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                       $Tmp_par   = $cadapar[0];
                       $$Tmp_par = $cadapar[1];
                       if ($Tmp_par == "nmgp_opcao")
                       {
                           $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['opcao'] = $cadapar[1];
                       }
                   }
              }
          } 
          ...
          if (isset($varIdTenacidade)) 
          {
              ...
              nm_limpa_str_MotivoPerda_Gra($_SESSION["varIdTenacidade"]);
          }
      } 
      if ($Parms_form_pdf)
      { 
          $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_pdf'] = true;
          $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_form'] = true;
          $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_form_full'] = false;
          $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_pai'] = "";
      } 
      $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_ibase'])) 
      { 
          $this->Ini = new MotivoPerda_Gra_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida_ibase'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
      if (!isset($nmgp_opcao)) {
         $nmgp_opcao = "";
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'])) {
         $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = "";
      }
       if ($nmgp_opcao == "link_res")  
       { 
           $nmgp_opcao = "inicio";  
           $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = "inicio";  
           $Temp_parms = "";  
           ...
           foreach ($todo as $param)
           {
                ...
                if ($cadapar[0] == "p_idnegociacaomotivoperda")  
                { 
                    $cadapar[0] = str_replace("p_idnegociacaomotivoperda", "p.IdNegociacaoMotivoPerda", $cadapar[0]);
                } 
                if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_Ind_Groupby'] == "sc_free_group_by")
                { 
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['where_resumo'] = $Temp_parms;
       } 
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['MotivoPerda_Gra']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['MotivoPerda_Gra'];
          }
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['MotivoPerda_Gra']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['MotivoPerda_Gra']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('MotivoPerda_Gra') . "/MotivoPerda_Gra.php";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['MotivoPerda_Gra']['label'] = "" . $this->Ini->Nm_lang['lang_othr_chart_title'] . " negociacaotarefa";
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida'])
      {
          $this->Change_Menu = false;
      }
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("pt_br");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "MotivoPerda_Gra/MotivoPerda_Gra_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "MotivoPerda_Gra_erro.class.php"); 
      } 
      $this->Erro      = new MotivoPerda_Gra_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "MotivoPerda_Gra/MotivoPerda_Gra_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "MotivoPerda_Gra_lookup.class.php"); 
      } 
      $this->Lookup       = new MotivoPerda_Gra_lookup();
      $this->Lookup->Db   = $this->Db;
      $this->Lookup->Ini  = $this->Ini;
      $this->Lookup->Erro = $this->Erro;
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "MotivoPerda_Gra.php" ; 
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_export")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = $nmgp_opcao;
              if ($nmgp_opcao == "print" || $nmgp_opcao == "res_print" || $nmgp_opcao == "det_print")
              {
                  $ajax_opc_print   = true;
                  $nm_arquivo_print = "/sc_MotivoPerda_Gra_" . session_id();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['ajax_nav'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['scroll_navigate'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['scroll_navigate_reload'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['scroll_navigate_app'] = false;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['scroll_navigate_header_row']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['scroll_navigate_header_row'] = 1;
          }
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['ajax_nav'] = true;
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['save_grid'] = true;
              }
              ...
              {
                  $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['contr_total_geral'] = "NAO";
                  $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['contr_array_resumo'] = "NAO";
                  unset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['tot_geral']);
                  unset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['arr_total']);
                  unset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['using_summary_cache']);
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_Gb_date_format'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_Gb_date_format'] = array();
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_All_Groupby'] = array('sc_free_group_by' => 'all');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if ($Tp == "grid")
              {
                  continue;
              }
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_Ind_Groupby'] = $Ind;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_Gb_Free_cmp'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_Gb_Free_cmp']  = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_Gb_Free_sql']  = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_Gb_Free_orig'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_Gb_Free_cmp']['p_idnegociacaomotivoperda'] = "p.IdNegociacaoMotivoPerda";
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_Gb_Free_sql']['p_idnegociacaomotivoperda']["p.IdNegociacaoMotivoPerda"] = 'asc';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['Labels_GB'] = array();
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_Ind_Groupby'] == "sc_free_group_by")
      {
          $Arr_free_labels = array();
          $Arr_free_labels['p_idnegociacaomotivoperda'] = "Motivo";
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_Gb_Free_cmp'] as $Field => $Label)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['Labels_GB'][] = $Arr_free_labels[$Field];
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['summarizing_fields_display']['sc_free_group_by'][2]['display'] = true;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['summarizing_fields_control']['sc_free_group_by']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['summarizing_fields_control']['sc_free_group_by'] = array(
               array(
                   'cmp_res' => "NM_Count",
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['dados_orig_gb']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['dados_orig_gb'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['dados_orig_gb']['all']['SC_Ind_Groupby'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_Ind_Groupby']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['dados_orig_gb']['all']['SC_Ind_Groupby'] = $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_Ind_Groupby'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_Gb_Free_cmp']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_Gb_Free_cmp'];
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['dados_orig_gb']['res']['summarizing_fields_display'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['dados_orig_gb']['res']['summarizing_fields_order']   = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['dados_orig_gb']['res']['summarizing_fields_control'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['dados_orig_gb']['res']['pivot_x_axys']               = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['summarizing_fields_display']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['dados_orig_gb']['res']['summarizing_fields_display'] = $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['summarizing_fields_display'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['summarizing_fields_order']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['dados_orig_gb']['res']['summarizing_fields_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['summarizing_fields_order'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['summarizing_fields_control']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['dados_orig_gb']['res']['summarizing_fields_control'] = $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['summarizing_fields_control'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pivot_x_axys']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['dados_orig_gb']['res']['pivot_x_axys'] = $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pivot_x_axys'];
          }
      }
      $this->Ini->Apl_resumo  = "MotivoPerda_Gra_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "MotivoPerda_Gra_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['SC_Ind_Groupby'] . ".class.php"; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['xls_return']  = ($nmgp_opcao == "xls")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['csv_return']  = ($nmgp_opcao == "csv")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['xml_return']  = ($nmgp_opcao == "xml")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['json_return'] = ($nmgp_opcao == "json") ? "volta_grid" : "resumo"; 
      ...
      if ($nmgp_opcao == 'print' || $nmgp_opcao == 'res_print') {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['print_return'] = $this->ret_print;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida'])
      {
          if ($this->Ini->Export_html_zip)
          {
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['html_name']))
              {
                  $nm_arquivo_html = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['html_name'];
              }
              elseif ($nmgp_opcao == 'print' && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
              {
                  $nm_arquivo_html = "/sc_MotivoPerda_Gra_" . session_id() . ".html";
              }
              else
              {
                  $nm_arquivo_html = "/sc_MotivoPerda_Gra_res_" . session_id() . ".html";
              }
      ...
      if ($nmgp_opcao == "doc_word") {  
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['word_return'] = $this->ret_word;
          $_SESSION['scriptcase']['proc_mobile'] = false;
      }
      ...
      { 
          $nmgp_opcao = "doc_word"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = "doc_word"; 
      }
      elseif ($nmgp_opcao == "doc_word" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "doc_word_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = "doc_word_res"; 
      }
      if ($nmgp_opcao == "xls_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xls"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = "xls"; 
      }
      elseif ($nmgp_opcao == "xls" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xls_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = "xls_res"; 
      }
      if ($nmgp_opcao == "csv_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "csv"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = "csv"; 
      }
      elseif ($nmgp_opcao == "csv" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "csv_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = "csv_res"; 
      }
      if ($nmgp_opcao == "xml_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xml"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = "xml"; 
      }
      elseif ($nmgp_opcao == "xml" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xml_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = "xml_res"; 
      }
      if ($nmgp_opcao == "json_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "json"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = "json"; 
      }
      elseif ($nmgp_opcao == "json" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "json_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = "json_res"; 
      }
      $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['skip_summary'] = false;
      if ('chart' == $this->Ini->SC_module_export) {
          $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['skip_summary'] = true;
          $this->Ini->SC_module_export = 'resume,chart';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pdf_det'] = false;
      if ($nmgp_opcao == 'pdf')
      { 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
          }
          else
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pdf_res'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['conf_chart_level'] = "S";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['graf_disp']))
      {
          $thisChartWidth = '800';
          $thisChartHeight = '600';
          if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['MotivoPerda_Gra'] ['responsive_chart'] ['active']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['MotivoPerda_Gra'] ['responsive_chart'] ['active']) {
              $thisChartWidth = '100%';
              $thisChartHeight = '85%';
          } elseif (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['MotivoPerda_Gra'] ['responsive_chart'] ['active']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['MotivoPerda_Gra'] ['responsive_chart'] ['active']) {
              $thisChartWidth = '800';
              $thisChartHeight = '600';
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['graf_disp'] = array('Bar');
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_tipo'] = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_larg'] = $thisChartWidth;
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_alt'] = $thisChartHeight;
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['graf_opc_atual'] = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['graf_mod_allowed'] = array(1, 2);
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['graf_order'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_font'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['graf_subtitle_val'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['chartpallet'] = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['graf_exibe_val'] = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['chart_has_enable_scroll'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['chart_show_enable_scroll'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['chart_enable_scroll'] = 'N';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['paletteColors']     = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_barra_orien'] = 'Vertical';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_barra_forma'] = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_barra_dimen'] = '2d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_barra_sobre'] = 'No';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_barra_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_barra_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_barra_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_barra_funil'] = 'N';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_barra_funil'] = 'N';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_barra_is_scroll'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_barra_is_overlapped'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_barra_is_overlapped'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_pizza_forma'] = 'Pie';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_pizza_dimen'] = '2d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_pizza_orden'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_pizza_explo'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_pizza_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_linha_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_linha_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_linha_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_linha_is_scroll'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_linha_is_zoom'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_area_forma']  = 'Area';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_area_empil']  = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_area_inver']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_area_agrup']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_area_is_scroll']  = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_marca_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_marca_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_gauge_forma'] = 'Circular';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_radar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_radar_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_polar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_funil_dimen'] = '2d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_funil_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_pyram_dimen'] = '2d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_pyram_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_pyram_forma'] = 'S';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cfg_graf']['graf_combi_dimen'] = '2d';
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['summarizing_drill_down'])) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['summarizing_drill_down'] = true;
          }
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida_treeview'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida_opcao']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida_opcao'] = "";
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['proc_pdf'] = (!$_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] == "pdf_res")) ? true : false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['proc_pdf']) {
          $_SESSION['scriptcase']['proc_mobile'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['proc_pdf_vert'] = false;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['field_order']))
      { 
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['usr_cmp_sel']))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['usr_cmp_sel'] = array();
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['usr_cmp_sel_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['usr_cmp_sel'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['MotivoPerda_Gra']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['MotivoPerda_Gra']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['MotivoPerda_Gra']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      if (!$_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida'])
      { 
      ...
      if (!$_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida'])
      { 
          $this->pdf_zip = (isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['opc_pdf']['pdf_zip'])) ? $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['opc_pdf']['pdf_zip'] : "N";
          $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['use_pass_pdf'] = "";
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['where_orig'])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = "inicio";//=)
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['MotivoPerda_Gra']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['MotivoPerda_Gra']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = "busca";
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opc_liga'] = $NMSC_conf_apl;  
          }   
      }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opc_liga']['paginacao'];
          } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] == "print")  
      { 
          if (strpos(" " . $this->Ini->SC_module_export, "grid") === false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = "res_print";
          }
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['print_all'] = true;
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = "print";
              $nmgp_tipo_print = "RC";
          }
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] == "pdf")
      { 
      ...
      if (isset($_POST['nmgp_opcao']) && 'resumo' == $_POST['nmgp_opcao']
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['contr_array_resumo'] = 'NAO';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['contr_total_geral'] = 'NAO';
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['tot_geral']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['using_summary_cache']);
      }

      $this->Ini->grid_search_change_fil = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] == "grid_search" || $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] == "grid_search_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] == "grid_search")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] == "grid_search_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['orig_pesq'] = 'res';
          } 
          $this->SC_proc_grid_search($_POST['parm']);
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['where_pesq'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['contr_array_resumo'] = "NAO";
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['contr_total_geral']  = "NAO";
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['tot_geral']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['using_summary_cache']);
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = 'pesq';
          ob_end_clean();
          $this->Ini->Arr_result = array();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] == "grid_search_change_fil" || $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] == "grid_search_change_fil_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] == "grid_search_change_fil")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] == "grid_search_change_fil_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['orig_pesq'] = 'res';
          } 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "MotivoPerda_Gra_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "MotivoPerda_Gra_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new MotivoPerda_Gra_pesq();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = 'inicio';
          } 
      } 
      if ('gantt' == $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] && ('inicio' == $_GET['nmgp_opcao'] || 'inicio' == $_POST['nmgp_opcao'])) {
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = 'inicio';
      }
//
      $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['prim_cons'] = false;  
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['use_pass_pdf']);
       if (!$GLOBALS['nm_restore_grid_save']) { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['prim_cons'] = true;  
         $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['where_orig'] = " where n.Ativo = 'N' and n.Idtenacidade = '" . $_SESSION['varIdTenacidade'] . "'";
         $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['cond_pesq']         = ""; 
         $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['where_pesq_filtro'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['where_pesq_lookup'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['campos_busca']      = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['grid_pesq']         = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['Grid_search']       = array();
       }
         $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['contr_total_geral'] = "NAO";
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['sc_total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['tot_geral']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['using_summary_cache']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['contr_array_resumo'] = "NAO";
      } 
      if (!in_array($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'], array('config_print', 'word_res', 'xls_res', 'xml_res', 'json_res', 'csv_res', 'rtf_res', 'image_res', 'ajax_comb_table', 'ajax_comb_save', 'ajax_comb_file_view', 'ajax_comb_file_download'))) {
      $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['where_pesq_ant'];  
      }
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_MotivoPerda_Gra_html_" . session_id() . "_2.html";
            $nm_arquivo_pdf_base = "/sc_pdf_" . md5(date("Ymd") . "_" . session_id()) . "_MotivoPerda_Gra.pdf";
            $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_MotivoPerda_Gra_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_MotivoPerda_Gra_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($this->NM_ajax_opcao == "ajax_comb_table")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida'])
          {
              require_once($this->Ini->path_embutida . "MotivoPerda_Gra/" . $this->Ini->Apl_resumo);
          }
          else 
          {
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['comb_field_display_type'][ $_POST['sumcfg_field'] ] = $_POST['sumcfg_value'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['chart_display_values'][ $_POST['sumcfg_field'] ]    = 1 == $_POST['sumcfg_display'];
          echo 'ok';
          exit;
      }
      else
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['chart_combination_order_rule']   = 'asc' == $_POST['sort_option'] || 'desc' == $_POST['sort_option'] ? $_POST['sort_option'] : '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['chart_combination_order_field']  = $_POST['sort_field'];
          if ('orig' == $_POST['sort_option'])
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['chart_combination_order_forced'] = false;
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['chart_combination_order_forced'] = true;
          }
          echo 'ok';
          exit;
      }
      ...
      {
          if (!isset($_SESSION['scriptcase']['chart_export_file']['MotivoPerda_Gra']) || !isset($_SESSION['scriptcase']['chart_export_file']['MotivoPerda_Gra'][ $_REQUEST['chart_file_md5'] ]))
          {
              echo 'error_file_not_found';
          }
          else
          {
              echo $this->Ini->path_imag_temp . '/' . $_SESSION['scriptcase']['chart_export_file']['MotivoPerda_Gra'][ $_REQUEST['chart_file_md5'] ]['name'];
          }
          exit;
      }
      else
      if ($nmgp_opcao == "ajax_comb_file_download")
      {
          ...
          {
              $filename = $_SESSION['scriptcase']['chart_export_file']['MotivoPerda_Gra'][ $_REQUEST['chart_file_md5'] ]['name'];
              $path     = $_SESSION['scriptcase']['chart_export_file']['MotivoPerda_Gra'][ $_REQUEST['chart_file_md5'] ]['dir'] . $filename;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] == "print_res" || $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] == "res_print")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida'])
          {
              require_once($this->Ini->path_embutida . "MotivoPerda_Gra/" . $this->Ini->Apl_resumo);
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao']);
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['export_progress_file']  = $_POST['export_progress_file'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['export_progress_step']  = 'init';
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['export_progress_count'] = 0;
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['export_progress_total'] = 0;
          $this->outputCombinationPrint();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] == "config_print")
      { 
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao']);
    ...
    if (isset($_POST['chartapp_action']) && 'Y' == $_POST['chartapp_action']) {
        if (isset($_POST['chartapp_chart_type']) && 'Y' == $_POST['chartapp_chart_type'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['chart_info'][$_POST['chart_md5']])) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida']) {
                require_once($this->Ini->path_embutida . "MotivoPerda_Gra" . $this->Ini->Apl_resumo);
            } else {
                require_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo);
            }
            $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['chart_app_change_type'] = true;
            $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['chart_app_md5'] = $_POST['chart_md5'];
            $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['chart_app_type'] = $_POST['chart_type'];
            $this->Res = new MotivoPerda_Gra_resumo("out");
            $this->prep_modulos("Res");
            $this->Res->monta_resumo();
        } else {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['embutida']) {
                require_once($this->Ini->path_embutida . "MotivoPerda_Gra" . $this->Ini->Apl_grafico);
            } else {
                require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico);
            }
            $this->Graf = new MotivoPerda_Gra_grafico();
      ...
      { 
          ...
          $this->Graf  = new MotivoPerda_Gra_grafico();
          $this->prep_modulos("Graf");
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'], 8));
              $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = "grid";
          }
          else
          { 
              if (isset($_POST['summary_chart_data']) && 'Y' == $_POST['summary_chart_data'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['chart_info'][$_POST['chart_md5']])) {
                  $this->Graf->display_summaryChart_data($_POST['chart_md5']);
              }
              elseif (isset($_POST['summary_chart']) && 'Y' == $_POST['summary_chart'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['chart_info'][$_POST['chart_md5']])) {
              ...
              elseif (isset($_POST['chart_inline_update']) && 'Y' == $_POST['chart_inline_update'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['chart_info'][$_POST['chart_md5']])) {
                  $this->Graf->display_summaryChart_inline_updateAjaxResponse($_POST['chart_md5']);
              }
              elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['dashboard_refresh_after_chart'])) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['dashboard_refresh_after_chart'];
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['dashboard_refresh_after_chart']);
              }
              else {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] = "grid";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "MotivoPerda_Gra_pesq.class.php"); 
      ...
      { 
          ...
          $this->Res = new MotivoPerda_Gra_resumo();
          $this->prep_modulos("Res");
          $this->Res->monta_resumo();
      }   
//--- 
...
<?php
      ...
      {
         $nm_saida->finaliza();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['ajax_nav'])
         {
             $Temp = ob_get_clean();
             ...
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['opcao'] != "ajax_detalhe")  
             {
            ...
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['export_sel_columns']['field_order']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['export_sel_columns']['field_order'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['export_sel_columns']['field_order']);
            }
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['export_sel_columns']['usr_cmp_sel']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['export_sel_columns']['usr_cmp_sel'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['export_sel_columns']['usr_cmp_sel']);
            }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['doc_word'])
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['word_file'] = $this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    MotivoPerda_Gra_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . $this->grid->progress_tot . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                    fwrite($this->grid->progress_fp, ($this->grid->progress_tot) . "_#NM#_" . $lang_protect . "...\n");
                    fclose($this->grid->progress_fp);
                }
            }
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pdf_name']))
            {
                $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pdf_name'], ".");
                if ($Pos === false) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pdf_name'] .= ".pdf";
                }
                if ('/' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pdf_name'], 0, 1)) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pdf_name'] = substr($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pdf_name'], 1);
                }
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pdf_name']);
            }
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['use_pass_pdf'];
            ...
            $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['contr_array_resumo'] = '';
            $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['contr_total_geral']  = '';
            // ----- PDF log
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    if ($this->grid->progress_fp)
                    {
                        ...
                        MotivoPerda_Gra_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . ($this->grid->progress_now + 1 + $this->grid->progress_pdf) . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                        MotivoPerda_Gra_pdf_progress_call("off\n", $this->Ini->Nm_lang);
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pdf_file'] = $nm_arquivo_pdf_serv;
}
if ($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pdf_det'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_chart_title'] ?> negociacaotarefa :: PDF</TITLE>
...
<?php
                    ...
                    fwrite($rRFP, "off\n");
                    fclose($rRFP);
$downloadFileName = "MotivoPerda_Gra.pdf";
if ($this->pdf_zip == 'S') {
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][md5("newpdf_" . $downloadFileName)][0] = $nm_arquivo_pdf_url;
    $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][md5("newpdf_" . $downloadFileName)][1] = $downloadFileName;
}
...
?>
<FORM name="F0" method=post action="MotivoPerda_Gra.php" target="<?php echo $NM_target; ?>"> 
...
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableDef]['label'] as $series_name)
        {
...
<?php
        $this->outputCombinationTableRow($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableData], 0, $tableDef);
?>
</table>
<?php
        exit;
...
<?php
            ...
            {
?>
  <td class="scGridFieldOdd scGridFieldOddFont" style="text-align: right"><?php echo MotivoPerda_Gra_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableDef]['summ'][$index], $value); ?></td>
<?php
            }
?>
 </tr>
<?php
	...
	function outputCombinationZipPassword($type, $fileName, $password) {
		$zipCommand  = "";
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_imag_temp'] . '/';
	...
	function outputCombinationData() {
		if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['anlt_table_def']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['anlt_table_def'])) {
	...
	function outputCombinationExport($type, $content, $password) {
		...
		$fileName = "sc_{$type}_{$dateTime}_{$fileSeq}_MotivoPerda_Gra.{$type}";
		...
		if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$testFilename . '_name'])) {
			$fileName = $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$testFilename . '_name'];
		}
		...
		if (!isset($_SESSION['scriptcase']['chart_export_file']['MotivoPerda_Gra'])) {
			$_SESSION['scriptcase']['chart_export_file']['MotivoPerda_Gra'] = array();
		}
		$_SESSION['scriptcase']['chart_export_file']['MotivoPerda_Gra'][$fileMd5] = array(
			'dir'  => $fileDir,
			'name' => $fileName
		);
		...
		switch ($type) {
			...
			case 'html':
				if ($this->Ini->sc_export_ajax) {
					$_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['export_print_files'][] = $fileName;

					$this->outputCombinationEmail($this->Res->zipFileList($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['export_print_files']));
				}
				else {
...
<form name="form_chart_export_download" method="get" action="MotivoPerda_Gra.php" target="_blank" style="display: none">
...
SCEOT;
	...
	function outputCombinationPrintConfig() {
		...
		$hasOneGroupByLevel = 1 >= count($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['Labels_GB']);
		$isMultiSeriesChart = !isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['summarizing_drill_down']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['summarizing_drill_down'];
...
SCEOT;
		...
		$lastGroupby = count($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['Labels_GB']) - 1;
		foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['Labels_GB'] as $groupbyIndex => $groupbyLabel) {
...
SCEOT;
	...
	function outputCombinationPrintCss() {
		if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['chart_export_print_css'])) {
			$_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['chart_export_print_css'] = 'color';
		}

		if ('bw' == $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['chart_export_print_css']) {
	...
	function outputCombinationPrintCharts() {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['export_print_bw'] = isset($_POST['export_chart_bw']) && 'Y' == $_POST['export_chart_bw'];

		$chartImages = $this->Res->generateChartImages();

		$_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['export_print_bw'] = false;
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['export_print_files'] = $chartImages;
    ...
    {
        $jsonData = $this->outputCombinationJsonRow($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableData], 0, $tableDef);
...
/* mantis 0019720  */
            ...
            foreach ($data['values'] as $index => $value) {
                $thisMetric = array(
                    'field' => $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableDef]['field'][$index],
                    'value' => $this->outputCombinationJsonProtectNumber($value)
                );

                if ($this->jsonShowFormatted) {
                	$thisMetric['formatted'] = $this->outputCombinationJsonProtectNumber(MotivoPerda_Gra_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableDef]['summ'][$index], $value));
                }
                if ($this->jsonShowLabel) {
                	$thisMetric['label'] = $this->outputCombinationJsonProtectText($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableDef]['label'][$index]);
                }
	...
	function outputCombinationXmlContent($tableDef, $tableData) {
		return "<?xml version=\"1.0\" encoding=\"{$_SESSION['scriptcase']['charset']}\" ?>\r\n" .
		       "<MotivoPerda_Gra>\r\n" .
		       $this->outputCombinationXmlRow($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableData], 0, $tableDef) .
		       "</MotivoPerda_Gra>";
	...
	function outputCombinationXmlRow($rows, $level, $tableDef) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$aggregateLabelTag = $this->xmlLabel ? $this->outputCombinationXmlProtectTag($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableDef]['label'][$index]) : $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableDef]['field'][$index];

				if ($this->xmlDisplayAsAttributes) {
					$outputData .= "<aggregate_{$aggregateLabelTag} label=\"" . $this->outputCombinationXmlProtectText($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableDef]['label'][$index]) . "\" value=\"" . $this->outputCombinationXmlProtectNumber(MotivoPerda_Gra_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableDef]['summ'][$index], $value)) . "\" />\r\n";
				} else {
					$outputData .= "<aggregate_{$aggregateLabelTag}>\r\n";
					$outputData .= "<label>" . $this->outputCombinationXmlProtectText($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableDef]['label'][$index]) . "</label>\r\n";
					$outputData .= "<value>" . $this->outputCombinationXmlProtectNumber(MotivoPerda_Gra_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableDef]['summ'][$index], $value)) . "</value>\r\n";
					$outputData .= "</aggregate_{$aggregateLabelTag}>\r\n";
				}
			}
	...
	function outputCombinationCsvContent($tableDef, $tableData) {
        $hasChildren = $this->outputCombinationHasChildren($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableData]);

		if ($this->csvHeader) {
			return $this->outputCombinationCsvHeader($tableDef, $hasChildren) .
			       $this->outputCombinationCsvRow($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pivot_y_axys']), $hasChildren);
		} else {
			return $this->outputCombinationCsvRow($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pivot_y_axys']), $hasChildren);
		}
	...
	function outputCombinationCsvHeader($tableDef, $hasChildren) {
		...
		if ($hasChildren) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pivot_group_by'] as $groupByName) {
				$headers[] = $groupByName;
			}
		}
		else {
			$headers[] = current($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pivot_group_by']);
		}

		foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableDef]['label'] as $summName) {
			$headers[] = $summName;
		}
	...
	function outputCombinationCsvRow($rows, $level, $parameters, $tableDef, $totalDepth, $hasChildren) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$thisRow[] = $this->outputCombinationCsvProtectNumber(MotivoPerda_Gra_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableDef]['summ'][$index], $value));
			}
	...
	function outputCombinationRtfContent($tableDef, $tableData) {
		...
		return "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>\r\n" .
		       ...
		       $this->outputCombinationRtfRow($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pivot_y_axys']), $hasChildren) .
			   "</table>\r\n" .
		       "</DOC>\r\n";
	...
	function outputCombinationRtfHeader($tableDef, $hasChildren) {
		...
		if ($hasChildren) {
			...
			$headers .= "<td>" . current($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pivot_group_by']) . "</td>\r\n";
		}
	...
	function outputCombinationRtfRow($rows, $level, $parameters, $tableDef, $totalDepth, $hasChildren) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$outputData .= "<td>" . $this->outputCombinationRtfProtectNumber(MotivoPerda_Gra_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableDef]['summ'][$index], $value)) . "</td>\r\n";
			}
	...
	function outputCombinationXlsContent($tableDef, $tableData) {
		...
		$this->outputCombinationXlsRow($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pivot_y_axys']), $hasChildren);
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pivot_group_by'] as $groupByName) {
				$this->addXlsCell(array(
					...
					'align'   => 'left'
                         ...
                         if ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pivot_group_by'] == null) {
                             $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pivot_group_by'] = array();
                         }
			$this->addXlsCell(array(
				'col'     => $column++,
				'row'     => $this->thisRow,
				'content' => current($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pivot_group_by']),
				'size'    => 'auto',
				'bold'    => true,
				'align'   => 'left'
			));
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$this->addXlsCell(array(
					'col'     => $column++,
					'row'     => $this->thisRow,
					'content' => $this->outputCombinationXlsProtectNumber(MotivoPerda_Gra_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableDef]['summ'][$index], $value)),
					'align'   => 'right'
				));
			}
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['chart_export_word_css'] = isset($_POST['export_chart_bw']) && 'Y' == $_POST['export_chart_bw'] ? 'bw' : 'color';

        if (isset($_REQUEST['nmgp_cor_word'])) {
            if ('pb' == $_REQUEST['nmgp_cor_word']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['chart_export_word_css'] = 'bw';
            } elseif ('co' == $_REQUEST['nmgp_cor_word']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['chart_export_word_css'] = 'color';
            }
        }
    }
	...
	function outputCombinationWordContent($tableDef, $tableData) {
		...
		return "<html xmlns:o=\"urn:schemas-microsoft-com:office:office\" xmlns:x=\"urn:schemas-microsoft-com:office:word\" xmlns=\"http://www.w3.org/TR/REC-html40\"{$_SESSION['scriptcase']['reg_conf']['html_dir']}>\r\n" .
		       ...
		       $this->outputCombinationWordRow($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pivot_y_axys']), $hasChildren) .
		       "</table>\r\n" .
		       "</body>\r\n" .
		       "</html>\r\n";
	...
	function outputCombinationWordCss() {
		if ('bw' == $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['chart_export_word_css']) {
			$cssFile    = "{$this->Ini->str_schema_all}_grid_bw.css";
			$cssDirFile = "{$this->Ini->str_schema_all}_grid_bw{$_SESSION['scriptcase']['reg_conf']['css_dir']}.css";
		}
		else {
	...
	function outputCombinationWordHeader($tableDef, $hasChildren) {
		...
		if ($hasChildren) {
			...
			$headers .= "<td class=\"scGridLabelFont\">" . current($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['pivot_group_by']) . "</td>\r\n";
		}
	...
	function outputCombinationWordRow($rows, $level, $parameters, $tableDef, $totalDepth, $hasChildren) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$outputData .= "<td class=\"scGridFieldOdd scGridFieldOddFont\">" . $this->outputCombinationWordProtectNumber(MotivoPerda_Gra_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$tableDef]['summ'][$index], $value)) . "</td>\r\n";
			}
...
SCEOT;
  ...
  function close_emb()
  {
   ...
   function SC_proc_grid_search($Parms)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['tmp_busca'] = array();
       foreach ($tmp as $cada_f)
       {
           $dats = explode("_DYN_", $cada_f);
           if ($dats[1] == "del_grid_search_all")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['grid_pesq'] as $ind => $dados)
               {
                   $this->proc_del_grid_search($ind, true);
               }
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['grid_pesq']);
               continue;
           }
           ...
           {
               $busca[$dats[0]] = $dats[1];
               $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['tmp_busca'][$dats[0]] = (isset($fields[$ix]['vls'][0])) ? $fields[$ix]['vls'][0][0] : "";
               if (isset($fields[$ix]['vls'][1]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['tmp_busca'][$dats[0] . '_input_2'] = $fields[$ix]['vls'][1][0];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['tmp_busca'][$dats[0] . '_cond'] = $dats[1];
           }
           $ix++;
      }
      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['tmp_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['tmp_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['tmp_busca'] as $ind => $dados)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['campos_busca'][$ind] = $dados;
      }
      if (!$_SESSION['scriptcase']['proc_mobile']) 
      { 
          require_once($this->Ini->path_aplicacao . "MotivoPerda_Gra_pesq.class.php"); 
   ...
   {
      if (is_array($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['campos_busca'][$cmp_del]))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['campos_busca'][$cmp_del] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['campos_busca'][$cmp_del . "_input_2"] = array();
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['campos_busca'][$cmp_del] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['campos_busca'][$cmp_del . "_input_2"] = "";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['campos_busca'][$cmp_del . "_cond"] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['grid_pesq'][$cmp_del]);
   }
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra']['word_file']);
      ...
      if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false || strpos(" " . $this->Ini->SC_module_export, "resume") !== false)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_imag_temp'] . "/");
          ...
          $this->pb->setReturnUrl("MotivoPerda_Gra.php");
...
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_chart_title'] ?> negociacaotarefa :: Doc</TITLE>
...
<form name="Fdown" method="get" action="MotivoPerda_Gra_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="MotivoPerda_Gra"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<FORM name="F0" method=post action="MotivoPerda_Gra.php"> 
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      ...
      $Html_password = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
          $_SESSION['sc_session'][$this->Ini->sc_page]['MotivoPerda_Gra'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_imag_temp'] . "/");
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['MotivoPerda_Gra']['sc_process_barr'])) {
       return;
   }
   ...
   $_SESSION['scriptcase']['MotivoPerda_Gra']['contr_erro'] = 'off';
   $sc_conv_var = array();
   $Sc_lig_md5 = false;
   ...
   if (!empty($_POST))
   {
       ...
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_MotivoPerda_Gra($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_MotivoPerda_Gra($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_imag_temp'] . "/sc_apl_default_LIGA_InfoTIME.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['MotivoPerda_Gra']['glo_nm_path_imag_temp'] . "/sc_apl_default_LIGA_InfoTIME.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "MotivoPerda_Gra") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['MotivoPerda_Gra']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['MotivoPerda_Gra']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['MotivoPerda_Gra']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_LIGA_InfoTIME'])) {
               $_SESSION['scriptcase']['MotivoPerda_Gra']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_LIGA_InfoTIME'];
           }
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['MotivoPerda_Gra']['master_pai']) && $_SESSION['sc_session'][$init_filho]['MotivoPerda_Gra']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['MotivoPerda_Gra']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['MotivoPerda_Gra']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['MotivoPerda_Gra']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['MotivoPerda_Gra']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['MotivoPerda_Gra']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['MotivoPerda_Gra']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['MotivoPerda_Gra']['embutida_form_full'] : false;
       $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['MotivoPerda_Gra']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['MotivoPerda_Gra']['embutida_form_parms']);
       $nm_apl_dependente = 1;
       $nm_embutida_form  = true;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_form_full']);
       unset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']);
               $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['b_sair'] = false;
           }   
       } 
   } 
   if (!isset($nmgp_opcao)) {
   ...
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida']) && $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['MotivoPerda_Gra']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['MotivoPerda_Gra']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['MotivoPerda_Gra']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['MotivoPerda_Gra']['protect_modal']) && !empty($_SESSION['scriptcase']['MotivoPerda_Gra']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['MotivoPerda_Gra']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "MotivoPerda_Gra";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'MotivoPerda_Gra' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (!isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('MotivoPerda_Gra' == $sReferer || 'MotivoPerda_Gra_' == substr($sReferer, 0, 16))
       {
           $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['initialize'] = false;
       }
       else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['contr_total_geral'] = "NAO";
   }
   ...
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['b_sair'] = true;
   }
   $STR_lang    = (isset($_SESSION['scriptcase']['str_lang']) && !empty($_SESSION['scriptcase']['str_lang'])) ? $_SESSION['scriptcase']['str_lang'] : "pt_br";
   if (isset($_SESSION['scriptcase']['MotivoPerda_Gra']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['MotivoPerda_Gra']['session_timeout']['lang'];
   }
   $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "Liga_Soft/Liga_Soft";
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'MotivoPerda_Gra')
   {
       $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/MotivoPerda_Gra_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['contr_total_geral'] = "NAO";
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['opcao'] = $nmgp_opcao ;  
       }   
       ...
       if (!isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['mostra_edit'] = "S";
       }
       if (isset($nmgp_lig_edit_lapis)) 
       {
          $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (!isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['sc_modal']))
       {
           $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['sc_modal'] = false;
       }
       if (isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['volta_redirect_tp'] = "";
           $nm_url_saida = "MotivoPerda_Gra_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['sc_modal'] = true;
               }
               $nm_url_saida = "MotivoPerda_Gra_fim.php"; 
           }
           elseif (!$nm_embutida_form)
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['opcao'] != "pdf" ) 
       { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['scriptcase']['nm_sc_retorno']; 
            $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['opc_psq'] = true;   
           if (isset($nmgp_iframe_ret)) {
               $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
           $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['opc_psq']  = false;   
           $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['psq_edit'] = 'N';   
       } 
       if (isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_form_full'])
           {
               $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['mostra_edit'] = "N";   
           } 
       ...
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['MotivoPerda_Gra'] = "on";
       } 
       if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['MotivoPerda_Gra'] = "on";
       } 
       if (!$_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['opc_psq'] && !isset($_SESSION['scriptcase']['MotivoPerda_Gra']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['MotivoPerda_Gra']) || $_SESSION['scriptcase']['sc_apl_seg']['MotivoPerda_Gra'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['iframe_menu']) ? false : true;
              if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
              {
                  foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
                  {
                      if (in_array("MotivoPerda_Gra", $apls_aba))
                      {
                          $nm_botao_ok = false;
                           break;
                      }
              ...
              if ((isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida']) && $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida']) || (isset($_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida_form']))
              {
                   $nm_botao_ok = false;
              }
...
<?php
       ...
       $contr_MotivoPerda_Gra = new MotivoPerda_Gra_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['opcao'] = "busca";
          $contr_MotivoPerda_Gra->NM_ajax_flag = true;
          $contr_MotivoPerda_Gra->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['opcao'] = "busca";
          $contr_MotivoPerda_Gra->NM_ajax_flag = true;
          $contr_MotivoPerda_Gra->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['opcao'] = "busca";
          $contr_MotivoPerda_Gra->NM_ajax_flag = true;
          $contr_MotivoPerda_Gra->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['opcao'] = "busca";
          $contr_MotivoPerda_Gra->NM_ajax_flag = true;
          $contr_MotivoPerda_Gra->NM_ajax_opcao = "ajax_filter_select";
      }
      if ('ajax_comb_table' == $nmgp_opcao)
      {
          $contr_MotivoPerda_Gra->NM_ajax_flag = true;
          $contr_MotivoPerda_Gra->NM_ajax_opcao = "ajax_comb_table";
      }
      if ('ajax_comb_save' == $nmgp_opcao)
      {
          $contr_MotivoPerda_Gra->NM_ajax_flag = true;
          $contr_MotivoPerda_Gra->NM_ajax_opcao = "ajax_comb_save";
      }
      if ('ajax_comb_sort' == $nmgp_opcao)
      {
          $contr_MotivoPerda_Gra->NM_ajax_flag = true;
          $contr_MotivoPerda_Gra->NM_ajax_opcao = "ajax_comb_sort";
      }
       $contr_MotivoPerda_Gra->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_MotivoPerda_Gra(&$str)
   {
   }
   function nm_protect_num_MotivoPerda_Gra($name, &$val)
   {
       if (empty($val))
       {
          return;
       ...
       $Nm_numeric[] = "p_idnegociacaomotivoperda";
   ...
   function MotivoPerda_Gra_pack_protect_string($sString)
   {
    ...
    function MotivoPerda_Gra_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
...
<?php
        global $script_case_init;
        if ($flushBuffer && $_SESSION['sc_session'][$script_case_init]['MotivoPerda_Gra']['opcao'] != 'print') {
            $bufferSize = @ini_get('output_buffering');
            if ('' != $bufferSize) {
