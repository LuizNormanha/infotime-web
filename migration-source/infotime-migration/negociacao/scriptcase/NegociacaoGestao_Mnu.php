<?php
include_once('NegociacaoGestao_Mnu_session.php');
...
$_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_path_prod']      = "";
$_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_perfil']         = "ligasistemas";
$_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_path_imag_temp'] = "";
$_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_usa_grupo']      = "";
...
//check prod
if(empty($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_path_prod']))
{
   /*check prod*/$_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
}
//check tmp
if(empty($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_path_imag_temp']))
{
   /*check tmp*/$_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
}
...
class NegociacaoGestao_Mnu_class
{
  var $Db;
  var $sc_charset;
  var $force_mobile;
 ...
 function NegociacaoGestao_Mnu_menu()
 {
    global $NegociacaoGestao_Mnu_menuData;
...
$nm_versao_sc  = "" ; 
$_SESSION['scriptcase']['NegociacaoGestao_Mnu']['contr_erro'] = 'off';
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_NegociacaoGestao_Mnu'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_NegociacaoGestao_Mnu'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_NegociacaoGestao_Mnu'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_path_prod'] . "/third";
$url_third      = $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "NegociacaoGestao_Mnu/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$path_lib_php   = $str_root . $path_link . "_lib/lib/php";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_path_imag_temp'];
$menu_largura   = '400';
$menu_mobile_hide          = 'N';
...
if(function_exists('set_php_timezone')) set_php_timezone('NegociacaoGestao_Mnu');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/NegociacaoGestao_Mnu_erro.php");
}
include_once(dirname(__FILE__) . "/NegociacaoGestao_Mnu_erro.class.php"); 
$this->Erro = new NegociacaoGestao_Mnu_erro();
$str_path = substr($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_conexao']);
}
/* Definição dos Caminhos */
$NegociacaoGestao_Mnu_menuData          = array();
$NegociacaoGestao_Mnu_menuData['path']  = array();
$NegociacaoGestao_Mnu_menuData['url']   = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $NegociacaoGestao_Mnu_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $NegociacaoGestao_Mnu_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $NegociacaoGestao_Mnu_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $NegociacaoGestao_Mnu_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$NegociacaoGestao_Mnu_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$NegociacaoGestao_Mnu_menuData['url']['web']   = str_replace("\\", '/', $NegociacaoGestao_Mnu_menuData['url']['web']);
$NegociacaoGestao_Mnu_menuData['path']['root'] = substr($NegociacaoGestao_Mnu_menuData['path']['sys'],  0, -1 * strlen($NegociacaoGestao_Mnu_menuData['url']['web']));
$NegociacaoGestao_Mnu_menuData['path']['app']  = substr($NegociacaoGestao_Mnu_menuData['path']['sys'],  0, strrpos($NegociacaoGestao_Mnu_menuData['path']['sys'],  '/'));
$NegociacaoGestao_Mnu_menuData['path']['link'] = substr($NegociacaoGestao_Mnu_menuData['path']['app'],  0, strrpos($NegociacaoGestao_Mnu_menuData['path']['app'],  '/'));
$NegociacaoGestao_Mnu_menuData['path']['link'] = substr($NegociacaoGestao_Mnu_menuData['path']['link'], 0, strrpos($NegociacaoGestao_Mnu_menuData['path']['link'], '/')) . '/';
$NegociacaoGestao_Mnu_menuData['path']['app'] .= '/';
$NegociacaoGestao_Mnu_menuData['url']['app']   = substr($NegociacaoGestao_Mnu_menuData['url']['web'],  0, strrpos($NegociacaoGestao_Mnu_menuData['url']['web'],  '/'));
$NegociacaoGestao_Mnu_menuData['url']['link']  = substr($NegociacaoGestao_Mnu_menuData['url']['app'],  0, strrpos($NegociacaoGestao_Mnu_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_usa_grupo'] == "S")
{
    $NegociacaoGestao_Mnu_menuData['url']['link']  = substr($NegociacaoGestao_Mnu_menuData['url']['link'], 0, strrpos($NegociacaoGestao_Mnu_menuData['url']['link'], '/'));
}
$NegociacaoGestao_Mnu_menuData['url']['link']  .= '/';
$NegociacaoGestao_Mnu_menuData['url']['app']   .= '/';

$_SESSION['scriptcase']['NegociacaoGestao_Mnu']['sc_apl_link'] = $NegociacaoGestao_Mnu_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['actual_lang']) || $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['actual_lang'] = $this->str_lang;
...
if ($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_usa_grupo'] != "S")
{
    ...
    $_SESSION['scriptcase']['menu_atual'] = "NegociacaoGestao_Mnu";
    $_SESSION['scriptcase']['menu_apls']['NegociacaoGestao_Mnu'] = array();
    if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
    {
        foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
        {
            if (isset($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_conexao']) && $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_conexao'] == $NM_con_orig)
            {
/*NM*/          $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_conexao'] = $NM_con_dest;
            }
            if (isset($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_perfil']) && $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_perfil'] == $NM_con_orig)
            {
/*NM*/          $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_perfil'] = $NM_con_dest;
            }
            if (isset($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_con_' . $NM_con_orig]))
            {
                $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_con_' . $NM_con_orig] = $NM_con_dest;
            }
        }
    }
...
if (isset($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['session_timeout']);
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['session_timeout']['redir']))
{
...
if (isset($script_case_init))
{
    $_SESSION['sc_session'][1]['NegociacaoGestao_Mnu']['init'] = $script_case_init;
}
elseif (!isset($_SESSION['sc_session'][1]['NegociacaoGestao_Mnu']['init']))
{
    $_SESSION['sc_session'][1]['NegociacaoGestao_Mnu']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['NegociacaoGestao_Mnu']['init'];
...
if (!isset($varIdNegociacaoSel) && isset($varidnegociacaosel)) 
{
    $_SESSION["varIdNegociacaoSel"] = $varidnegociacaosel;
}
...
{ 
    $_SESSION['scriptcase']['sc_apl_seg']['NegociacaoGestao_Mnu'] = "on";
} 
if (!isset($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['NegociacaoGestao_Mnu']) || $_SESSION['scriptcase']['sc_apl_seg']['NegociacaoGestao_Mnu'] != "on"))
{ 
...
{
    if(function_exists("nm_check_perfil_exists")) nm_check_perfil_exists($path_libs, $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_path_prod']);
    $_SESSION['sc_session'][1]['SC_Check_Perfil'] = true;
}
$nm_falta_var    = ""; 
$nm_falta_var_db = ""; 
if (isset($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_conexao']))
{
    db_conect_devel($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_path_prod'], 'LIGA_InfoTIME', 2); 
}
if (isset($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_perfil']))
{
   $_SESSION['scriptcase']['glo_perfil'] = $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_perfil'];
}
...
if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
{
    ...
    if (strlen($SC_temp) == 2)
    {
       $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['SC_sep_date']  = substr($SC_temp, 0, 1); 
       $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
   }
   else
    {
       $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['SC_sep_date']  = $SC_temp; 
       $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['SC_sep_date1'] = $SC_temp; 
   }
}
...
if (!empty($nm_falta_var) || !empty($nm_falta_var_db))
{
    ...
    { 
        if (isset($_SESSION['sc_session'][1]['NegociacaoGestao_Mnu']['sc_outra_jan']) && $_SESSION['sc_session'][1]['NegociacaoGestao_Mnu']['sc_outra_jan'])
        {
...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
 $glo_senha_protect = (isset($_SESSION['scriptcase']['glo_senha_protect'])) ? $_SESSION['scriptcase']['glo_senha_protect'] : "S";
if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_conexao']))
{ 
   $this->Db = db_conect_devel($_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_path_prod'], 'LIGA_InfoTIME'); 
} 
else 
{ 
...
//
if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'NegociacaoGestao_Mnu'))
{
    $_SESSION['sc_session'][1]['NegociacaoGestao_Mnu']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_NegociacaoGestao_Mnu'] = "javascript:window.close()";
}

/* Variáveis de Configuração do Menu */
$NegociacaoGestao_Mnu_menuData['iframe'] = TRUE;

$NegociacaoGestao_Mnu_menuData['height'] = '100%';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']))
{
    $_SESSION['scriptcase']['sc_apl_seg'] = array();
}
$_SESSION['scriptcase']['NegociacaoGestao_Mnu']['contr_erro'] = 'on';
...
if (!isset($_SESSION['varIdNegociacaoSel'])) {$_SESSION['varIdNegociacaoSel'] = "";}
if (!isset($this->sc_temp_varIdNegociacaoSel)) {$this->sc_temp_varIdNegociacaoSel = (isset($_SESSION['varIdNegociacaoSel'])) ? $_SESSION['varIdNegociacaoSel'] : "";}
  $check_sql = 
"SELECT  CLI.NomeFantasia, CLI.Cnpj, CLI.Cidade, CLI.Estado, CLI.Telefone, TPN.Descricao, CLC.Descricao, NEG.Ativo,
		 (SELECT concat(PRD.Descricao,' - ',PRF.Descricao) 
			FROM negociacaopropostafase NPF INNER JOIN propostafase PRF ON (NPF.IdPropostaFase = PRF.IdPropostaFase) 
			INNER JOIN propostadimensao PRD ON (PRF.IdPropostaDimensao = PRD.IdPropostaDimensao) 
			WHERE NPF.IdNegociacao = NEG.IdNegociacao AND NPF.IdTenacidade = NEG.IdTenacidade AND NPF.IdSituacaoFase IN (2) 
			ORDER BY NPF.IdNegociacaoPropostaFase DESC LIMIT 1) 
		 AS StatusAtual,
		 (SELECT SUM(PRF.ValorPercentual) AS Percentual 
			FROM negociacaopropostafase NPF 
			INNER JOIN propostafase PRF ON (NPF.IdPropostaFase = PRF.IdPropostaFase) 
			WHERE NPF.IdNegociacao = NEG.IdNegociacao AND NPF.IdTenacidade = NEG.IdTenacidade AND NPF.IdSituacaoFase IN (3)) 
		 AS Evolucao
FROM negociacao NEG
INNER JOIN cliente CLI ON (CLI.IdCliente = NEG.IdCliente)
INNER JOIN tiponegocio TPN ON (TPN.IdTipoNegocio =  NEG.IdTipoNegocio)
INNER JOIN clientecanal CLC ON (CLC.IdClienteCanal =  CLI.IdClienteCanal)
WHERE NEG.IdNegociacao = '$this->sc_temp_varIdNegociacaoSel'";
...
if (isset($this->rs[0][0])) {
    ...
    $DescricaoNegocio 	= $this->rs[0][5];
    $DescricaoCanal		= $this->rs[0][6];
    $Ativo				= $this->rs[0][7];
    $StatusAtual		= $this->rs[0][8];
    $Evolucao			= $this->rs[0][9];
}
else {
...
$codigoItem = 0;
unset($_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"]);
if (!isset($_SESSION['scriptcase']['sc_def_menu']))
{
    $_SESSION['scriptcase']['sc_def_menu'] = array();
}
if (!isset($_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"]))
{
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"] = array();
}
$sql = "SELECT IdPropostaDimensao, Descricao FROM propostadimensao WHERE IdTenacidade = '$this->sc_temp_varIdTenacidade'";
 
      $nm_select = $sql; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->dsDimensoes = array();
      $this->dsdimensoes = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->dsDimensoes[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->dsdimensoes[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->dsDimensoes = false;
          $this->dsDimensoes_erro = $this->Db->ErrorMsg();
          $this->dsdimensoes = false;
          $this->dsdimensoes_erro = $this->Db->ErrorMsg();
      } 


if (isset($this->dsdimensoes[0][0])) {
	
	foreach($this->dsdimensoes  as $arr_dimensao) {

		$codigoItem = $codigoItem + 1;
		$codigoDimensao = 'item_'.$codigoItem;
		$descricaoDimensao = $arr_dimensao[1];

		if (isset($_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"]))
{
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoDimensao]                   = array();
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoDimensao]['pai']            = "";
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoDimensao]['label']          = $descricaoDimensao;
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoDimensao]['link']           = "";
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoDimensao]['parm']           = "nm_run_menu*scin1*scout";
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoDimensao]['icon']           = "";
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoDimensao]['hint']           = "";
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoDimensao]['target']         = "_self";
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoDimensao]['name']           = "";
    $Temp_url = "";
    if ('http://' == substr($Temp_url, 0, 7) || 'https://' == substr($Temp_url, 0, 8) || '../' == substr($Temp_url, 0, 3) || '/' == substr($Temp_url, 0, 1))
    {
        $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoDimensao]['lnk_url'] = true;
    }
    else
    {
        $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoDimensao]['lnk_url'] = false;
        if (!empty($Temp_url))
        {
            $Temp_url = SC_dir_app_name($Temp_url) . "/" . $Temp_url . ".php";
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoDimensao]['target']) == '_blank')
            {
                $Temp_url .= "?nmgp_outra_jan=true&nm_apl_menu=" . "NegociacaoGestao_Mnu";
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoDimensao]['target']) == '_self')
            {
                $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoDimensao]['sc_init'] = $this->Gera_sc_init('');
                $Temp_url .= "?nm_run_menu=1&nm_apl_menu=" . "NegociacaoGestao_Mnu" . "&script_case_init=" . $this->Gera_sc_init('');
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoDimensao]['target']) == '_parent')
            {
                $Temp_url .= "?nm_run_menu=1&script_case_init=" . $_SESSION['sc_session'][1]["NegociacaoGestao_Mnu"]['init'];
            }
        }
    }
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoDimensao]['url'] = $Temp_url;
}
$sql = "SELECT NPF.IdNegociacaoPropostaFase, PRF.Descricao, SIF.Descricao, 
					   NMP.Descricao, NPF.ValorPercentual, NPF.DataInclusao, NPF.DataEncerramento, NPF.IdSituacaoFase"
			 . " FROM negociacaopropostafase NPF"
			 . " LEFT JOIN propostafase PRF ON (PRF.IdPropostaFase = NPF.IdPropostaFase)"
			 . " LEFT JOIN situacaofase SIF ON (SIF.IdSituacaoFase = NPF.IdSituacaoFase)"
			 . " LEFT JOIN negociacaomotivoperda NMP ON (NMP.IdNegociacaoMotivoPerda = NPF.IdNegociacaoMotivoPerda)"
			 . " WHERE NPF.IdNegociacao = '$this->sc_temp_varIdNegociacaoSel' AND PRF.IdPropostaDimensao = '$arr_dimensao[0]'";
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->dsFases[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->dsfases[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->dsFases = false;
          $this->dsFases_erro = $this->Db->ErrorMsg();
          $this->dsfases = false;
          $this->dsfases_erro = $this->Db->ErrorMsg();
      } 


		foreach($this->dsfases  as $arr_fase) {

			$codigoItem = $codigoItem + 1;
			$codigoFase = 'item_'.$codigoItem;
			$tituloFase = $arr_fase[1];
			$descricaoFase = $arr_fase[1] . ' ' . $arr_fase[2] . ' ' . $arr_fase[3] . $arr_fase[4] . ' ' . $arr_fase[5] .' ' . $arr_fase[6];
			
			switch ($arr_fase[7]) {
				case 1:
					$iconeFase = '../../../../devel/conf/scriptcase/img/ico/alarmclock_stop_16.png';
					break;
				case 2:
					$iconeFase = '../../../../devel/conf/scriptcase/img/ico/check_16.png';
					break;
				case 3:
					$iconeFase = '../../../../devel/conf/scriptcase/img/ico/check_16.png';
					break;
			...
			if (isset($_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"]))
{
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoFase]                   = array();
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoFase]['pai']            = $codigoDimensao;
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoFase]['label']          = $tituloFase;
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoFase]['link']           = "NegociacaoPropostaFase_Frm";
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoFase]['parm']           = "varIdNegociacaoPropostaFase*scin" . $arr_fase[0] . "*scout" . "nm_run_menu*scin1*scout";
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoFase]['icon']           = $iconeFase;
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoFase]['hint']           = $descricaoFase;
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoFase]['target']         = "_self";
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoFase]['name']           = "NegociacaoPropostaFase_Frm";
    $Temp_url = "NegociacaoPropostaFase_Frm";
    if ('http://' == substr($Temp_url, 0, 7) || 'https://' == substr($Temp_url, 0, 8) || '../' == substr($Temp_url, 0, 3) || '/' == substr($Temp_url, 0, 1))
    {
        $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoFase]['lnk_url'] = true;
    }
    else
    {
        $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoFase]['lnk_url'] = false;
        if (!empty($Temp_url))
        {
            $Temp_url = SC_dir_app_name($Temp_url) . "/" . $Temp_url . ".php";
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoFase]['target']) == '_blank')
            {
                $Temp_url .= "?nmgp_outra_jan=true&nm_apl_menu=" . "NegociacaoGestao_Mnu";
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoFase]['target']) == '_self')
            {
                $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoFase]['sc_init'] = $this->Gera_sc_init('NegociacaoPropostaFase_Frm');
                $Temp_url .= "?nm_run_menu=1&nm_apl_menu=" . "NegociacaoGestao_Mnu" . "&script_case_init=" . $this->Gera_sc_init('NegociacaoPropostaFase_Frm');
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoFase]['target']) == '_parent')
            {
                $Temp_url .= "?nm_run_menu=1&script_case_init=" . $_SESSION['sc_session'][1]["NegociacaoGestao_Mnu"]['init'];
            }
        }
    }
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoFase]['url'] = $Temp_url;
}
$sql = "SELECT COUNT(*)"
				 . " FROM negociacaotarefa"
				 . " WHERE IdNegociacaoPropostaFase = '" . $arr_fase[0] . "'";
      ...
      { 
          ...
          $this->rs_erro = $this->Db->ErrorMsg();
				...
				$codigoItem = $codigoItem + 1;
				$codigoTarefa = 'item_' . $codigoItem;
				$titulo = 'Tarefa(s): ' . $this->rs[0][0];

				if (isset($_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"]))
{
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoTarefa]                   = array();
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoTarefa]['pai']            = $codigoFase;
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoTarefa]['label']          = $titulo;
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoTarefa]['link']           = "NegociacaoTarefa_Gestao_Lst";
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoTarefa]['parm']           = "varIdNegociacaoPropostaFase*scin" . $arr_fase[0] . "*scout" . "nm_run_menu*scin1*scout";
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoTarefa]['icon']           = "../../../../devel/conf/scriptcase/img/ico/add_32.png";
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoTarefa]['hint']           = "";
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoTarefa]['target']         = "_self";
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoTarefa]['name']           = "NegociacaoTarefa_Gestao_Lst";
    $Temp_url = "NegociacaoTarefa_Gestao_Lst";
    if ('http://' == substr($Temp_url, 0, 7) || 'https://' == substr($Temp_url, 0, 8) || '../' == substr($Temp_url, 0, 3) || '/' == substr($Temp_url, 0, 1))
    {
        $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoTarefa]['lnk_url'] = true;
    }
    else
    {
        $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoTarefa]['lnk_url'] = false;
        if (!empty($Temp_url))
        {
            $Temp_url = SC_dir_app_name($Temp_url) . "/" . $Temp_url . ".php";
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoTarefa]['target']) == '_blank')
            {
                $Temp_url .= "?nmgp_outra_jan=true&nm_apl_menu=" . "NegociacaoGestao_Mnu";
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoTarefa]['target']) == '_self')
            {
                $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoTarefa]['sc_init'] = $this->Gera_sc_init('NegociacaoTarefa_Gestao_Lst');
                $Temp_url .= "?nm_run_menu=1&nm_apl_menu=" . "NegociacaoGestao_Mnu" . "&script_case_init=" . $this->Gera_sc_init('NegociacaoTarefa_Gestao_Lst');
            }
            if (strtolower($_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoTarefa]['target']) == '_parent')
            {
                $Temp_url .= "?nm_run_menu=1&script_case_init=" . $_SESSION['sc_session'][1]["NegociacaoGestao_Mnu"]['init'];
            }
        }
    }
    $_SESSION['scriptcase']['sc_def_menu']["NegociacaoGestao_Mnu"][$codigoTarefa]['url'] = $Temp_url;
}
}
	}
}
...
if (strlen($StatusAtual) < 5 and $Ativo == 'S')
	$StatusAtual = "<b><font color=orange>Sem programação</b></font>";
else if (strlen($StatusAtual) < 5 and $Ativo == 'N' and $Evolucao == 100)
	$StatusAtual = "<b><font color=green>Ganho</b></font>";
else if (strlen($StatusAtual) < 5 and $Ativo == 'N' and $Evolucao < 100)
	$StatusAtual = "<b><font color=red>Perda</b></font>";
else 
	$StatusAtual = "<b><font color=blue>$StatusAtual</b></font>";
...
<table class="scGridTabela">
    <tr>
        <td><p style="color: #6c757d; background-color: #e3eaef"><b> Cliente </b></p></td>
        ...
        <td><p style="color: #6c757d; background-color: #e3eaef"><b> Negócio </b></p></td>
        <td><p style="color: #6c757d; background-color: #e3eaef"><b> Canal </b></p></td>
        <td><p style="color: #6c757d; background-color: #e3eaef"><b> Fase atual </b></p></td>
        <td><p style="color: #6c757d; background-color: #e3eaef"><b> Evolução </b></p></td>
        <td><p style="color: #6c757d; background-color: #e3eaef"><b> Ativo </b></p></td>
    </tr>
    <tr>
        ...
        <td><font size="2" color="#313a46">' . $DescricaoNegocio . ' </font></td>
        <td><font size="2" color="#313a46">' . $DescricaoCanal . ' </font></td>
        <td><font size="2" color="#313a46">' . $StatusAtual . ' </font></td>
        <td><font size="2" color="#313a46">' . $Evolucao . ' </font></td>
        <td><font size="2" color="#313a46">' . $Ativo . ' </font></td>
	</tr>
</table>
</div>
';
echo $descricaoNegociacao;
if (isset($this->sc_temp_varIdNegociacaoSel)) {$_SESSION['varIdNegociacaoSel'] = $this->sc_temp_varIdNegociacaoSel;}
...
<head>
 <title>Gestão da Negociação</title>
 <META http-equiv="Content-Type" content="text/html; charset=<?php echo $_SESSION['scriptcase']['charset_html'] ?>" />
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_path_prod']; ?>/third/font-awesome/6/css/all.min.css" type="text/css" media="screen" />
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="NegociacaoGestao_Mnu_message.js"></script>
...
?> 
        ...
        <script  type="text/javascript">
                        ...
                        $(document).ready(function () {
                                ...
                                $('#css3menut').jstree({
                                        'state' : { 'key' : 'NegociacaoGestao_Mnu', 'filter' : function (k) { delete k.core.selected; return k; } },
                                        'plugins' : [ 'state']
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_NegociacaoGestao_Mnu'];
$NegociacaoGestao_Mnu_menuData['data'] = array();
$nextLevelToBeWrite = false;

if (isset($_SESSION['scriptcase']['sc_def_menu']['NegociacaoGestao_Mnu']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['NegociacaoGestao_Mnu']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'NegociacaoGestao_Mnu');
    $NegociacaoGestao_Mnu_menuData['data'] = $str_menu_usu;
}
if (is_file("NegociacaoGestao_Mnu_help.txt"))
{
    $Arq_WebHelp = file("NegociacaoGestao_Mnu_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $NegociacaoGestao_Mnu_menuData['data'][] = array(
                    ...
                    'target'   => "" . $this->NegociacaoGestao_Mnu_target('_blank') . "",
                    'sc_id'    => "item_Help",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['NegociacaoGestao_Mnu']) && !empty($_SESSION['scriptcase']['sc_menu_del']['NegociacaoGestao_Mnu']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($NegociacaoGestao_Mnu_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['NegociacaoGestao_Mnu']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($NegociacaoGestao_Mnu_menuData['data'][$i_menu]);
       }
    ...
    $NegociacaoGestao_Mnu_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['NegociacaoGestao_Mnu']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['NegociacaoGestao_Mnu']))
{
    $disable_menu = false;
    foreach ($NegociacaoGestao_Mnu_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['NegociacaoGestao_Mnu']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $NegociacaoGestao_Mnu_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
<?php
    $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['apl_inicial'] = ($NM_scr_iframe != "") ? $NM_scr_iframe : "NegociacaoGestao_Mnu_pag_ini.php";
    $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['path_link'] = $path_link;
?>
        ...
        <td class="scMenuTTableM" valign="top">
                <table cellpadding=0 cellspacing=0>
                    <tr>
                      ...
                      <?php
                      echo $this->NegociacaoGestao_Mnu_escreveMenu($NegociacaoGestao_Mnu_menuData['data']);
                      ?>
                            </td>
                    </tr>
                </table>
...
<div class="ui-layout-center">
  <table cellspacing=0 cellpadding=0 style="height: 100%; width: 100%" cellpadding=0 cellspacing=0>
    ...
    $(document).ready(function () {
        ...
        <iframe name="NegociacaoGestao_Mnu_iframe" id="iframe_NegociacaoGestao_Mnu" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;" src="<?php echo $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['apl_inicial']?>"></iframe>
<?php
?>
        </td>
      </tr>
...
Iframe_atual = "NegociacaoGestao_Mnu_iframe";
...
<?php
 $seq = 0;
 if(isset($NegociacaoGestao_Mnu_menuData['data']) && !empty($NegociacaoGestao_Mnu_menuData['data']))
 {
   foreach ($NegociacaoGestao_Mnu_menuData['data'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
 ...
 if(isset($NegociacaoGestao_Mnu_menuData['data_user']) && !empty($NegociacaoGestao_Mnu_menuData['data_user']))
 {
   foreach ($NegociacaoGestao_Mnu_menuData['data_user'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         if(empty($dados_menu['hint']))
 ...
 if(isset($NegociacaoGestao_Mnu_menuData['data_vertical']) && !empty($NegociacaoGestao_Mnu_menuData['data_vertical']))
 {
   foreach ($NegociacaoGestao_Mnu_menuData['data_vertical'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         if(empty($dados_menu['hint']))
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl, fa_ico)
{
    ...
    iframe.name = 'NegociacaoGestao_Mnu_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    var home_style="";
    if(str_id === 'NegociacaoGestao_Mnu'){ home_style=";padding-left:4px;min-height:14px;"; }
...
{
    $('#iframe_NegociacaoGestao_Mnu').hide();
    if (str_id == "")
    {
        $('#iframe_NegociacaoGestao_Mnu').show();
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            {
                $('#Iframe_control').append('<iframe id="iframe_'+ Tab_iframes[i] +'" name="NegociacaoGestao_Mnu_'+ Tab_iframes[i] +'_iframe" frameborder="0" class="scMenuIframe" style="display: none; width: 100%; height: 100%;" src=""></iframe>');
            }
            ...
            Iframe_atual = "NegociacaoGestao_Mnu_" + Tab_iframes[i] + '_iframe';
...
{
  str_target_sv = "";
  if (str_id != "iframe_NegociacaoGestao_Mnu")
  {
      str_target_sv = str_id + "_iframe";
      str_id        = str_id.replace("NegociacaoGestao_Mnu_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    if (str_target == "NegociacaoGestao_Mnu_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
        str_target = (str_target_sv != "") ? str_target_sv : str_target;
        mudaIframe(str_id);
        if (str_id != "NegociacaoGestao_Mnu")
        {
            $('#links_abas').css('display','');
            $('#id_links_abas').css('display','');
        }
        if (str_id != "NegociacaoGestao_Mnu" && Tab_abas[str_id] != 'show')
        {
            createAba(str_id);
      scToggleOverflow();
        }
    ...
    if(str_target != '_blank' && $('#iframe_NegociacaoGestao_Mnu').length)
        $('#iframe_NegociacaoGestao_Mnu')[0].contentWindow.focus();
  }
}
</script>
</body>
...
/* Controle de Target */
function NegociacaoGestao_Mnu_escreveMenu($arr_menu)
{
    $aMenuItemList = array();
            ...
            <?php
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    ?>
                    <li <?php echo $iconHtml; ?> class="scMenuTItems scMenuTItem" style="<?php echo $li_style; ?>"><a href="javascript:" onclick="openMenuItem('NegociacaoGestao_Mnu_<?php echo $aMenuItemList[$i]['id']; ?>'); <?php echo $focusFrame; ?>" item-href="<?php echo $aMenuItemList[$i]['link']; ?>" id="<?php echo $aMenuItemList[$i]['id']; ?>" title="<?php echo $aMenuItemList[$i]['hint']; ?>"<?php echo $aMenuItemList[$i]['target']; ?> class="scMenuTItem"><?php echo $aMenuItemList[$i]['label']; ?></a>
                    <?php
                  }
                }
                if ($aMenuItemList[$i + 1] && $aMenuItemList[$i]['level'] == $aMenuItemList[$i + 1]['level']) {
...
/* Controle de Target */
   function NegociacaoGestao_Mnu_target($str_target)
   {
       global $NegociacaoGestao_Mnu_menuData;
       ...
       elseif ($NegociacaoGestao_Mnu_menuData['iframe'])
       {
           return 'NegociacaoGestao_Mnu_iframe';
       }
       else
       {
           return $str_target;
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "javascript:parent.nm_out_menu('NegociacaoGestao_Mnu_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($NegociacaoGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_usa_grupo'] . "')";  
               }
               else
               {
                    $str_line['link'] = "NegociacaoGestao_Mnu_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($NegociacaoGestao_Mnu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_usa_grupo'] . ""; 
               }
           }
           elseif ($arr_item['target'] == '_parent')
           {
               $str_line['link'] = "javascript:parent.nm_out_menu('" . $_SESSION['scriptcase']['sc_saida_NegociacaoGestao_Mnu'] . "')"; 
           }
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->NegociacaoGestao_Mnu_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['sc_init'][$apl_menu] = rand(2, 10000);
        $_SESSION['sc_session'][$_SESSION['scriptcase']['NegociacaoGestao_Mnu']['sc_init'][$apl_menu]] = array();
        return  $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['sc_init'][$apl_menu];
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_path_imag_temp'] . "/sc_apl_default_LIGA_InfoTIME.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['glo_nm_path_imag_temp'] . "/sc_apl_default_LIGA_InfoTIME.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "NegociacaoGestao_Mnu") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_LIGA_InfoTIME'])) {
            $_SESSION['scriptcase']['NegociacaoGestao_Mnu']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_LIGA_InfoTIME'];
        }
    }
}
...
$contr_NegociacaoGestao_Mnu = new NegociacaoGestao_Mnu_class;
$contr_NegociacaoGestao_Mnu->NegociacaoGestao_Mnu_menu();
