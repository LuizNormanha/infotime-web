...
include_once('IndicadoresComercial_Dsb_session.php');
@ini_set('session.cookie_httponly', 1);
@ini_set('session.use_only_cookies', 1);
@ini_set('session.cookie_secure', 0);
@session_start();

$_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_perfil']          = "ligasistemas";
$_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_path_prod']       = "";
$_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_path_imagens']    = "";
$_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_path_imag_temp']  = "";
$_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_path_doc']        = "";
...
//check prod
if(empty($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_path_prod']))
{
    /*check prod*/$_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
}
//check img
if(empty($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_path_imagens']))
{
    /*check img*/$_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
}
//check tmp
if(empty($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_path_imag_temp']))
{
    /*check tmp*/$_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
}
//check doc
if(empty($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_path_doc']))
{
    /*check doc*/$_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
}
...
if (!empty($_POST))
{
    foreach ($_POST as $nmgp_var => $nmgp_val)
    {
        ...
        nm_limpa_str_IndicadoresComercial_Dsb($nmgp_val);
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_path_imag_temp'] . "/sc_apl_default_LIGA_InfoTIME.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_path_imag_temp'] . "/sc_apl_default_LIGA_InfoTIME.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "IndicadoresComercial_Dsb") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['IndicadoresComercial_Dsb']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['IndicadoresComercial_Dsb']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['IndicadoresComercial_Dsb']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_LIGA_InfoTIME'])) {
            $_SESSION['scriptcase']['IndicadoresComercial_Dsb']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_LIGA_InfoTIME'];
        }
    }
}
if (isset($nmgp_parms) && !empty($nmgp_parms) && !is_array($nmgp_parms))
{
    ...
    while (!empty($todo[$ix]))
    {
       ...
       if (1 < sizeof($cadapar))
       {
           ...
           nm_limpa_str_IndicadoresComercial_Dsb($cadapar[1]);
...
elseif (isset($script_case_init) && !empty($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['IndicadoresComercial_Dsb']['parms']))
{
    if (!isset($nmgp_opcao) || ($nmgp_opcao != "incluir" && $nmgp_opcao != "novo" && $nmgp_opcao != "recarga" && $nmgp_opcao != "muda_form"))
    {
        $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['IndicadoresComercial_Dsb']['parms']);
        $todo  = explode("?@?", $todox);
        $ix = 0;
        while (!empty($todo[$ix]))
        {
...
$IndicadoresComercial_Dsb_control = new IndicadoresComercial_Dsb_control();
$IndicadoresComercial_Dsb_control->control();

class IndicadoresComercial_Dsb_ini {
    ...
    function init()
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->sc_page]['IndicadoresComercial_Dsb'])) {
            $_SESSION['sc_session'][$this->sc_page]['IndicadoresComercial_Dsb'] = array();
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['IndicadoresComercial_Dsb']['embutida_form'])) {
            $_SESSION['sc_session'][$this->sc_page]['IndicadoresComercial_Dsb']['embutida_form'] = false;
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['IndicadoresComercial_Dsb']['embutida_proc'])) {
            $_SESSION['sc_session'][$this->sc_page]['IndicadoresComercial_Dsb']['embutida_proc'] = false;
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['IndicadoresComercial_Dsb']['iframe_menu'])) {
            $_SESSION['sc_session'][$this->sc_page]['IndicadoresComercial_Dsb']['iframe_menu'] = false;
        }

        $this->nm_cod_apl      = "IndicadoresComercial_Dsb";
        $this->nm_nome_apl     = "";
        $this->nm_seguranca    = "";
        ...
        $this->nm_dt_criacao   = "20150826";
        $this->nm_hr_criacao   = "083258";
        ...
        if (!isset($_SESSION['sc_session'][$this->sc_page]['IndicadoresComercial_Dsb']['initialize'])) {
            $_SESSION['sc_session'][$this->sc_page]['IndicadoresComercial_Dsb']['initialize'] = true;
        } elseif (!isset($_SERVER['HTTP_REFERER'])) {
            $_SESSION['sc_session'][$this->sc_page]['IndicadoresComercial_Dsb']['initialize'] = false;
        } elseif (false === strpos($_SERVER['HTTP_REFERER'], '/IndicadoresComercial_Dsb/')) {
            $_SESSION['sc_session'][$this->sc_page]['IndicadoresComercial_Dsb']['initialize'] = true;
        } else {
            $_SESSION['sc_session'][$this->sc_page]['IndicadoresComercial_Dsb']['initialize'] = false;
        }
        ...
        $this->sc_protocolo   = "";
        $this->path_prod      = $_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_path_prod'];
        $this->path_imagens   = $_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_path_imagens'];
        $this->path_imag_temp = $_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_path_imag_temp'];
        $this->path_doc       = $_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_path_doc'];
        ...
        $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/IndicadoresComercial_Dsb';
        ...
        if (isset($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['session_timeout']['lang'])) {
            $this->str_lang = $_SESSION['scriptcase']['IndicadoresComercial_Dsb']['session_timeout']['lang'];
        }
        elseif (!isset($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['actual_lang']) || $_SESSION['scriptcase']['IndicadoresComercial_Dsb']['actual_lang'] != $this->str_lang) {
            $_SESSION['scriptcase']['IndicadoresComercial_Dsb']['actual_lang'] = $this->str_lang;
        ...
        if (isset($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['session_timeout']['redir'])) {
...
';
            ...
            if ($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['session_timeout']['redir_tp'] == "R") {
                $SS_cod_html .= "  </HEAD>\r\n";
                $SS_cod_html .= "   <body>\r\n";
            }
            else {
                ...
                $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['IndicadoresComercial_Dsb']['session_timeout']['redir'] . "');\">\r\n";
                $SS_cod_html .= "     </form>\r\n";
            ...
            if ($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['session_timeout']['redir_tp'] == "R") {
                $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['IndicadoresComercial_Dsb']['session_timeout']['redir'] . "');\r\n";
            }
            ...
            $SS_cod_html .= " </body>\r\n";
            $SS_cod_html .= "</HTML>\r\n";
            unset($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['session_timeout']);
   ...
   {
      $con_devel             =  (isset($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      ...
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_conexao']) && $_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_perfil']) && $_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      if (isset($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_conexao']))
      {
          db_conect_devel($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_conexao'], $this->root . $this->path_prod, 'LIGA_InfoTIME', 2, $this->force_db_utf8); 
          if (empty($_SESSION['scriptcase']['glo_tpbanco']) && empty($_SESSION['scriptcase']['glo_banco']))
          {
              $nm_crit_perfil = true;
          }
      }
      if (isset($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_perfil'];
      }
...
// 
      ...
      {
         $_SESSION['sc_session'][$this->sc_page]['IndicadoresComercial_Dsb']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['IndicadoresComercial_Dsb']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['IndicadoresComercial_Dsb']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
          {
              $_SESSION['sc_session'][$this->sc_page]['IndicadoresComercial_Dsb']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['IndicadoresComercial_Dsb']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['IndicadoresComercial_Dsb']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['IndicadoresComercial_Dsb']['SC_sep_date1'];
      }
// 
...
<body>
    <div class='ui container' style='padding-top:2rem'>
        <section class='ui message'>
          ...
          echo $str_message;
          if (!$_SESSION['sc_session'][$this->sc_page]['IndicadoresComercial_Dsb']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->sc_page]['IndicadoresComercial_Dsb']['sc_outra_jan']) || $_SESSION['sc_session'][$this->sc_page]['IndicadoresComercial_Dsb']['sc_outra_jan'] != 'IndicadoresComercial_Dsb')) 
          { 
...
// 
  function conectDB()
  {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_conexao'], $this->root . $this->path_prod, 'LIGA_InfoTIME', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['glo_nm_conexao'], $this->root . $this->path_prod, 'LIGA_InfoTIME', 1, $this->force_db_utf8);
    }
    else {
...
} // IndicadoresComercial_Dsb_ini

class IndicadoresComercial_Dsb_control {
...
$_SESSION['scriptcase']['IndicadoresComercial_Dsb']['contr_erro'] = 'on';
 
$_SESSION['scriptcase']['IndicadoresComercial_Dsb']['contr_erro'] = 'off';
...
$_SESSION['scriptcase']['IndicadoresComercial_Dsb']['contr_erro'] = 'off';
    ...
    function control()
    {
        ...
        $this->Db = $this->Ini->Db;
        $this->checkSecurity();
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['IndicadoresComercial_Dsb']['initialize']) {
            $this->executeApplicationInit();
            $_SESSION['sc_session'][$this->Ini->sc_page]['IndicadoresComercial_Dsb']['initialize'] = false;
        }
    ...
    function init()
    {
        if (!$this->Ini)
        {
            $this->Ini = new IndicadoresComercial_Dsb_ini();
            $this->Ini->init();
        }
        ...
        $_SESSION['scriptcase']['sc_aba_iframe']['IndicadoresComercial_Dsb'] = array(
        );

        $_SESSION['scriptcase']['dashboard_targets']['IndicadoresComercial_Dsb'] = array();


        $_SESSION['scriptcase']['dashboard_scinit']['IndicadoresComercial_Dsb'] = array();

        $_SESSION['scriptcase']['dashboard_scinit']['IndicadoresComercial_Dsb']['dbifrm_widget9'] = rand(2, 10000);
        $_SESSION['scriptcase']['dashboard_scinit']['IndicadoresComercial_Dsb']['dbifrm_widget11'] = rand(2, 10000);

        $_SESSION['scriptcase']['dashboard_toolbar']['IndicadoresComercial_Dsb'] = array();

        $_SESSION['scriptcase']['dashboard_toolbar']['IndicadoresComercial_Dsb']['MenuResumoComercial_Blk'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['IndicadoresComercial_Dsb']['MenuIndicadoresComercial_Blk'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['IndicadoresComercial_Dsb']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['IndicadoresComercial_Dsb']['sc_outra_jan']))
        {
            $this->sc_init_menu = "x";
            if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['IndicadoresComercial_Dsb']))
            {
                $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['IndicadoresComercial_Dsb'];
            }
            ...
            if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['IndicadoresComercial_Dsb']))
            {
                 $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['IndicadoresComercial_Dsb']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('IndicadoresComercial_Dsb') . "/IndicadoresComercial_Dsb.php";
                 $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['IndicadoresComercial_Dsb']['label'] = "IndicadoresComercial_Dsb";
            ...
            elseif ($this->Ini->sc_page == $this->sc_init_menu)
            {
                ...
                {
                    if ($apl == "IndicadoresComercial_Dsb")
                    {
                        $achou = true;
                    }
                    elseif ($achou)
    ...
    function checkSecurity()
    {
        ...
        {
            $_SESSION['scriptcase']['sc_apl_seg']['IndicadoresComercial_Dsb'] = "on";
        }

        if (!isset($_SESSION['scriptcase']['IndicadoresComercial_Dsb']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['IndicadoresComercial_Dsb']) || $_SESSION['scriptcase']['sc_apl_seg']['IndicadoresComercial_Dsb'] != "on"))
        {
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="IndicadoresComercial_Dsb_container_index.css" />
<?php
...
var scIframeSCInit = {};
<?php
        foreach ($_SESSION['scriptcase']['dashboard_scinit']['IndicadoresComercial_Dsb'] as $sIframe => $iSCInit) {
?>
...
<?php
$this->startUpWidget_widget9();
$this->getWidgetContent_widget9();
echo $this->getStyleChanges('widget9', 'link');
?>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="0" data-gs-width="4" data-gs-height="8"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-0">
                    <div  class="grid-stack-item-content scContainerLinkMoldura_widget9 scContainerWidget" id="id-div-0">
                        ...
                        <div class='widget-content widget-content-title-none' id="id-div-iframe-0"><iframe id="id-iframe-0" name="dbifrm_widget9" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('MenuResumoComercial_Blk'); ?>/MenuResumoComercial_Blk.php?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["IndicadoresComercial_Dsb"]["dbifrm_widget9"] ?>&under_dashboard=1&dashboard_app=IndicadoresComercial_Dsb&own_widget=dbifrm_widget9&compact_mode=0&remove_margin=0&remove_border=0" alt="60"></iframe></div>
                    </div>
                </div>
<?php
$this->startUpWidget_widget11();
$this->getWidgetContent_widget11();
echo $this->getStyleChanges('widget11', 'link');
?>
                <div  class="grid-stack-item" data-gs-x="4" data-gs-y="0" data-gs-width="7" data-gs-height="13"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-1">
                    <div  class="grid-stack-item-content scContainerLinkMoldura_widget11 scContainerWidget" id="id-div-1">
                        <div class="widget-head" style="display:none">
                            <h3 class="scContainerTitle"><?php echo $this->widgetParams['title'] ?></h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none' id="id-div-iframe-1"><iframe id="id-iframe-1" name="dbifrm_widget11" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('MenuIndicadoresComercial_Blk'); ?>/MenuIndicadoresComercial_Blk.php?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["IndicadoresComercial_Dsb"]["dbifrm_widget11"] ?>&under_dashboard=1&dashboard_app=IndicadoresComercial_Dsb&own_widget=dbifrm_widget11&compact_mode=0&remove_margin=0&remove_border=0"></iframe></div>
                    </div>
                </div></div>
...
<META http-equiv="Pragma" content="no-cache" />
    ...
    <body class="scGridPage">
        <form name="Fsenha" method="post" action="IndicadoresComercial_Dsb.php">
...
<?php
    ...
    function startUpWidget_widget9()
    {
        $this->runningWidgetId = "widget9";
    ...
    function getWidgetContent_widget9()
    {
    ...
    function getWidgetOutput_widget9()
    {
        return $this->widgetInfo['output'];
    }

    function startUpWidget_widget11()
    {
        $this->runningWidgetId = "widget11";
        $this->runningWidgetType = "link";
    ...
    function getWidgetContent_widget11()
    {
        $this->executeWidgetLoad();
    ...
    function getWidgetOutput_widget11()
    {
        return $this->widgetInfo['output'];
    }
...
} // IndicadoresComercial_Dsb_control

function nm_limpa_str_IndicadoresComercial_Dsb(&$str)
{
}
