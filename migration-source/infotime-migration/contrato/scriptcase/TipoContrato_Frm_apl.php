...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->Refresh_aba_menu)) {
          $_SESSION['sc_session'][$script_case_init]['TipoContrato_Frm']['Refresh_aba_menu'] = $this->Refresh_aba_menu;
      }
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          $_POST['nmgp_opcao'] = "novo";
          $this->nmgp_opcao    = "novo";
          $_SESSION['sc_session'][$script_case_init]['TipoContrato_Frm']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['TipoContrato_Frm']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['TipoContrato_Frm']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['TipoContrato_Frm']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['TipoContrato_Frm']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['TipoContrato_Frm']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['TipoContrato_Frm']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['TipoContrato_Frm']['sc_redir_insert'] = $this->sc_redir_insert;
              unset($_SESSION['sc_session'][$script_case_init]['TipoContrato_Frm']['opc_ant']);
          }
          if (!isset($this->varIdTenacidade) && isset($this->varidtenacidade)) 
          {
              $this->varIdTenacidade = $this->varidtenacidade;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['TipoContrato_Frm']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['TipoContrato_Frm']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['TipoContrato_Frm']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['TipoContrato_Frm']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['TipoContrato_Frm']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['TipoContrato_Frm']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['TipoContrato_Frm']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['TipoContrato_Frm']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['TipoContrato_Frm']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new TipoContrato_Frm_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['initialize'])
          {
              
/*----- Scriptcase Locale: Event onApplicationInit ------*/
$_SESSION['scriptcase']['TipoContrato_Frm']['contr_erro'] = 'on';
...
/*----- END - Scriptcase Locale: Event onApplicationInit ------*/
      ...
      $_SESSION['sc_session'][$script_case_init]['TipoContrato_Frm']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['TipoContrato_Frm']['upload_field_info']['nomereferencia'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'TipoContrato_Frm',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['TipoContrato_Frm']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['TipoContrato_Frm'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['TipoContrato_Frm']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['TipoContrato_Frm']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('TipoContrato_Frm') . "/TipoContrato_Frm.php";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['TipoContrato_Frm']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - Tipo de Contrato";
      ...
      $_SESSION['scriptcase']['error_icon']['TipoContrato_Frm']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['TipoContrato_Frm'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }

      $this->Ini->cor_grid_par = $this->Ini->cor_grid_impar;
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "TipoContrato_Frm.php"; 
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['upload_field_ul_name'][$this->nomereferencia_ul_name]))
          {
              $this->NM_ajax_info['param']['nomereferencia_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['upload_field_ul_name'][$this->nomereferencia_ul_name];
          }
      ...
      elseif (isset($this->nomereferencia_ul_name) && '' != $this->nomereferencia_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['upload_field_ul_name'][$this->nomereferencia_ul_name]))
          {
              $this->nomereferencia_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['upload_field_ul_name'][$this->nomereferencia_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TipoContrato_Frm']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['TipoContrato_Frm'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['TipoContrato_Frm'];
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['dados_form'];
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'TipoContrato_Frm_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'TipoContrato_Frm_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'TipoContrato_Frm/TipoContrato_Frm_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "TipoContrato_Frm_erro.class.php"); 
      }
      $this->Erro      = new TipoContrato_Frm_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opcao']))
         { 
             if ($this->idtipocontrato != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['TipoContrato_Frm']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['Auditoria'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['botoes']['Auditoria'];
          $this->nmgp_botoes['sc_btn_0'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['botoes']['sc_btn_0'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['TipoContrato_Frm']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['TipoContrato_Frm']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "TipoContrato_Frm.php"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      //-- idtipocontrato
      $this->field_config['idtipocontrato']               = array();
      $this->field_config['idtipocontrato']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['idtipocontrato']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['idtipocontrato']['symbol_dec'] = '';
      $this->field_config['idtipocontrato']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['idtipocontrato']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- versao
      $this->field_config['versao']               = array();
      $this->field_config['versao']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['versao']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['versao']['symbol_dec'] = '';
      $this->field_config['versao']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['versao']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- idtenacidade
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "TipoContrato_Frm.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm'][$path_doc_md5][1] = $Zip_name;
?><!DOCTYPE html>
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - Tipo de Contrato") ?></TITLE>
...
<form name="Fdown" method="get" action="TipoContrato_Frm_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="TipoContrato_Frm"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="TipoContrato_Frm.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//--------------------------------------------------------------------------------------
   ...
   function sc_btn_Auditoria() 
   {
     ...
     if (empty($this->nomereferencia)) {
         $this->nomereferencia = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['dados_form']['nomereferencia'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['dados_form']['nomereferencia'] : "";
     }
?>
<!DOCTYPE html>
...
<?php
include_once("TipoContrato_Frm_sajax_js.php");
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->idtipocontrato) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['dados_form']['idtipocontrato']))
          {
              $varloc_btn_php['idtipocontrato'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['dados_form']['idtipocontrato'];
          }
      }
      $nm_f_saida = "TipoContrato_Frm.php";
      nm_limpa_numero($this->idtipocontrato, $this->field_config['idtipocontrato']['symbol_grp']) ; 
      nm_limpa_numero($this->versao, $this->field_config['versao']['symbol_grp']) ; 
...
if (isset($this->rs[0][0])) {
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_TipoContrato_Frm';
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['csrf_token']) && $this->scCsrfGetToken() != $this->csrf_token)
     {
          $this->Campos_Mens_erro .= (empty($this->Campos_Mens_erro)) ? "" : "<br />";
          $this->Campos_Mens_erro .= "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_TipoContrato_Frm']) || !is_array($this->NM_ajax_info['errList']['geral_TipoContrato_Frm']))
              {
                  $this->NM_ajax_info['errList']['geral_TipoContrato_Frm'] = array();
              }
              $this->NM_ajax_info['errList']['geral_TipoContrato_Frm'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_descricao(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['php_cmp_required']['descricao']) || $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['php_cmp_required']['descricao'] == "on")) 
      { 
          if ($this->descricao == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_idtipocontrato(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      nm_limpa_numero($this->idtipocontrato, $this->field_config['idtipocontrato']['symbol_grp']) ; 
      if ($this->nmgp_opcao == "incluir" || 'validate_idtipocontrato' == $this->NM_ajax_opcao)
      { 
          if ($this->idtipocontrato != '')  
          { 
              $iTestSize = 20;
              if (strlen($this->idtipocontrato) > $iTestSize)  
              { 
                  $hasError = true;
                  ...
                  $Campos_Erros['idtipocontrato'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  ...
                  $this->NM_ajax_info['errList']['idtipocontrato'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->idtipocontrato, 20, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Id.; " ; 
                  if (!isset($Campos_Erros['idtipocontrato']))
   ...
   if (isset($this->Field_no_validate['categoria'])) {
      ...
      if ($this->categoria == "" && $this->nmgp_opcao != "excluir")
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['php_cmp_required']['categoria']) || $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['php_cmp_required']['categoria'] == "on")
        { 
          $hasError = true;
      ...
      if ($this->categoria != "" && !in_array("categoria", $this->sc_force_zero))
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['Lookup_categoria']) && !in_array($this->categoria, $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['Lookup_categoria']))
          {
              $hasError = true;
    ...
    function ValidateField_versao(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              $iTestSize = 6;
              if (strlen($this->versao) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Versão: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['versao']))
                  {
                      $Campos_Erros['versao'] = array();
                  }
                  $Campos_Erros['versao'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  ...
                  $this->NM_ajax_info['errList']['versao'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->versao, 6, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Versão; " ; 
                  if (!isset($Campos_Erros['versao']))
                  ...
                  $Campos_Erros['versao'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['versao']) || !is_array($this->NM_ajax_info['errList']['versao']))
                  {
                      $this->NM_ajax_info['errList']['versao'] = array();
                  }
                  $this->NM_ajax_info['errList']['versao'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['php_cmp_required']['versao']) || $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['php_cmp_required']['versao'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Versão" ; 
              if (!isset($Campos_Erros['versao']))
    ...
    function ValidateField_ativo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "Ativo " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 1 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
    ...
    function ValidateField_nomereferencia(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if (isset($this->Field_no_validate['nomereferencia'])) {
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            {
                include_once 'TipoContrato_Frm_doc_name.php';
            }
...
//--------------------------------------------------------------------------------------
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['dados_form'] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      $this->Before_unformat['idtipocontrato'] = $this->idtipocontrato;
      nm_limpa_numero($this->idtipocontrato, $this->field_config['idtipocontrato']['symbol_grp']) ; 
      $this->Before_unformat['versao'] = $this->versao;
      nm_limpa_numero($this->versao, $this->field_config['versao']['symbol_grp']) ; 
   ...
   {
      if ($Nome_Campo == "idtipocontrato")
      {
          nm_limpa_numero($this->idtipocontrato, $this->field_config['idtipocontrato']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "versao")
      {
          nm_limpa_numero($this->versao, $this->field_config['versao']['symbol_grp']) ; 
      }
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      if ('' !== $this->idtipocontrato || (!empty($format_fields) && isset($format_fields['idtipocontrato'])))
      {
          nmgp_Form_Num_Val($this->idtipocontrato, $this->field_config['idtipocontrato']['symbol_grp'], $this->field_config['idtipocontrato']['symbol_dec'], "0", "S", $this->field_config['idtipocontrato']['format_neg'], "", "", "-", $this->field_config['idtipocontrato']['symbol_fmt']) ; 
      }
      if ('' !== $this->versao || (!empty($format_fields) && isset($format_fields['versao'])))
      {
          nmgp_Form_Num_Val($this->versao, $this->field_config['versao']['symbol_grp'], $this->field_config['versao']['symbol_dec'], "0", "S", $this->field_config['versao']['format_neg'], "", "", "-", $this->field_config['versao']['symbol_fmt']) ; 
      }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idtipocontrato']['keyVal'] = TipoContrato_Frm_pack_protect_string($this->nmgp_dados_form['idtipocontrato']);
          }
   } // ajax_return_values
   ...
   function ajax_return_values_idtipocontrato($bForce = false)
   {
          ...
          $this->NM_ajax_info['fldList']['idtipocontrato'] = array(
               ...
               'labList' => array($this->form_format_readonly("idtipocontrato", $this->form_encode_input($sTmpValue))),
              );
          }
   }
...
$aLookup[] = array(TipoContrato_Frm_pack_protect_string('C') => str_replace('<', '&lt;',TipoContrato_Frm_pack_protect_string("Cliente")));
$aLookup[] = array(TipoContrato_Frm_pack_protect_string('F') => str_replace('<', '&lt;',TipoContrato_Frm_pack_protect_string("Fornecedor")));
$_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['Lookup_categoria'][] = 'C';
$_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['Lookup_categoria'][] = 'F';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          if (isset($this->NM_ajax_info['select_html']['categoria']) && !empty($this->NM_ajax_info['select_html']['categoria']))
          {
              $sOptComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['categoria']);
          }
          ...
          {
              $this->NM_ajax_info['fldList']['categoria']['valList'][$i] = TipoContrato_Frm_pack_protect_string($v);
          }
   ...
   function ajax_return_values_nomereferencia($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("nomereferencia", $this->nmgp_refresh_fields)) || $bForce || in_array("nomereferencia", $this->Upload_refresh_fields))
          {
              ...
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['download_filenames']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['download_filenames'] = array();
              }
              $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['download_filenames'][$sTmpFile] = $this->nomereferencia;
          ...
          $this->NM_ajax_info['fldList']['nomereferencia'] = array(
               ...
               'type'    => 'documento',
               'valList' => array($sTmpValue),
               'docLink' => "<a href=\"javascript:nm_mostra_doc('0', '" . $sTmpFile . "', 'TipoContrato_Frm')\">" . $tmp_file_nomereferencia . "</a>",
   ...
   function ajax_return_values_nomeaplicacaoauditoria($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['upload_dir'][$fieldName][] = $newName;
  ...
  function nm_proc_onload($bFormat = true)
  {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['Field_no_validate'] = array();
...
if (!isset($this->sc_temp_varNomeReferencia)) {$this->sc_temp_varNomeReferencia = (isset($_SESSION['varNomeReferencia'])) ? $_SESSION['varNomeReferencia'] : "";}
  $this->Preparar_LstFrm_OnSrip_OnLoad_Auditoria($this->Ini->nm_cod_apl, $this->idtipocontrato );
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['total']))
          {
               $sc_where_pos = " WHERE ((IdTipoContrato < $this->idtipocontrato))";
               if ('' != $sc_where)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->idtipocontrato)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opcao'] = '';
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->idtipocontrato)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
...
$_SESSION['scriptcase']['TipoContrato_Frm']['contr_erro'] = 'on';
      ...
      {
          $sc_cmd_dependency = "SELECT COUNT(*) AS countTest FROM clientecontrato WHERE IdContrato = '" . $idcontrato  . "'";
      }
      else
      {
          $sc_cmd_dependency = "SELECT COUNT(*) AS countTest FROM clientecontrato WHERE IdContrato = '" . $idcontrato  . "'";
...
;
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      {
          $sc_cmd_dependency = "SELECT COUNT(*) AS countTest FROM contratoitem WHERE IdContrato = '" . $idcontrato  . "'";
      }
      else
      {
          $sc_cmd_dependency = "SELECT COUNT(*) AS countTest FROM contratoitem WHERE IdContrato = '" . $idcontrato  . "'";
...
/*----- END - Scriptcase Locale: Event Dependency ------*/
      ...
      if ($this->versao === "" || is_null($this->versao))  
      { 
          $this->versao = 0;
          $this->sc_force_zero[] = 'versao';
      } 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select count(*) AS countTest from " . $this->Ini->nm_tabela . " where IdTipoContrato = $this->idtipocontrato ";
              $rs1 = $this->Db->Execute("select count(*) AS countTest from " . $this->Ini->nm_tabela . " where IdTipoContrato = $this->idtipocontrato "); 
          }  
          else  
          {
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select count(*) AS countTest from " . $this->Ini->nm_tabela . " where IdTipoContrato = $this->idtipocontrato ";
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "IdTenacidade = $this->idtenacidade, IdUsuarioAuditoria = $this->idusuarioauditoria, Categoria = '$this->categoria', Versao = $this->versao, Descricao = '$this->descricao', Observacoes = '$this->observacoes', NomeArquivo = '$this->nomearquivo', Ativo = '$this->ativo', EnderecoIpAuditoria = '$this->enderecoipauditoria', NomeAplicacaoAuditoria = '$this->nomeaplicacaoauditoria'"; 
              } 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
                  $comando .= " WHERE IdTipoContrato = $this->idtipocontrato ";  
              }  
              else  
              {
                  $comando .= " WHERE IdTipoContrato = $this->idtipocontrato ";  
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['nomereferencia_salva'] = array(
                      'row'     => '',
              ...
              $this->nmgp_refresh_fields = array_diff(array('descricao', 'idtipocontrato', 'categoria', 'versao', 'observacoes', 'ativo', 'nomereferencia', 'nomearquivo', 'idtenacidade', 'idusuarioauditoria', 'enderecoipauditoria', 'nomeaplicacaoauditoria'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          { 
              $NM_seq_auto = "NULL, ";
              $NM_cmp_auto = "IdTipoContrato, ";
          } 
          $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(IdTipoContrato) from " . $this->Ini->nm_tabela; 
          $comando = "select max(IdTipoContrato) from " . $this->Ini->nm_tabela; 
          $rs = $this->Db->Execute($comando); 
          if ($rs === false && !$rs->EOF)  
          { 
          ...
          $this->idtipocontrato_before_qstr = $this->idtipocontrato = $rs->fields[0] + 1;
          $rs->Close(); 
          $bInsertOk = true;
          $aInsertOk = array(); 
          $bInsertOk = $bInsertOk && empty($aInsertOk);
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (IdTenacidade, IdUsuarioAuditoria, Categoria, Versao, Descricao, Observacoes, NomeArquivo, NomeReferencia, Ativo, EnderecoIpAuditoria, NomeAplicacaoAuditoria) VALUES ($this->idtenacidade, $this->idusuarioauditoria, '$this->categoria', $this->versao, '$this->descricao', '$this->observacoes', '$this->nomearquivo', '$this->nomereferencia', '$this->ativo', '$this->enderecoipauditoria', '$this->nomeaplicacaoauditoria')"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
              ...
              { 
                  ...
                  $this->idtipocontrato =  $rsy->fields[0];
                 $rsy->Close(); 
              } 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      if ($this->nmgp_opcao == "excluir") 
      { 
          $this->idtipocontrato = substr($this->Db->qstr($this->idtipocontrato), 1, -1); 
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "DELETE FROM " . $this->Ini->nm_tabela . " where IdTipoContrato = $this->idtipocontrato "; 
                  $rs = $this->Db->Execute("DELETE FROM " . $this->Ini->nm_tabela . " where IdTipoContrato = $this->idtipocontrato "); 
              }  
              else  
              {
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "DELETE FROM " . $this->Ini->nm_tabela . " where IdTipoContrato = $this->idtipocontrato "; 
...
/*----- END - Scriptcase Locale: Event onAfterInsert ------*/
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['parms'] = "idtipocontrato?#?$this->idtipocontrato?@?"; 
      }
      ...
      { 
          $this->idtipocontrato = null === $this->idtipocontrato ? null : substr($this->Db->qstr($this->idtipocontrato), 1, -1); 
      } 
      if (isset($this->NM_where_filter))
      {
          $this->NM_where_filter = str_replace("@percent@", "%", $this->NM_where_filter);
          $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          $nmgp_select = "SELECT IdTipoContrato, IdTenacidade, IdUsuarioAuditoria, Categoria, Versao, Descricao, Observacoes, NomeArquivo, NomeReferencia, Ativo, EnderecoIpAuditoria, NomeAplicacaoAuditoria from " . $this->Ini->nm_tabela ; 
          $aWhere = array();
          $aWhere[] = $sc_where_filter;
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
                  $aWhere[] = "IdTipoContrato = $this->idtipocontrato"; 
              }  
              else  
              {
                  $aWhere[] = "IdTipoContrato = $this->idtipocontrato"; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "insert" || $this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['empty_filter'] = true;
                  return; 
              }
          ...
          if ($this->nmgp_opcao != "novo") 
          { 
              $this->idtipocontrato = $rs->fields[0] ; 
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $this->versao = (string)$this->versao; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['parms'] = "idtipocontrato?#?$this->idtipocontrato?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['sub_dir'][0]  = "/" . $_SESSION['varIdTenacidade'];
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['dados_select'] = $this->nmgp_dados_select;
...
//-- 
      ...
      { 
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
$_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['Field_disabled_macro']['idtenacidade'] = array('I'=>array(),'U'=>array());
;
			$this->sc_field_readonly("idusuarioauditoria", 'on');
$_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['Field_disabled_macro']['idusuarioauditoria'] = array('I'=>array(),'U'=>array());
;
			$this->sc_field_readonly("enderecoipauditoria", 'on');
$_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['Field_disabled_macro']['enderecoipauditoria'] = array('I'=>array(),'U'=>array());
;
			$this->sc_field_readonly("nomeaplicacaoauditoria", 'on');
$_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['Field_disabled_macro']['nomeaplicacaoauditoria'] = array('I'=>array(),'U'=>array());
;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['download_filenames'][$sTmpFile_nomereferencia] = $this->nomereferencia;
   } 
        $this->initFormPages();
    include_once("TipoContrato_Frm_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        $searchOk = false;
        if ('SC_all_Cmp' == $this->nmgp_fast_search && in_array($field, array("idtipocontrato", "categoria", "versao", "descricao", "observacoes", "nomearquivo"))) {
            $searchOk = true;
        }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function Form_lookup_categoria()
   {
       $nmgp_def_dados  = "";
       $nmgp_def_dados .= "Cliente?#?C?#?N?@?";
       $nmgp_def_dados .= "Fornecedor?#?F?#?N?@?";
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['dyn_search_cache']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['empty_filter']);
      ...
      foreach ($fields as $field) {
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "IdTipoContrato", $arg_search, str_replace(",", ".", $data_search), "BIGINT", false);
          }
          if ($field == "SC_all_Cmp") 
          {
          ...
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "Versao", $arg_search, str_replace(",", ".", $data_search), "SMALLINT", false);
          }
          if ($field == "SC_all_Cmp") 
          {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_TipoContrato_Frm = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['total'] = $qt_geral_reg_TipoContrato_Frm;
      $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          TipoContrato_Frm_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      $nm_numeric[] = "idtipocontrato";$nm_numeric[] = "idtenacidade";$nm_numeric[] = "idusuarioauditoria";$nm_numeric[] = "versao";
      if (in_array($campo_join, $nm_numeric))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "TipoContrato_Frm_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['nm_run_menu'] = 2;
       $nmgp_saida_form = "TipoContrato_Frm_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['link_info']['compact_mode']) {
            return;
        }
?>
...
<div style="width: 100%">
 ...
 <div style="height:25px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: solid; border-color:#72c045; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - Tipo de Contrato"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - Tipo de Contrato"; } ?></span></td>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['TipoContrato_Frm']['ordem_ord'] == " desc") {
