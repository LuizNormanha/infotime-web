<?php
   include_once('Configuracao_Lst_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_perfil']          = "ligasistemas";
   $_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class Configuracao_Lst_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "Configuracao_Lst"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_dt_criacao   = "20140227"; 
      $this->nm_hr_criacao   = "111023"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['Configuracao_Lst']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['Configuracao_Lst']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['Configuracao_Lst']['save_session']['data'] = '';
      } 
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['sub_cons_schema_all']))
      { 
         $this->str_schema_all    = $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['sub_cons_schema_all'];
         $this->str_schema_filter = $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['sub_cons_schema_filter'];
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/Configuracao_Lst';
      ...
      $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['Configuracao_Lst']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['Configuracao_Lst']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['Configuracao_Lst']['actual_lang']) || $_SESSION['scriptcase']['Configuracao_Lst']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['Configuracao_Lst']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("Configuracao_Lst_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if (!$_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['embutida'])
    {
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dyn_search_add']['cmp'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dyn_search_add']['seq'] = $_POST['seq'];
          $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
    }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['remove_border']   = false;
          $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['remove_background'] = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
              if (isset($_GET['remove_background'])) {
                  $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['remove_background'] = 1 == $_GET['remove_background'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
              if (isset($remove_background)) {
                  $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['remove_background'] = 1 == $remove_background;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      $Tmp_apl_lig = "Configuracao_Frm";
      if (is_file($this->root . $this->path_link . "_lib/_app_data/Configuracao_Frm_ini.php"))
      {
          require($this->root . $this->path_link . "_lib/_app_data/Configuracao_Frm_ini.php");
          $Tmp_apl_lig = $arr_data['friendly_url'];
          if (isset($arr_data['md5']) && trim($arr_data['md5']) == "LigMd5")
          {
              $this->sc_lig_md5["Configuracao_Frm"] = 'S';
          }
      }
      $this->sc_lig_target["A_@scinf_"] = '_self';
      $this->sc_lig_target["A_@scinf__@scinf_Configuracao_Frm"] = '_self';
      if ($_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["Configuracao_Lst"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["Configuracao_Lst"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) || isset($link_remove_margin) || isset($link_remove_border) || isset($link_remove_background) || isset($link_margin_top)) {
            $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['link_info'] = array();
        }
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['link_info']['remove_border'] = true;
        }
        if (isset($link_remove_background) && 'ok' == $link_remove_background) {
            $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['link_info']['remove_background'] = true;
        }
        if (isset($link_margin_top) && '' != $link_margin_top) {
            $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['link_info']['margin_top'] = $link_margin_top;
        }
      $this->link_Configuracao_Frm =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('Configuracao_Frm') . "/Configuracao_Frm.php" ; 
      if (!isset($_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['Configuracao_Lst']['session_timeout']['redir']))
      {
      ...
      if (isset($_POST['nm_grid_submit']) && $_POST['nm_grid_submit'] == 1 && isset($_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['csrf_token'] ) && !isset($_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['embutida']) && !isset($_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['embutida_form'])) {
          if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] != $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['csrf_token']) {
              echo "<html>";
              echo "<body>";
              echo "<table align=\"center\" width=\"50%\" border=1 height=\"50px\">";
              echo "<tr>";
      ...
      $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['path_doc'] = $this->path_doc; 
...
<body>
    <div class='ui container' style='padding-top:2rem'>
        <section class='ui message'>
         ...
         echo $str_message;
          if (!$_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "Configuracao_Lst_erro.class.php"); 
      $this->Erro = new Configuracao_Lst_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('Configuracao_Lst'); 
// 
      $this->sc_Include($this->path_lib_php . "/nm_functions.php", "", "") ; 
      global $bol_api_prod; 
      $bol_api_prod = true; 
      if (isset($_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_conexao'])) 
      { 
          $bol_api_prod = false; 
      } 
      ...
      if (isset($_SESSION['scriptcase']['Configuracao_Lst']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['Configuracao_Lst']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['Configuracao_Lst']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['Configuracao_Lst']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['Configuracao_Lst']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['Configuracao_Lst']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      if (isset($_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['initialize'])  
      { 
          
/*----- Scriptcase Locale: Event onApplicationInit ------*/
$_SESSION['scriptcase']['Configuracao_Lst']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['Configuracao_Lst']['contr_erro'] = 'off';
/*----- END - Scriptcase Locale: Event onApplicationInit ------*/
 
          $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['initialize'] = false;
      } 
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_conexao']) && $_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_perfil']) && $_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['Configuracao_Lst']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['Configuracao_Lst']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      ...
      if (isset($_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['embutida_init']) 
      {
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_conexao'], $this->root . $this->path_prod, 'LIGA_InfoTIME', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['embutida'])
      {
...
// 
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['csrf_token']))
       {
           $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['csrf_token'] = $this->scCsrfGenerateToken();
       }

       return $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['csrf_token'];
   }
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['Configuracao_Lst']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class Configuracao_Lst_sub_css
{
   function __construct()
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['Configuracao_Lst']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['Configuracao_Lst'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class Configuracao_Lst_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['Configuracao_Lst']))
      { 
          $GLOBALS['nmgp_parms'] = $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['Configuracao_Lst'];
          $Parms_form_pdf = true;
      } 
      if ($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida'] || $Parms_form_pdf)
      { 
          ...
          { 
              ...
              foreach ($todo as $param)
              {
                   ...
                   if (1 < sizeof($cadapar))
                   {
                       ...
                       nm_limpa_str_Configuracao_Lst($cadapar[1]);
                       nm_protect_num_Configuracao_Lst($cadapar[0], $cadapar[1]);
                       if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                       $Tmp_par   = $cadapar[0];
                       $$Tmp_par = $cadapar[1];
                       if ($Tmp_par == "nmgp_opcao")
                       {
                           $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['opcao'] = $cadapar[1];
                       }
                   }
              }
          } 
          ...
          if (isset($varIdTenacidade)) 
          {
              ...
              nm_limpa_str_Configuracao_Lst($_SESSION["varIdTenacidade"]);
          }
          ...
          if (isset($varPrimeiraVez)) 
          {
              ...
              nm_limpa_str_Configuracao_Lst($_SESSION["varPrimeiraVez"]);
          }
          ...
          if (isset($varIdUsuario)) 
          {
              ...
              nm_limpa_str_Configuracao_Lst($_SESSION["varIdUsuario"]);
          }
          ...
          if (isset($varPrivAdmin)) 
          {
              ...
              nm_limpa_str_Configuracao_Lst($_SESSION["varPrivAdmin"]);
          }
      } 
      if ($Parms_form_pdf)
      { 
          $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_pdf'] = true;
          $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_form'] = true;
          $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_form_full'] = false;
          $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_pai'] = "";
      } 
      $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_ibase'])) 
      { 
          $this->Ini = new Configuracao_Lst_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida_ibase'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
      if (!isset($nmgp_opcao)) {
         $nmgp_opcao = "";
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'])) {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = "";
      }
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['Configuracao_Lst']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['Configuracao_Lst'];
          }
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Configuracao_Lst']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Configuracao_Lst']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('Configuracao_Lst') . "/Configuracao_Lst.php";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Configuracao_Lst']['label'] = "" . $this->Ini->Nm_lang['lang_othr_grid_titl'] . " Configuração geral";
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'])
      {
          $this->Change_Menu = false;
      }
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("pt_br");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "Configuracao_Lst/Configuracao_Lst_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "Configuracao_Lst_erro.class.php"); 
      } 
      $this->Erro      = new Configuracao_Lst_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "Configuracao_Lst/Configuracao_Lst_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "Configuracao_Lst_lookup.class.php"); 
      } 
      $this->Lookup       = new Configuracao_Lst_lookup();
      $this->Lookup->Db   = $this->Db;
      $this->Lookup->Ini  = $this->Ini;
      $this->Lookup->Erro = $this->Erro;
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "Configuracao_Lst.php" ; 
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_export")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = $nmgp_opcao;
              if ($nmgp_opcao == "print" || $nmgp_opcao == "res_print" || $nmgp_opcao == "det_print")
              {
                  $ajax_opc_print   = true;
                  $nm_arquivo_print = "/sc_Configuracao_Lst_" . session_id();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['ajax_nav'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['scroll_navigate'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['scroll_navigate_reload'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['scroll_navigate_app'] = false;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['scroll_navigate_header_row']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['scroll_navigate_header_row'] = 1;
          }
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['ajax_nav'] = true;
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['save_grid'] = true;
              }
              ...
              {
                  $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['contr_total_geral'] = "NAO";
                  $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['contr_array_resumo'] = "NAO";
                  unset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['tot_geral']);
                  unset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['arr_total']);
                  unset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['using_summary_cache']);
                  unset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['pivot_group_by']);
                  unset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['pivot_x_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['pivot_y_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['pivot_fill']);
                  unset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['pivot_order']);
                  unset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['pivot_order_col']);
                  unset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['pivot_order_level']);
                  unset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['pivot_order_sort']);
                  unset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['pivot_tabular']);
              }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['SC_Gb_date_format'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['SC_Gb_date_format'] = array();
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['SC_All_Groupby'] = array('sc_free_total' => 'grid');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['SC_Ind_Groupby'] = $Ind;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['Labels_GB'] = array();
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['SC_Ind_Groupby'] == "sc_free_total")
      {
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dados_orig_gb']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dados_orig_gb'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dados_orig_gb']['all']['SC_Ind_Groupby'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['SC_Ind_Groupby']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dados_orig_gb']['all']['SC_Ind_Groupby'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['SC_Ind_Groupby'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['SC_Gb_Free_cmp']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['SC_Gb_Free_cmp'];
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dados_orig_gb']['res']['summarizing_fields_display'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dados_orig_gb']['res']['summarizing_fields_order']   = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dados_orig_gb']['res']['summarizing_fields_control'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dados_orig_gb']['res']['pivot_x_axys']               = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['summarizing_fields_display']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dados_orig_gb']['res']['summarizing_fields_display'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['summarizing_fields_display'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['summarizing_fields_order']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dados_orig_gb']['res']['summarizing_fields_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['summarizing_fields_order'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['summarizing_fields_control']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dados_orig_gb']['res']['summarizing_fields_control'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['summarizing_fields_control'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['pivot_x_axys']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dados_orig_gb']['res']['pivot_x_axys'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['pivot_x_axys'];
          }
      }
      $this->Ini->Apl_resumo  = "Configuracao_Lst_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "Configuracao_Lst_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['SC_Ind_Groupby'] . ".class.php"; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['xls_return']  = ($nmgp_opcao == "xls")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['csv_return']  = ($nmgp_opcao == "csv")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['xml_return']  = ($nmgp_opcao == "xml")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['json_return'] = ($nmgp_opcao == "json") ? "volta_grid" : "resumo"; 
      ...
      if ($nmgp_opcao == 'print' || $nmgp_opcao == 'res_print') {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['print_return'] = $this->ret_print;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'])
      {
          if ($this->Ini->Export_html_zip)
          {
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['html_name']))
              {
                  $nm_arquivo_html = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['html_name'];
              }
              elseif ($nmgp_opcao == 'print' && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
              {
                  $nm_arquivo_html = "/sc_Configuracao_Lst_" . session_id() . ".html";
              }
              else
              {
                  $nm_arquivo_html = "/sc_Configuracao_Lst_res_" . session_id() . ".html";
              }
      ...
      if ($nmgp_opcao == "doc_word") {  
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['word_return'] = $this->ret_word;
          $_SESSION['scriptcase']['proc_mobile'] = false;
      }
      ...
      { 
          $nmgp_opcao = "doc_word"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = "doc_word"; 
      }
      elseif ($nmgp_opcao == "doc_word" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "doc_word_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = "doc_word_res"; 
      }
      if ($nmgp_opcao == "xls_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xls"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = "xls"; 
      }
      elseif ($nmgp_opcao == "xls" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xls_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = "xls_res"; 
      }
      if ($nmgp_opcao == "csv_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "csv"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = "csv"; 
      }
      elseif ($nmgp_opcao == "csv" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "csv_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = "csv_res"; 
      }
      if ($nmgp_opcao == "xml_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xml"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = "xml"; 
      }
      elseif ($nmgp_opcao == "xml" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xml_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = "xml_res"; 
      }
      if ($nmgp_opcao == "json_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "json"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = "json"; 
      }
      elseif ($nmgp_opcao == "json" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "json_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = "json_res"; 
      }
      $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['skip_summary'] = false;
      if ('chart' == $this->Ini->SC_module_export) {
          $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['skip_summary'] = true;
          $this->Ini->SC_module_export = 'resume,chart';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['pdf_det'] = false;
      if ($nmgp_opcao == 'pdf')
      { 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
          }
          else
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['pdf_res'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['conf_chart_level'] = "S";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida_treeview'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida_opcao']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida_opcao'] = "";
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['proc_pdf'] = (!$_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "pdf_res")) ? true : false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['proc_pdf']) {
          $_SESSION['scriptcase']['proc_mobile'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['proc_pdf_vert'] = false;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['field_order']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['field_order'][] = "idtenacidade";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['field_order'][] = "idconfiguracao";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['field_order_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['field_order'];
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['usr_cmp_sel']))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['usr_cmp_sel'] = array();
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['usr_cmp_sel_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['usr_cmp_sel'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Configuracao_Lst']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['Configuracao_Lst']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['Configuracao_Lst']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      if (!$_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida'])
      { 
      ...
      if (!$_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida'])
      { 
          $this->pdf_zip = (isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['opc_pdf']['pdf_zip'])) ? $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['opc_pdf']['pdf_zip'] : "N";
          $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['use_pass_pdf'] = "";
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_orig'])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = "inicio";//=)
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Configuracao_Lst']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['Configuracao_Lst']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = "busca";
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opc_liga'] = $NMSC_conf_apl;  
          }   
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opc_liga']['inicial']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opc_liga']['inicial'];
              $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['orig_pesq'] = "grid";
          }
      }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opc_liga']['paginacao'];
          } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "print")  
      { 
          if (strpos(" " . $this->Ini->SC_module_export, "grid") === false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = "res_print";
          }
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['print_all'] = true;
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = "print";
              $nmgp_tipo_print = "RC";
          }
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "pdf")
      { 
      ...
      if (isset($_POST['nmgp_opcao']) && 'resumo' == $_POST['nmgp_opcao']
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['contr_array_resumo'] = 'NAO';
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['contr_total_geral'] = 'NAO';
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['tot_geral']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['using_summary_cache']);
      }

      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "fast_search")  
      { 
          $this->SC_fast_search($GLOBALS["nmgp_fast_search"], $GLOBALS["nmgp_cond_fast_search"], $GLOBALS["nmgp_arg_fast_search"]);
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq'])
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = 'igual';
          } 
          else 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['contr_array_resumo'] = "NAO";
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['contr_total_geral']  = "NAO";
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['tot_geral']);
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['using_summary_cache']);
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = 'pesq';
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['orig_pesq'] = 'grid';
          } 
      } 
      if(in_array($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'], array('dyn_search_save', 'dyn_search_select', 'dyn_search_delete', 'dyn_search_save_res', 'dyn_search_select_res', 'dyn_search_delete_res')))
      { 
          $this->SC_proc_dyn_search_save($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'], $_POST['parm']);
          if($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == 'dyn_search_select' || $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == 'dyn_search_save')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = 'dyn_search';
          }
          elseif($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == 'dyn_search_select_res' || $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == 'dyn_search_save_res')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = 'dyn_search_res';
          }
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "dyn_search" || $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "dyn_search_clear")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "dyn_search_clear")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dyn_search_clear'] = true;
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['cond_dyn_search']);
          } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = 'inicio';
          } 
      } 
      if ('gantt' == $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] && ('inicio' == $_GET['nmgp_opcao'] || 'inicio' == $_POST['nmgp_opcao'])) {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = 'inicio';
      }
//
      $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['prim_cons'] = false;  
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['use_pass_pdf']);
       if (!$GLOBALS['nm_restore_grid_save']) { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['prim_cons'] = true;  
         $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_orig'] = " where (IdTenacidade = '" . $_SESSION['varIdTenacidade'] . "')";
         $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['cond_pesq']         = ""; 
         $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_filtro'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_lookup'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['campos_busca']      = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['grid_pesq']         = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['Grid_search']       = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dyn_search']        = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['cond_dyn_search']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_fast']   = "";
       }
         $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['contr_total_geral'] = "NAO";
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['sc_total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['tot_geral']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['using_summary_cache']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['contr_array_resumo'] = "NAO";
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_ant'];  
      ...
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_Configuracao_Lst_html_" . session_id() . "_2.html";
            $nm_arquivo_pdf_base = "/sc_pdf_" . md5(date("Ymd") . "_" . session_id()) . "_Configuracao_Lst.pdf";
            $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_Configuracao_Lst_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_Configuracao_Lst_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "doc_word_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['print_navigator'] = "Microsoft Internet Explorer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['print_all'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['doc_word']  = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao']     = "resumo";
          $_SESSION['scriptcase']['saida_word'] = true;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['word_name']))
          {
              $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['word_name'], ".");
              if ($Pos === false) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['word_name'] .= ".doc";
              }
              $nm_arquivo_doc_word = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['word_name'];
          }
          else
          {
              $nm_arquivo_doc_word = "/sc_Configuracao_Lst_res_" . session_id() . ".doc";
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "xls")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Configuracao_Lst/Configuracao_Lst_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Configuracao_Lst_xls.class.php"); 
          } 
          $this->xls  = new Configuracao_Lst_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "xls_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Configuracao_Lst/Configuracao_Lst_res_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Configuracao_Lst_res_xls.class.php"); 
          } 
          $this->xls  = new Configuracao_Lst_res_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "xml")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Configuracao_Lst/Configuracao_Lst_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Configuracao_Lst_xml.class.php"); 
          } 
          $this->xml  = new Configuracao_Lst_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "xml_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Configuracao_Lst/Configuracao_Lst_res_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Configuracao_Lst_res_xml.class.php"); 
          } 
          $this->xml  = new Configuracao_Lst_res_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "json")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Configuracao_Lst/Configuracao_Lst_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Configuracao_Lst_json.class.php"); 
          } 
          $this->json  = new Configuracao_Lst_json();
          $this->prep_modulos("json");
          $this->json->monta_json();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "json_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Configuracao_Lst/Configuracao_Lst_res_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Configuracao_Lst_res_json.class.php"); 
          } 
          $this->json  = new Configuracao_Lst_res_json();
          $this->prep_modulos("json");
          $this->json->monta_json();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "csv")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Configuracao_Lst/Configuracao_Lst_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Configuracao_Lst_csv.class.php"); 
          } 
          $this->csv  = new Configuracao_Lst_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "csv_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Configuracao_Lst/Configuracao_Lst_res_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Configuracao_Lst_res_csv.class.php"); 
          } 
          $this->csv  = new Configuracao_Lst_res_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "rtf")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Configuracao_Lst/Configuracao_Lst_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Configuracao_Lst_rtf.class.php"); 
          } 
          $this->rtf  = new Configuracao_Lst_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "rtf_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Configuracao_Lst/Configuracao_Lst_res_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Configuracao_Lst_res_rtf.class.php"); 
          } 
          $this->rtf  = new Configuracao_Lst_res_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
    if (isset($_POST['chartapp_action']) && 'Y' == $_POST['chartapp_action']) {
        if (isset($_POST['chartapp_chart_type']) && 'Y' == $_POST['chartapp_chart_type'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['chart_info'][$_POST['chart_md5']])) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida']) {
                require_once($this->Ini->path_embutida . "Configuracao_Lst" . $this->Ini->Apl_resumo);
            } else {
                require_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo);
            }
            $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['chart_app_change_type'] = true;
            $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['chart_app_md5'] = $_POST['chart_md5'];
            $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['chart_app_type'] = $_POST['chart_type'];
            $this->Res = new Configuracao_Lst_resumo("out");
            $this->prep_modulos("Res");
            $this->Res->monta_resumo();
        } else {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida']) {
                require_once($this->Ini->path_embutida . "Configuracao_Lst" . $this->Ini->Apl_grafico);
            } else {
                require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico);
            }
            $this->Graf = new Configuracao_Lst_grafico();
      ...
      { 
          ...
          $this->Graf  = new Configuracao_Lst_grafico();
          $this->prep_modulos("Graf");
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'], 8));
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = "grid";
          }
          else
          { 
              if (isset($_POST['summary_chart_data']) && 'Y' == $_POST['summary_chart_data'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['chart_info'][$_POST['chart_md5']])) {
                  $this->Graf->display_summaryChart_data($_POST['chart_md5']);
              }
              elseif (isset($_POST['summary_chart']) && 'Y' == $_POST['summary_chart'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['chart_info'][$_POST['chart_md5']])) {
              ...
              elseif (isset($_POST['chart_inline_update']) && 'Y' == $_POST['chart_inline_update'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['chart_info'][$_POST['chart_md5']])) {
                  $this->Graf->display_summaryChart_inline_updateAjaxResponse($_POST['chart_md5']);
              }
              elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dashboard_refresh_after_chart'])) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dashboard_refresh_after_chart'];
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dashboard_refresh_after_chart']);
              }
              else {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] = "grid";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "Configuracao_Lst_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Configuracao_Lst_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new Configuracao_Lst_pesq();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "resumo")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Configuracao_Lst/" . $this->Ini->Apl_resumo); 
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "print" && $nmgp_tipo_print == "RC")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['print_navigator'] = $nmgp_navegator_print;
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao']     = "pdf";
              $GLOBALS['nmgp_tipo_pdf'] = strtolower($nmgp_cor_print);
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] == "doc_word")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['print_navigator'] = "Microsoft Internet Explorer";
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['doc_word']  = true;
              ...
              {
                  $nm_arquivo_doc_word = "/sc_Configuracao_Lst_" . session_id() . ".doc";
              }
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word);
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Configuracao_Lst/Configuracao_Lst_grid.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Configuracao_Lst_grid.class.php"); 
          } 
          $this->grid  = new Configuracao_Lst_grid();
...
<?php
      ...
      {
         $nm_saida->finaliza();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['ajax_nav'])
         {
             $Temp = ob_get_clean();
             ...
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['opcao'] != "ajax_detalhe")  
             {
            ...
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['export_sel_columns']['field_order']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['export_sel_columns']['field_order'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['export_sel_columns']['field_order']);
            }
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['export_sel_columns']['usr_cmp_sel']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['export_sel_columns']['usr_cmp_sel'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['export_sel_columns']['usr_cmp_sel']);
            }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['doc_word'])
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['word_file'] = $this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['pdf_res'])
            { 
                $str_pd4ml .= " --outline-depth 0";
            }
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    Configuracao_Lst_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . $this->grid->progress_tot . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                    fwrite($this->grid->progress_fp, ($this->grid->progress_tot) . "_#NM#_" . $lang_protect . "...\n");
                    fclose($this->grid->progress_fp);
                }
            }
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['pdf_name']))
            {
                $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['pdf_name'], ".");
                if ($Pos === false) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['pdf_name'] .= ".pdf";
                }
                if ('/' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['pdf_name'], 0, 1)) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['pdf_name'] = substr($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['pdf_name'], 1);
                }
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['pdf_name']);
            }
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['use_pass_pdf'];
            ...
            $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['contr_array_resumo'] = '';
            $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['contr_total_geral']  = '';
            // ----- PDF log
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    if ($this->grid->progress_fp)
                    {
                        ...
                        Configuracao_Lst_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . ($this->grid->progress_now + 1 + $this->grid->progress_pdf) . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                        Configuracao_Lst_pdf_progress_call("off\n", $this->Ini->Nm_lang);
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['pdf_file'] = $nm_arquivo_pdf_serv;
}
$NM_volta  = "volta_grid";
$NM_target = "_parent";
if ($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['pdf_res'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> Configuração geral :: PDF</TITLE>
...
<?php
                    ...
                    fwrite($rRFP, "off\n");
                    fclose($rRFP);
$downloadFileName = "Configuracao_Lst.pdf";
if ($this->pdf_zip == 'S') {
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst'][md5("newpdf_" . $downloadFileName)][0] = $nm_arquivo_pdf_url;
    $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst'][md5("newpdf_" . $downloadFileName)][1] = $downloadFileName;
}
...
?>
<FORM name="F0" method=post action="Configuracao_Lst.php" target="<?php echo $NM_target; ?>"> 
...
<?php
   ...
   function SC_btn_0() 
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_filtro'];
      $nm_f_saida = "Configuracao_Lst.php";
?>
     <!DOCTYPE html>
      <html<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
      <head>
   ...
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0, $opc="")
   {
      if (is_array($nm_apl_parms))
      {
          ...
          foreach ($nm_apl_parms as $par => $val)
          {
              ...
              elseif (substr($val, 0, 1) == "[")
              {
                  $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst'][substr($val, 1, -1)];
              }
              else
              {
                  $tmp_parms .= $val;
      ...
      if ($nm_target == "modal")
      {
          ...
          $par_modal = "?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&nmgp_outra_jan=true&nmgp_url_saida=modal&NMSC_modal=ok&";
           if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['embutida_form_full']) || (isset($this->grid_emb_form_full) && $this->grid_emb_form_full))
           {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['iframe_print']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['iframe_print'] )
      {
          $target = "_parent";
      }
...
?>
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (empty($data_search)) 
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_fast'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_filtro'] = "";
          $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_orig'];
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_dyn'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_dyn'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_dyn'] . ")"; 
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq'] = $tmp_cmd;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['fast_search']);
          return;
      }
      $comando = "";
      ...
      foreach ($fields as $field) {
          if ($field == "SC_all_Cmp" || $field == "idconfiguracao") 
          {
              $this->SC_monta_condicao($comando, "IdConfiguracao", $arg_search, str_replace(",", ".", $data_search));
          }
          if ($field == "SC_all_Cmp" || $field == "idtenacidade") 
          {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_fast'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_filtro'] = "";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_orig'])) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_orig'] . " and ( " . $comando . " )"; 
      }
      else
      {
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_dyn'])) 
      {
          $comando .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_dyn'] . ")";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['fast_search'][0] = $in_fields;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['fast_search'][2] = $sv_data;
   }
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      $nm_numeric[] = "idconfiguracao";$nm_numeric[] = "idtenacidade";
      if (in_array($campo_join, $nm_numeric))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
   ...
   function SC_proc_dyn_search($Parms)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dyn_search_and_or']['new'] = $dynamicAndOr;
       $tmp    = explode("_FDYN_", $Parms);
       $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dyn_search'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dyn_refresh'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['tmp_busca'] = array();
       ...
       foreach ($tmp as $cada_f)
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dyn_search'][$ix2++] = array('cmp' => $dats[0], 'opc' => $dats[1], 'val_formated' => $val_formated, 'val' => $val_sv, 'Res_chk' => $fields[$ix]['Res_chk'], 'seq' => $dats[3]);
           if (!isset($busca[$dats[0]]))
           {
               $busca[$dats[0]] = $dats[1];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['tmp_busca'][$dats[0]] = (isset($fields[$ix]['vls'][0])) ? $fields[$ix]['vls'][0][0] : "";
               if (isset($fields[$ix]['vls'][1]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['tmp_busca'][$dats[0] . '_input_2'] = $fields[$ix]['vls'][1][0];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['tmp_busca'][$dats[0] . '_cond'] = $dats[1];
           }
           $ix++;
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dyn_search_and_or']['old'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dyn_search'];
      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['tmp_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['tmp_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['tmp_busca'] as $ind => $dados)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['campos_busca'][$ind] = $dados;
      }
   ...
   function SC_processa_dyn_search($fields, $Res_comp='dyn')
   {
       ...
       $this->Cmd_Dyn_Search    = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['cond_dyn_search'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq'] = "";
       foreach ($fields as $ind => $dados)
       {
           ...
           if ($dados['field'] == "idconfiguracao" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dyn_search_label']['idconfiguracao'];
               ...
               $this->SC_proc_dyn_search_all($dados['cond'], $dados['vls'], "IdConfiguracao", 'N', 'BIGINT', $Label_cmp, false);
           }
           if ($dados['field'] == "idtenacidade" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dyn_search_label']['idtenacidade'];
               $dados['vls'][0] = $dados['vls'][0][0];
               if ($dados['cond'] == "BW")
               {
                   $dados['vls'][1] = $dados['vls'][1][0];
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dyn_search_out_cmd']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dyn_search_out_cmd']))
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dyn_search_out_cmd'] as $cada_out)
           {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dyn_search_out_cond']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dyn_search_out_cond']))
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['dyn_search_out_cond'] as $cada_out)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['cond_dyn_search'] .= $cada_out . "##*@@";
           }
       }
       if ($this->NM_case_insensitive)
       {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_dyn'] = $this->Cmd_Dyn_Search;
       if (empty($this->Cmd_Dyn_Search)) 
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_orig'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_filtro'] = "";
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['cond_dyn_search']   = "";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_fast'])) 
           {
               if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq'])) 
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_fast'] . ")";
               }
               else 
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_fast'] . ")";
               }
           }
           return;
       }
       if ($Res_comp == "compara") {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_compara'] = (!empty($this->Cmd_Dyn_Search)) ? "(" . $this->Cmd_Dyn_Search . ")" : "";
       }
       if ($Res_comp == "calend") {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_calend'] = (!empty($this->Cmd_Dyn_Search)) ? "(" . $this->Cmd_Dyn_Search . ")" : "";
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_filtro'] = "( " . $this->Cmd_Dyn_Search . " )";
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_orig'])) 
       {
           $this->Cmd_Dyn_Search = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_orig'] . " and (" . $this->Cmd_Dyn_Search . ")"; 
       }
       else
       {
           $this->Cmd_Dyn_Search = " where " . $this->Cmd_Dyn_Search; 
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq'] = $this->Cmd_Dyn_Search;
       $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['cond_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['cond_dyn_search'] . $this->Dyn_Serarch_and_or;
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_fast'])) 
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['where_pesq_fast'] . ")";
       }
       if (NM_is_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['cond_pesq']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['cond_pesq'] = sc_convert_encoding($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['cond_pesq'], $_SESSION['scriptcase']['charset'], "UTF-8");
       }
   }
   function SC_proc_dyn_search_lookup($cond, $vls, $sql, $tp, $tsql, $lab)
   {
       ...
       if (!empty($nm_cmd))
       {
           ...
           if ($cond == "DF" || $cond == "NP")
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['cond_dyn_search'] .= $lab . " " . $Lang_descr_final . " " . $nm_cond . "##*@@";
           }
           else
           {
   ...
   function SC_proc_dyn_search_all($cond, $vls, $sql, $tp, $tsql, $lab, $tp_unaccent=false)
   {
       ...
       if ($tp == "N" && $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['decimal_db'] == ".")
       {
           $nm_aspas  = "";
           $nm_aspas1 = "";
       }
       if ($tp == "DT" || $tp == "DH" || $tp == "HH")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['SC_sep_date']))
           {
               $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['SC_sep_date'];
               $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['SC_sep_date1'];
           }
       }
       $nm_ini_lower = "";
       $nm_fim_lower = "";
       ...
       $dados   = $vls[0];
           ...
           if (!empty($nm_cmd))
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['cond_dyn_search'] .= $nm_cond;
           }
   }
  ...
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst']['word_file']);
      ...
      if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false || strpos(" " . $this->Ini->SC_module_export, "resume") !== false)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_imag_temp'] . "/");
          ...
          $this->pb->setReturnUrl("Configuracao_Lst.php");
...
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> Configuração geral :: Doc</TITLE>
 <META http-equiv="Content-Type" content="text/html; charset=<?php echo $_SESSION['scriptcase']['charset_html'] ?>" />
 <META http-equiv="Expires" content="Fri, Jan 01 1900 00:00:00 GMT"/>
 <META http-equiv="Last-Modified" content="<?php echo gmdate("D, d M Y H:i:s"); ?> GMT"/>
 <META http-equiv="Cache-Control" content="no-store, no-cache, must-revalidate"/>
...
<form name="Fdown" method="get" action="Configuracao_Lst_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="Configuracao_Lst"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<FORM name="F0" method=post action="Configuracao_Lst.php"> 
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      ...
      $Html_password = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Configuracao_Lst'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_imag_temp'] . "/");
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['Configuracao_Lst']['sc_process_barr'])) {
       return;
   }
   ...
   if (!empty($_POST))
   {
       ...
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_Configuracao_Lst($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_Configuracao_Lst($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_imag_temp'] . "/sc_apl_default_LIGA_InfoTIME.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['Configuracao_Lst']['glo_nm_path_imag_temp'] . "/sc_apl_default_LIGA_InfoTIME.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "Configuracao_Lst") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['Configuracao_Lst']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['Configuracao_Lst']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['Configuracao_Lst']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_LIGA_InfoTIME'])) {
               $_SESSION['scriptcase']['Configuracao_Lst']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_LIGA_InfoTIME'];
           }
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['Configuracao_Lst']['master_pai']) && $_SESSION['sc_session'][$init_filho]['Configuracao_Lst']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['Configuracao_Lst']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['Configuracao_Lst']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['Configuracao_Lst']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['Configuracao_Lst']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['Configuracao_Lst']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['Configuracao_Lst']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['Configuracao_Lst']['embutida_form_full'] : false;
       $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['Configuracao_Lst']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['Configuracao_Lst']['embutida_form_parms']);
       $nm_apl_dependente = 1;
       $nm_embutida_form  = true;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_form_full']);
       unset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']);
               $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['b_sair'] = false;
           }   
       } 
   } 
   if (!isset($nmgp_opcao)) {
   ...
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida']) && $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['Configuracao_Lst']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['Configuracao_Lst']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['Configuracao_Lst']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['Configuracao_Lst']['protect_modal']) && !empty($_SESSION['scriptcase']['Configuracao_Lst']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['Configuracao_Lst']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "Configuracao_Lst";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'Configuracao_Lst' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (!isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('Configuracao_Lst' == $sReferer || 'Configuracao_Lst_' == substr($sReferer, 0, 17))
       {
           $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['initialize'] = false;
       }
       else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['contr_total_geral'] = "NAO";
   }
   ...
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['b_sair'] = true;
   }
   $STR_lang    = (isset($_SESSION['scriptcase']['str_lang']) && !empty($_SESSION['scriptcase']['str_lang'])) ? $_SESSION['scriptcase']['str_lang'] : "pt_br";
   if (isset($_SESSION['scriptcase']['Configuracao_Lst']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['Configuracao_Lst']['session_timeout']['lang'];
   }
   $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "Liga_Soft_sm/Liga_Soft_sm";
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'Configuracao_Lst')
   {
       $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/Configuracao_Lst_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['contr_total_geral'] = "NAO";
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['opcao'] = $nmgp_opcao ;  
       }   
       ...
       if (!isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['mostra_edit'] = "S";
       }
       if (isset($nmgp_lig_edit_lapis)) 
       {
          $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (!isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['sc_modal']))
       {
           $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['sc_modal'] = false;
       }
       if (isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['volta_redirect_tp'] = "";
           $nm_url_saida = "Configuracao_Lst_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['sc_modal'] = true;
               }
               $nm_url_saida = "Configuracao_Lst_fim.php"; 
           }
           elseif (!$nm_embutida_form)
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['opcao'] != "pdf" ) 
       { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['scriptcase']['nm_sc_retorno']; 
            $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['opc_psq'] = true;   
           if (isset($nmgp_iframe_ret)) {
               $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
           $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['opc_psq']  = false;   
           $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['psq_edit'] = 'N';   
       } 
       if (isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_form_full'])
           {
               $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['mostra_edit'] = "N";   
           } 
       ...
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['Configuracao_Lst'] = "on";
       } 
       if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['Configuracao_Lst'] = "on";
       } 
       if (!$_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['opc_psq'] && !isset($_SESSION['scriptcase']['Configuracao_Lst']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Configuracao_Lst']) || $_SESSION['scriptcase']['sc_apl_seg']['Configuracao_Lst'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['iframe_menu']) ? false : true;
              if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
              {
                  foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
                  {
                      if (in_array("Configuracao_Lst", $apls_aba))
                      {
                          $nm_botao_ok = false;
                           break;
                      }
              ...
              if ((isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida']) && $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida']) || (isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida_form']))
              {
                   $nm_botao_ok = false;
              }
...
<?php
       ...
       $contr_Configuracao_Lst = new Configuracao_Lst_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['opcao'] = "busca";
          $contr_Configuracao_Lst->NM_ajax_flag = true;
          $contr_Configuracao_Lst->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['opcao'] = "busca";
          $contr_Configuracao_Lst->NM_ajax_flag = true;
          $contr_Configuracao_Lst->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['opcao'] = "busca";
          $contr_Configuracao_Lst->NM_ajax_flag = true;
          $contr_Configuracao_Lst->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['opcao'] = "busca";
          $contr_Configuracao_Lst->NM_ajax_flag = true;
          $contr_Configuracao_Lst->NM_ajax_opcao = "ajax_filter_select";
      }
      if ('ajax_fixed_columns_grid_save' == $nmgp_opcao) {
          _4659dc304dce123233515fddd4cc5558_saveFixedColumnsGrid($_POST['fixed_index'], $_POST['fixed_action'], $_POST['script_case_init']);
      }
      if ('ajax_fixed_columns_grid_load' == $nmgp_opcao) {
          _4659dc304dce123233515fddd4cc5558_loadFixedColumnsGrid($_POST['script_case_init']);
      }
       $contr_Configuracao_Lst->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_Configuracao_Lst(&$str)
   {
   }
   function nm_protect_num_Configuracao_Lst($name, &$val)
   {
       if (empty($val))
       {
          return;
   ...
   function Configuracao_Lst_pack_protect_string($sString)
   {
    ...
    function Configuracao_Lst_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
...
<?php
        global $script_case_init;
        if ($flushBuffer && $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['opcao'] != 'print') {
            $bufferSize = @ini_get('output_buffering');
            if ('' != $bufferSize) {
    ...
    function _4659dc304dce123233515fddd4cc5558_initializeFixedColumnsGrid($script_case_init)
    {
        if (!isset($_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['fixed_columns_grid'])) {
            $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['fixed_columns_grid'] = '';
        }
    }

    function _4659dc304dce123233515fddd4cc5558_saveFixedColumnsGrid($index, $action, $script_case_init)
    {
        _4659dc304dce123233515fddd4cc5558_initializeFixedColumnsGrid($script_case_init);

        if ('on' == $action) {
            $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['fixed_columns_grid'] = $index;
        } elseif (0 < $index) {
            $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['fixed_columns_grid'] = $index - 1;
        } else {
            $_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['fixed_columns_grid'] = '';
        }
    ...
    function _4659dc304dce123233515fddd4cc5558_loadFixedColumnsGrid($script_case_init)
    {
        _4659dc304dce123233515fddd4cc5558_initializeFixedColumnsGrid($script_case_init);
        ...
        echo json_encode(
            array(
                'status' => 'ok',
                'last_index' =>$_SESSION['sc_session'][$script_case_init]['Configuracao_Lst']['fixed_columns_grid']
            )
        );
        exit;
    }
